...
cd C:\Users\7336135\Android11\eclipse-workspace\Realme_85G_RMX3241
mvn -DtotalPictureCountFront=3 -DtotalPictureCountFront1=3 -DtotalPictureCountFront2=3 -DtotalPictureCountFront3=3 -DTolerance_Level=%Tolerance_Level% -DfileName=testng9F.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\ABC\Realme_85G_RMX3241_%mydate%_%mytime%_%Qual_Capacity%.txt
