...
public class Test10
{
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Click on first file to play highest recorded resolution video file in usd card");
			System.out.println("Click on first file to play highest recorded resolution video file in usd card");
	...
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		...
		try {
			...
			TimeUnit.SECONDS.sleep(5);
			logger.info("sselect test1 folder");
