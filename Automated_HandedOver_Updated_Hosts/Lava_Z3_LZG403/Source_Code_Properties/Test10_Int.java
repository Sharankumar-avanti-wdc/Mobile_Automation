...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[336,159][384,207]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[336,159][384,207]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select 3rd rear Video Resolution: 420p");
			System.out.println("Select 3rd rear Video Resolution: 420p");
			//Select 2nd resolution
			MobileElement thirdRes = driver.findElement(By.xpath("//*[@bounds='[70,297][185,402]']"));
			thirdRes.click();
			TimeUnit.SECONDS.sleep(2);
	...
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		...
		try {
			...
			System.err.println("Pass: FHD Video play back and fast forward is successful ");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		}
