...
import Xiaomi_11i_HyperCharge_21091116UI.Test9;
...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Click 9:16
			logger.info("Select third rear camera resolution 3:4");
			System.out.println("Select third rear camera resolution 3:4");
			...
			System.out.println("Select Fourth rear camera resolution: Full");
			...
			System.out.println("Launch file manager application and verify captures Images present in uSD Card");
