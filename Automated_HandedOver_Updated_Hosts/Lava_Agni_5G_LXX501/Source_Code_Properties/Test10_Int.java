...
import Lava_Agni_5G_LXX501.Test10_Int;
...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Select 2nd resolution
			logger.info("Select 4th highest rear camera video resolution: CIF");
			System.out.println("Select 4th highest rear camera video resolution: CIF");
	...
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		...
		driver.findElement(By.xpath("Internal/*[@text='Internal storage']")).click();
		TimeUnit.SECONDS.sleep(5);
