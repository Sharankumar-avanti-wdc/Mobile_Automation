...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select 1st Back Video Resolution:1080p,30fps");
			System.out.println("Select 1st Back Video Resolution: 1080p,30fps");
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 2nd Back Video Resolution: 720P,30fps");
			System.out.println("Select 2nd Back Video Resolution:  720P,30fps");
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 3rd Back Video Resolution: 1080,30fps");
			System.out.println("Select 3rd Back Video Resolution:  1080p,60fps");
			//Select 2nd resolution
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 3rd Back Video Resolution: 4k,30fps");
			System.out.println("Select 3rd Back Video Resolution:  4k,30fps");
			//Select 2nd resolution
