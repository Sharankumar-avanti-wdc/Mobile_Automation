...
import BlackView_Tab6_Kids.Test10_Int;
  ...
  public class Test10_Int
  {
	...
	private boolean isPaused;
		...
		public void SetUp() throws MalformedURLException {
			...
			dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Tab 6 Kids");
			dc.setCapability(MobileCapabilityType.UDID, "TAB6KIDSNEU001549");
			...
			//Launch Home screen 
			 ...
			 ((StartsActivity) driver).startActivity(new Activity("com.blackview.launcher", "com.android.searchlauncher.SearchLauncher"));
	  		...
	  		TimeUnit.SECONDS.sleep(2);
  				...
  				logger.info("Select first highest rear camera video resolution: HD 720p");
  				System.out.println("Select first highest rear camera video resolution: HD 720p");
  	...
  	//Click On Settings
		...
		logger.info("Select second highest rear camera video resolution: SD 480p");
		System.out.println("Select second highest rear camera video resolution: SD 480p");
