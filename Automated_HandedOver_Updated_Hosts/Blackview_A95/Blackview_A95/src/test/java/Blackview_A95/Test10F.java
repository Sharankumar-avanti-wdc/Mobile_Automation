...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("3.Move front camera recorded videos from uSD card to Test10F folder in uSD card");
		...
		System.out.println("3.Move front camera recorded videos from uSD card to Test10F folder in uSD card");
