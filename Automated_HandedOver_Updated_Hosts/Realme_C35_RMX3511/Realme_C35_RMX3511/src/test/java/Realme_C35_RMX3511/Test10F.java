...
public class Test10F
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera front camera videos create Test10F and cut paste all videos in Test10F folder");
