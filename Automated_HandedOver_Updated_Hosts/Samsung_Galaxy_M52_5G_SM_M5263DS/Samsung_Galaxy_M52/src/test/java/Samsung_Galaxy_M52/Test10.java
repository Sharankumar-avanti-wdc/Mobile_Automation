...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select fourth rear camera Video Resolution: BACK_CAMCORDER_RESOLUTION_FHD_30");
			System.out.println("Select fourth rear camera Video Resolution: BACK_CAMCORDER_RESOLUTION_FHD_30");
			//Select 3rd resolution
