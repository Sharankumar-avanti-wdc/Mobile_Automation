...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			System.out.println("recordingDurationRearExt2 = "+ recordingDurationRearExt2 + "Seconds");
			...
			System.out.println("recordingDurationRearExt3 = "+ recordingDurationRearExt3 + "Seconds");
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Pass: Recorded Video play back and fast forward successfull ");
			System.out.println("Calling DataMovementOperation() to move recorded rear camer videos to Test10 Folder in exteral storage ");
			logger.info("Calling DataMovementOperation() to move recorded rear camer videos to Test10 Folder in external storage");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
	...
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		...
		try {
			...
			try {
				...
				logger.info("Select LG_4K_DEMO_HDR_2018_(60FPS)_ELBA(480p).mp4 file for video playback from uSD card(Test-->Videos)");
