...
import Samsung_Galaxy_M33_5G_SMM336BUDS.Test9F;
...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Unable to select Front camera image resolutions during automation.Hence capturing default resolution images.");
			System.out.println("Unable to select Front camera image resolutions during automation.Hence capturing default resolution images.");
			...
			//	MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[306,120][426,240]']"));
			//	SecRes.click();
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			...
			//MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[654,120][774,240]']"));
			//ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
