package ZTE_Axon30_5G_ZTE_A2322G;
...
public class Test10F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "ZTE  Axon 30 5G");
		dc.setCapability(MobileCapabilityType.UDID, "320316011744");
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			((StartsActivity) driver).startActivity(new Activity("com.zte.camera", "com.zte.camera.CameraActivity"));
			TimeUnit.SECONDS.sleep(5);
			try {
				...
				((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"REJECT\")").click();
				TimeUnit.SECONDS.sleep(5);
				logger.info("Select turn on option");
				System.out.println("Select turn on option");
				driver.findElement(By.xpath("//*[@resource-id='com.zte.camera:id/tip_delete']")).click();
				TimeUnit.SECONDS.sleep(5);
			}
			...
			driver.findElement(By.xpath("//*[@bounds='[888,99][1032,243]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click On Settings
			logger.info("Select settings option1");
			System.out.println("Select settings option1");
			driver.findElement(By.xpath("//*[@text='More Setting']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Swipe Up and Search for Storage Option and Click 
			logger.info("select Save location");
			System.out.println("select Save location");
			driver.findElement(By.xpath("//*[@text='Save location']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("select sd card");
			System.out.println("select sd  card");
			driver.findElement(By.xpath("//*[@bounds='[936,2086][1008,2158]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@resource-id='com.zte.camera:id/camera_picker']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Switch to Video mode
			logger.info("Clicking Video Tab");
			System.out.println("Clicking Video Tab");
			MobileElement video1 = driver.findElement(By.xpath("//*[@text='VIDEO']"));
			video1.click();
			TimeUnit.SECONDS.sleep(3);
			//Click On Settings
			logger.info("Select settings option");
			...
			driver.findElement(By.xpath("//*[@bounds='[249,126][380,216]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			MobileElement StartRecording = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Shutter button\"]"));
			...
			MobileElement StopRecording = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Stop Recording\"]"));
			StopRecording.click();
			...
			logger.info("Select First back video Resolution:  720P");
			System.out.println("Select First Back video resolution:  720P");
			driver.findElement(By.xpath("//*[@bounds='[711,126][818,216]']")).click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording1 = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Shutter button\"]"));
			...
			MobileElement StopRecording1 = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Stop Recording\"]"));
			StopRecording1.click();
			TimeUnit.SECONDS.sleep(3);
			//select photo mode
			logger.info("select SELFIE mode");
			System.out.println("select SELFIE mode");
			driver.findElement(By.xpath("//*[@text='SELFIE']")).click();
			TimeUnit.SECONDS.sleep(3);
