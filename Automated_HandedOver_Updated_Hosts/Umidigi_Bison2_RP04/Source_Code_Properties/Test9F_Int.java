...
import Umidigi_Bison2_RP04.Test9F_Int;
...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Select 3:4 
			logger.info("Select front camera second image resolution: 18M(16:9)-5632x3168");
			System.out.println("Select front camera second image resolution: 18M(16:9)-5632x3168");
			...
			//Click 9:16
			logger.info("Select front camera third image resolution: 12M(4:3)-4000x3000");
			System.out.println("Select front camera third image resolution: 12M(4:3)-4000x3000");
			...
			//Click 9:16
			logger.info("Select front camera fourth image resolution: 10M(20:9)-4800x2160");
			System.out.println("Select front camera fourth image resolution: 10M(20:9)-4800x2160");
			...
			//Click 9:16
			logger.info("Select front camera fifth image resolution 9M(16:9)-4096x2304");
			System.out.println("Select front camera fifth image resolution: 9M(16:9)-4096x2304");
			...
			//Click 9:16
			logger.info("Select front camera sixth image resolution: 5M(4:3)-2560x1920");
			System.out.println("Select front camera sixth image resolution: 5M(4:3)-2560x1920");
