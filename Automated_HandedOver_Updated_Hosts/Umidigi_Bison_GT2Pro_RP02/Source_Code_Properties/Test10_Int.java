...
import Umidigi_Bison_GT2Pro_RP02.Test10_Int;
	...
	private boolean isPaused;
		...
		public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
	  	java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
	        ...
	        logger.info("2.Playback Highest resolution recorded video from internal storage Card, fast forward playback and pause video scenario ");
	        logger.info("3.Playback copied videos from Test1 folder, fast forward and pause scenario");
	        logger.info("4.Move recorded videos from Exteranl storage-->DCIM-->Camera folder to Test10_Int folder in internal storage");
			...
			//Launch Home screen 
			 ...
			 ((StartsActivity) driver).startActivity(new Activity("com.android.launcher3", "com.android.searchlauncher.SearchLauncher"));
  			...
  			//Click On Settings
  				...
  				MobileElement Setting1 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/hdr_icon']"));
  				Setting1.click();
  				TimeUnit.SECONDS.sleep(5);
  				...
  				logger.info("Select first highest rear camera video resolution: 4K(3840x2160)");
  				System.out.println("Select first highest rear camera video resolution: 4K(3840x2160)");
  				MobileElement FirstRes = driver.findElement(By.xpath("//*[@text='4K(3840x2160)']"));
  				FirstRes.click();
  				TimeUnit.SECONDS.sleep(2);
  				((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
  				TimeUnit.SECONDS.sleep(2);
  	...
  	// Load properties file for video recording duration
		...
		//Start Recording
  		...
  		MobileElement StartRecording = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/img']"));
  	...
  	//Click On Settings
  		logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Setting2 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/hdr_icon']"));
			Setting2.click();
			TimeUnit.SECONDS.sleep(5);
  	//Click On Video size
		logger.info("Select Video size option");
		...
		logger.info("Select second highest rear camera video resolution: FHD(1920x1080)");
		System.out.println("Select second highest rear camera video resolution: FHD(1920x1080)");
		MobileElement secondRes = driver.findElement(By.xpath("//*[@text='FHD(1920x1080)']"));
		secondRes.click();
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
  	...
  	// Load properties file for video recording duration
		...
		//Start Recording
  		logger.info("Start video recording");
  		System.out.println("Start video recording");
  		MobileElement StartRecording1 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/img']"));
  	...
  	//Click On Settings
  		logger.info("Select settings option");
		System.out.println("Select settings option");
		MobileElement Setting3 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/hdr_icon']"));
		Setting3.click();
		TimeUnit.SECONDS.sleep(5);
		...
		TimeUnit.SECONDS.sleep(5);
  			...
  			//Select 2nd resolution
  				logger.info("Select rear camera third video resolution: HD(1280x720)");
  				System.out.println("Select rear camera third video resolution: HD(1280x720)");
  				MobileElement ThirdRes = driver.findElement(By.xpath("//*[@text='HD(1280x720)']"));
  				ThirdRes.click();
  	  		TimeUnit.SECONDS.sleep(2);
  	  	  ((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
  	  		TimeUnit.SECONDS.sleep(2);
	  	...
	  	prop.load(Test10_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
  			...
  			//Start Recording
  	  		logger.info("Start video recording");
  	  		System.out.println("Start video recording");
  	  		MobileElement StartRecording2 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/img']"));
  	  	...
  	  	//Click On Settings
  	  		logger.info("Select settings option");
  			System.out.println("Select settings option");
  			MobileElement Setting4 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/hdr_icon']"));
  			Setting4.click();
  			TimeUnit.SECONDS.sleep(5);
  			...
  			logger.info("Select Video size option");
  			System.out.println("Select Video size option");
  			MobileElement Videosize4 = driver.findElement(By.xpath("//*[@text='Video quality']"));
  			Videosize4.click();
  			TimeUnit.SECONDS.sleep(5);
  	  			
  	  			//Select 2nd resolution
  	  				logger.info("Select rear camera fourth video resolution: VGA(640x480)");
  	  				System.out.println("Select rear camera fourth video resolution: VGA(640x480)");
  	  				MobileElement FourthRes = driver.findElement(By.xpath("//*[@text='VGA(640x480)']"));
  	  			FourthRes.click();
  	  	  		TimeUnit.SECONDS.sleep(2);
  	  	  	  ((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
  	  	  		TimeUnit.SECONDS.sleep(2);
  		  	...
  		  	prop.load(Test10_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
  	  			...
  	  			//Start Recording
  	  	  		logger.info("Start video recording");
  	  	  		System.out.println("Start video recording");
  	  	  		MobileElement StartRecording3 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/img']"));
	  ...
	  public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		public void DataMoveOperation() throws  IOException, InterruptedException{	   
			...
			try {
				...
				logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test10_Int and cut paste all videos in Test10_Int folder");
