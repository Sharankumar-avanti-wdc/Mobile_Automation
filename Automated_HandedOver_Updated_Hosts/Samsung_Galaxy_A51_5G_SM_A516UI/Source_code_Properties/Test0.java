			...
			System.out.println("select rear video size option");
	  		...
	  		//Select 1st resolution
				...
				//Start Recording
		  		...
		  		MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[540,2009][744,2186]']"));
		  		StopRecording.click();
		  	...
		  	//Start Recording
		  		...
		  		logger.info("Stop video recording");
		  		System.out.println("Stop video recording");
		  		MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[540,2009][744,2186]']"));
