...
import Xiaomi_Redmi10_Prime_2106111981.Test3;
...
public class Test3 {
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("1.Unmount,mount uSD Card and Format uSD card for specified number of times");
		...
		{ 
			...
			logger.info("Launch  setting application to Unmount,mount and Format uSD card");
			System.out.println("Launch  setting application to Unmount,mount and Format uSD card");
			try {
				...
				try {
					...
					logger.info("Pass: Images and videos are not present in the DCIM folder! Hence card format is successfully completed ");

					System.out.println("Pass: Images and videos are not present in the DCIM folder! Hence card format is successfully completed ");
