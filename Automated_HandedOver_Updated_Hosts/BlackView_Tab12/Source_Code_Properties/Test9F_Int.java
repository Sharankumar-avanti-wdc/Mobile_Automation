...
import BlackView_Tab12.Test9F_Int;
...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		//Select 3:4 
		logger.info("Select front camera second image resolution: (16:9) 3.8 megapixels");
		System.out.println("Select front camera second image resolution: (16:9) 3.8 megapixels");
