...
cd C:\Users\7336135\Android11\eclipse-workspace\BlackView_Tab_10_Pro
mvn -DtotalPictureCountRear=18 -DtotalPictureCountRear1=18 -DtotalPictureCountRear2=18 -DTolerance_Level=%Tolerance_Level% -DfileName=testng9F.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\TEST\Blackview_Tab10_Pro_%mydate%_%mytime%_%Qual_Capacity%.txt
