...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 4th resolution
			logger.info("Select fourth Image Resoution: 4:3 (64MP)");
			System.out.println("Select fourth Image Resoution: 4:3 (64MP)");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.asus.camera:id/capture_inside_icon_root']")).click();
				TimeUnit.SECONDS.sleep(6);
				System.out.println("clicking Image of 4th Resolutions4:3 (64MP): "+j4);
				logger.info("clicking Image of 4th Resolutions4:3 (64MP): "+j4);
