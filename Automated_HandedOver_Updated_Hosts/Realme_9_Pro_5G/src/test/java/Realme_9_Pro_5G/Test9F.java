...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@resource-id='com.oplus.camera:id/switch_camera_button']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[678,0][834,240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select first Image Resoution: 4:3 ");
			System.out.println("Select first Image Resoution: 4:3 ");
			driver.findElement(By.xpath("//*[@bounds='[600,122][708,230]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[450,122][558,230]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Select third Resoution: 16:9");
			System.out.println("Select third Image Resoution: 16:9");
			driver.findElement(By.xpath("//*[@bounds='[750,122][858,230]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.oplus.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 3rd Resolutions 16:9: "+j2);
				logger.info("clicking Image of 3rd Resolutions 16:9: "+j2);
			...
			driver.findElement(By.xpath("//*[@bounds='[900,122][1008,230]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.oplus.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 4th Resolutions Full: "+j3);
				logger.info("clicking Image of 4th Resolutions Full: "+j3);
