...
public class Test0 {
	...
	@Test
		...
		//Click On Settings
			...
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
  			...
  			System.out.println("Click ratio to select video resolution");
	  			...
	  			System.out.println("Select first rear camera  Video Resolution:BACK_CAMCORDER_RESOLUTION_UHD_30");
				...
				//Start Recording
	  			...
	  			logger.info("Select Second highest rear camera Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
	  			System.out.println("Select Second highest rear camera Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
  	...
  	//Verifying Captured Videos
		...
		logger.info("Click On Select All Options");
		System.out.println("Click On Select All Options");
		MobileElement SelectAll = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget."
				+ "FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.view.ViewGroup/android."
				+ "widget.LinearLayout[1]/android.widget.FrameLayout/android.view.ViewGroup/android.widget.LinearLayout/android.view."
