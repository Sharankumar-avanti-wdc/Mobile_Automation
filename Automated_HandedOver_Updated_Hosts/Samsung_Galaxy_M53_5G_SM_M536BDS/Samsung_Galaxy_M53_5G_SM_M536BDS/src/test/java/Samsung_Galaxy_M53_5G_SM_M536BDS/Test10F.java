package Samsung_Galaxy_M53_5G_SM_M536BDS;
...
import Samsung_Galaxy_M53_5G_SM_M536BDS.Test10;
...
public class Test10F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Galaxy M53 5G");
		dc.setCapability(MobileCapabilityType.UDID, "RFCT41Y5Y9V");
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select 1st Front Video Resolution:Front camera video size, UHD (30 fps)");
			System.out.println("Select 1st Front Video Resolution:Front camera video size, UHD (30 fps)");
			...
			driver.findElement(By.xpath("//*[@bounds='[540,2024][744,2175]']")).click();
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			...
			logger.info("Select second resolution::Front camera video size, FHD (60 fps)");
			System.out.println("Select second resolution:Front camera video size, FHD (60 fps)");
			...
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			logger.info("Click front video size and select third resolution");
			System.out.println("Click front video size and select third resolution");
			MobileElement FrontVideoResolution2 = driver.findElement(By.xpath("//*[@text='Video size']"));
			...
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			logger.info("Click front video size and select fourth resolution");
			System.out.println("Click front video size and select fourth resolution");
			MobileElement FrontVideoResolution3 = driver.findElement(By.xpath("//*[@text='Video size']"));
			FrontVideoResolution3.click();
			TimeUnit.SECONDS.sleep(2);
			//Select second  resolution
			logger.info("Select 4th resolution");
			System.out.println("Select 4th resolution");
			...
			logger.info("Switch to back  camera mode");
			System.out.println("Switch to back camera mode");
			MobileElement SwitchTobackCamera1 = driver.findElement(By.xpath("//*[@text='PHOTO']"));
			TimeUnit.SECONDS.sleep(2);
			SwitchTobackCamera1.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
