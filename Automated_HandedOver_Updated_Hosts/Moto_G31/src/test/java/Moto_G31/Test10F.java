...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//*[@bounds='[207,1879][333,2005]']"));
			...
			//FirstRes.click();
			MobileElement FirstRes1 = driver.findElement(By.xpath("//*[@bounds='[834,1357][960,1483]']"));
			FirstRes1.click();
			TimeUnit.SECONDS.sleep(3);
			...
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[708,1357][834,1483]']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement SwitchToBackCamera = driver.findElement(By.xpath("//*[@bounds='[207,1879][333,2005]']"));
			...
			TimeUnit.SECONDS.sleep(5);
			driver.findElement(By.xpath("//*[@bounds='[627,2148][805,2237]']")).click();
			TimeUnit.SECONDS.sleep(5);
