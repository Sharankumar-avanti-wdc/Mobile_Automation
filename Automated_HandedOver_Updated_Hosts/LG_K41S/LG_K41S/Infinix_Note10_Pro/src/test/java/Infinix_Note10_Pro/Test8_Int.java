...
public class Test8_Int
{
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("Clicking Test1Folder");
		((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Test1\")").click();
		TimeUnit.SECONDS.sleep(5);
		logger.info("Clicking again Test1Folder");
		System.out.println("Clicking again Test1Folder");
		driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/title']")).click();
		TimeUnit.SECONDS.sleep(5);
		logger.info("Clicking testfile");
		System.out.println("Clicking testfile");
		((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"test_file\")").click();
		TimeUnit.SECONDS.sleep(5);
		logger.info("Clicking on 1GB ");
		System.out.println("Clicking on1GB");
		...
		TimeUnit.SECONDS.sleep(5);
		System.out.println("Click on 1st File to Play audio for 30Seconds");
		logger.info("Click on 1st File to Play audio for 30Seconds");
		//Click 1st File to Play Video
		try {
			logger.info("Clicking on 11 Rob Thomas - Lonely No More.mp3");
			System.out.println("Clicking on 11 Rob Thomas - Lonely No More.mp3");
			...
			try
			{
				logger.info("Clicking on Files by Google");
				System.out.println("Clicking on Files by Google");
				((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Files by Google\")").click();
				TimeUnit.SECONDS.sleep(5);
				logger.info("Clicking on always");
				System.out.println("Clicking on always");
				((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Always\")").click();
				TimeUnit.SECONDS.sleep(5);
		...
		logger.info("Click on 2nd File to Play audio for 30Seconds");
		System.out.println("Click on 2nd File to Play audio for 30Seconds");
		//Click 1st File to Play Video
		try {
			logger.info("Clicking on file_example_MP3_5MG.mp3");
			System.out.println("Clicking on file_example_MP3_5MG.mp3");
		...
		logger.info("Click on 3rd File to Play audio for 30Seconds");
		System.out.println("Click on 3rd File to Play audio for 30Seconds");
		//Click 1st File to Play Video
		try
		{
			logger.info("Clicking on Laahe.Mp3.mp3");
			System.out.println("Clicking on Laahe.Mp3.mp3");
