...
import Blackview_Oscal_C20.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		//Click 9:16
		logger.info("Select rear camera third resolution:(4:3) 1.2 megapixels");
		System.out.println("Select rear camera third resolution:(4:3) 1.2 megapixels");
		driver.findElement(By.xpath("//*[@text='(4:3) 1.2 megapixels']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		//Click 9:16
		logger.info("Select Rear camera fourth image resolution (16:9) 2.1 megapixels");
		System.out.println("Select Rear camera fourth image resolution (16:9) 2.1 megapixels");
		...
		//Click 9:16
		logger.info("Select Rear camera fifth image resolution: (16:9) 0.4 megapixels");
		System.out.println("Select rear camera fifth image resolution: (16:9) 0.4 megapixels");
