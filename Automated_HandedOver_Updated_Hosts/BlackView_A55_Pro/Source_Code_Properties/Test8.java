...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(5);
		logger.info("Host does not support audio recording to external storage. Hence skipping audio recording and recorded audio playback scenario");
		System.out.println("Host does not support audio recording to external storage. Hence skipping audio recording and recorded audio playback scenario");
		PlayCopiedAudioFile();
