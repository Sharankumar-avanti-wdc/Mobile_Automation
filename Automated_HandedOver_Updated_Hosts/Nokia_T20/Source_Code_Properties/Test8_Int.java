...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		FileHandler fileHandler = new FileHandler("status_log_Test8_Int_Int.log");
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("Launch file manager select internal storage-->Test1 folder-->test_file-->1GB-->MP3 folder for audio playback and fast forward scenario");
		System.out.println("Launch file manager select internal storage-->Test1 folder-->test_file-->1GB-->MP3 folder for audio playback and fast forward scenario");
