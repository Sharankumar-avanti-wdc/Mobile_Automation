...
import Umidigi_Bison2_RP04.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select Rear camera first image resolution: 48M(4:3)-8000x6000");
			System.out.println("Select Rear camera first image resolution: 48M(4:3)-8000x6000");
			...
			//Select 3:4 
			logger.info("Select Rear camera second resolution: 24M(4:3)-5632x4224");
			System.out.println("Select Rear camera second resolution: 24M(4:3)-5632x4224");
			...
			//Click 9:16
			logger.info("Select rear camera third resolution:18M(16:9)-5632x3168");
			System.out.println("Select rear camera third resolution:18M(16:9)-5632x3168");
			driver.findElement(By.xpath("//*[@text='18M(16:9)-5632x3168']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			//Click 9:16
			logger.info("Select Rear camera fourth image resolution 12M(4:3)-4000x3000");
			System.out.println("Select Rear camera fourth image resolution 12M(4:3)-4000x3000");
			driver.findElement(By.xpath("//*[@text='12M(4:3)-4000x3000']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			//Click 9:16
			logger.info("Select Rear camera fifth image resolution: 8M(16:9)-3840x2160");
			System.out.println("Select rear camera fifth image resolution: 8M(16:9)-3840x2160");
			driver.findElement(By.xpath("//*[@text='8M(16:9)-3840x2160']")).click();
			TimeUnit.SECONDS.sleep(3);
