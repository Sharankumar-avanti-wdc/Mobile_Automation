...
public class Test0 {
	...
	public void Images() throws  IOException, InterruptedException {
		...
		{ 
			TimeUnit.SECONDS.sleep(2);
			driver.findElement(By.xpath("//*[@resource-id='com.motorola.camera3:id/capture_bar_shutter_button']")).click();
			TimeUnit.SECONDS.sleep(5);
			System.out.println("Capturing default resolutions image"+j);
			logger.info("Capturing default resolutions image"+j);
		}
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
	...
	public void Video() throws  IOException, InterruptedException {
		...
		try 
		{ 
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Not now\")").click();
			TimeUnit.SECONDS.sleep(2);
		} 
		catch(Exception exp)
		{ 
		...
		try 
		{ 
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"SURE\")").click();
			TimeUnit.SECONDS.sleep(2);
		} 
		catch(Exception exp)
		{ 
		...
		RearVideoSize.click();
		logger.info("Select 1st Back Video Resolution: Aspect ratio 9:16");
		System.out.println("Select 1st Back Video Resolution: Aspect ratio 9:16");
		...
		logger.info("Select 2nd Back Video Resolution: Aspect ratio Full");
		System.out.println("Select 2nd Back Video Resolution: Aspect ratio Full");
