...
import Motorola_Moto_E30_XT21596.Test9F_Int;
...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select front camera front image resolution: 3:4");
			System.out.println("Select front camera front image resolution: 3:4");
			...
			{ 
				TimeUnit.SECONDS.sleep(2);
				//Start image capture
				MobileElement shutter1 = driver.findElement(By.xpath("//*[@resource-id='com.ontim.camera2:id/mode_shutter_button']"));
				shutter1.click();
				TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select front camera third image resolution: 1:1");
			System.out.println("Select front camera third image resolution: 1:1");
			...
			{ 
				TimeUnit.SECONDS.sleep(2);
				//Start image capture
				MobileElement shutter2 = driver.findElement(By.xpath("//*[@resource-id='com.ontim.camera2:id/mode_shutter_button']"));
				shutter2.click();
				TimeUnit.SECONDS.sleep(5);
