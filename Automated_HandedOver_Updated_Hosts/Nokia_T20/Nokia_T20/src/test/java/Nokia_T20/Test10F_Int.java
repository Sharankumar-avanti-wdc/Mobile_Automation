  ...
  public class Test10F_Int
  {
	...
	private String Result;
		...
		public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
			...
			System.out.println("1.Launch Camera application and start front camera video recording for all host applicable resolutions in internal mount storage");
			System.out.println("2.Playback front Highest recorded video from uSD card for 30 seconds, pause video playback, lock mobile and wait 30 seconds, unlock mobile and playback video from pause video duration");
			 System.out.println("3.Move recorded videos from internal mount storage-->DCIM-->Camera folder to Test10 folder in internal mount storage");
	  	...
	  	//Launch Camera Application for front camera video recording
			try {
				...
				((StartsActivity) driver).startActivity(new Activity("com.android.camera2", "com.android.camera.CameraLauncher"));
				logger.info("Test10F_Int_Fcam_res: 1 resolutions supported");
				System.out.println("Test10F_Int_Fcam_res: 1 resolutions supported");
		 ...
		 // Load properties file
	  	...
	  	//launch file manager application and verify recorded video files in uSD card
			...
			TimeUnit.SECONDS.sleep(5);
			TotalFiles.click();
			logger.info("Test10F_Int_Fcam_video: 1 Videos captured successfull");
			System.out.println("Test10F_Int_Fcam_video: 1 Videos captured successfull");
