...
import BlackView_Tab10.Test10_Int;
	...
	private boolean isPaused;
		...
		public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
	  	java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
	        ...
	        logger.info("2.Playback Highest resolution recorded video from Internal mount uSD card storage, fast forward playback and pause video scenario ");
	        ...
	        System.out.println("4.Move recorded videos from Exteranl storage-->DCIM-->Camera folder to Test10_Int folder in internal mount storage");
		...
		//Select 1st resolution
			logger.info("Select rear camera first video resolution: FHD");
			System.out.println("Select rear camera first video resolution: FHD");
  	...
  	//Click On Settings
		...
		//Select 2nd resolution
			logger.info("Select rear camera second video reslotion: HD");
			System.out.println("Select rear camera second video reslotion: HD");
  	...
  	//Click On Settings
  			...
  			//Select 2nd resolution
  				logger.info("Select rear camera third video resolution: VGA");
  				System.out.println("Select rear camera third video resolution: VGA");
  				MobileElement ThirdRes = driver.findElement(By.xpath("//*[@text='VGA']"));
  				ThirdRes.click();
  	  		TimeUnit.SECONDS.sleep(2);
  	  	  ((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
  	  		TimeUnit.SECONDS.sleep(2);
	  	...
	  	//launch file manager application and verify recorded video files in uSD card
			logger.info("Launch File Manager Application to verify captured videos in internal mount storage");
			System.out.println("Launch File Manager Application to verify captured videos in internal mount storage");
			//Launch File Manager application to verify  Image capture
			logger.info("Launch File Manager application and verify recorded video from internal storage");
			System.out.println("Launch File Manager application and verify recorded video from internal storage");
	  ...
	  public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		public void DataMoveOperation() throws  IOException, InterruptedException{	   
			...
			try {
				...
				logger.info("launch file manager application select internal storage-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test10_Int and cut paste all videos in BCFC_Cameravideos folder");
				System.out.println("launch file manager application select internal storage-->DCIM folder-->Camera folder-->Select all rear camera images create Test10_Int folder and cut paste all videos in BCFC_Cameravideos folder");
