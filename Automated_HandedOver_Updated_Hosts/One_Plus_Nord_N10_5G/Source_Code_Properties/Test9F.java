...
import OnePlus_Nord_N10_5G.Test9F;
	...
	private boolean isPaused;
		...
		public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
	  	...
	  	//Launching Camera Application for Rear picture capture
	  		logger.info("Launch camera applicatio for front camera image capture");
  			System.out.println("Launch camera applicatio for front camera image capture");
		...
		System.out.println("Switch to Front  Camera mode");
  		MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//*[@resource-id='com.oneplus.camera:id/switch_camera_button']"));
		TimeUnit.SECONDS.sleep(2);
		...
		driver.findElement(By.xpath("//*[@bounds='[701,108][809,216]']")).click();
			TimeUnit.SECONDS.sleep(6);
			logger.info("Select front camera image resoltuion");
			System.out.println("Select front camera image resoltuion");
