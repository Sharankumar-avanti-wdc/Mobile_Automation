	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				MobileElement Unmount =	driver.findElement(By.xpath("//*[@bounds='[1078,588][1162,700]']"));
				Unmount.click();
				...
				MobileElement SDCard =	driver.findElement(By.xpath("//*[@bounds='[604,612][792,648]']"));
				SDCard.click();
				TimeUnit.SECONDS.sleep(3);
				//Select mount option
				logger.info("Select mount option");
				System.out.println("Select mount option");
				MobileElement Mount =	driver.findElement(By.xpath("//*[@bounds='[603,959][990,1040]']"));
				Mount.click();
