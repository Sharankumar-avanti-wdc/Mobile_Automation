...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@resource-id='com.transsion.camera:id/setting_ui_item_settings_entry']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[278,1849][397,1918]']")).click();
			TimeUnit.SECONDS.sleep(3);
