...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("3. Move front camera recorded videos from external storage to Test10F folder in external storage");
		...
		System.out.println("3. Move front camera recorded videos from external storage to Test10F folder in external storage");
		...
		try {
			...
			logger.info("Select first highest front camera video resolution: 1080p");
			System.out.println("Select first highest front camera video resolution: 1080p");
			...
			//Select first resolution
			logger.info("Select second highest front camera video resolution: 720p");
			System.out.println("Select second highest front camera video resolution: 720p");
			MobileElement SecRes = driver.findElement(By.xpath("//*[@text='720p']"));
			SecRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select first resolution
			logger.info("Select third highest front camera video resolution: 480p");
			System.out.println("Select third highest front camera video resolution: 480p");
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@text='480p']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement SwitchToBackCamera = driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/camera_switch']"));
