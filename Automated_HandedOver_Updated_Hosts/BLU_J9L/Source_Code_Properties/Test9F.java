...
public class Test9F
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera front camera images create Test9F and cut paste all images in test9F folder");
