	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try {
				...
				TimeUnit.SECONDS.sleep(3);
				//Click MoreOption
				logger.info("Click on Delete options");
				System.out.println("Click Delete options");
				MobileElement Moreoptions =	driver.findElement(By.xpath("//*[@bounds='[528,64][624,160]']"));
				Moreoptions.click();
				TimeUnit.SECONDS.sleep(3);
			...
			//logger.info("Host does not support format with data scneario for internal mount");
			//System.out.println("Host does not support format with data scneario for internal mount");
