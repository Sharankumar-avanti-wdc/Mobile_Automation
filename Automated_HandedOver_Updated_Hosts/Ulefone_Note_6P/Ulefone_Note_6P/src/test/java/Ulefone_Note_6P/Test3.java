	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				MobileElement Unmount =	driver.findElement(By.xpath("//*[@bounds='[576,732][688,877]']"));
				Unmount.click();
				...
				MobileElement SDCard =	driver.findElement(By.xpath("//*[@bounds='[32,780][80,828]']"));
				SDCard.click();
