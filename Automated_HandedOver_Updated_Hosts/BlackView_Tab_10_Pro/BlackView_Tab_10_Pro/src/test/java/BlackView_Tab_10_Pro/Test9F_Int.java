...
import BlackView_Tab_10_Pro.Test9F_Int;
...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Select 3:4 
			logger.info("Select front camera second image resolution: 5M(1:1)");
			System.out.println("Select front camera second image resolution: 5M(1:1)");
			...
			//Select 3:4 
			logger.info("Select front camera third image resolution: 5M(16:9)");
			System.out.println("Select front camera third image resolution: 5M(16:9)");
			...
			System.out.println("totalPictureCountFront1 = "+ totalPictureCountFront2);
