...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement Storagepath = driver.findElement(By.xpath("//*[@bounds='[882,597][1008,723]']"));
			Storagepath .click();
			TimeUnit.SECONDS.sleep(5);
			//Select SD Card
			logger.info("Select SD as storage option");
			System.out.println("Select SD as storage option");
			MobileElement Sdcard = driver.findElement(By.xpath("//*[@bounds='[746,1095][872,1221]']"));
			Sdcard.click();
			TimeUnit.SECONDS.sleep(5);
			//Switch to front camera mode
			logger.info("Switch to front camera mode");
			System.out.println("Switch to front camera mode");
			MobileElement SwitchCameraF = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/camera_switcher']"));
			SwitchCameraF.click();
			TimeUnit.SECONDS.sleep(5);
			// Switch to Video mode
				...
				//Click On Settings
  				...
  				MobileElement Videosize = driver.findElement(By.xpath("//*[@bounds='[342,129][468,255]']"));
  				Videosize.click();
  				TimeUnit.SECONDS.sleep(5);

  				//Select 1st resolution
  				logger.info("Select first highest front camera video resolution: FHD");
  				System.out.println("Select first highest front camera video resolution: FHD");
			...
			logger.info("Select Video quality option");
			System.out.println("Select Video quality option");
			MobileElement Videosize1 = driver.findElement(By.xpath("//*[@bounds='[342,129][468,255]']"));
			Videosize1.click();
			TimeUnit.SECONDS.sleep(5);

			//Select 2nd resolution
			logger.info("Select second highest front camera video resolution: FHD");
			System.out.println("Select second highest front camera video resolution: FHD");
			MobileElement secondRes = driver.findElement(By.xpath("//*[@bounds='[341,861][467,987]']"));
			secondRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			//Click On Settings
  			...
  			logger.info("Select Video quality option");
			System.out.println("Select Video quality option");
  			MobileElement Videosize2 = driver.findElement(By.xpath("//*[@bounds='[342,129][468,255]']"));
  			Videosize2.click();
  			TimeUnit.SECONDS.sleep(5);

  			//Select third resolution
  			logger.info("Select third highest front camera video resolution: HD");
  			System.out.println("Select third highest front camera video resolution: HD");
  			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[341,861][467,987]']"));
  			ThirdRes.click();
  			TimeUnit.SECONDS.sleep(2);
  		// Load properties file for video recording duration
  				...
  				//Click On Settings
  		  		...
  		  		logger.info("Select Video quality option");
  				System.out.println("Select Video quality option");
  		  			MobileElement Videosize3 = driver.findElement(By.xpath("//*[@bounds='[342,129][468,255]']"));
  		  			Videosize3.click();
  		  			TimeUnit.SECONDS.sleep(5);

  		  			//Select third resolution
  		  			logger.info("Select fourth highest front camera video resolution: HD");
  		  			System.out.println("Select fourth highest front camera video resolution: HD");
  		  			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[341,861][467,987]']"));
  		  			FourthRes.click();
  		  			TimeUnit.SECONDS.sleep(2);
  		  		// Load properties file for video recording duration
  		  				...
  		  				logger.info("Switch to front camera mode");
  		  				System.out.println("Switch to front camera mode");
  		  				MobileElement SwitchCameraR = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/camera_switcher']"));
  		  				SwitchCameraR.click();
  		  				TimeUnit.SECONDS.sleep(5);
