...
import Alldocube_K_Pad.Test10_Int;
...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Check for total files if Total files=3 print pass message else print fail message");
			System.out.println("Check for total files if Total files=3 print pass message else print fail message");
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		try {
			//Launch Camera Application for rear camera video recording
			logger.info("Launch file manager for recorded video playback from internal storage");
			System.out.println("Launch file manager for recorded video playback from internal storage");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
