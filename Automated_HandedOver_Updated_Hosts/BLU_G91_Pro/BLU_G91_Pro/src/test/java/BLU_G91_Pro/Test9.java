...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select Rear camera second resolution:  29M");
			System.out.println("Select Rear camera second resolution: 29M");
			driver.findElement(By.xpath("//*[@text='29M']")).click();
			TimeUnit.SECONDS.sleep(3);
