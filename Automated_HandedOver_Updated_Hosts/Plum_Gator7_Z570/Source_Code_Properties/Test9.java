...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select Rear camera first image resolution: 3264x2448");
			System.out.println("Select Rear camera first image resolution: 3264x2448");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select Rear camera second resolution: 3168x1584");
			System.out.println("Select Rear camera second resolution: 3168x1584");
			driver.findElement(By.xpath("//*[@text='3168x1584']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select rear camera third resolution:3072x1728");
			System.out.println("Select rear camera third resolution:3072x1728");
			driver.findElement(By.xpath("//*[@text='3072x1728']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
