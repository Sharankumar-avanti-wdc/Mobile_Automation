...
import Realme_8i_RMX3151.Test9;
...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select setting1 option");
			driver.findElement(By.xpath("//*[@bounds='[930,889][1026,985]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[441,303][555,417]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			TimeUnit.SECONDS.sleep(2);
			System.out.println("front camera second resolution: " + j + " images Captured succesfull" );
			logger.info("front camera second resolution: " + j + " images Captured succesfull" );
			//Click On Settings option to select rear camera resolution
			logger.info("Select camera Resolution");
			System.out.println("Select camera Resolution");
			driver.findElement(By.xpath("//*[@bounds='[888,0][1005,240]']")).click();
			...
			driver.findElement(By.xpath("//*[@bounds='[591,303][705,417]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[741,303][855,417]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			// capture  pics for the selected resolution
			int j2=0;
			for( j2 = 0; j2 < totalPictureCountFront1Int; j2++) 
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.id("com.oppo.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(2);
			System.out.println("front camera second resolution: " + j2 + " images Captured succesfull" );
			logger.info("front camera second resolution: " + j2 + " images Captured succesfull" );
			//Click On Settings option to select rear camera resolution
			logger.info("Select camera Resolution");
			System.out.println("Select camera Resolution");
			driver.findElement(By.xpath("//*[@bounds='[888,0][1005,240]']")).click();
			...
			driver.findElement(By.xpath("//*[@bounds='[891,303][1005,417]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			// capture  pics for the selected resolution
			int j3=0;
			for( j3 = 0; j3 < totalPictureCountFront1Int; j3++) 
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.id("com.oppo.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 4th Resolutions16:9: "+j3);
				logger.info("clicking Image of 4th Resolutions16:9: "+j3);
