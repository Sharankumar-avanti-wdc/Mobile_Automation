...
import Samsung_GalaxyNote10_Lite.Test9F;
...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Frontcamera 5 image resolutions supports
			...
			MobileElement frontImage = driver.findElement(By.xpath("//*[@text='Ratio']"));
			frontImage.click();

			//Select 1st resolution
			logger.info("Select first Image Resoution: 3:4 48MP");
			System.out.println("Select first Image Resoution: 3:4 48MP");
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[567,122][687,242]']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Front Image Size");
			System.out.println("Select Front Image Size");
			MobileElement FrontImage1 = driver.findElement(By.xpath("//*[@text='Ratio']"));
			FrontImage1.click();
			...
			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[567,122][687,242]']"));
			SecRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[567,122][687,242]']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[567,122][687,242]']"));
			FourthRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("totalPictureCountRear3 = "+ totalPictureCountFront3);
			...
			MobileElement FifthRes = driver.findElement(By.xpath("//*[@bounds='[567,122][687,242]']"));
			FifthRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("totalPictureCountRear4 = "+ totalPictureCountFront4);
