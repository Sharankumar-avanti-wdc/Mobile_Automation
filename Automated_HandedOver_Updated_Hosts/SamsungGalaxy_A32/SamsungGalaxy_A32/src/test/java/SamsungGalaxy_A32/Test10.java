...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@content-desc='Rear camera video size, FHD (30 fps)']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select second Back Video Resolution:FHD 30");
			System.out.println("Select second Back Video Resolution:FHD 30");
			MobileElement secondRes = driver.findElement(By.xpath("//*[@content-desc='Rear camera video size, HD (30 fps)']"));
			secondRes.click();
			TimeUnit.SECONDS.sleep(2);
