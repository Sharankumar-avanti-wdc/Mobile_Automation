...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Launch File Manager Application to verify captured videos in Internal card");
			System.out.println("Launch File Manager Application to verify captured videos in Internal card");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all Rear camera videos create Test10_Int and cut paste all videos inTest10_Int folder");
