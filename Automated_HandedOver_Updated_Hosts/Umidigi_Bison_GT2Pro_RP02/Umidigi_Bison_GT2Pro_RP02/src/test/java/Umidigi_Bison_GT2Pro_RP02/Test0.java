...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try
			{
				...
				MobileElement  closeAll =	driver.findElement(By.xpath("//*[@bounds='[408,1870][672,1954]']"));
				closeAll.click();
				TimeUnit.SECONDS.sleep(5);
	...
	public void Images() throws  IOException, InterruptedException {
		...
		try {
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/hdr_icon']"));
			Settings.click();
			TimeUnit.SECONDS.sleep(5);
			...
			MobileElement Sdcard = driver.findElement(By.xpath("//*[@resource-id='android:id/switch_widget']"));
			Sdcard.click();
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		try {
			...
			logger.info("Final Message: Pass Test0 Pass format with data scenario");
			System.out.println("Pass: Images and videos are not present in the DCIM folder, CARD format is successfully completed ");
			System.out.println("Final Message: Pass Test0 Pass format with data scenario");
			logger.info("Test: End");
			System.out.println("Test: End");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
