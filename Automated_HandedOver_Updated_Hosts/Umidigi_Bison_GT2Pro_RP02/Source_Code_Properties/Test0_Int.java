...
public class Test0_Int {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		logger.info("Pass: Test0_Int Pass for clear recent apps and clear Internal memory");
		System.out.println("Pass: Test0_Int Pass for clear recent apps and clear Internal memory");
		logger.info("Host does not support format with data scenario for internal mount. Hence skipping format with data scenario");
		System.out.println("Host does not support format with data scenario for internal mount. Hence skipping format with data scenario");
	...
	public void FormatAsExternal() throws  IOException, InterruptedException {
		...
		try {
			...
			logger.info("Clicking on more options");
			System.out.println("Clicking on more options");
			MobileElement moreOptions = driver.findElement(By.xpath("//*[@bounds='[960,90][1080,234]']"));
			moreOptions.click();
			TimeUnit.SECONDS.sleep(5);
