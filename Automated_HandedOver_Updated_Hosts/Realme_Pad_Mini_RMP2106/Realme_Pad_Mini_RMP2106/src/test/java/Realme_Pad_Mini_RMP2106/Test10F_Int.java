	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(10);
			//Click On Settings
  				...
  				logger.info("Select first highest front camera video resolution: HD 720p, 30fps");
  				System.out.println("Select first highest front camera video resolution: HD 720p, 30fps");
  				MobileElement FirstRes = driver.findElement(By.xpath("//*[@text='HD 720p, 30fps']"));
  				FirstRes.click();
  				TimeUnit.SECONDS.sleep(2);
  				((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
  				TimeUnit.SECONDS.sleep(2);
	  	...
	  	//Click On Settings
			...
			logger.info("Select second highest front camera video resolution: SD 480p, 30fps");
			System.out.println("Select second highest front camera video resolution: SD 480p, 30fps");
			MobileElement secondRes = driver.findElement(By.xpath("//*[@text='SD 480p, 30fps']"));
			secondRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 2nd resolution
			logger.info("Select third highest front camera video resolution: CIF, 30fps");
			System.out.println("Select third highest front camera video resolution: CIF, 30fps");
			MobileElement thirdRes = driver.findElement(By.xpath("//*[@text='CIF, 30fps']"));
			thirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
