...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select 1st Rear Video Resolution:FHD 1920 x 1080 (60 fps)");
			System.out.println("Select 1st  Rear Video Resolution: FHD 1920 x 1080 (60 fps)");
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Select 2nd Rear Video Resolution:FHD 1920 x 1080");
			System.out.println("Select 2nd Rear Video Resolution: FHD 1920 x 1080");
			//Select 1st resolution
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Select 3rd Rear Video Resolution:HD 1280 x 720");
			System.out.println("Select 3rd Rear Video Resolution: HD 1280 x 720");
			//Select 1st resolution
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Select 4th Rear Video Resolution:4K 3840 x 2160");
			System.out.println("Select 4th  Rear Video Resolution: 4K 3840 x 2160");
			//Select 1st resolution
