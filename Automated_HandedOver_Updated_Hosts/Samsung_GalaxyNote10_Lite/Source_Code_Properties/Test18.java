...
public class Test18
{
	...
	/*	logger.info("Select Test2 folder");
		...
		TimeUnit.SECONDS.sleep(5);*/
			...
			//Select Sort options
			logger.info("Select Sort options");
			System.out.println("SelectSort options");
			MobileElement Sort =driver.findElement(By.xpath("//*[@text='Sort']"));
			Sort.click();
			TimeUnit.SECONDS.sleep(2);
			//Select Done option
			logger.info("Select date options to select Test2 folder");
			System.out.println("Select date options to select Test2 folder");
			MobileElement Date =driver.findElement(By.xpath("//*[@text='Date']"));
			Date.click();
			TimeUnit.SECONDS.sleep(2);
