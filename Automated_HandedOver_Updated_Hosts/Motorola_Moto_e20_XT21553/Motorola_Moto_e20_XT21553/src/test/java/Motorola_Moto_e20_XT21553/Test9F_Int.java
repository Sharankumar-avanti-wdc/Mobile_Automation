...
import Motorola_Moto_e20_XT21553.Test9F_Int;
...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Test9F_Int_Fcam_res: 1 resolutions supported");
			System.out.println("Test9F_Int_Fcam_res: 1 resolutions supported");
			...
			logger.info("Select front camera front image resolution: 9:16");
			System.out.println("Select front camera front image resolution: 9:16");
