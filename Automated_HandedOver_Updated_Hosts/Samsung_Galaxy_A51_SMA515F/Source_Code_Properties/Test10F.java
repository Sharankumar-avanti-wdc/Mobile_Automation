...
import Samsung_Galaxy_A51_SM515F.Test10;
...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[305,120][425,240]']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[480,120][600,240]']"));
			SecRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			//Select front camera third video resolutio:BACK_CAMCORDER_RESOLUTION_FHD_60
			...
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[655,120][775,240]']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
