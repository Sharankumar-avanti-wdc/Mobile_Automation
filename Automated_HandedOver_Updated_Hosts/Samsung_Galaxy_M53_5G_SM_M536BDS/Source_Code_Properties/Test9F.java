...
import Samsung_Galaxy_M53_5G_SM_M536BDS.Test9;
...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//front camera 5 image resolutions supports
			...
			logger.info("Select First front Image Resoution: 3:4(32mp)");
			System.out.println("Select First front Image Resoution: 3:4(32mp)");
			MobileElement res1 = driver.findElement(By.xpath("//*[@bounds='[132,120][252,240]']"));
			res1.click();
			TimeUnit.SECONDS.sleep(2);
