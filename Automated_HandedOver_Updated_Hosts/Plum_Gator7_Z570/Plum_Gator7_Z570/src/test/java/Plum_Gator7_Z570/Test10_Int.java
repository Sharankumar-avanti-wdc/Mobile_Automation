...
import Plum_Gator7_Z570.Test10_Int;
...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Launch File Manager Application to verify captured videos in uInternal storage");
			System.out.println("Launch File Manager Application to verify captured videos in uInternal storage");
