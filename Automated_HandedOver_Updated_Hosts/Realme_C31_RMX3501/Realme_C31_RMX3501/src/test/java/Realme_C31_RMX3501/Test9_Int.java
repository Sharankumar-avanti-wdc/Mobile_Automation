...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			System.out.println("Pass: Test_Int Pass for clearing Recent apps ");
		}
		catch (Exception e) {
			e.printStackTrace();
		...
		try {
			...
			logger.info("Select 1st Image Resoution: (4:3) 13.0 megapixels ");
			System.out.println("Select 1st Image Resoution:(4:3) 13.0 megapixels ");
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 1st Resolutions (4:3) 13.0 megapixels: "+j);
				logger.info("clicking Image of 1st Resolutions (4:3) 13.0 megapixels: "+j);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 4th Image Resoution: (16:9) 9.7 megapixels ");
			System.out.println("Select 4th Image Resoution:(16:9) 9.7 megapixels ");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions ultra (16:9) 9.7 megapixels: "+j3);
				logger.info("clicking Image of 3rd Resolutions ultra (16:9) 9.7 megapixels: "+j3);
			...
			// capture  pics for the selected resolution
			int j5=0;
			for( j5 = 0; j5 < totalPictureCountRear_Int1Int; j5++) 
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
