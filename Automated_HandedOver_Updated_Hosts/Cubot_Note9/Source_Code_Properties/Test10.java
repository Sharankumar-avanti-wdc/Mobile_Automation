...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			// Launch settings app
			logger.info("Launch Settings application for select storage as sd card ");
			System.out.println("Launch Settings application for select storage as sd card  ");
