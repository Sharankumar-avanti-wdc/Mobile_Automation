...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			logger.info("Final Message: Pass Test0 Pass for clear recent apps and clear internal memory,Test0 Not applicable Sometimes  card (with data) while doing format getting failed & it's display SD card error Failed to format. "); 
			System.out.println("Final Message: Pass Test0 Pass for clear recent apps and clear internal memory,Test0 Not applicable Sometimes  card (with data) while doing format getting failed & it's display SD card error Failed to format. ");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
	...
	public void Images() throws  IOException, InterruptedException {
		...
		sdcard.click();
		logger.info("Clicking on Auto save data to SD card");
		System.out.println("Clicking on Auto save data to SD card");
		MobileElement Sdcard = 	driver.findElement(By.xpath("//*[@text='Auto save data to SD card']"));
		Sdcard.click();
	...
	public void Video() throws  IOException, InterruptedException {
		...
		touchAction.tap(PointOption.point(310, 1777)).perform();
		TimeUnit.SECONDS.sleep(5);
		//Click On Rear Video size to select resolution
		MobileElement VideoResolution = driver.findElement(By.xpath("//*[@bounds='[618,0][735,240]']"));
		...
		MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[486,56][594,242]']"));
		FirstRes.click();
		TimeUnit.SECONDS.sleep(2);
		//Start Recording
		...
		TimeUnit.SECONDS.sleep(5);
		//Click On Rear Video size to select resolution
		MobileElement VideoResolution1 = driver.findElement(By.xpath("//*[@bounds='[618,0][735,240]']"));
		...
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[900,56][1008,242]']"));
		SecondRes.click();
		TimeUnit.SECONDS.sleep(2);
		//Start Recording
		logger.info("Start video recording");
		...
		touchAction.tap(PointOption.point(753, 1775)).perform();
		TimeUnit.SECONDS.sleep(5);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
