package Nokia_G21_TA1418;

import org.testng.annotations.Test;
import Nokia_G21_TA1418.Test9;
...
public class Test9
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Nokia G21");
		dc.setCapability(MobileCapabilityType.UDID, "PT19655JA1233000716");
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first highest resolution: 4:3 50MP");
			System.out.println("Select first highest resolution: 4:3 50MP");
			driver.findElement(By.xpath("//*[@bounds='[321,62][396,135]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Select rear camera second image resoltion: 16:9 ");
			System.out.println("Select rear camera second image resoltion: 16:9 ");
			driver.findElement(By.xpath("//*[@bounds='[453,62][528,135]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//load properties
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			System.out.println("select rear camera third resolution: Full ");
			logger.info("select rear camera third resolution: Full ");
			driver.findElement(By.xpath("//*[@bounds='[585,62][660,135]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3rd resolution
			System.out.println("select rear camera 4th resolution: 1:1");
			logger.info("select rear camera 4th resolution: 1:1");
			driver.findElement(By.xpath("//*[@bounds='[57,62][132,135]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3rd resolution
			System.out.println("select rear camera 5th resolution: 4:3 ");
			logger.info("select rear camera 5th resolution: 4:3 ");
			driver.findElement(By.xpath("//*[@bounds='[189,62][264,135]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			{ 
				...
				driver.findElement(By.id("com.hmdglobal.app.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(3);
				System.out.println("clicking third Resolution image"+j4);
				logger.info("clicking third Resolution image"+j4);
