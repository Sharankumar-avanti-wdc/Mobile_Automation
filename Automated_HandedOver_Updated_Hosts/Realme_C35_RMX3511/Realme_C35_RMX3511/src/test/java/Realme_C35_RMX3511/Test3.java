...
import Realme_C35_RMX3511.Test3;
...
public class Test3 {
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		logger.info(" Host does'nt support Mount,Unmount uSD Card and Format uSD card for specified number of times");
		logger.info("Setting up the appium desired capabilities");
		System.out.println("Test3 Scenario is as follows");
		System.out.println("Host does'nt support Unmount uSD Card and Format card for specified number of times");
