...
public class Test0 {
	...
	public void Images() throws  IOException, InterruptedException {
		...
		TimeUnit.SECONDS.sleep(3);
		////Scroll Up to find external Storage option
		logger.info("swipe and search for sd card ");
		System.out.println("swipe and search for sd card");
		MobileElement element = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
				"new UiScrollable(new UiSelector().scrollable(true)).setMaxSearchSwipes(10)" +
	...
	public void Video() throws  IOException, InterruptedException {
		...
		driver.findElement(By.xpath("//*[@bounds='[191,1141][263,1179]']")).click();
		TimeUnit.SECONDS.sleep(5);
		//Click On Settings
		logger.info("Select settings option");
		System.out.println("Select settings option");
		...
		TimeUnit.SECONDS.sleep(3);
		////Scroll Up to find external Storage option
		logger.info("swipe and search for sd acrd");
		System.out.println("swipe and search for sd card");
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		logger.info("Swipe Up and Search android");
		System.out.println("Swipe Up and Search android");
