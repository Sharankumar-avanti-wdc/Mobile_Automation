...
import Xiaomi_Poco_M4_Pro_5G.Test9;
...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Launch File manager
			logger.info("Launch file manager application and verify Captuted images present  in uSD Card");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException {
		...
		try {
			...
			System.out.println("Cut paste  Images files operation completed successfully");
