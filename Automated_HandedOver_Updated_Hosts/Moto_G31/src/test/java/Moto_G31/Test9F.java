...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				//Select Photo mode option
				logger.info("Select Continue option");
				System.out.println("Select Continue option");
			...
			driver.findElement(By.xpath("//*[@bounds='[582,1357][708,1483]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			{ 
				TimeUnit.SECONDS.sleep(2);
				//Start image capture
				driver.findElement(By.xpath("//*[@bounds='[435,1847][645,2036]']")).click();
			...
			driver.findElement(By.xpath("//*[@bounds='[708,1357][834,1483]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[834,1357][960,1483]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
