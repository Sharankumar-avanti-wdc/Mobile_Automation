...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			logger.info("Long press and select Android folder");
			System.out.println("Long press and select Android folder");
			...
			try {
				...
				MobileElement Delete =	driver.findElement(By.xpath("//*[@bounds='[589,2205][759,2255]']"));
				Delete.click();
				TimeUnit.SECONDS.sleep(3);

				//Click move to recycle Bin
				MobileElement MovetoRecycleBin =	driver.findElement(By.xpath("//*[@bounds='[406,2084][1016,2179]']"));
	...
	public void Video() throws  IOException, InterruptedException {
		...
		try {
			...
			System.out.println("Select 1st Back Video Resolution:BACK_CAMCORDER_RESOLUTION_UHD_30");
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		try {
			...
			//Launch File Manager
			logger.info("Launch File Manager Application and verify uSD data format with data");
			System.out.println("Launch File Manager Application and verify uSD data format with data");
			((StartsActivity) driver).startActivity(new Activity("com.sec.android.app.myfiles", "com.sec.android.app.myfiles.external.ui.MainActivity"));
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Fail: Test0 Fail for uSD card with data");
			System.out.println("Fail: Test0 Fail for uSD card with data");
			logger.info("Final message: Fail Test0 Fail for uSD card with data");
			System.out.println("Final message: Fail Test0 Fail for uSD card with data");
			logger.info("Test: End");
			System.out.println("Test: End");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
