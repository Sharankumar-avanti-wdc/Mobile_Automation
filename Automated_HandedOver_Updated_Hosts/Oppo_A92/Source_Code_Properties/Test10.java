...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			touchAction.tap(PointOption.point(319, 1784)).perform();
			TimeUnit.SECONDS.sleep(5);
			//Click On Settings
			logger.info("Select settings option");
			System.out.println("Select settings option");
			driver.findElement(By.xpath("//*[@bounds='[890,0][1007,240]']")).click();
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select First back video Resolution:  4K");
			System.out.println("Select First Back video resolution: 4K");
			driver.findElement(By.xpath("//*[@bounds='[72,436][129,501]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 1st resolution
			logger.info("Select second back video Resolution: 1080P");
			System.out.println("Select second Back video resolution:  1080P");
			driver.findElement(By.xpath("//*[@bounds='[72,588][210,653]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 1st resolution
			logger.info("Select Third back video Resolution:  720P");
			System.out.println("Select Third Back video resolution:  720P");
			driver.findElement(By.xpath("//*[@bounds='[72,740][183,805]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			touchAction.tap(PointOption.point(750, 1766)).perform();
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
