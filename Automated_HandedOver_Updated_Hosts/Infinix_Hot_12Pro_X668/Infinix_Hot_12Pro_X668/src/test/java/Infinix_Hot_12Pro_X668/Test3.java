...
import Infinix_Hot_12Pro_X668.Test3;
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				logger.info("Clicking on SD card");
				System.out.println("Clicking on SD card");
				MobileElement sdcard1 = 	driver.findElement(By.xpath("//*[@text='SanDisk SD card']"));
				sdcard1.click();
				TimeUnit.SECONDS.sleep(5);
				//Select uSD Card
				logger.info("Clicking on mountr");
				System.out.println("Clicking on mount");
				...
				logger.info("Clicking on SD card");
				System.out.println("Clicking on SD card");
				MobileElement portable2 = 	driver.findElement(By.xpath("//*[@text='SanDisk SD card']"));
				portable2.click();
				TimeUnit.SECONDS.sleep(5);
				//Click on More Options
				logger.info("Clicking on moreoptions");
				...
				logger.info("Select Storage settings");
				System.out.println("Select Storage settings");
				MobileElement formatsdcard3 = 	driver.findElement(By.xpath("//*[@text='Storage Settings']"));
				formatsdcard3.click();
				TimeUnit.SECONDS.sleep(5);
				// Select Format option
				logger.info("Select  format");
				System.out.println("Select  format");
				MobileElement formatsdcard4 = 	driver.findElement(By.xpath("//*[@text='Format']"));
				formatsdcard4.click();
				TimeUnit.SECONDS.sleep(5);
				logger.info("Select again formatsdcard");
				System.out.println("Select again formatsdcard");
				MobileElement formatsdcard5 = 	driver.findElement(By.xpath("//*[@text='Erase & format']"));
				formatsdcard5.click();
