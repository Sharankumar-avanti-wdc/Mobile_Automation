...
public class Test3 {
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("Host does not support Unmount mont uSD. !Hence Only Format uSD card for specified number of times and verify data format ");
		...
		try {
			...
			{ 
				...
				logger.info("!Host does not provide unmount, mount uSD card");
				System.out.println("!Host does not provide unmount, mount uSD card");
				

				//Select UnMount 
				//logger.info("Unmount uSD card");
				//System.out.println("Unmount uSD card");
				//	driver.findElement(By.xpath("//*[@id='com.android.settings:id/button']")).click();
				...
				//driver.findElement(By.xpath("//*[@bounds='[545,2063][1012,2164]']")).click();
				TimeUnit.SECONDS.sleep(30);
			...
			if (Result == "Pass")
			{
				logger.info("Pass: Test3 Pass for Formating the uSD Card");
				System.out.println("Pass: Test3 Pass for Formating the uSD Card");
				logger.info("Final Message:Pass Test3 Pass Formattig uSD Card ");
				System.out.println("Final Message:Pass Test3 Pass Formattig uSD Card");
			...
			{
				logger.info("Fail: Test3 Fail for Formatting uSD Card");
				System.out.println("Fail: Test3 Fail for Formatting uSD Card");
				logger.info("Test End");
				System.out.println("Test End");
				logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
				System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
