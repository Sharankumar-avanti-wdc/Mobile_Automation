...
import Ulefone_Note_12.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Select 3:4 
			logger.info("Select Rear camera second resolution: (4:3) 5.0 megapixels");
			System.out.println("Select Rear camera second resolution: (4:3) 5.0 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera third resolution: (4:3) 3.1 megapixels");
			System.out.println("Select Rear camera third resolution: (4:3) 3.1 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera fouth resolution: (16:9) 9.7 megapixels");
			System.out.println("Select Rear camera fourth resolution: (16:9) 9.7 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera fifth resolution: (16:9) 3.8 megapixels");
			System.out.println("Select Rear camera fifth resolution: (16:9) 3.8 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera sixth resolution: (16:9) 2.4 megapixels");
			System.out.println("Select Rear camera sixth resolution: (16:9) 2.4 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera seventh resolution: (18:9) 8.7 megapixels");
			System.out.println("Select Rear camera seventh resolution: (18:9) 8.7 megapixels");
			driver.findElement(By.xpath("//*[@text='(18:9) 8.7 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 3:4 
			logger.info("Select Rear camera eigth resolution: (18:9) 3.4 megapixels");
			System.out.println("Select Rear camera eigth resolution: (18:9) 3.4 megapixels");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("captureing eighth  Resolution image "+j7);
				logger.info("captureing eighth  Resolution image "+j7);
			}
			TimeUnit.SECONDS.sleep(2);
			//Click On Settings
			logger.info("Select settings option");
			...
			//Select 3:4 
			logger.info("Select Rear camera ninth resolution: (18:9) 2.3 megapixels");
			System.out.println("Select Rear camera ninth resolution: (18:9) 2.3 megapixels");
			...
			System.out.println("totalPictureCountRear8 = "+ totalPictureCountRear8 + " Imgaes to be captured");
