...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		MobileElement PhoneStorage = driver.findElement(By.xpath("//*[@resource-id='com.coloros.filemanager:id/phone_title']"));
		PhoneStorage.click();
		TimeUnit.SECONDS.sleep(5);
		//Click More Options
		...
		MobileElement Delete =	driver.findElement(By.xpath("//*[@bounds='[687,2220][759,2292]']"));
		Delete.click();
		TimeUnit.SECONDS.sleep(3);
		try {
			//Click Delete
			//Click move to recycle Bin
			logger.info("Allow delete folders");
			System.out.println("Allow delete folders");
			...
			MobileElement OnlyDelete =	driver.findElement(By.xpath("//*[@text='Delete all items']"));
			OnlyDelete.click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Allow delet folders");
			System.out.println("Allow delet folders");
			MobileElement DeletePermanently =	driver.findElement(By.xpath("//*[@text='Permanently delete all items']"));
			DeletePermanently.click();
			TimeUnit.SECONDS.sleep(30);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
