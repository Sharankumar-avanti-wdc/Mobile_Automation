...
public class Test0 {
	...
	public void Video() throws  IOException, InterruptedException {
		...
		{ 
			...
			System.out.println("Current Existing Camera is Rear Camera"); 
		}
		...
		RearVideoSize.click();
		logger.info("Select 1st Rear Video Resolution: Resolution Aspect ratio 9:16");
		System.out.println("Select 1st Rear Video Resolution: Resolution Aspect ratio 9:16");
		...
		logger.info("Select 2nd Rear Video Resolution: Resolution Aspect ratio Full");
		System.out.println("Select 2nd Rear Video Resolution: Resolution Aspect ratio Full");
