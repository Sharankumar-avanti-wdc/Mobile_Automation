	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try {
				...
				MobileElement Folder =	driver.findElement(By.xpath("//*[@bounds='[62,552][175,665]']"));
				...
				MobileElement Delete =	driver.findElement(By.xpath("//*[@bounds='[640,2121][708,2189]']"));
				Delete.click();
				TimeUnit.SECONDS.sleep(3);
				//Click move to recycle Bin
				logger.info("Select  Delete");
				System.out.println("Select  Delete");
				MobileElement MovetoRecycleBin =	driver.findElement(By.xpath("//*[@bounds='[467,2063][1012,2164]']"));
