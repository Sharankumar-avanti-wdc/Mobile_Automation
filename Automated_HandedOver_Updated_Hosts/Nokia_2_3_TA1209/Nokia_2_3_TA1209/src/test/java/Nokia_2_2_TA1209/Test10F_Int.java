  ...
  public class Test10F_Int
  {
	...
	private String Result;
		...
		public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
			...
			logger.info("1.Launch Camera application and start front camera video recording for all host applicable resolutions");
			...
			System.out.println("1.Launch Camera application and start front camera video recording for all host applicable resolutions");
		...
		//Switch to Video Tab
		  	...
		  	//click Back to settings option
				...
				logger.info("select first highest front camera video resolution: FHD 1080P");
				System.out.println("select first highest front camera video resolution: FHD 1080P");
				driver.findElement(By.xpath("//*[@bounds='[18,654][701,738]']")).click();
				TimeUnit.SECONDS.sleep(3);
				...
				((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		   	  	...
		   	  	((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			  		TimeUnit.SECONDS.sleep(2);
				  		...
				  		System.out.println("recordingDurationfrontExt = "+ recordingDurationfrontExt);
				  	...
				  	// click on recording button and wait for 5 mins 
						...
						driver.findElement(By.xpath("//*[@bounds='[18,738][701,822]']")).click();
						TimeUnit.SECONDS.sleep(3);
						...
						((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
				  		...
				  		System.out.println("recordingDurationfrontExt1 = "+ recordingDurationfrontExt1);
					  ...
					  //Switch back to Photo camera mode
					  	logger.info("Switch back to photo camera mode");
						System.out.println("Switch back to photo camera mode");
				  	...
				  	//Launch File manager
						...
						((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
						((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
						logger.info("Test10F_Int_Fcam_video: 2 videos captured successfully");
						System.out.println("Test10F_Int_Fcam_video: 2 videos captured successfully");
				...
				public void VideoPlayBackForSleepWake() throws  IOException, InterruptedException {
					...
					try {
						...
						logger.info("Pass: Pass Test10F_Int Pass for Pause Video Playback scenario");
						System.out.println("Pass: Pass Test10F_Int Pass for Pause Video Playback scenario");
						logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
						System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
