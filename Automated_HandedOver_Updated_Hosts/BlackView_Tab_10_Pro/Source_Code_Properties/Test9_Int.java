...
import BlackView_Tab_10_Pro.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		//Select 3:4 
		logger.info("Select Rear camera second resolution: 8M(16:9)");
		System.out.println("Select Rear camera second resolution: 8M(16:9)");
		...
		//Click On Settings
				...
				//Select 1st photo resolution
				logger.info("Select Rear camera third image resolution: 8M(1:1)");
				System.out.println("Select Rear camera third image resolution: 8M(1:1)");
				driver.findElement(By.xpath("//*[@text='8M(1:1)']")).click();
				TimeUnit.SECONDS.sleep(3);
