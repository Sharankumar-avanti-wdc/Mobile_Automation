...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("Select zero Image Resoution: 8.1M (4032x2016) ");
		System.out.println("Select zero Image Resoution:8.1M (4032x2016) ");
		driver.findElement(By.xpath("//*[@bounds='[288,396][744,556]']")).click();
		TimeUnit.SECONDS.sleep(3);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(5);
		...
		{ 
			...
			TimeUnit.SECONDS.sleep(5);
			System.out.println("clicking Image of 0th Resolutions 8.1M (4032x2016): "+j);
			logger.info("clicking Image of 0th Resolutions 8.1M (4032x2016): "+j);
		...
		logger.info("Select first Image Resoution: 9.1M (4032x2268) ");
		System.out.println("Select first Image Resoution:9.1M (4032x2268) ");
		driver.findElement(By.xpath("//*[@bounds='[288,656][744,816]']")).click();
		TimeUnit.SECONDS.sleep(5);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(5);
		...
		{ 
			...
			driver.findElement(By.id("jp.co.sharp.android.camera:id/ui_stillcamerashutter")).click();
			TimeUnit.SECONDS.sleep(5);
			System.out.println("clicking Image of 1st Resolutions ultra 9.1M (4032x2268): "+j1);
			logger.info("clicking Image of 1st Resolutions ultra 9.1M (4032x2268): "+j1);
		...
		TimeUnit.SECONDS.sleep(3);
		//Select 1st resolution
		logger.info("Select second Image Resoution: 12.2M (4032x3024) ");
		System.out.println("Select second Image Resoution:12.2M (4032x3024) ");
		...
		{ 
			...
			driver.findElement(By.id("jp.co.sharp.android.camera:id/ui_stillcamerashutter")).click();
			TimeUnit.SECONDS.sleep(5);
			System.out.println("clicking Image of 2nd Resolutions ultra 12.2M (4032x3024): "+j2);
			logger.info("clicking Image of 2nd Resolutions ultra 12.2M (4032x3024): "+j2);
		...
		TimeUnit.SECONDS.sleep(3);
		//Select 1st resolution
		logger.info("Select third Image Resoution: Memo Size (1600x1200) ");
		System.out.println("Select third Image Resoution:Memo Size (1600x1200) ");
		driver.findElement(By.xpath("//*[@bounds='[288,1080][896,1240]']")).click();
		...
		{ 
			...
			driver.findElement(By.id("jp.co.sharp.android.camera:id/ui_stillcamerashutter")).click();
			TimeUnit.SECONDS.sleep(5);
			System.out.println("clicking Image of 3rd Resolutions ultra Memo Size (1600x1200): "+j3);
			logger.info("clicking Image of 3rd Resolutions ultra Memo Size (1600x1200): "+j3);
		...
		TimeUnit.SECONDS.sleep(3);
		//Select 1st resolution
		logger.info("Select fourth Image Resoution: 9.1M (3024x3024) ");
		System.out.println("Select fourth Image Resoution:9.1M (3024x3024) ");
		driver.findElement(By.xpath("//*[@bounds='[288,1340][743,1500]']")).click();
		...
		{ 
			...
			driver.findElement(By.id("jp.co.sharp.android.camera:id/ui_stillcamerashutter")).click();
			TimeUnit.SECONDS.sleep(5);
			System.out.println("clicking Image of 4th Resolutions ultra 9.1M (3024x3024): "+j4);
			logger.info("clicking Image of 4th Resolutions ultra 9.1M (3024x3024): "+j4);
		...
		MobileElement Camera2 =	driver.findElement(By.xpath("//*[@text='100SHARP']"));
		Camera2.click();
		TimeUnit.SECONDS.sleep(3);
