...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try {
				...
				MobileElement Folder =	driver.findElement(By.xpath("//*[@bounds='[62,580][175,693]']"));
				...
				System.out.println("Selec SelectAll");
	...
	public void Video() throws  IOException, InterruptedException {
		...
		logger.info("Select 2nd Back Video Resolution: HD 30");
		System.out.println("Select 2nd Back Video Resolution: HD 30");
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		try {
			...
			TimeUnit.SECONDS.sleep(5);
			//click on indicator icon
			MobileElement indicator =driver.findElement(By.xpath("//*[@bounds='[542,1683][590,1731]']"));
			indicator.click();
			//Clicking on more options
			logger.info("Clicking on more options");
			System.out.println("Clicking on more options");
			MobileElement moreOptions = driver.findElement(By.xpath("//android.widget.ImageView[@resource-id=\"com.sec.android.app.myfiles:id/more_option_icon\"]"));
			TimeUnit.SECONDS.sleep(5);
			moreOptions.click();
			// click on format
