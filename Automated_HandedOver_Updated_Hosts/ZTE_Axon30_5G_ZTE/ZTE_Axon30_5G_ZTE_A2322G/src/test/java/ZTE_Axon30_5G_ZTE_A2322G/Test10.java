...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[447,2007][633,2193]']")).click();
			TimeUnit.SECONDS.sleep(2);
			...
			driver.findElement(By.xpath("//*[@bounds='[888,99][1032,243]']")).click();
			TimeUnit.SECONDS.sleep(2);
			logger.info("Select 3rd Back Video Resolution: 4k");
			System.out.println("Select 3rd Back Video Resolution:  4k");
			//Select 2nd resolution
			MobileElement third = driver.findElement(By.xpath("//*[@bounds='[211,126][269,216]']"));
			third.click();
			TimeUnit.SECONDS.sleep(2);
