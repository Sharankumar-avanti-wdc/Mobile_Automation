...
import Nokia_X100_TA1399.Test9;
...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first highest resolution: 4:3 48MP");
			System.out.println("Select first highest resolution: 4:3 48MP");
			driver.findElement(By.xpath("//*[@bounds='[480,120][600,240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[684,120][804,240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//load properties
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[889,120][1009,240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[70,120][190,240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3rd resolution
			System.out.println("select rear camera 5th resolution: 4:3 12MP");
			logger.info("select rear camera 5th resolution: 4:3 12MP");
			driver.findElement(By.xpath("//*[@bounds='[275,120][395,240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
