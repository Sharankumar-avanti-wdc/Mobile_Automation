	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		{ 
			...
			{ 
				...
				driver.findElement(By.id("com.lge.camera:id/shutter_large_comp")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 7th Resolutions FullVision (1Point2 MP) 1600x720: "+j6);
				logger.info("clicking Image of 7th Resolutions FullVision (1Point2 MP) 1600x720: "+j6);
			}
			TimeUnit.SECONDS.sleep(2);
