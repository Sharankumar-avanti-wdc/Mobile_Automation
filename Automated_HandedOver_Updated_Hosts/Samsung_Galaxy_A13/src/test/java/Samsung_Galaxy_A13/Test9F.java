...
import Samsung_Galaxy_A13.Test9F;
...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("front camera first resolution:" + j1 + " images Captured succesfull");
			System.out.println("front camera first resolution:" + j1 + " images Captured succesfull" );
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("front camera first resolution:" + j2 + " images Captured succesfull");
			System.out.println("front camera first resolution:" + j2 + " images Captured succesfull" );
