...
public class Test0 {
	...
	public void Video() throws  IOException, InterruptedException {
		...
		touchAction.tap(PointOption.point(314, 1776)).perform();
		TimeUnit.SECONDS.sleep(5);
		//Click On Settings
		logger.info("Select settings option");
		System.out.println("Select settings option");
		...
		TimeUnit.SECONDS.sleep(5);
		///Scroll Up to find external Storage option
		logger.info("swipe up and search for video resolution");
		System.out.println("swipe up and search for video resolution");
		MobileElement element = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
				"new UiScrollable(new UiSelector().scrollable(true)).setMaxSearchSwipes(10)" +
		...
		MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[72,703][210,768]']"));
		FirstRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		...
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[72,855][183,920]']"));
		SecondRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		...
		//select photo mode
		logger.info("select camera mode");
		System.out.println("select camera mode");
		TouchAction touchAction1 = new TouchAction(driver);
		touchAction.tap(PointOption.point(755, 1776)).perform();
		TimeUnit.SECONDS.sleep(5);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
