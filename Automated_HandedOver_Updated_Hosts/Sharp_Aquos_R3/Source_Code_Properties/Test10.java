...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//back camera supports 7 video resolutions
			...
			MobileElement VideoResolution = driver.findElement(By.xpath("//*[@text='Video Size']"));
			VideoResolution.click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select 1st Back Video Resolution:1.8M (1920x960)");
			System.out.println("Select 1st Back Video Resolution: 1.8M (1920x960)");
			//Select 1st resolution
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[288,396][713,556]']"));
			FirstRes.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("recordingDurationRearExt = "+ recordingDurationRear + "Seconds");
			int recordingDurationRearInt=Integer.parseInt(recordingDurationRear);	
			//Start Recording
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.widget.ImageView[2]"));
			...
			MobileElement StopRecording = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout[2]/android.widget.ImageView[2]"));
			StopRecording.click();
			TimeUnit.SECONDS.sleep(5);
			//Click On Settings
			logger.info("Select settings option");
			...
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution1 = driver.findElement(By.xpath("//*[@text='Video Size']"));
			VideoResolution1.click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select 2nd Back Video Resolution: FULL HD (1920x1080)");
			System.out.println("Select 2nd Back Video Resolution:  FULL HD (1920x1080)");
			//Select 2nd resolution
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[288,820][836,980]']"));
			SecondRes.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement StartRecording1 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.widget.ImageView[2]"));
			...
			MobileElement StopRecording1 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout[2]/android.widget.ImageView[2]"));
			...
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution2 = driver.findElement(By.xpath("//*[@text='Video Size']"));
			VideoResolution2.click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select 3rd Back Video Resolution: FULL HD (1920x1080) 60fps");
			System.out.println("Select 3rd Back Video Resolution: FULL HD (1920x1080) 60fps");
			//Select 2nd resolution
			MobileElement thirdRes = driver.findElement(By.xpath("//*[@bounds='[288,984][991,1144]']"));
			thirdRes.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("Start video recording");
			logger.info("Start Recording");
			MobileElement StartRecording2 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.widget.ImageView[2]"));
			...
			MobileElement StopRecording2 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout[2]/android.widget.ImageView[2]"));
			...
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution3 = driver.findElement(By.xpath("//*[@text='Video Size']"));
			VideoResolution3.click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select 4th Back Video Resolution: HD (1280x720)");
			System.out.println("Select 4th Back Video Resolution: HD (1280x720)");
			//Select 2nd resolution
			MobileElement fourth = driver.findElement(By.xpath("//*[@bounds='[288,1148][664,1308]']"));
			fourth.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("Start video recording");
			logger.info("Start Recording");
			MobileElement StartRecording3 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.widget.ImageView[2]"));
			...
			MobileElement StopRecording3 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout[2]/android.widget.ImageView[2]"));
			...
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution4 = driver.findElement(By.xpath("//*[@text='Video Size']"));
			VideoResolution4.click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select 5th Back Video Resolution: 1.6M (1440x1080)");
			System.out.println("Select 5thBack Video Resolution: 1.6M (1440x1080)");
			//Select 2nd resolution
			MobileElement fifth = driver.findElement(By.xpath("//*[@bounds='[288,1408][744,1568]']"));
			fifth.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement StartRecording4 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.widget.ImageView[2]"));
			...
			MobileElement StopRecording4 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout[2]/android.widget.ImageView[2]"));
			...
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution5 = driver.findElement(By.xpath("//*[@text='Video Size']"));
			VideoResolution5.click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select 6th Back Video Resolution: 1.2M (1080x1080)");
			System.out.println("Select 6th Back Video Resolution: 1.2M (1080x1080)");
			//Select 2nd resolution
			MobileElement sixth = driver.findElement(By.xpath("//*[@bounds='[288,1668][745,1828]']"));
			sixth.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement StartRecording5 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.widget.ImageView[2]"));
			...
			MobileElement StopRecording5 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout[2]/android.widget.ImageView[2]"));
			...
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution6 = driver.findElement(By.xpath("//*[@text='Video Size']"));
			VideoResolution6.click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select 7th Back Video Resolution: 4K (3840x2160)");
			System.out.println("Select 7th Back Video Resolution: 4K (3840x2160)");
			//Select 2nd resolution
			MobileElement seventh = driver.findElement(By.xpath("//*[@bounds='[288,656][684,816]']"));
			seventh.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("recordingDurationRear6 = "+ recordingDurationRear6 + "Seconds");
			int recordingDurationRear6Int=Integer.parseInt(recordingDurationRear6);	
			//Start Recording
			logger.info("Start video recording");
			System.out.println("Start video recording");

			MobileElement StartRecording6 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout/android.widget.ImageView[2]"));
			StartRecording6.click();
			TimeUnit.SECONDS.sleep(2);
			//Stop Recording
			logger.info("Stop video recording");
			System.out.println("Stop video recording");
			TimeUnit.SECONDS.sleep(recordingDurationRear6Int);
			MobileElement StopRecording6 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.FrameLayout[3]/android.widget.FrameLayout[2]/android.widget.ImageView[2]"));
			StopRecording6.click();
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@text='100SHARP']")).click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Select Camera folder");
			System.out.println("Select Camera folder");
			MobileElement Camera = driver.findElement(By.xpath("//*[@text='100SHARP']")); 
			Camera.click();
			TimeUnit.SECONDS.sleep(3);
			//Swtich to list view mode
			logger.info("switch back to list  view mode");
