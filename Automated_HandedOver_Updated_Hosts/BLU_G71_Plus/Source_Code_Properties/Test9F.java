...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select second Image Resoution: (16:9) 9.7 MP");
			System.out.println("Select second Image Resoution: (16:9) 9.7 MP");
			driver.findElement(By.xpath("//*[@bounds='[202,514][332,629]']")).click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first third Resoution:(20:9) 7.8 MP");
			System.out.println("Select third Image Resoution: (20:9) 7.8 MP");
			driver.findElement(By.xpath("//*[@bounds='[386,514][516,629]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			logger.info("Select fourth Image Resoution: (1:1) 6.0 MP");
			System.out.println("Select fourth Image Resoution: (1:1) 6.0 MP");
			driver.findElement(By.xpath("//*[@bounds='[570,514][700,629]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
