...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select 1st Front Video Resolution:Front camera video size, HD (30 fps)");
			System.out.println("Select 1st Front Video Resolution:Front camera video size, HD (30 fps)");
			...
			logger.info("Select second resolution::Front camera video size, FHD (30 fps)");
			System.out.println("Select second resolution:Front camera video size, FHD (30 fps)");
