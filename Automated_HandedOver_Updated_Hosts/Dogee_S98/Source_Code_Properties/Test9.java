...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		MobileElement RearPhotoSize = driver.findElement(By.xpath("//*[@bounds='[342,129][468,255]']"));
		RearPhotoSize.click();
		TimeUnit.SECONDS.sleep(3);

		//Select 1st photo resolution
		logger.info("Select Rear camera first image resolution: 64M");
		System.out.println("Select Rear camera first image resolution: 64M");
		driver.findElement(By.xpath("//*[@bounds='[71,1095][197,1221]']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		logger.info("Select settings option");
		System.out.println("Select settings option");
		MobileElement Settings1 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/camera_settings']"));
		TimeUnit.SECONDS.sleep(5);
		Settings1.click();
		//Select settings option to select resolution
		logger.info("Select settings option to select resolution");
		System.out.println("Select settings option to select resolution");
		MobileElement RearPhotoSize1 = driver.findElement(By.xpath("//*[@bounds='[342,129][468,255]']"));
		RearPhotoSize1.click();
		TimeUnit.SECONDS.sleep(3);

		//Select 3:4 
		logger.info("Select Rear camera second resolution: 40M");
		System.out.println("Select Rear camera second resolution: 40M");
		driver.findElement(By.xpath("//*[@bounds='[341,1095][467,1221]']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		//Click On Settings
				...
				logger.info("Select settings option to select resolution");
				System.out.println("Select settings option to select resolution");
				MobileElement RearPhotoSize2 = driver.findElement(By.xpath("//*[@bounds='[342,129][468,255]']"));
				RearPhotoSize2.click();
				TimeUnit.SECONDS.sleep(3);

				//Select 3:4 
				logger.info("Select Rear camera third resolution: 16M");
				System.out.println("Select Rear camera third resolution: 16M");
				driver.findElement(By.xpath("//*[@bounds='[611,1095][737,1221]']")).click();
				TimeUnit.SECONDS.sleep(3);
				...
				logger.info("Select settings option to select resolution");
				System.out.println("Select settings option to select resolution");
				MobileElement RearPhotoSize3 = driver.findElement(By.xpath("//*[@bounds='[342,129][468,255]']"));
				RearPhotoSize3.click();
				TimeUnit.SECONDS.sleep(3);

				//Select 3:4 
				logger.info("Select Rear camera fourth resolution: 1M");
				System.out.println("Select Rear camera fourth resolution: 1M");
				driver.findElement(By.xpath("//*[@bounds='[881,1095][1007,1221]']")).click();
				TimeUnit.SECONDS.sleep(3);
