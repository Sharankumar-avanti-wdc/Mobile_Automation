...
import Realme_Pad_RMP2102.Test10;
...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//MobileElement Videosize = driver.findElement(By.xpath("//*[@text='Video aspect ratio (Front camera)']"));
			//	Videosize.click();
			TimeUnit.SECONDS.sleep(5);

			//Select 1st resolution
			logger.info("Select first highest front camera video resolution: HD 1080P");
			System.out.println("Select first highest front camera video resolution: HD 1080P");
			...
			MobileElement Videosize1 = driver.findElement(By.xpath("//*[@text='Video aspect ratio (Front camera)']"));
			Videosize1.click();
			TimeUnit.SECONDS.sleep(5);

			//Select 2nd resolution
			logger.info("Select second highest front camera video resolution: HD 720P");
			System.out.println("Select second highest front camera video resolution: HD 720P");
			...
			logger.info("Select Video size option");
			System.out.println("Select Video size option");
			MobileElement Videosize2 = driver.findElement(By.xpath("//*[@text='Video aspect ratio (Front camera)']"));
			Videosize2.click();
			TimeUnit.SECONDS.sleep(5);

			//Select 2nd resolution
			logger.info("Select third highest front camera video resolution: SD 480P");
			System.out.println("Select third highest front camera video resolution: SD 480P");
