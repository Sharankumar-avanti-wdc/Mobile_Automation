...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			catch (Exception exp)
			{
				...
				logger.info("Pass: Pass Test0 Pass for clear recent apps and clear intenal memory scenario");
				System.out.println("Pass: Pass Test0 Pass for clear recent apps and clear intenal memory scenario");
	...
	public void Images() throws  IOException, InterruptedException {
		...
		try {
			...
			logger.info("Select SD as storage option");
			System.out.println("Select SD as storage option");
			MobileElement Picture = driver.findElement(By.xpath("//*[@text='Photo']"));
			Picture.click();
