...
public class Test0 {
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "realme 9i");
		dc.setCapability(MobileCapabilityType.UDID, "755b3e4a");
	...
	public void Video() throws  IOException, InterruptedException {
		...
		touchAction.tap(PointOption.point(310, 1785)).perform();
		TimeUnit.SECONDS.sleep(5);
		//Click On Settings
		logger.info("Select settings option");
		System.out.println("Select settings option");
		...
		touchAction.tap(PointOption.point(743, 1777)).perform();
		TimeUnit.SECONDS.sleep(5);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		logger.info("Swipe Up and Search for format sd acrd");
		System.out.println("Swipe Up and Search for format sd card");
		MobileElement element = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
				"new UiScrollable(new UiSelector().scrollable(true)).setMaxSearchSwipes(10)" +
				".scrollIntoView(new UiSelector().text(\"Format SD card\"))"));
		...
		TimeUnit.SECONDS.sleep(5);
		//Select formatsdcard
		MobileElement formatsdcard1 = 	driver.findElement(By.xpath("//*[@text='FORMAT']"));
		formatsdcard1.click();
