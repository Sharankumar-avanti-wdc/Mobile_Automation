...
public class Test9F
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera images create Test9F folder and cut paste all videos in Test9F folder
