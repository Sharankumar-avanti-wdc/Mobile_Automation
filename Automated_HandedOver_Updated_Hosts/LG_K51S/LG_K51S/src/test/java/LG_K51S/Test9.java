...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Rear camera 7th resolution: " + j6 + " images Captured succesfull");
			System.out.println("Rear camera 7th resolution: " + j6 + " images Captured succesfull" );
			//Click On Rear Image Resolution to select first resolution
			logger.info("Select Rear Image Size");
			System.out.println("Select Rear Image Size");
			driver.findElement(By.xpath("//*[@content-desc='Settings']")).click();
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Rear camera 8th resolution: " + j7 + " images Captured succesfull");
			System.out.println("Rear camera 8th resolution: " + j7 + " images Captured succesfull" );
			//Click On Rear Image Resolution to select first resolution
			logger.info("Select Rear Image Size");
			System.out.println("Select Rear Image Size");
			driver.findElement(By.xpath("//*[@content-desc='Settings']")).click();
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Rear camera fourth resolution: " + j8 + " images Captured succesfull");
			System.out.println("Rear camera fourth resolution: " + j8 + " images Captured succesfull" );
			...
			Result ="Pass";
			//Launch File manager
			logger.info("Launch file manager application and verify caaptured images present  in uSD Card");
			System.out.println("Launch file manager application and verify caaptured images present in uSD Card");
