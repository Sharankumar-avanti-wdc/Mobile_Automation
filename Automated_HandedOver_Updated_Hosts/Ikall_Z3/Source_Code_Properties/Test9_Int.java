...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@text='8M(16:9)']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("1st resolution selected 8M(16:9)");
			System.out.println("1st resolution selected 8M(16:9)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("totalPictureCountRear = "+ totalPictureCountRear + " Imgaes to be captured");
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 1st Resolutions 8M(16:9)"+j);
				logger.info("clicking Image of 1st Resolutions 8M(16:9)"+j);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("2nd resolution selected 8M(4:3)");
			System.out.println("2nd resolution selected 8M(4:3)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.mediatek.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 2nd Resolutions 8M(16:9)"+j1);
				logger.info("clicking Image of 2nd Resolutions 8M(16:9)"+j1);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.mediatek.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 3rd Resolutions 8M(16:9)"+j2);
				logger.info("clicking Image of 3rd Resolutions 8M(16:9)"+j2);
			}
			TimeUnit.SECONDS.sleep(2);
			//Click Settings Option
			driver.findElement(By.xpath("//*[@bounds='[15,7][62,54]']")).click();
			...
			{  
				...
				driver.findElement(By.id("com.mediatek.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 4th Resolutions 8M(16:9)"+j3);
				logger.info("clicking Image of 4th Resolutions 8M(16:9)"+j3);
			}
			TimeUnit.SECONDS.sleep(2);
			//Click Settings Option
			driver.findElement(By.xpath("//*[@bounds='[15,7][62,54]']")).click();
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("5th resolution selected 2M(4:3)");
			System.out.println("5th resolution selected 2M(4:3)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.mediatek.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 5th Resolutions 8M(16:9)"+j4);
				logger.info("clicking Image of 5th Resolutions 8M(16:9)"+j4);
			}
			TimeUnit.SECONDS.sleep(2);
			//Click Settings Option
			driver.findElement(By.xpath("//*[@bounds='[15,7][62,54]']")).click();
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("6th resolution selected 1M(16:9)");
			System.out.println("6th resolution selected 1M(16:9)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{  
				...
				driver.findElement(By.id("com.mediatek.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 6th Resolutions 8M(16:9)"+j5);
				logger.info("clicking Image of 6th Resolutions 8M(16:9)"+j5);
			}
			TimeUnit.SECONDS.sleep(2);
