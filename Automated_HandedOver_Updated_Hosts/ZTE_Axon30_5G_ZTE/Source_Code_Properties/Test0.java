...
public class Test0 {
	...
	public void Images() throws  IOException, InterruptedException {
		...
		{ 
			TimeUnit.SECONDS.sleep(2);
			driver.findElement(By.xpath("//*[@resource-id='com.zte.camera:id/photo_shutter_button']")).click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void Video() throws  IOException, InterruptedException {
		...
		MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[474,126][605,216]']"));
		FirstRes.click();
		TimeUnit.SECONDS.sleep(3);
		//Start Recording
		...
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[786,126][893,216]']"));
		SecondRes.click();
		TimeUnit.SECONDS.sleep(3);
		//Start Recording
		logger.info("Start video recording");
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		MobileElement formatsdcard = 	driver.findElement(By.xpath("//*[@text='Format']"));
		formatsdcard.click();
		TimeUnit.SECONDS.sleep(5);
		//Select formatsdcard
