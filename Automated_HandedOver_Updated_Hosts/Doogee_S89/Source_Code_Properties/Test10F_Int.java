...
public class Test10F_Int
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("2.Playback front Highest recorded video from Internal storagefor 30 seconds, pause video playback, lock mobile and wait 30 seconds, unlock mobile and playback video from pause video duration");
		...
		try {
			...
			logger.info("Select First front video Resolution: 1920x1080");
			System.out.println("Select First front video resolution: 1920x1080");
			driver.findElement(By.xpath("//*[@text='1920x1080']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/video_stop_shutter']")).click();
			TimeUnit.SECONDS.sleep(5);
			//Click On Settings
			logger.info("Select settings option");
			System.out.println("Select settings option");
			...
			logger.info("Select second front video Resolution:  1280x720");
			System.out.println("Select second front video resolution: 1280x720");
			driver.findElement(By.xpath("//*[@text='1280x720']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 2nd resolution
			logger.info("Select third front video Resolution:  640x480");
			System.out.println("Select third front video resolution:640x480");
			driver.findElement(By.xpath("//*[@text='640x480']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 2nd resolution
			logger.info("Select third front video Resolution:  352x288");
			System.out.println("Select third front video resolution: 352x288");
			driver.findElement(By.xpath("//*[@text='352x288']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("recordingDurationFront_Int3 = "+ recordingDurationFront_Int3 + "sec");
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("Test10F_Int_Fcam_video: 4 videos captured successfully");
			System.out.println("Test10F_Int_Fcam_video: 4 videos captured successfully");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");	 
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(3);
	...
	public void VideoPlayBackForSleepWake() throws  IOException, InterruptedException {
		...
		try {
			...
			if(Result == "Fail")
			{
				...
				logger.info("Final Message: Fail Test101F_Int Fail for Data Move Operation");
			}
			else {
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			System.out.println("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all front camera Videos create Test10F_Int and cut paste all videos in Test10F_Int folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//If file manager permission request access accept allow permission
			try
