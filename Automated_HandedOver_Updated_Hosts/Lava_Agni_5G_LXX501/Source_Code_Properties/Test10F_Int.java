...
import Lava_Agni_5G_LXX501.Test10;
...
public class Test10F_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("2.Playback Newest resolution recorded video from Internal storage, fast forward playback and pause video scenario ");
		...
		System.out.println("2.Playback Newest resolution recorded video from Internal storage, fast forward playback and pause video scenario ");
		System.out.println("3.Move front camera recorded videos from Internal storage to Test10F_Int folder in Internal storage");
		...
		try {
			...
			logger.info("Select front camera first video resolution: 1080p");
			System.out.println("Select front camera first video resolution: 1080p");
			...
			logger.info("Select front camera second video resolution : 720p");
			System.out.println("Select front camera second video resolution : 720p");
			...
			TimeUnit.SECONDS.sleep(5);
			//Select 2nd resolution
			logger.info("Select front camera 3rd video resolution : 480p");
			System.out.println("Select front camera 3rd video resolution : 480p");
			...
			TimeUnit.SECONDS.sleep(5);
			//Select 2nd resolution
			logger.info("Select front camera second video resolution : CIF");
			System.out.println("Select front camera second video resolution : CIF");
			MobileElement fourthres = driver.findElement(By.xpath("//*[@text='CIF']"));
			fourthres.click();
			TimeUnit.SECONDS.sleep(2);
			// Load properties file for video recording duration
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording3 = driver.findElement(By.xpath("//*[@bounds='[424,1929][655,2160]']"));
			StartRecording3.click();
			TimeUnit.SECONDS.sleep(recordingDurationFront3Int);
			//Stop Recording
			logger.info("Stop video recording");
			System.out.println("Stop video recording");
			MobileElement StopRecording3 = driver.findElement(By.xpath("//*[@bounds='[424,1929][655,2160]']"));
