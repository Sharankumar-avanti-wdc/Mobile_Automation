...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			logger.info("Launching file manager application for clearing phone internal memory");
			System.out.println("Launching file manager application for clearing phone internal memory");
	...
	public void Images() throws  IOException, InterruptedException {
		...
		try {
			...
			try {
				TimeUnit.SECONDS.sleep(3);
				driver.findElement(By.xpath("//*[@text='26 selected']")).click();
				...
				logger.info("Fail: Video() cannot be called as incorrect Images captured ");
				logger.info("Final Message: Fail Test0 Fail for Image capture");
				System.out.println("Fail: Video() cannot be called as incorrect Images captured ");
	...
	public void Video() throws  IOException, InterruptedException {
		...
		try {
			...
			try {
				...
				TimeUnit.SECONDS.sleep(3);
				driver.findElement(By.xpath("//*[@text='28 selected']")).click();
