...
import SamsungGalaxy_A32.Test10;
...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@bounds='[39,122][159,242]']"));
			TimeUnit.SECONDS.sleep(5);
			Settings.click();
			...
			MobileElement RearVideoSize = driver.findElement(By.xpath("//*[@text='Front camera video size']"));
			RearVideoSize.click();

			logger.info("Select 1st Back Video Resolution:FHD (30 fps)");
			System.out.println("Select 1st Front camera video size, FHD (30 fps)");
			...
			MobileElement RearVideoSize1 = driver.findElement(By.xpath("//*[@text='Front camera video size']"));
			RearVideoSize1.click();
			logger.info("Select 2nd Front camera video size, HD (30 fps)");
			System.out.println("Select 2nd Front camera video size, HD (30 fps)");
			//Select 2nd resolution
			//MobileElement secondRes = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/quick_setting_button']"));
			...
			TimeUnit.SECONDS.sleep(6);
			//Switch to front camera mode
			logger.info("Switch to rear camera");
			System.out.println("Switch to rear camera");
			MobileElement SwitchToFrontCamera1 = driver.findElement(By.xpath("//*[@content-desc='Switch to rear camera']"));
			TimeUnit.SECONDS.sleep(5);
