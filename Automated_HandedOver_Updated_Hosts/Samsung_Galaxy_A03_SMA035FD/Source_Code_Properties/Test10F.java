...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Host does not support front camera video resolution during automation. !Hence recording only default front video resolution.");
			System.out.println("Host does not support front camera video resolution during automation. !Hence recording only default front video resolution.");
			//MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[306,120][426,240]']"));
			//FirstRes.click();
		...
		MobileElement RearVideoSize1 = driver.findElement(By.xpath("//*[@text='Video size']"));
			...
			logger.info("Select rear camera second Video Resolution:FRONT_CAMCORDER_RESOLUTION_FHD_30");
			System.out.println("Select rear camera second Video Resolution:FRONT_CAMCORDER_RESOLUTION_FHD_30");
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[480,120][600,240]']"));
			SecondRes.click();
  		TimeUnit.SECONDS.sleep(2);
		...
		//Click On Rear Video size to select resolution
				...
				MobileElement RearVideoSize2 = driver.findElement(By.xpath("//*[@text='Video size']"));
					...
					//Select 3rd resolution
					logger.info("Select rear camera second Video Resolution:FRONT_CAMCORDER_RESOLUTION_HD_30");
					System.out.println("Select rear camera second Video Resolution:FRONT_CAMCORDER_RESOLUTION_HD_30");
					MobileElement ThirsRes = driver.findElement(By.xpath("//*[@bounds='[654,120][774,240]']"));
					ThirsRes.click();
		  		TimeUnit.SECONDS.sleep(2);
