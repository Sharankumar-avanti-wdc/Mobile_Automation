...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first highest  video resolution 720p, 30fps,");
			System.out.println("Select first highest video resolution 1080p, 30fps,");
			...
			logger.info("Select second video resolution  1080p, 30fps");
			System.out.println("Select second video resolution  1080p, 30fps");
