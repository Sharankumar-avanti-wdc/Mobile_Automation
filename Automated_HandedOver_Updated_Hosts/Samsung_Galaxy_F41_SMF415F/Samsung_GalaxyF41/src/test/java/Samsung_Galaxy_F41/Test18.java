...
public class Test18
{
	...
	public void CopyPaste() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"More\"]/android.widget.ImageView")).click();
		TimeUnit.SECONDS.sleep(5);
		...
		TimeUnit.SECONDS.sleep(5);
		logger.info("Name exract zip file name as Test1");
		System.out.println("Name exract zip file name as Test1");
		...
		logger.info("Extracting zip file Completed successfully in Internal storge");
		System.out.println("Extracting zip file Completed successfully in Internal storge");
		...
		TimeUnit.SECONDS.sleep(5);	
		logger.info("Test2 folder created in external storage");
		System.out.println("Test2 folder created in external storage");
		...
		logger.info("Select Test1 Folder from exteranl storage");
		...
		// Long Prees and Hold Test1 folder
				...
				driver.findElement(By.id("com.sec.android.app.myfiles:id/operation_done")).click();
				TimeUnit.SECONDS.sleep(120);
				logger.info("Pass: Test18 Pass for Copy paste operation from internal  external storage and vice versa scenario completed successfully");
				System.out.println("Pass: Test18 Pass for Copy paste operation from internal  external storage and vice versa scenario completed successfully");
		...
		logger.info("click on create folder and create folder name folder name New_Scenarion in external storage");
		System.out.println("click on create folder and create folder name folder name New_Scenario in external storage");
		((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Create folder\")").click();
		TimeUnit.SECONDS.sleep(5);
		driver.findElement(By.id("com.sec.android.app.myfiles:id/text_input")).clear();
		...
		((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Create\")").click();
		TimeUnit.SECONDS.sleep(5);
		logger.info("New_scenario folder in external storage created succesfully");
		System.out.println("New_scenario folder in external storage created succesfully");
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(5);
		...
		logger.info("Select New_Scenario folder in external stoarage");
		System.out.println("Select New_Scenario folder in external storage");
		...
		logger.info("Pass: Test18 Pass for operation Cut paste Operation  Successfully");
		
		System.out.println("Pass: Test18 Pass for operation Cut paste Operation  Successfully\"");
