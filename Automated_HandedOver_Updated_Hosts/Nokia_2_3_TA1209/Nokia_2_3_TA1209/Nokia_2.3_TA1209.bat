...
cd C:\Users\7336135\Android11\eclipse-workspace\Nokia_2_3_TA1209
mvn -DrecordingDurationfrontExt=180 -DrecordingDurationfrontExt1=180  -DfileName=testng10F_Int.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\ABC\Nokia_2.3_TA1209_%mydate%_%mytime%_%Qual_Capacity%.txt
