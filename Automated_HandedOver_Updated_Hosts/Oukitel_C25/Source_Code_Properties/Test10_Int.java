...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 1st Rear Video Resolution:HD 1080p");
			System.out.println("Select 1st Rear Video Resolution: HD 1080p");
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 2nd Rear Video Resolution: HD 720p");
			System.out.println("Select 2nd Rear Video Resolution:  HD 720p");
