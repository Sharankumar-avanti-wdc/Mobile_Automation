...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			logger.info("Final Message: Pass Test0 Pass for clear internal memory, host does'nt support format with data operation in usd card"); 
			System.out.println("Final Message: Pass Test0 Pass for clear internal memory,  host does'nt support format with data operation in usd card ");
