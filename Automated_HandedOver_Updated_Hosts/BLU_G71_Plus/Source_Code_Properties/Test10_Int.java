...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement VideoResolution = driver.findElement(By.xpath("//*[@text='Video size(Back)']"));
			...
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[18,514][148,632]']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Video quality");
			System.out.println("Select Video quality");
			MobileElement VideoResolution1 = driver.findElement(By.xpath("//*[@text='Video size(Back)']"));
			...
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[202,514][332,632]']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Video quality");
			System.out.println("Select Video quality");
			MobileElement VideoResolution2 = driver.findElement(By.xpath("//*[@text='Video size(Back)']"));
			...
			//Select 2nd resolution
			MobileElement thirdRes = driver.findElement(By.xpath("//*[@bounds='[386,514][516,632]']"));
			thirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Video quality");
			System.out.println("Select Video quality");
			MobileElement VideoResolution3 = driver.findElement(By.xpath("//*[@text='Video size(Back)']"));
			VideoResolution3.click();
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 3rd Rear Video Resolution: CIF");
			System.out.println("Select 3rd Rear Video Resolution:  CIF");
			//Select 2nd resolution
			MobileElement fourthres = driver.findElement(By.xpath("//*[@bounds='[570,514][700,632]']"));
			fourthres.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording3 = driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']"));
			...
			MobileElement StopRecording3 = driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']"));
			...
			TimeUnit.SECONDS.sleep(5);
			TotalFiles.click();
			logger.info("Test10_Int_Bcam_video: 4 Videos captured successfully");
			System.out.println("Test10_Int_Bcam_video: 4 Videos captured successfully");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		logger.info("Launch File Manager for playing highest resolution recorded video from Internal, fast forward and pause scenario");
		System.out.println("Launch File Manager for playing highest resolution recorded video from Internal, fast forward and pause scenario");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			System.out.println("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all rear camera videos create Test10_Int and cut paste all videos in Test10_Int folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
