...
import Infinix_Hot_12Pro_X668.Test9;
...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			//front camera 3 image resolutions supports
			...
			driver.findElement(By.xpath("//*[@bounds='[592,1362][672,1442]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			MobileElement picturesize = driver.findElement(By.xpath("//*[@text='Picture size']"));
			picturesize.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select first Image Resoution: 4:3 ");
			System.out.println("Select first Image Resoution: 4:3 ");
			driver.findElement(By.xpath("//*[@bounds='[32,1028][688,1144]']")).click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select  picture size");
			System.out.println("Select  picture size");
			MobileElement picturesize1 = driver.findElement(By.xpath("//*[@text='Picture size']"));
			picturesize1.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 2nd resolution
			logger.info("Select second Image Resoution: 1:1");
			System.out.println("Select second Image Resoution: 1:!");
			driver.findElement(By.xpath("//*[@bounds='[32,1144][688,1260]']")).click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select  picture size");
			System.out.println("Select  picture size");
			MobileElement picturesize2 = driver.findElement(By.xpath("//*[@text='Picture size']"));
			picturesize2.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first third Resoution: 20:9");
			System.out.println("Select third Image Resoution: 20:9");
			driver.findElement(By.xpath("//*[@bounds='[32,1260][688,1376]']")).click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@bounds='[296,1338][424,1444]']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 3rd Resolutions 20:9: "+j2);
				logger.info("clicking Image of 3rd Resolutions 20:9: "+j2);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			SDcard.click();
			TimeUnit.SECONDS.sleep(6);
			logger.info("switch to list gird mode");
			System.out.println("switch to list gird mode");
