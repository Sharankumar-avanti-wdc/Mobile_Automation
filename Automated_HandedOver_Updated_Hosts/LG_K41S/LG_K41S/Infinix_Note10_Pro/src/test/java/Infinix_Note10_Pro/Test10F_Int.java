...
public class Test10F_Int
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select First front video Resolution:  1080P,30fps");
			System.out.println("Select First front video resolution:  1080P,30fps");
			...
			logger.info("Select First front video Resolution:  720P,30fps");
			System.out.println("Select First front video resolution:  720P,30fps");
