package Motorola_Moto_e20_XT21553;

import org.testng.annotations.Test;
import Motorola_Moto_e20_XT21553.Test9_Int;
...
public class Test9_Int
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "moto e20");
		dc.setCapability(MobileCapabilityType.UDID, "ZE222TSDX3");
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(2);
			/*
			logger.info("Host going to sleep mode for 3 minutes because phone temperature has increased, Please use it after a while");
			System.out.println("Host going to sleep mode for 3 minutes because phone temperature has increased, Please use it after a while");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select Rear camera second resolution:  3:4");
			System.out.println("Select Rear camera second resolution: 3:4");
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select rear camera third resolution: 9:16");
			System.out.println("Select rear camera third resolution: 9:16");
