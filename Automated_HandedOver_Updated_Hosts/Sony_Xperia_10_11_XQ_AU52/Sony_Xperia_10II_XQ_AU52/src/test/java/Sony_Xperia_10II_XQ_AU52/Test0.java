...
public class Test0 {
	...
	@Test
  	...
  	//Calling Image Function to capture Image and Record Video and Verify Images and recorded video present in SD Card
			...
			System.out.println("Final Message: Fail Test0 Fail for Clear recent apps and clear internal memory");
			logger.info("Final Message: Fail Test0 Fail for Clear recent apps and clear internal memory");
		...
		for(int j = 0; j < 25; j++) 
  		{ 
			...
			TimeUnit.SECONDS.sleep(6);
  			...
  			System.out.println("clicking default resolutio image" +j);
  	...
  	public void Video() throws  IOException, InterruptedException {
		...
		//Switch to Settings and Select video resolution
				...
				logger.info("Select video size option to select resolution");
	  			System.out.println("Select video size option to select resolution");
	  			MobileElement RearVideoSize = driver.findElement(By.xpath("//*[@text='Video size']"));
	  			RearVideoSize.click();
	  			logger.info("Select first highest rear camera Video Resolution:Full HD (21:9)");
	  			System.out.println("Select first highest rear camera Video Resolution:Full HD (21:9)");
  	...
  	try {
		...
		TimeUnit.SECONDS.sleep(5);
		logger.info("Selected Storage settings");
