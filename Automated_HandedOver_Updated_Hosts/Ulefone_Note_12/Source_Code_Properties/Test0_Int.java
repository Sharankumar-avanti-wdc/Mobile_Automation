...
public class Test0_Int {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try {
				...
				MobileElement DeleteP =	driver.findElement(By.xpath("//*[@text='Delete permanently']"));
				DeleteP.click();
				TimeUnit.SECONDS.sleep(3);
	...
	public void FormatAsInternal() throws  IOException, InterruptedException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(5);
			logger.info("Scrolling till Storage option is visible");
			System.out.println("Scrolling till Storage option is visible");
			String text = "Storage";
