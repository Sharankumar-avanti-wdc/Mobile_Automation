...
import Motorola_Edge20_Fusion.Test0;
import Motorola_Edge20_Fusion.Test10;
...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first video resolution: Aspect ratio Full");
			System.out.println("Select first video resolution: Aspect ratio Full");
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@content-desc='Aspect ratio Full']"));
			FirstRes.click();
			...
			logger.info("Select second highest resolution: Aspect ratio 9:16");
			System.out.println("Select second highest resolution: Aspect ratio 9:16");
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@content-desc='Aspect ratio 9:16']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		TimeUnit.SECONDS.sleep(5);
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create BCFC_Videos folder and cut paste all videos in Test10F folder
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test10 and cut paste all videos in Test10F folder");
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera images create Test10 folder and cut paste all videos in Test10F folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
