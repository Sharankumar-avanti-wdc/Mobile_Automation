...
import Xiaomi_RedmiNote10T_5G_M2103K191.Test0;
...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(6);
			logger.info("Test10_Fcam_res: 2 resolutions supported");
			System.out.println("Test10_Fcam_res: 2 resolutions supported");
