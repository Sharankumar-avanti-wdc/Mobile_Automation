...
public class Test10_Int
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera videos create Test10_Int folder and cut paste all videos in Test10_Int folder
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all raer camera videos create Test10_Int and cut paste all videos in Test10_Int folder");
