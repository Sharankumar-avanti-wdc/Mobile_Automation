...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			logger.info("Clearing phone internal memory");
			System.out.println("Clearing phone internal memory");
			//Launch File manager
			...
			MobileElement StorageButton = driver.findElement(By.xpath("//*[@bounds='[540,102][864,254]']"));
			...
			MobileElement SelectAll =	driver.findElement(By.xpath("//*[@bounds='[864,102][1080,254]']"));
			SelectAll.click();
	...
	public void Images() throws  IOException, InterruptedException {
		...
		logger.info("Switching to  SwitchStorage");
		System.out.println("Switching to  SwitchStorage");
		MobileElement SwitchStorage = driver.findElement(By.xpath("//*[@resource-id='com.mi.android.globalFileexplorer:id/volume_switch']")); 
		SwitchStorage.click();
		TimeUnit.SECONDS.sleep(3);		
		...
		MobileElement ExternalStorage = driver.findElement(By.xpath("//*[@bounds='[14,793][224,875]']")); 
	...
	public void Video() throws  IOException, InterruptedException {
		...
		driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_10']")).click();	
		TimeUnit.SECONDS.sleep(3);
		//Click on Video Resolution
		logger.info("Select Video resolution: FHD 1080p, 60fps");
		System.out.println("Select Video resolution: FHD 1080p, 60fps");
		...
		MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[412,1915][668,2168]']"));
		StopRecording.click();
		TimeUnit.SECONDS.sleep(5);
		//Click Settings option to select video resolution
		logger.info("Click setting option to select video resolution");
		...
		logger.info("Select second highest resolution: UHD 4K, 30fps");
		System.out.println("Select second highest resolution: UHD 4K, 30fps");
		...
		logger.info("Stop video recording");
		System.out.println("Stop video recording");
		MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@bounds='[412,1915][668,2168]']"));
