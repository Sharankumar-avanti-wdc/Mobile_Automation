...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(2);
			//front camera supports 5 video resolutions
			...
			driver.findElement(By.xpath("//*[@bounds='[894,164][1044,308]']")).click();
			...
			logger.info("Select First front video Resolution: 1.8M (1920x960)");
			System.out.println("Select First front video resolution: 1.8M (1920x960)");
			driver.findElement(By.xpath("//*[@bounds='[288,396][713,556]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement StartRecording = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			StartRecording.click();
			//Stop Recording
			logger.info("Stop video recording");
			System.out.println("Stop video recording");
			TimeUnit.SECONDS.sleep(recordingDurationFrontInt);
			MobileElement StopRecording = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			StopRecording.click();
			...
			logger.info("Select second front video Resolution:  FULL HD (1920x1080)");
			System.out.println("Select second front video resolution:FULL HD (1920x1080)");
			driver.findElement(By.xpath("//*[@bounds='[288,820][836,980]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording1 = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			...
			MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2nd resolution
			logger.info("Select third front video Resolution: Video Stabilization");
			System.out.println("Select third front video resolution: Video Stabilization");
			driver.findElement(By.xpath("//*[@bounds='[64,1080][224,1240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording2 = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			...
			MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2nd resolution
			logger.info("Select fourth front video Resolution: 1.2M (1080x1080)");
			System.out.println("Select fourth front video resolution: 1.2M (1080x1080)");
			driver.findElement(By.xpath("//*[@bounds='[288,1340][745,1500]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording3 = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			...
			MobileElement StopRecording3 = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2nd resolution
			logger.info("Select fifth front video Resolution: 4K (3840x2160)");
			System.out.println("Select fifth front video resolution: 4K (3840x2160)");
			driver.findElement(By.xpath("//*[@bounds='[288,656][684,816]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording4 = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			...
			MobileElement StopRecording4 = driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_recbutton']"));
			...
			driver.findElement(By.xpath("//*[@bounds='[1060,164][1210,308]']")).click();
			//driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[5]/android.widget.LinearLayout[2]/android.widget.FrameLayout[7]/android.widget.ImageButton")).click();
			TimeUnit.SECONDS.sleep(5);
			//Click On photo mode
			...
			driver.findElement(By.xpath("//*[@text='101INCAM']")).click();
			TimeUnit.SECONDS.sleep(5);
			//Click More Options
			...
			TimeUnit.SECONDS.sleep(3);
			//Select All
			MobileElement TotalFiles = driver.findElement(By.xpath("//*[@text='5 selected']"));
			TimeUnit.SECONDS.sleep(5);
			TotalFiles.click();
			logger.info("Test10F_Fcam_video: 5 Videos captured successfull");
			System.out.println("Test10F_Fcam_video: 5 Videos captured successfull");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
