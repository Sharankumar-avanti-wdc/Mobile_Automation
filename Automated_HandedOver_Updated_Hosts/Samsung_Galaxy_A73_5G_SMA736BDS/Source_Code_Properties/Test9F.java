package Samsung_Galaxy_A73_5G_SMA736BDS;
...
import Samsung_Galaxy_A73_5G_SMA736BDS.Test9;
...
public class Test9F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Galaxy A73 5G");
		dc.setCapability(MobileCapabilityType.UDID, "R5CT41HSTSJ");
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select First front Image Resoution: FRONT_CAMERA_PICTURE_RATIO_SUPER_RESOLUTION");
			System.out.println("Select First front Image Resoution: FRONT_CAMERA_PICTURE_RATIO_SUPER_RESOLUTION");
			//MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[129,120][249,240]']"));
			//FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Second resolution FRONT_CAMERA_PICTURE_RATIO_NORMAL");
			System.out.println("Select Second resolution FRONT_CAMERA_PICTURE_RATIO_NORMAL");
			//	MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[304,120][424,240]']"));
			//	SecRes.click();
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			...
			logger.info("Select third Image Resoution: FRONT_CAMERA_PICTURE_RATIO_WIDE");
			System.out.println("Select third Image Resoution: FRONT_CAMERA_PICTURE_RATIO_WIDE");
			//MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[479,120][599,240]']"));
			//ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select fourth resolution:FRONT_CAMERA_PICTURE_RATIO_SQUARE");
			System.out.println("Select fourth resolution: FRONT_CAMERA_PICTURE_RATIO_SQUARE");
			//MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[654,120][774,240]']"));
			//FourthRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			//Select fourth resolution
			logger.info("Select fith resolution: FRONT_CAMERA_PICTURE_RATIO_FULL");
			System.out.println("Select fifth resolution: FRONT_CAMERA_PICTURE_RATIO_FULL");
			//MobileElement fifthRes = driver.findElement(By.xpath("//*[@bounds='[829,120][949,240]']"));
			//fifthRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(2);
			System.out.println("front camera fifth resolution:" + j4 + " images Captured succesfull" );
			logger.info("front camera fifth resolution:" + j4 + " images Captured succesfull" );
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
