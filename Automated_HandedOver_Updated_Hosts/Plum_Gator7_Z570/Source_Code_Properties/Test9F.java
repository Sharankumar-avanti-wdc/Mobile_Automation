package Plum_Gator7_Z570;

import org.testng.annotations.Test;
import Plum_Gator7_Z570.Test9F;
...
public class Test9F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Z570");
		dc.setCapability(MobileCapabilityType.UDID, "Z570000000000585");
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[22,62][92,132]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"SD card storage\")").click();
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select front camera front image resolution: 2560x1920");
			System.out.println("Select front camera front image resolution: 2560x1920");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select front camera second image resolution: 2464x1232");
			System.out.println("Select front camera second image resolution: 2464x1232");
			driver.findElement(By.xpath("//*[@text='2464x1232']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select front camera third image resolution: 2304x1296");
			System.out.println("Select front camera third image resolution: 2304x1296");
			driver.findElement(By.xpath("//*[@text='2304x1296']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
