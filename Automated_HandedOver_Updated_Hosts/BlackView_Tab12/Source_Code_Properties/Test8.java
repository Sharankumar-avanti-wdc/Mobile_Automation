...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("Host does not support audio recording in SD card storage.Hence skipping audio recording and recorded audio playback scenario");
		System.out.println("Host does not support audio recording in SD card storage.Hence skipping audio recording and recorded audio playback scenario");
		//Calling PlayCopiedAudioFile() for copied audio files playback from SD card storage from TEST1 folder
		logger.info("Calling PlayCopiedAudioFile() for copied audio files playback from SD card storage from TEST1 folder");
		System.out.println("Calling PlayCopiedAudioFile() for copied audio files playback from SD card storage from TEST1 folder");
		PlayCopiedAudioFile();
