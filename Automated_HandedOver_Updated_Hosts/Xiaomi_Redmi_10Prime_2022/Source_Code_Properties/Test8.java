...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("1.Host voice recorder application does not support uSD storage option. Hence skipping voice recording scenario,Playing recorded audio playback and fastforward scenario!");
		logger.info("2.Launch file manager application and playback copied audio files from external storage from Test1 folder");

		logger.info("Setting up the appium desired capabilities");
		System.out.println("Test8 scenario is as follows");
		System.out.println("1.Host voice recorder application does not support uSD storage option. Hence skipping voice recording scenario,Playing recorded audio playback and fastforward scenario!");
		System.out.println("2.Launch file manager application and playback copied audio files from external storage the files from  Test1 folder");
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
		try {
		logger.info("Launch file manager application to play copied audio files from Test1 folder");
		System.out.println("Launch file manager application to play copied audio files from Test1 folder");
		...
		try {
			...
			touchAction.tap(PointOption.point(624, 1812)).perform();
			TimeUnit.SECONDS.sleep(10);
			
			logger.info("continue audio play back for 30 seconds");
			System.out.println("continue audio play back for 30 seconds");
