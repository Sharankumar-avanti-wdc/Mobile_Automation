...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select rear camera first resolution");
			System.out.println("Select rear camera first resolution");
			MobileElement firstRes = driver.findElement(By.xpath("//*[@bounds='[405,465][519,579]']"));
			firstRes.click();
			...
			System.out.println("Select rear second first resolution");
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[567,465][681,579]']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			//close layout
			logger.info("Close Layoff");
			...
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[729,465][843,579]']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			//close layout
			logger.info("Close Layoff");
			...
			Layout3.click();
			//Select first resolution
			logger.info("Select rear camera fourth resolution");
			System.out.println("Select rear camera fourth resolution");
			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[891,465][1005,579]']"));
			FourthRes.click();
			TimeUnit.SECONDS.sleep(2);
			//close layout
			logger.info("Close Layoff");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException {
		...
		try {
			...
			touchAction3.tap(PointOption.point(1003, 203)).perform();
			TimeUnit.SECONDS.sleep(5);
