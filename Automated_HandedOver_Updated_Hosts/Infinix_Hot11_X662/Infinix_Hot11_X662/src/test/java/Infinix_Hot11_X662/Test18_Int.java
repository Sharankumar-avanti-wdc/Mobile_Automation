...
public class Test18_Int
{
	...
	public void CopyPaste() throws InterruptedException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(5);	
			logger.info("Test2 folder created successfully in internal storage");
			System.out.println("Test2 folder created successfully in internal storage");
			//Switch to Grid View
			...
			TimeUnit.SECONDS.sleep(180);
			logger.info("Copy paste Test1 folder data to Test2 folder within internal storage is successfull");
			System.out.println("Copy paste Test1 folder data to Test2 folder within internal storage is successfull");
			//((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			//TimeUnit.SECONDS.sleep(5);
