...
public class Test10F_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("3.Move front camera recorded videos from Internal storage to Test10_Int folder in Internal storage");
		...
		System.out.println("3.Move front camera recorded videos from Internal storage to Test10_Int folder in Internal storage");
		...
		try {
			...
			MobileElement StartRecording = driver.findElement(By.xpath("//*[@bounds='[290,1289][430,1424]']"));
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Setting2 = driver.findElement(By.xpath("//*[@bounds='[636,48][720,132]']"));
			Setting2.click();
			TimeUnit.SECONDS.sleep(5);
			//Click On Video size
			logger.info("Select Video size option");
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording1 = driver.findElement(By.xpath("//*[@bounds='[290,1289][430,1424]']"));
