...
public class Test18
{
	...
	public void CopyPaste() throws InterruptedException, IOException {
		...
		try {
			...
			logger.info("Pass: Test18 Pass for copy paste operation from interanl to external memory(Test1)");
			//Select more options
			...
			TimeUnit.SECONDS.sleep(3);
			//select Test2 folder
			logger.info("select Test2 folder in external storage");
			System.out.println("select Test2 folder in external storage");
			...
			Paste1.click();
			TimeUnit.SECONDS.sleep(90);
			logger.info("Pass: Test18 pass for Copy paste Test1 folder from internal memory to external memory in Test2 folder is Successfull");
			System.out.println("Pass: Test18 pass for Copy paste Test1 folder from internal memory to external memory in Test2 folder is Successfull");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			//Select More option
