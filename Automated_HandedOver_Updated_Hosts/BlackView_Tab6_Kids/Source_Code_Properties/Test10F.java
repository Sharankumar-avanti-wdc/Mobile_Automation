...
import BlackView_Tab6_Kids.Test10;
...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select front camera second video resolution : SD 480p");
			System.out.println("Select front camera second video resolution : SD 480p");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera images create Test10 Ffolder and cut paste all videos in Test10F folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//If file manager permission request access accept allow permission
			//Swipe and Select external storage
