...
public class Test0_Int {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			logger.info("Host does not support Format with data scenario for internal mount(Host behaviour). Hence skipping format with data scenario");
			System.out.println("Host does not support Format with data scenario for internal mount(Host behaviour). Hence skipping format with data scenario");
