...
public class Test10
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "TECNO SPARK 8C");
		dc.setCapability(MobileCapabilityType.UDID, "078563124F043089");
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[28,122][108,202]']")).click();
			...
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[32,1028][688,1144]']"));
			FirstRes.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[32,1144][688,1260]']"));
			SecondRes.click();
			...
			logger.info("Select 3rd Back Video Resolution: 480P");
			System.out.println("Select 3rd Back Video Resolution:  480p");
			//Select 2nd resolution
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[32,1260][688,1376]']"));
			ThirdRes.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
