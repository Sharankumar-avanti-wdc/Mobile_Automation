...
public class Test0 {
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "oppo A16e");
		dc.setCapability(MobileCapabilityType.UDID, "ROBMW85T7DIFVG95");
	...
	public void Images() throws  IOException, InterruptedException {
		...
		driver.findElement(By.xpath("//*[@bounds='[606,0][670,144]']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		System.err.println("Pass:Total Number Of Image captured 25 is successfull");
		logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
	...
	public void Video() throws  IOException, InterruptedException {
		...
		touchAction.tap(PointOption.point(204, 1169)).perform();
		TimeUnit.SECONDS.sleep(5);
		//Click On Settings
		logger.info("Select settings option");
		System.out.println("Select settings option");
		...
		MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[48,281][140,324]']"));
		FirstRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		...
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[48,377][122,420]']"));
		SecondRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		...
		touchAction.tap(PointOption.point(503, 1153)).perform();
		TimeUnit.SECONDS.sleep(5);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		TimeUnit.SECONDS.sleep(5);
		////Scroll Up to find external Storage option
		logger.info("swipe up and search for Format SD card");
