...
import BlackView_Tab6_Kids.Test9F_Int;
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		//Launch Home screen 
 		...
 		TimeUnit.SECONDS.sleep(2);
				...
				logger.info("Test9F_Int_Fcam_res: 2 resolutions supported");
				System.out.println("Test9F_Int_Fcam_res: 2 resolutions supported");
		...
		//Select 3:4 
		logger.info("Select front camera second image resolution: (16:9) 0.9 megapixels");
		System.out.println("Select front camera second image resolution: (16:9) 0.9 megapixels");
