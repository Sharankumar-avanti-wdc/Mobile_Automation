...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			//logger.info("Host does not support clear recent apps scenario during automation. Hence skipping clear recent apps scenario");
			//System.out.println("Host does not support clear recent apps scenario during automation. Hence skipping clear recent apps scenario");
			// Click Recent Apps
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		try {
			...
			MobileElement NavigateBar = driver.findElement(By.xpath("//*[@bounds='[90,333][600,441]']"));
			NavigateBar.click();
			TimeUnit.SECONDS.sleep(10);
