...
import Samusng_Galaxy_A51_5G.Test9;
	...
	private boolean isPaused;
		...
		public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
	  	...
	  	//Launch Home screen and clear recent apps
	  		...
	  		logger.info("Test9F_Fcam_res: 0 resolutions supported");
			System.out.println("Test9F_Fcam_res: 0 resolutions supported");
			
			logger.info("Unable to select Rear camera resolution in automation. Hence capturing default image resolution");
			System.out.println("Unable to select Rear camera resolution in automation. Hence capturing default image resolution");
