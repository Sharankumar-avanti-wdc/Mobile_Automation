	...
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		...
		try {
			...
			try {
				...
				System.out.println("Select FHD 5.1 ( 1350 X 2560 ).webm file for video playback from uInternal storage(Test-->Videos)");
				logger.info("Select FHD 5.1 ( 1350 X 2560 ).webm file for video playback from uInternal storage(Test-->Videos)");
