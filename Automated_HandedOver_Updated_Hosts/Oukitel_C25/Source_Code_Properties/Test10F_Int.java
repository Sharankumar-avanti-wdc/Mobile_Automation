...
public class Test10F_Int
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select First front video Resolution:  HD 1080p");
			System.out.println("Select First front video resolution: HD 1080p");
			...
			logger.info("Select third front video Resolution: SD 480p");
			System.out.println("Select third front video resolution: SD 480p");
