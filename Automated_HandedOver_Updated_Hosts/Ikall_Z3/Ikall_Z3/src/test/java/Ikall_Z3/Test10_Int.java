...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			logger.info("Record Rear camera videos for all Host resolutions in Internal Mount uSD Card");
			System.out.println("Record Rear camera videos for all Host resolutions in Internal Mount uSD Card");
			//launch camera
			...
			System.err.println("Selecting 1st resolution HD");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 2nd resolution 
			//Selecting 2nd Highest resolution
			driver.findElement(By.xpath("//*[@bounds='[21,294][53,323]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Selecting 3rd resolution CIF");
			System.out.println("Selecting 3rd resolution CIF");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 2nd resolution 
			//Selecting 2nd Highest resolution
			driver.findElement(By.xpath("//*[@bounds='[21,393][76,422]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Selecting 4th resolution QVGA");
			System.out.println("Selecting 4th resolution QVGA");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
