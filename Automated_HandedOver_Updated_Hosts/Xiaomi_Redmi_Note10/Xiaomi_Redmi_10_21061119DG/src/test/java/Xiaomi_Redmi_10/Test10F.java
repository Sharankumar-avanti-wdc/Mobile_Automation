...
import Xiaomi_Redmi_10.Test0;
import Xiaomi_Redmi_10.Test10;
...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("3.Move front camera recorded video files form uSD card to Test10F folder in uSD card");
		...
		System.out.println("3.Move front camera recorded video files form uSD card to Test10F folder in uSD card");
		...
		try {
			...
			logger.info("Select first video resolution: HD 720p");
			System.out.println("Select first video resolution: HD 720p");
			...
			logger.info("Select second video resolution: FHD 1080p");
			System.out.println("Select second video resolution: FHD 1080p");
			...
			TimeUnit.SECONDS.sleep(5); 			
			//Switch to Front Video camera mode
			logger.info("Switch to back video camera mode");
			System.out.println("Switch to back video camera mode");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/v9_camera_picker_horizontal']")).click();	
			TimeUnit.SECONDS.sleep(3);
			//Switch to photo tab
			...
			logger.info("Pass: Test10F front camera video recording is successfull");
			System.out.println("Pass: Test10F front camera video recording is successfull");
