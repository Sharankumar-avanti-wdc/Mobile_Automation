...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement RearVideoSize = driver.findElement(By.xpath("//*[@bounds='[627,122][747,242]']"));
			RearVideoSize.click();
			//Select 1st resolution
			logger.info("Select  Front camera first Video Resolution:FRONT_CAMCORDER_RESOLUTION_UHD_60");
			System.out.println("Select  Front camera first Video Resolution:FRONT_CAMCORDER_RESOLUTION_UHD_60");
			...
			MobileElement RearVideoSize1 = driver.findElement(By.xpath("//*[@bounds='[627,122][747,242]']"));
			RearVideoSize1.click();
			//Select 2nd resolution
			logger.info("Select front camera second video resolutio:BACK_CAMCORDER_RESOLUTION_FHD_60");
			System.out.println("Select front camera second video resolutio:BACK_CAMCORDER_RESOLUTION_FHD_60");
			...
			logger.info("Click front video size and select second resolution");
			System.out.println("Click front video size and select second resolution");
			MobileElement RearVideoSize2 = driver.findElement(By.xpath("//*[@bounds='[627,122][747,242]']"));
			RearVideoSize2.click();
			//Select 2nd resolution
			logger.info("Select front camera third video resolutio:BACK_CAMCORDER_RESOLUTION_FHD_60");
			System.out.println("Select front camera third video resolutio:BACK_CAMCORDER_RESOLUTION_FHD_60");
			...
			logger.info("Click front video size and select second resolution");
			System.out.println("Click front video size and select second resolution");
			MobileElement RearVideoSize3 = driver.findElement(By.xpath("//*[@bounds='[627,122][747,242]']"));
			RearVideoSize3.click();
			//
			logger.info("Select front camera fourth video resolutio:BACK_CAMCORDER_RESOLUTION_FHD_30");
			System.out.println("Select front camera fourth video resolutio:BACK_CAMCORDER_RESOLUTION_FHD_30");
			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[294,110][438,254]']"));
			FourthRes.click();
			TimeUnit.SECONDS.sleep(2);
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Click front video size and select second resolution");
			System.out.println("Click front video size and select second resolution");
			MobileElement RearVideoSize4 = driver.findElement(By.xpath("//*[@bounds='[627,122][747,242]']"));
			RearVideoSize4.click();
			//Select 2nd resolution
			logger.info("Select front camera fifth video resolutio:BACK_CAMCORDER_RESOLUTION_FHD_30");
			System.out.println("Select front camera fifth video resolutio:BACK_CAMCORDER_RESOLUTION_FHD_30");
			MobileElement FifthRes = driver.findElement(By.xpath("//*[@bounds='[468,110][612,254]']"));
			FifthRes.click();
			TimeUnit.SECONDS.sleep(2);
			TimeUnit.SECONDS.sleep(2);
