...
import Realme_Pad_RMP2102.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select Photo aspect ratio (Rear camera) option to select resolution");
			System.out.println("Select Photo aspect ratio (Rear camera) option to select resolution");
			MobileElement RearPhotoSize = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Rear camera)']"));
			RearPhotoSize.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 1st photo resolution
			logger.info("Select Rear camera first image resolution: (4:3) 4.0 MP");
			System.out.println("Select Rear camera first image resolution: (4:3) 4.0 MP");
			driver.findElement(By.xpath("//*[@text='(4:3) 4.0 MP']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement RearPhotoSize1 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Rear camera)']"));
			RearPhotoSize1.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select Rear camera second resolution: (4:3) 8.0 MP");
			System.out.println("Select Rear camera second resolution: (4:3) 8.0 MP");
			driver.findElement(By.xpath("//*[@text='(4:3) 8.0 MP']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Picture size(Back camera) option to select resolution");
			System.out.println("Select Picture size(Back camera) option to select resolution");
			MobileElement RearPhotoSize2 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Rear camera)']"));
			RearPhotoSize2.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select Rear camera third resolution: (4:3) 1.9 MP");
			System.out.println("Select Rear camera third resolution: (4:3) 1.9 MP");
			driver.findElement(By.xpath("//*[@text='(4:3) 1.9 MP']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("totalPictureCountRear2 = "+ totalPictureCountRear2 + " Imgaes to be captured");
			...
			logger.info("Select Picture size(Back camera) option to select resolution");
			System.out.println("Select Picture size(Back camera) option to select resolution");
			MobileElement RearPhotoSize3 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Rear camera)']"));
			RearPhotoSize3.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select Rear camera fouth resolution: (16:9) 6.0 MP");
			System.out.println("Select Rear camera fourth resolution: (16:9) 6.0 MP");
			driver.findElement(By.xpath("//*[@text='(16:9) 6.0 MP']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("totalPictureCountRear3 = "+ totalPictureCountRear3 + " Imgaes to be captured");
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Settings4 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/mode']"));
			TimeUnit.SECONDS.sleep(5);
			Settings4.click();
			//Select settings option to select resolution
			logger.info("Select Picture size(Back camera) option to select resolution");
			System.out.println("Select Picture size(Back camera) option to select resolution");
			MobileElement RearPhotoSize4 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Rear camera)']"));
			RearPhotoSize4.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select Rear camera fifth resolution: (16:9) 2.4 MP");
			System.out.println("Select Rear camera fifth resolution: (16:9) 2.4 MP");
			driver.findElement(By.xpath("//*[@text='(16:9) 2.4 MP']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("totalPictureCountRear4 = "+ totalPictureCountRear4 + " Imgaes to be captured");
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Settings5 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/mode']"));
			TimeUnit.SECONDS.sleep(5);
			Settings5.click();
			//Select settings option to select resolution
			logger.info("Select Picture size(Back camera) option to select resolution");
			System.out.println("Select Picture size(Back camera) option to select resolution");
			MobileElement RearPhotoSize5 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Rear camera)']"));
			RearPhotoSize5.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select Rear camera sixth resolution: (16:9) 2.1 MP");
			System.out.println("Select Rear camera sixth resolution: (16:9) 2.1 MP");
			driver.findElement(By.xpath("//*[@text='(16:9) 2.1 MP']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("totalPictureCountRear5 = "+ totalPictureCountRear5 + " Imgaes to be captured");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test9_Int and cut paste all videos in Test9_Int folder");
