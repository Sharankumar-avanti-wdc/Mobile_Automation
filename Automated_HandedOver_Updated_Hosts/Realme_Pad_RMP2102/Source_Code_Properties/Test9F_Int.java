package Realme_Pad_RMP2102;
import org.testng.annotations.Test;
import Realme_Pad_RMP2102.Test9F_Int;
...
public class Test9F_Int
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "realme Pad");
		dc.setCapability(MobileCapabilityType.UDID, "ZLJRS4I7E6L7B6NB");
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			MobileElement  ClearAll =	driver.findElement(By.xpath("//*[@resource-id='com.android.launcher3:id/action_clear_all']"));
			ClearAll.click();
			TimeUnit.SECONDS.sleep(5);
		...
		try {
			...
			MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/camera_switcher_button']"));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Photo aspect ratio (Front camera) option to select resolution");
			System.out.println("Select Photo aspect ratio (Front camera) option to select resolution");
			MobileElement RearPhotoSize = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Front camera)']"));
			RearPhotoSize.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 1st photo resolution
			logger.info("Select front camera front image resolution: (4:3) 4.0M");
			System.out.println("Select front camera front image resolution: (4:3) 4.0M");
			driver.findElement(By.xpath("//*[@text='(4:3) 4.0M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Setting3 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/mode']"));
			Setting3.click();
			TimeUnit.SECONDS.sleep(5);
			...
			MobileElement RearPhotoSize1 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Front camera)']"));
			RearPhotoSize1.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select front camera second image resolution: (4:3) 8.0M");
			System.out.println("Select front camera second image resolution: (4:3) 8.0M");
			driver.findElement(By.xpath("//*[@text='(4:3) 8.0M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Setting4 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/mode']"));
			Setting4.click();
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select Picture size(Front camera) option to select resolution");
			System.out.println("Select Picture size(Front camera) option to select resolution");
			MobileElement RearPhotoSize2 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Front camera)']"));
			RearPhotoSize2.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select front camera third image resolution: (4:3) 1.9M");
			System.out.println("Select front camera third image resolution: (4:3) 1.9M");
			driver.findElement(By.xpath("//*[@text='(4:3) 1.9M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Setting5 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/mode']"));
			Setting5.click();
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select Picture size(Front camera) option to select resolution");
			System.out.println("Select Picture size(Front camera) option to select resolution");
			MobileElement RearPhotoSize3 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Front camera)']"));
			RearPhotoSize3.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select front camera fourth image resolution: (16:9) 6.0M");
			System.out.println("Select front camera fourth image resolution: (16:9) 6.0M");
			driver.findElement(By.xpath("//*[@text='(16:9) 6.0M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Setting6 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/mode']"));
			Setting6.click();
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select Picture size(Front camera) option to select resolution");
			System.out.println("Select Picture size(Front camera) option to select resolution");
			MobileElement RearPhotoSize4 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Front camera)']"));
			RearPhotoSize4.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select front camera fifth image resolution: (16:9) 2.4M");
			System.out.println("Select front camera fifth image resolution: (16:9) 2.4M");
			driver.findElement(By.xpath("//*[@text='(16:9) 2.4M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Setting7 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/mode']"));
			Setting7.click();
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select Picture size(Front camera) option to select resolution");
			System.out.println("Select Picture size(Front camera) option to select resolution");
			MobileElement RearPhotoSize5 = driver.findElement(By.xpath("//*[@text='Photo aspect ratio (Front camera)']"));
			RearPhotoSize5.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3:4 
			logger.info("Select front camera sixth image resolution: (16:9) 2.1M");
			System.out.println("Select front camera sixth image resolution: (16:9) 2.1M");
			driver.findElement(By.xpath("//*[@text='(16:9) 2.1M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement SwitchTobackCamera = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/camera_switcher_button']"));
	...
	public void DataMoveOperation() throws  IOException, InterruptedException {
		java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
		//Launch File Manager application and playback front recorded video from Internal storage for 30 seconds, pause video playback, locking phone and unlock after 30 seconds delay and playback video from pause duration.
		isPaused = true;
		try {
