...
import Realme_C30_RMX3581.Test9;
...
public class Test9F_Int
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		logger.info("Test9F_Int Scenario is follows:");
		logger.info("1.Launch camera application, start front camera Image capture for all host resolutions");
		logger.info("2.Move front camera image captured files from camera folder to Test9F_Int folder");
		logger.info("Setting up the appium desired capabilities");
		System.out.println("Test9_Int Scenario is follows:");
		System.out.println("1.Launch camera application, start front camera Image capture for all host resolutions");
		System.out.println("2.Move front camera  captured image files from camera folder to Test9F_Int folder");
		...
		try {
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 5th Resolutions  "+j4);
				logger.info("clicking Image of 5th Resolutions  "+j4);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			{  
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 4th Resolutions  "+j5);
				logger.info("clicking Image of 4th Resolutions  "+j5);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uInternal storage-->DCIM folder-->Camera folder-->Select all front camera videos create Test9F_Int folder and cut paste all videos in Test9F_Int folder
