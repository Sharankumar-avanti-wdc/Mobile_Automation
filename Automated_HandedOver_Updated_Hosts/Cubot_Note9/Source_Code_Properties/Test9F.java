...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(5);
			//front camera 6 image resolutions supports
			...
			driver.findElement(By.xpath("//*[@bounds='[367,778][433,844]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Select second Image Resoution: (4:3) 2.0 megapixels");
			System.out.println("Select second Image Resoution: (4:3) 2.0 megapixels");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 2nd Resolutions (4:3) 2.0 megapixels : "+j1);
				logger.info("clicking Image of 2nd Resolutions (4:3) 2.0 megapixels : "+j1);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first third Resoution:(4:3) 2.0 megapixels");
			System.out.println("Select third Image Resoution: (4:3) 2.0 megapixels");
			...
			{  
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 3rd Resolutions (4:3) 2.0 megapixels: "+j2);
				logger.info("clicking Image of 3rd Resolutions (4:3) 2.0 megapixels: "+j2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first 4TH Resoution:(16:9) 4.0 megapixels");
			System.out.println("Select 4TH Image Resoution: (16:9) 4.0 megapixels");
			...
			{  
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 4th Resolutions (16:9) 4.0 megapixels: "+j3);
				logger.info("clicking Image of 4th Resolutions (16:9) 4.0 megapixels: "+j3);
			...
			logger.info("Select  picture size");
			System.out.println("Select  picture size");
			MobileElement picturesize4 = driver.findElement(By.xpath("//*[@text='Picture size(Front camera)']"));
			picturesize4.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first 5th Resoution:(16:9) 2.0 megapixels");
			System.out.println("Select 5th Image Resoution: (16:9) 2.0 megapixels");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 5th Resolutions (16:9) 2.0 megapixels: "+j4);
				logger.info("clicking Image of 5th Resolutions (16:9) 2.0 megapixels: "+j4);
			...
			logger.info("Select  picture size");
			System.out.println("Select  picture size");
			MobileElement picturesize5 = driver.findElement(By.xpath("//*[@text='Picture size(Front camera)']"));
			picturesize5.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first 6th Resoution:(16:9) 0.9 megapixels");
			System.out.println("Select 6th Image Resoution: (16:9) 0.9 megapixels");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 6th Resolutions (16:9) 0.9 megapixels: "+j5);
				logger.info("clicking Image of 6th Resolutions (16:9) 0.9 megapixels: "+j5);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			TimeUnit.SECONDS.sleep(6);
			//Click  Move to Option
			logger.info("Select Test9F");
			System.out.println("select Test9F");
			MobileElement uSD1 =	driver.findElement(By.xpath("//*[@text='Test9F']"));
			uSD1.click();
			TimeUnit.SECONDS.sleep(6);
			//Click Create option
