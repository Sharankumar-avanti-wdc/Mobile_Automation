package Motorola_Edge20_Fusion;
...
public class Test10 
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "motorola edge 20 fusion");
		dc.setCapability(MobileCapabilityType.UDID, "ZD2222DYHB");
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first video resolution: Resolution 4K UHD");
			System.out.println("Select first video resolution: Resolution 4K UHD");
			...
			logger.info("Select second highest resolution: Resolution FHD 30");
			System.out.println("Select second highest resolution: Resolution FHD 30");
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@content-desc='Resolution FHD']"));
			SecondRes.click();
			MobileElement SecondRes1 = driver.findElement(By.xpath("//*[@content-desc='Frame rate 30fps']"));
			SecondRes1.click();
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select Video Resolution FHD 1080 fps
			logger.info("Select Third highest resolution: Resolution FHD 60");
			System.out.println("Select Third highest resolution: Resolution FHD 60");
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@content-desc='Resolution FHD']"));
			ThirdRes.click();
			MobileElement ThirdRes1 = driver.findElement(By.xpath("//*[@content-desc='Frame rate 60fps']"));
			ThirdRes1.click();
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			prop.load(Test10.class.getClassLoader().getResourceAsStream("MyProject.properties"));
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		try {
			//Launch Camera Application for rear camera video recording
			logger.info("Launch Camera Application to play recorded video play back from rear camera video recording");
			System.out.println("Launch Camera Application to play recorded video play back from rear camera video recording");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		TimeUnit.SECONDS.sleep(5);
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create BCFC_Videos folder and cut paste all videos in Test10 folder
