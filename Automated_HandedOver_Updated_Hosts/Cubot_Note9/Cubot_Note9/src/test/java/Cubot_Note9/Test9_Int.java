	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			for( j5 = 0; j5 < totalPictureCountRear_Int5Int; j5++)
			{
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 6th Resolutions ultra (16:9) 2.0 megapixels: "+j);
				logger.info("clicking Image of 6th Resolutions ultra (16:9) 2.0 megapixels: "+j);
