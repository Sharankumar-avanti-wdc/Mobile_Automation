...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select First front video Resolution: FHD 16:9 1920x1080");
			System.out.println("Select First front video resolution: FHD 16:9 1920x1080");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select First front video Resolution: HD FullVision 1600x720");
			System.out.println("Select First front video resolution: HD FullVision 1600x720");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select First front video Resolution: HD 16:9 1280x720");
			System.out.println("Select First front video resolution: HD 16:9 1280x720");
