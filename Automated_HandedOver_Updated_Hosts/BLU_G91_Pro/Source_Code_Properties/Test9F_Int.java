...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select front camera second image resolution: 10M");
			System.out.println("Select front camera second image resolution: 10M");
			driver.findElement(By.xpath("//*[@text='10M']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9F_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select front camera third image resolution: 7M");
			System.out.println("Select front camera third image resolution: 7M");
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select front camera fourth image resolution: 4M");
			System.out.println("Select front camera fourth image resolution: 4M");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException {
		...
		try {
			...
			//If file manager permission request access accept allow permission
			//Swipe and Select external storage
			logger.info("Swipe up to select uInternal storage");
			System.out.println("Swipe up to select uInternal storage");
