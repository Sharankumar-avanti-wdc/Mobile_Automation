...
public class Test0 {
	...
	@Test
  	...
  	//Launch File Manager application to verify  Image capture
		...
		driver.findElement(By.xpath("//*[@bounds='[888,61][1182,133]']")).click();
		TimeUnit.SECONDS.sleep(5);
			...
			System.out.println("select rear video size option");
	  		...
	  		//Select 1st resolution
				...
				//Start Recording
		  		...
		  		MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[1018,1329][1117,1428]']"));
		  		StopRecording.click();
				...
				System.out.println("select rear video size option");
	  			...
	  			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[626,97][707,178]']"));
	  			SecondRes.click();
		  		TimeUnit.SECONDS.sleep(2);
		  	...
		  	//Start Recording
		  		...
		  		logger.info("Stop video recording");
		  		System.out.println("Stop video recording");
		  		MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[1018,1329][1117,1428]']"));
