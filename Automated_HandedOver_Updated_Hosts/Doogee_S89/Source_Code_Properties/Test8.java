...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[809,2113][991,2202]']")).click();
			...
			MobileElement location1 =	driver.findElement(By.xpath("//*[@bounds='[162,377][1020,499]']"));
			location1.click();
			try {
				//Select uSD card
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(358, 1788)).perform();
			TimeUnit.SECONDS.sleep(20);
			//clikc Pause button
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			System.out.println("click on fastforward  10 seconds");
			TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(313, 1791)).perform();
