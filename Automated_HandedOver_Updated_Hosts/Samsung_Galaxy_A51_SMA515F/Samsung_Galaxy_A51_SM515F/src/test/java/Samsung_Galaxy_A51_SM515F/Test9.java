package Samsung_Galaxy_A51_SM515F;
import org.testng.annotations.Test;
import Samsung_Galaxy_A51_SM515F.Test9;
...
public class Test9
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Galaxy A51 ");
		dc.setCapability(MobileCapabilityType.UDID, "RZ8N20BF9QE");
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select rear camera first Image Resoution: 3:4 64MP");
			System.out.println("Select rear camera first Image Resoution: 3:4 64MP");
			...
			logger.info("Select rear camear second Image Resoution: 3:4 ");
			System.out.println("Select rear camera Second Image Resoution: 3:4 ");
			...
			RearImage2.click();
			logger.info("Select rear camera third Image Resoution: 9:16");
			System.out.println("Select rear camera third Image Resoution: 9:16");
			...
			System.out.println("totalPictureCountRear2 = "+ totalPictureCountRear2 +"Image to be captured");
			...
			RearImage3.click();
			logger.info("Select  rear camear Fourth Image Resoution: 1:1");
			System.out.println("Select rear camera Fourth Image Resoution: 1:1");
			...
			logger.info("Select rear camera fifth resolution");
			System.out.println("Select rear camera fifth resolution");
