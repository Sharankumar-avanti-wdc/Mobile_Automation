...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		{ 
			...
			{ 
				...
				driver.findElement(By.id("com.oppo.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 4th Resolutions1:1: "+j);
				logger.info("clicking Image of 4th Resolutions1:1: "+j);
	...
	try {
		...
		MobileElement TestFile = driver.findElement(By.xpath("//*[@text='Test9F']")); 
		TestFile.click();
		TimeUnit.SECONDS.sleep(5);
