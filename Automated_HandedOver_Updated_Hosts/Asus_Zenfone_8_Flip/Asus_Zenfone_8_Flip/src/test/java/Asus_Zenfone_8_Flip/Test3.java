...
import Asus_Zenfone_8_Flip.Test3;
...
public class Test3 {
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		logger.info(" Mount,Unmount doesn't support host and Format uSD card for specified number of times");
		logger.info("Setting up the appium desired capabilities");
		System.out.println("Test3 Scenario is as follows");
		System.out.println(" Mount,Unmount doesn't support host and Format card for specified number of times");
		...
		try
		{
			...
			TimeUnit.SECONDS.sleep(5);
			logger.info("Pass: Test3 Pass for clearing Recent apps ");
			System.out.println("Pass: Test3 Pass for clearing Recent apps ");
		}
		catch (Exception e) {
			e.printStackTrace();
