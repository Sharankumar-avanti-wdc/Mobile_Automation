...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[480,121][600,241]']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[306,121][426,241]']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[654,121][774,241]']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
