...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			// capture  pics for the selected resolution
			int j4=0;
			for(j4 = 0; j4 < totalPictureCountFront3Int; j4++) 
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.xpath("//*[@resource-id='com.asus.camera:id/capture_inside_icon_root']")).click();
				TimeUnit.SECONDS.sleep(6);
				System.out.println("clicking Image of 5th Resolutions4:3 (64MP): "+j4);
				logger.info("clicking Image of 5th Resolutions4:3 (64MP): "+j4);
			}
			TimeUnit.SECONDS.sleep(2);
