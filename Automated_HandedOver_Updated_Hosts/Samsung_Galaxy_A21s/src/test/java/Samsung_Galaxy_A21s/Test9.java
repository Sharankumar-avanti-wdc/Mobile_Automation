...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[80,73][176,169]']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[196,73][292,169]']"));
			SecRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[312,73][408,169]']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(6);
			...
			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[428,73][524,169]']"));
			FourthRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement FifthRes = driver.findElement(By.xpath("//*[@bounds='[544,73][640,169]']"));
			FifthRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			Result= "Pass";
			logger.info("Launch file manager application and verify recorded images present in uSD Card");
			System.out.println("Launch file manager application and verify recorded images present in uSD Card");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{
		...
		try {
			...
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test9 folder and cut paste all videos in Test9 folder");
