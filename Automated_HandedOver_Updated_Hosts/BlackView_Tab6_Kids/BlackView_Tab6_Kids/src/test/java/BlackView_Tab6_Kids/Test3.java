...
import BlackView_Tab6_Kids.Test3;
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				MobileElement Unmount =	driver.findElement(By.xpath("//*[@bounds='[692,560][766,657]']"));
				Unmount.click();
				...
				MobileElement SDCard =	driver.findElement(By.xpath("//*[@bounds='[109,581][188,613]']"));
				SDCard.click();
