	...
	public void CopyPaste() throws InterruptedException, IOException {
		...
		try {
			...
			MobileElement element1 = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
					...
					".scrollIntoView(new UiSelector().text(\"SD card\"))"));
			//Select uSD card
			logger.info("Switch to external storage from Internal storage");
			System.out.println("Switch from internla to external storage");
			driver.findElement(By.xpath("//*[@text='SD card']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Switch from external to internal storage");
			System.out.println("Switch from external to internal storage");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			driver.findElement(By.xpath("//*[@text='Internal storage']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			System.out.println("Final Message: Pass Test18 Pas for copy paste & cut paste operation");
