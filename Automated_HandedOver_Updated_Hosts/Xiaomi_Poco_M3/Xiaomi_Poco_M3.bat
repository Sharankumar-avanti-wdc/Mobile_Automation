...
cd C:\Users\sandisk\Android11\Xiaomi_POCO_M3_Pro_5G
...
mvn  -DmountUnmountCycle=1 -DrecordingDurationRearExt=300 -DrecordingDurationRearExt1=300  -DrecordingDurationfront=300 -DrecordingDurationfront1=300 -DrecordingDurationfront2=300 -DtotalPictureCountRear=30 -DtotalPictureCountRear1=30 -DtotalPictureCountRear2=30 -DtotalPictureCountRear3=30 -DTolerance_Level=%Tolerance_Level%  -DtotalPictureCountFront=30 -DtotalPictureCountFront1=30 -DtotalPictureCountFront2=30 -DtotalPictureCountFront3=30 -DTolerance_Level=%Tolerance_Level%  -DfileName=testngMain.xml clean install  >> C:\Users\sandisk\Android11\External_Logs\Avanti\Xiaomi_POCO_M3_Pro_5G_%mydate%_%mytime%_%Qual_Capacity%.txt
