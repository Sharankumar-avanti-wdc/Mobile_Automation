...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Click On SD card
			logger.info("Select Phone option");
			System.out.println("Select Phone option");
			MobileElement SDcard = driver.findElement(By.xpath("//*[@text='Phone']"));
			SDcard.click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			//System.out.println("Launch File Manager Application");
			System.out.println("Selec Internal storage");
			...
			//touchAction.tap(PointOption.point(593, 1742)).perform();
