...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[816,2105][983,2171]']")).click();
			...
			MobileElement location1 =	driver.findElement(By.xpath("//*[@bounds='[149,389][1024,448]']"));
			location1.click();
			try {
				//Select uSD card
			...
			logger.info("Select sd card");
			System.out.println("Select sd card");
			driver.findElement(By.xpath("//*[@bounds='[14,790][224,872]']")).click();
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[176,1461][591,1514]']")).click();
			TimeUnit.SECONDS.sleep(5);
			logger.info("Select android");
			System.out.println("Select android");
			driver.findElement(By.xpath("//*[@text='Android']")).click();
