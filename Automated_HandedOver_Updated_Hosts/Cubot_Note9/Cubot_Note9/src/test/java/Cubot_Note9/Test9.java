...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(5);
			//backcamera 6 image resolutions supports
			...
			driver.findElement(By.xpath("//*[@bounds='[414,0][480,44]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Select first Image Resoution: (4:3) 16.0 megapixels");
			System.out.println("Select first Image Resoution: (4:3) 16.0 megapixels ");
			driver.findElement(By.xpath("//*[@bounds='[34,253][445,330]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 1st Resolutions ultra (4:3) 16.0 megapixels: "+j);
				logger.info("clicking Image of 1st Resolutions ultra (4:3) 16.0 megapixels: "+j);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 2nd Image Resoution: (4:3) 8.0 megapixels ");
			System.out.println("Select 2nd Image Resoution: (4:3) 8.0 megapixels ");
			driver.findElement(By.xpath("//*[@bounds='[34,330][445,407]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image  Resolution (4:3) 8.0 megapixels: "+j1);
				logger.info("clicking Image  Resolution (4:3) 8.0 megapixels "+j1);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select third Image Resoution: (4:3) 4.0 megapixels ");
			System.out.println("Select third Image Resoution: (4:3) 4.0 megapixels ");
			driver.findElement(By.xpath("//*[@bounds='[34,407][445,484]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions ultra (4:3) 4.0 megapixels: "+j2);
				logger.info("clicking Image of 3rd Resolutions ultra (4:3) 4.0 megapixels: "+j2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 4TH Image Resoution: (16:9) 12.0 megapixels ");
			System.out.println("Select 4TH Image Resoution: (16:9) 12.0 megapixels ");
			driver.findElement(By.xpath("//*[@bounds='[34,484][445,561]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			for( j3 = 0; j3 < totalPictureCountRear3Int; j3++)
			{
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 4TH Resolutions ultra (16:9) 12.0 megapixels: "+j3);
				logger.info("clicking Image of 4TH Resolutions ultra (16:9) 12.0 megapixels: "+j3);
			...
			logger.info("Select  picture size");
			System.out.println("Select  picture size");
			MobileElement picturesize4 = driver.findElement(By.xpath("//*[@text='Picture size(Back camera)']"));
			picturesize4.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 5th Image Resoution: (16:9) 6.0 megapixels ");
			System.out.println("Select 5th Image Resoution: (16:9) 6.0 megapixels ");
			driver.findElement(By.xpath("//*[@bounds='[34,561][445,638]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			for( j4 = 0; j4 < totalPictureCountRear4Int; j4++)
			{
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 5th Resolutions ultra (16:9) 6.0 megapixels: "+j4);
				logger.info("clicking Image of 5th Resolutions ultra (16:9) 6.0 megapixels: "+j4);
			...
			logger.info("Select  picture size");
			System.out.println("Select  picture size");
			MobileElement picturesize5 = driver.findElement(By.xpath("//*[@text='Picture size(Back camera)']"));
			picturesize5.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 6th Image Resoution: (16:9) 2.0 megapixels ");
			System.out.println("Select 6th Image Resoution: (16:9) 2.0 megapixels ");
			driver.findElement(By.xpath("//*[@bounds='[34,638][445,715]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			for( j5 = 0; j5 < totalPictureCountRear5Int; j5++)
			{
				...
				driver.findElement(By.xpath("//*[@bounds='[196,767][284,855]']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 6th Resolutions ultra (16:9) 2.0 megapixels: "+j5);
				logger.info("clicking Image of 6th Resolutions ultra (16:9) 2.0 megapixels: "+j5);
			...
			TimeUnit.SECONDS.sleep(3);
			MobileElement element41 = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
					"new UiScrollable(new UiSelector().scrollable(true)).setMaxSearchSwipes(10)" +
					".scrollIntoView(new UiSelector().text(\"SD card\"))"));
			TimeUnit.SECONDS.sleep(3);
