...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("1.Launch camera application, set Internal storage as a Storage option, start rear camera Image capture for all host resolutions");
		...
		try {
			...
			MobileElement Setting1 = driver.findElement(By.xpath("//*[@bounds='[636,48][720,132]']"));
			Setting1.click();
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select Rear camera first image resolution: 20M(4:3)");
			System.out.println("Select Rear camera first image resolution: 20M(4:3)");
			driver.findElement(By.xpath("//*[@text='20M(4:3)']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			System.out.println("totalPictureCountRear_Int = "+ totalPictureCountRear_Int + " Images to be captured");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select Rear camera second resolution: 15M(16:9)");
			System.out.println("Select Rear camera second resolution: 15M(16:9)");
			driver.findElement(By.xpath("//*[@text='15M(16:9)']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			...
			System.out.println("totalPictureCountRear_Int1 = "+ totalPictureCountRear_Int1 + " Imgaes to be captured");
			int totalPictureCountRear_Int1Int=Integer.parseInt(totalPictureCountRear_Int);
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select rear camera third resolution:15M(1:1)");
			System.out.println("Select rear camera third resolution:15M(1:1)");
			driver.findElement(By.xpath("//*[@text='15M(1:1)']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			...
			System.out.println("totalPictureCountRear_Int2 = "+ totalPictureCountRear_Int2 + " Images to be captured");
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Settings3 = driver.findElement(By.xpath("//*[@bounds='[636,48][720,132]']"));
			TimeUnit.SECONDS.sleep(5);
			Settings3.click();
			//Select settings option to select resolution
			logger.info("Select settings option to select resolution");
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select Rear camera fourth image resolution 13M(18:9)");
			System.out.println("Select Rear camera fourth image resolution 13M(18:9)");
			driver.findElement(By.xpath("//*[@text='13M(18:9)']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			...
			System.out.println("totalPictureCountRear_Int3 = "+ totalPictureCountRear_Int3 +" Images to be captured");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all Rear camera videos create Test9_Int folder and cut paste all images in Test9_Int  folder
			logger.info("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all rear camera images create Test9_Int and cut paste all images in Test9_Int folder");
			System.out.println("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all rear camera images create Test9_Int folder and cut paste all images in Test9_Int folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//Swipe and Select external storage
			logger.info("Swipe up to select Internal storage");
			...
			MobileElement Test9_Int =	driver.findElement(By.xpath("//*[@text='Test9_Int']"));
			Test9_Int.click();
			TimeUnit.SECONDS.sleep(6);
			//Select Test9_Int folder
