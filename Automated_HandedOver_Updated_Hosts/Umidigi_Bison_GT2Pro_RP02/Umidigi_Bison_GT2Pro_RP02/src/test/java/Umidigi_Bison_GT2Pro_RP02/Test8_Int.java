...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@bounds='[809,2077][991,2178]']"));
			Settings.click();
			TimeUnit.SECONDS.sleep(5);
			...
			MobileElement SDcard = driver.findElement(By.xpath("//*[@bounds='[162,221][1020,343]']"));
			SDcard.click();
			TimeUnit.SECONDS.sleep(5);
			//Click On SD card
			...
			MobileElement StopRec = driver.findElement(By.xpath("//*[@bounds='[417,1710][662,1955]']"));
			StopRec.click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			touchAction.tap(PointOption.point(625, 1756)).perform();
