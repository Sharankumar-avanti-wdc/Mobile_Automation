...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@text='Picture size(Back)']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 1st Image Resoution: (4:3) 13.0 MP ");
			System.out.println("Select 1st Image Resoution:(4:3) 13.0 MP ");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 3rd Image Resoution: (20:9) 7.8 MP ");
			System.out.println("Select 3rd Image Resoution:(20:9) 7.8 MP ");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 4th Image Resoution: (1:1) 6.0 MP ");
			System.out.println("Select 4th Image Resoution:(1:1) 6.0 MP ");
