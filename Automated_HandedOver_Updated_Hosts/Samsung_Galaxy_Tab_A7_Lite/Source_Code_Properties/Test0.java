...
public class Test0 {
	...
	@Test
		...
		((StartsActivity) driver).startActivity(new Activity("com.sec.android.app.launcher", "com.sec.android.app.launcher.activities.LauncherActivity"));
  		...
  		MobileElement Edit =	driver.findElement(By.xpath("//*[@text='Edit']"));
  		Edit.click();
  		TimeUnit.SECONDS.sleep(3);
  		...
  		TimeUnit.SECONDS.sleep(3);
			...
			MobileElement Delete =	driver.findElement(By.xpath("//*[@bounds='[571,1194][603,1226]']"));
			Delete.click();
			TimeUnit.SECONDS.sleep(3);
			
			//Click move to recycle Bin
			logger.info("Select move to recycle Bin Option");
	  		System.out.println("Select move to recycle Bin Option");
			MobileElement MovetoRecycleBin =	driver.findElement(By.xpath("//*[@bounds='[514,1180][768,1228]']"));
  	...
  	//Calling Image Function to capture Image and Record Video and Verify Images and recorded video present in SD Card
		...
		try {
			...
			MobileElement SwitchToBackCamera = driver.findElement(By.xpath("com.sec.android.app.camera:id/normal_center_button"));
			TimeUnit.SECONDS.sleep(2);
  	...
  	public void Video() throws  IOException, InterruptedException {
  		...
  		logger.info("Launch Camera Application to recording rear videos");
  		System.out.println("Launch Camera Application to recording rear videos");
  		((StartsActivity) driver).startActivity(new Activity("com.sec.android.app.camera", "com.sec.android.app.camera.Camera"));
		...
		//Click On Settings
			...
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
	  		...
	  		logger.info("Click On Rear camera video size to select resolution");
			System.out.println("Click On Rear camera video size to select resolution");
	  			MobileElement RearVideoSize = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/ratio_switcher']"));
	  			RearVideoSize.click();
	  			logger.info("Select 1st Back Video Resolution: FHD 30");
	  			System.out.println("Select 1st Back Video Resolution: FHD 30");
	  			//Select 1st resolution
	  			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[262,30][337,94]']"));
	  			FirstRes.click();
		  		TimeUnit.SECONDS.sleep(2);
				...
				//Start Recording
		  		...
		  		logger.info("Click On Rear camera video size to  select second resolution");
				System.out.println("Click On Rear camera video size to select second resolution");
	  			...
	  			MobileElement SecondRes = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/cus_video_size_switcher']"));
	  			SecondRes.click();
		  		TimeUnit.SECONDS.sleep(2);
