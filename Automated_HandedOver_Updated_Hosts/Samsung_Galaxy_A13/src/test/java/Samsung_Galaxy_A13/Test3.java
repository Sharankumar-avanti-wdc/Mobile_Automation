...
import Samsung_Galaxy_A13.Test3;
...
public class Test3 {
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("1.Mount,Unmount uSD Card and Format card for specified number of times");
		...
		try {
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(5);
				logger.info("Click on Unmount");
				System.out.println("Click on Unmount");
				...
				logger.info("Clicking on more options");
				System.out.println("Clicking on more options");
				MobileElement moreOptions1 = driver.findElement(By.xpath("//android.widget.ImageView[@resource-id=\"com.sec.android.app.myfiles:id/more_option_icon\"]"));
				TimeUnit.SECONDS.sleep(5);
				moreOptions1.click();
				// click on format
