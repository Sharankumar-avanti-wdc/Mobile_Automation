...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			//Launch File Manager to clear internal memory
	...
	//Click On Settings
		...
		RearVideoSize.click();
		logger.info("Select 1st Back Video Resolution: Aspect ratio Full");
		System.out.println("Select 1st Back Video Resolution: Aspect ratio Full");
		...
		logger.info("Select 2nd Back Video Resolution: Aspect ratio 9:16");
		System.out.println("Select 2nd Back Video Resolution: Aspect ratio 9:16");
