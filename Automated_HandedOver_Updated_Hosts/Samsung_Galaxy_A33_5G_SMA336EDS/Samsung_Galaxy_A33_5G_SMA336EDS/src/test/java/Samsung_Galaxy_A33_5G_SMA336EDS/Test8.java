...
public class Test8
{
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//below bounds path fast forward audio 
			TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(661, 1834)).perform();
			TimeUnit.SECONDS.sleep(10);
		...
		try
		{
			...
			System.out.println("Playing third audio playback");
			logger.info("Playing third audio playback");
			TimeUnit.SECONDS.sleep(30);

			TimeUnit.SECONDS.sleep(3);
			// FastForward
			logger.info("Fast forwarding audio playback for 30 seconds duration");
			System.out.println("Fast forwarding audio playback for 30 seconds duration");
			...
			logger.info("Pass: Third audio playback is successfull ");
			System.out.println("Pass: Third audio playback is successfull");
		}
		catch (Exception e) {
			logger.info("Fail: Test8 Fail for Copied audio file playback,fast forward scenario");
			logger.info("Final Message: Fail Test8 Fail for copied audio file playback,fast forwward scenario");
		...
		logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		logger.info("Final Message: Pass Test8 Pass for playing recorded audio playback and  copied audio playback and fast forward scenario");
		System.out.println("Final Message: Pass Test8 Pass for playing recorded audio playback and  copied audio playback and fast forward scenario");
