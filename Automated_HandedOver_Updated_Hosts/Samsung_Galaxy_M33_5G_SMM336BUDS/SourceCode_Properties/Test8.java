  ...
  public class Test8
  {
	...
	java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
			...
			try {
				...
				logger.info("Select First 11 Rob Thomas - Lonely No More.mp3 file for play back");
			...
			try {
				logger.info("Select file_example_MP3_5MG.mp3 for play back");
				System.out.println("Select file_example_MP3_5MG.mp3 for play back");
			...
			logger.info("Select Laahe.Mp3.mp3 for play back");
			System.out.println("Select Laahe.Mp3.mp3 for play back");
			//Click 1st File to Play Video
			try
			{
