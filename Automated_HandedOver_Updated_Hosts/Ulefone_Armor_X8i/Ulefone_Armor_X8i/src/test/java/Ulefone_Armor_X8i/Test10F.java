...
import Ulefone_Armor_X8i.Test10;
...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first highest front camera video resolution: Fine");
			System.out.println("Select first highest front camera video resolution: Fine");
			...
			System.out.println("Select second highest front camera video resolution: High");
			...
			logger.info("Select third highest front camera video resolution: VGA");
			System.out.println("Select third highest front camera video resolution: VGA");
			...
			//Select 3rd resolution
			logger.info("Select Fourth highest front camera video resolution: CIF");
			System.out.println("Select fourth highest front camera video resolution: CIF");
