...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			MobileElement InternalStorage = driver.findElement(By.xpath("//*[@bounds='[0,597][1080,762]']")); 
			...
			MobileElement SelectAll =	driver.findElement(By.xpath("//*[@bounds='[864,104][1080,256]']"));
			SelectAll.click();
	...
	public void Images() throws  IOException, InterruptedException {
		...
		MobileElement ExternalStorage = driver.findElement(By.xpath("//*[@bounds='[14,795][224,877]']")); 
	...
	public void Video() throws  IOException, InterruptedException {
		...
		//Switching to  SwitchStorage
		logger.info("click to  SwitchStorage");
		System.out.println("click to  SwitchStorage");
		MobileElement SwitchStorage = driver.findElement(By.xpath("//*[@resource-id='com.mi.android.globalFileexplorer:id/volume_switch']")); 
		SwitchStorage.click();
		TimeUnit.SECONDS.sleep(3);		  		
		//Select External Storage Card
		...
		touchAction4.longPress(LongPressOptions.longPressOptions().withDuration(Duration.ofMillis(3)).withElement (ElementOption.element (Folder))).release().perform();
		TimeUnit.SECONDS.sleep(10);
		//Click Select all option
