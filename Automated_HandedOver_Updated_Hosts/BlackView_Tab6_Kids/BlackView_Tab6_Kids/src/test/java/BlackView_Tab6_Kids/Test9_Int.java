...
import BlackView_Tab6_Kids.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		//Select 3:4 
		logger.info("Select Rear camera second resolution: (16:9) 3.8 megapixels");
		System.out.println("Select Rear camera second resolution: (16:9) 3.8 megapixels");
