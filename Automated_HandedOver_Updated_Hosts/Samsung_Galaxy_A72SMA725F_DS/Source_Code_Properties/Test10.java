			...
			public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
				...
				Settings.click();
			  	...
			  	//Click On Rear Video size to select resolution
		  			...
		  			logger.info("Select Fourth Back Video Resolution: BACK_CAMCORDER_RESOLUTION_HD_30");
		  			System.out.println("Select Fourth Back Video Resolution: BACK_CAMCORDER_RESOLUTION_HD_30");
		  			//Select 3rd resolution
		  	...
		  	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
			  	...
			  	//Select Test1 folder
					...
					MobileElement Test1 = driver.findElement(By.xpath("//*[@text='Test1']")); 
		  			...
		  			logger.info("Select Test1 folder");
		  			System.out.println("Select Test1 folder");
		  			MobileElement TestFile = driver.findElement(By.xpath("//*[@bounds='[227,492][501,555]']")); 
		  			TestFile.click();
		  			TimeUnit.SECONDS.sleep(3);
		  			//Select OneGB folder
