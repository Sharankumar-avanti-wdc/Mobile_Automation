...
public class Test10F_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select front camera first video resolution: HD 720p");
			System.out.println("Select front camera first video resolution: HD 720p");
			...
			logger.info("Select front camera second video reslotion: SD 480p");
			System.out.println("Select front camera second video reslotion: SD 480p");
			...
			logger.info("Select front camera third video resolution: CIF");
			System.out.println("Select front camera third video resolution: CIF");
			...
			SelectAll.click();
			TimeUnit.SECONDS.sleep(3);
			//Check for Total files if Total files =3 print pass message else print fail message
			logger.info("Click Select all");
			System.out.println("Click select all");
	...
	public void VideoPlayBackForSleepWake() throws  IOException, InterruptedException{	   
		...
		try {
			...
			//driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/video_player']")).click();
			//Click play button
			logger.info("Click Play video button");
			System.out.println("Click Play video button");
			driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/play_pause']")).click();
			TimeUnit.SECONDS.sleep(3);	
