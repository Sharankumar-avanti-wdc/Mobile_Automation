...
public class Test0 {
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "realme9pro");
		dc.setCapability(MobileCapabilityType.UDID, "f1c6f7c3");
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		((StartsActivity) driver).startActivity(new Activity("com.android.launcher", "com.android.launcher.Launcher"));
		TimeUnit.SECONDS.sleep(5);
		try {
			//Launch File Manager
	...
	public void Images() throws  IOException, InterruptedException {
		...
		((StartsActivity) driver).startActivity(new Activity("com.oplus.camera", "com.oplus.camera.Camera"));
		TimeUnit.SECONDS.sleep(5);
		//Click On More
		logger.info("Select More option");
		System.out.println("Select More option");
		driver.findElement(By.xpath("//*[@bounds='[894,0][1050,240]']")).click();
		TimeUnit.SECONDS.sleep(3);
		//Click On Settings
		logger.info("Select settings option");
		System.out.println("Select settings option");
		driver.findElement(By.xpath("//*[@bounds='[72,558][894,664]']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		try {
			...
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Turn on the \"Save to SD card\" option?\")").click();
			TimeUnit.SECONDS.sleep(5);
		...
		{ 
			...
			driver.findElement(By.xpath("//*[@resource-id='com.oplus.camera:id/shutter_button']")).click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void Video() throws  IOException, InterruptedException {
		...
		//MobileElement StopRecording = driver.findElement(By.xpath("//*[@resource-id='com.oppo.camera:id/shutter_button']"));
		//StopRecording.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(5);
		...
		//Select 2nd resolution
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[606,0][762,240]']"));
		SecondRes.click();
		//Start Recording
		logger.info("Start video recording");
		System.out.println("Start video recording");
		...
		System.out.println("Stop video recording");
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		//MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@resource-id='com.oppo.camera:id/shutter_button']"));
		//StopRecording1.click();
		TimeUnit.SECONDS.sleep(5);
		//select photo mode
		TouchAction touchAction2 = new TouchAction(driver);
		touchAction2.tap(PointOption.point(769, 1770)).perform();
		TimeUnit.SECONDS.sleep(5);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
		...
		try {
			...
			System.out.println("Final Message: Fail Test0 Fail for Video Capture");logger.info("Test: End");
			System.out.println("Test: End");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		}
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		String text = "About device";
		driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()).setAsVerticalList().scrollIntoView("+ "new UiSelector().text(\""+text+"\"));"));
		TimeUnit.SECONDS.sleep(5);
		((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"About device\")").click();
		TimeUnit.SECONDS.sleep(8);
		logger.info("Select Storage");
		System.out.println("Select Storage");
		String text1 = "Storage";
		...
		MobileElement formatsdcard = 	driver.findElement(By.xpath("//*[@text='Erase SD card']"));
		formatsdcard.click();
