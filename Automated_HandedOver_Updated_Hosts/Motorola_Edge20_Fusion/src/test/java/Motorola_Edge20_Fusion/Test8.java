...
public class Test8
{
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(5);
		logger.info("Launching file manager application to play copied audio playback");
		System.out.println("Launching file manager application to play copied audio playback");
