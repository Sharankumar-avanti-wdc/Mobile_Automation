	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				MobileElement Unmount =	driver.findElement(By.xpath("//*[@bounds='[576,734][688,879]']"));
				Unmount.click();
				...
				MobileElement SDCard =	driver.findElement(By.xpath("//*[@bounds='[144,766][252,809]']"));
				SDCard.click();
