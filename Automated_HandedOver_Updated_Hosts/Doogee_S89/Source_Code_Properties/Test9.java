...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select 1st Image Resoution: 48M ");
			System.out.println("Select 1st Image Resoution:48M ");
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 1st Resolutions 48M: "+j);
				logger.info("clicking Image of 1st Resolutions 48M: "+j);
			...
			logger.info("Select 2nd Image Resoution: 16M ");
			System.out.println("Select 2nd Image Resoution:16M ");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 2nd Resolutions 16M: "+j1);
				logger.info("clicking Image of 2nd Resolutions 16M: "+j1);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 3rd Image Resoution: 12M ");
			System.out.println("Select 3rd Image Resoution:12M ");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions 12M: "+j2);
				logger.info("clicking Image of 3rd Resolutions 12M: "+j2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 4th Image Resoution: 11M ");
			System.out.println("Select 4th Image Resoution:11M ");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions 11M: "+j3);
				logger.info("clicking Image of 3rd Resolutions 11M: "+j3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select fourth Image Resoution: 5M ");
			System.out.println("Select fourth Image Resoution:5M ");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 4th Resolutions 5M: "+j4);
				logger.info("clicking Image of 4th Resolutions 5M: "+j4);
			...
			// capture  pics for the selected resolution
			int j5=0;
			for( j5 = 0; j5 < totalPictureCountRear1Int; j5++) 
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 5th Resolutions 5M: "+j5);
				logger.info("clicking Image of 5th Resolutions 5M: "+j5);
