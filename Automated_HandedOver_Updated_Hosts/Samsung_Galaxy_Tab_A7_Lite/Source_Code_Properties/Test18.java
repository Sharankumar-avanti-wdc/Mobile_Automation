...
try {
		...
		String text4= "Test1";
		driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()).setAsVerticalList().scrollIntoView("+ "new UiSelector().text(\""+text4+"\"));"));
		TimeUnit.SECONDS.sleep(5);
		...
		// Select uSD Card
				...
				driver.findElement(By.xpath("//*[@content-desc='Showing in list view.']")).click();
				...
				//driver.findElement(By.xpath("//*[@content-desc='Showing in grid view..']")).click();
				((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
				TimeUnit.SECONDS.sleep(2);
				//Select uSD card
				logger.info("Select  SD Card");
		  		System.out.println("Select  SD Card");
				String text5 = "SD card";
				...
				//Select Internal storage
		  		String text7 = "Internal storage";
				driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()).setAsVerticalList().scrollIntoView("+ "new UiSelector().text(\""+text7+"\"));"));
				TimeUnit.SECONDS.sleep(5);
		  		logger.info("Select  Internal storage");
		  		System.out.println("Select  Internal storage");
		  		((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Internal storage\")").click();
		  	...
		  	//long press and Hold Test1 folder
				...
				TimeUnit.SECONDS.sleep(5);
				//Select SD card
		  		String text8 = "SD card";
				driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()).setAsVerticalList().scrollIntoView("+ "new UiSelector().text(\""+text8+"\"));"));
				TimeUnit.SECONDS.sleep(5);
		  		logger.info("Select  SD card");
		  		System.out.println("Select  SD card");
		  		((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"SD card\")").click();
				...
				((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Move to folder\")").click();
				TimeUnit.SECONDS.sleep(180);	
