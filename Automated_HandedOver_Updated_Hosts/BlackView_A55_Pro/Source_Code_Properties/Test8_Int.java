...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@bounds='[539,1480][660,1552]']"));
			Settings.click();
			TimeUnit.SECONDS.sleep(5);
			...
			MobileElement SDcard = driver.findElement(By.xpath("//*[@bounds='[108,163][680,244]']"));
			SDcard.click();
			TimeUnit.SECONDS.sleep(5);
			//Click On SD card
			...
			MobileElement StopRec = driver.findElement(By.xpath("//*[@bounds='[278,1236][441,1399]']"));
			StopRec.click();
			TimeUnit.SECONDS.sleep(5);
