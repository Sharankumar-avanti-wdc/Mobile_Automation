package Infinix_Hot_12Pro_X668;
...
public class Test0 {
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Infinix HOT 12 PRO");
		dc.setCapability(MobileCapabilityType.UDID, "08574312A1013436");
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		((StartsActivity) driver).startActivity(new Activity("com.transsion.XOSLauncher.upgrade", "com.android.quickstep.recents_ui_overrides.src.com.android.launcher3.uioverrides.QuickstepLauncher"));
	...
	public void Images() throws  IOException, InterruptedException {
		...
		driver.findElement(By.xpath("//*[@bounds='[40,122][120,202]']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		TimeUnit.SECONDS.sleep(3);
		//select storage permissions
		logger.info("Select storage permissions");
		System.out.println("Select storage permissions");
		try {


			logger.info("Select USE THIS FOLDER");
			System.out.println("Select USE THIS FOLDER");
			driver.findElement(By.xpath("//*[@text='USE THIS FOLDER']")).click();
			TimeUnit.SECONDS.sleep(5);
			logger.info("Select ALLOW button");
			System.out.println("Select ALLOW button");
		...
		{ 
			TimeUnit.SECONDS.sleep(2);
			driver.findElement(By.xpath("//*[@bounds='[296,1338][424,1444]']")).click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void Video() throws  IOException, InterruptedException {
		...
		//select camera permissions
		try {
			logger.info("Select While using the app option");
			System.out.println("Select While using the app option");
			driver.findElement(By.xpath("//*[@text='While using the app']")).click();
			TimeUnit.SECONDS.sleep(5);
		}
		...
		try {
			...
			logger.info("Select USE THIS FOLDER option");
			System.out.println("Select USE THIS FOLDER option");
			driver.findElement(By.xpath("//*[@text='USE THIS FOLDER']")).click();
			TimeUnit.SECONDS.sleep(5);
			logger.info("Select ALLOW option");
			System.out.println("Select ALLOW option");
			driver.findElement(By.xpath("//*[@text='ALLOW']")).click();
			TimeUnit.SECONDS.sleep(5);
		}
		...
		MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[32,1144][688,1260]']"));
		FirstRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		//Start Recording
		...
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[32,1260][688,1376]']"));
		SecondRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		//Select uSD Card
		logger.info("Clicking on portable");
		System.out.println("Clicking on portable");
		MobileElement sdcard = 	driver.findElement(By.xpath("//*[@text='Portable']"));
		sdcard.click();
		TimeUnit.SECONDS.sleep(5);
		//Select uSD Card
		logger.info("Clicking on SD card");
		System.out.println("Clicking on SD card");
		MobileElement portable = 	driver.findElement(By.xpath("//*[@text='SanDisk SD card']"));
		portable.click();
		TimeUnit.SECONDS.sleep(5);
		...
		//MobileElement done = 	driver.findElement(By.xpath("//*[@bounds='Done']"));
		//done.click();
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
