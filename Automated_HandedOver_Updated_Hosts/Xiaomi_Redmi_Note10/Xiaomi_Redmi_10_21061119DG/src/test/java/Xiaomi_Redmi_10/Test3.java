	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				logger.info("Pass: Test3 Pass for unmount,mount,Format uSD card");
				System.out.println("Pass: Test3 Pass for unmount,mount,Format uSD card");
