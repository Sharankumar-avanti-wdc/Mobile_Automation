...
public class Test8
{
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		{
			////Launch File Manager
			logger.info("Launch File Manager Application and verfify recorded audio file in uSD card, and perform audio playback fastforward scenario");
			System.out.println("Launch File Manager Application and verfify recorded audio file in uSD card, and perform audio playback fastforward scenario");
			...
			TimeUnit.SECONDS.sleep(5);
			logger.info("Recorded audio file present in uSD card succesfully");
			System.out.println("Recorded audio file present in uSD card succesfully");
			logger.info("Click Audio file for playback and fast forward");
			System.out.println("Click Audio file for playback and fast forward");

			//Click 1st File to Play Video
			driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/title']")).click();
			logger.info("Playing audio playback");
			System.out.println("Playing audio playback");
			TimeUnit.SECONDS.sleep(30);
			// FastForward first mp3 music for 30 seconds duration
			logger.info("Fast Forwarding audio playback for 10 sceonds duration");
			System.out.println("Fast Forwarding audio playback for 10 sceonds duration");

			TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(444, 1199)).perform();
			...
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
			TimeUnit.SECONDS.sleep(2);
			logger.info("Pass: Test8 Pass for playing, fast forward, and pause recorded audio file from external storage scenario");
			System.out.println("Pass: Test8 Pass for playing, fast forward, and pause recorded audio file from external storage scenario");
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(2);
		//Launch File Manager
		logger.info("Launch File Manager Application and select SD card");
		System.out.println("Launch File Manager Application and select SD card");
		((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
		TimeUnit.SECONDS.sleep(5);
		...
		TimeUnit.SECONDS.sleep(5);
		System.out.println("Select First audio file 11 Rob Thomas - Lonely No More.mp3 for playback");
		logger.info("Select First audio file 11 Rob Thomas - Lonely No More.mp3 for playback");
		//Click 1st File to Play Video
		try {
		...
		try {
			logger.info("Select second audio file_example_MP3_5MG.mp3 for playback");
			System.out.println("Select second audio file_example_MP3_5MG.mp3 for playback");
			...
			logger.info("Fast forwarding audio for 30 seconds");
			System.out.println("Fast forwarding audio for 30 seconds");
		...
		try
		{
			logger.info("select Laahe.Mp3.mp");
			System.out.println("select Laahe.Mp3.mp");
