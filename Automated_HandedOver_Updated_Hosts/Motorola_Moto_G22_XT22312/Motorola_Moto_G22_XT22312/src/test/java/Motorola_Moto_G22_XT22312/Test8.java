...
public class Test8
{
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			touchAction.tap(PointOption.point(365, 1224)).perform();
			...
			MobileElement Pause = driver.findElement(By.xpath("//*[@bounds='[290,1282][430,1418]']")); 
			Pause.click();
			TimeUnit.SECONDS.sleep(3);
		...
		try {
			...
			logger.info("Pause Audio playback");
			System.out.println("Pause Audio playback");
			driver.findElement(By.xpath("//*[@bounds='[290,1282][430,1418]']")).click();
			TimeUnit.SECONDS.sleep(3);
