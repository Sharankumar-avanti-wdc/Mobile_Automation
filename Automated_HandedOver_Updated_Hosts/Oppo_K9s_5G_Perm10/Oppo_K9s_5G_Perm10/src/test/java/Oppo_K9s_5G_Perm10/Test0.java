...
public class Test0 {
	...
	public void Images() throws  IOException, InterruptedException {
		...
		System.out.println("Select setting1 option");
	...
	public void Video() throws  IOException, InterruptedException {
		...
		System.out.println("Select settings1 option");
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		formatsdcard.click();
		logger.info("Clicking on format sdcard");
		System.out.println("Clicking on format sdcard");
		TimeUnit.SECONDS.sleep(5);
		//Select formatsdcard
		MobileElement formatsdcard1 = 	driver.findElement(By.xpath("//*[@text='FORMAT SD CARD']"));
		formatsdcard1.click();
		logger.info("Select format sdcard");
		System.out.println("Select format sdcard");
		TimeUnit.SECONDS.sleep(5);
		// Select Format option
		logger.info("Select again format sdcard");
		System.out.println("Select again format sdcard");
