...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement RearPhotoSize = driver.findElement(By.xpath("//*[@resource-id='com.myos.camera:id/camera_top_bar_start_left_reserved_item']"));
			RearPhotoSize.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 1st photo resolution
			logger.info("Select first rear camera resolution: 16:9");
			System.out.println("Select first rear camera resolution: 16:9");
			...
			logger.info("Select settings option to select resolution");
			System.out.println("Select settings option to select resolution");
			MobileElement RearPhotoSize1 = driver.findElement(By.xpath("//*[@resource-id='com.myos.camera:id/camera_top_bar_start_left_reserved_item']"));
			RearPhotoSize1.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select second rear camera resolution: 4:3");
			System.out.println("Select second rear camera resolution: 4:3");
			...
			logger.info("Select settings option to select resolution");
			System.out.println("Select settings option to select resolution");
			MobileElement RearPhotoSize3 = driver.findElement(By.xpath("//*[@resource-id='com.myos.camera:id/camera_top_bar_start_left_reserved_item']"));
			RearPhotoSize3.click();
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select third rear camera resolution: Full Screen");
			System.out.println("Select third rear camera resolution: Full Screen");
			...
			Result= "Pass";
			logger.info("Launch file manager application and verify capture images present  in uSD Card");
			System.out.println("Launch file manager application and verify capture images present in uSD Card");
			...
			if(Result == "Fail")
			{
				System.out.println("Final Mesaage: Fail Test9 Fail for Data Move Operation");
				logger.info("Final Mesaage: Fail Test9 Fail for Data Move Operation");
				...
				Result= "Pass";
				logger.info("Final Mesaage: Pass Test9 Pass for Rear camera image capture  successfully");
				System.out.println("Final Mesaage: Pass Test9 Pass for Rear camera image capture  successfully");
				logger.info("Test: End");
				System.out.println("Test: End");
				logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
				System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			...
			System.out.println("Calling DataMoveOperation");
			DataMoveOperation();
			System.out.println("Final Mesaage: Fail Test9 for rear camera image capture");
			logger.info("Final Mesaage: Fail Test9 for rear camera image capture");
			logger.info("Test: End");
			System.out.println("Test: End");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		TimeUnit.SECONDS.sleep(5);
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera images create Test9folder and cut paste all videos in Test9 folder
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera images create Test9 and cut paste all videos in Test9 folder");
