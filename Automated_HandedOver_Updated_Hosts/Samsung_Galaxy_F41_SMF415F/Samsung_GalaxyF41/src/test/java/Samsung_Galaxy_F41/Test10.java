...
import Samsung_Galaxy_F41.Test10;
			...
			public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
				...
				Settings.click();
			  	...
			  	//Click On Rear Video size to select resolution
			  		...
			  		MobileElement RearVideoSize2 = driver.findElement(By.xpath("//*[@text='Ratio']"));
		  			...
		  			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[642,104][786,248]']"));
		  			ThirdRes.click();
			  		TimeUnit.SECONDS.sleep(2);
			  		...
			  		System.out.println("recordingDurationRea2 = "+ recordingDurationRear2 + "Sec");
		  	...
		  	java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
				...
				MobileElement element1 = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
					...
					Sortby1.click();
	  				...
	  				TimeUnit.SECONDS.sleep(2);
	  				TimeUnit.SECONDS.sleep(2);
			  		logger.info("Pass: Recorded Video play back  from uSD card and fast forward scenario is successfull");
			  		System.out.println("Pass: Recorded Video play back  from uSD card and fast forward scenario is successfull");
			  		logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
					System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			  		System.out.println("Calling DataMovementOperation() to move rear camera recorded videos from camera folder to Test10 folder");
					logger.info("Calling DataMovementOperation() to move rear camera recorded videos from camera folder to Test10 folder");
					DataMoveOperation();
			  		if(Result == "Fail")
					{
		  	...
		  	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
			  	...
			  	//Select Test1 folder
					...
					MobileElement Test1 = driver.findElement(By.xpath("//*[@text='Test1']")); 
		  			...
		  			logger.info("Select Test1 folder");
		  			System.out.println("Select Test1 folder");
		  			MobileElement TestFile = driver.findElement(By.xpath("//*[@bounds='[202,454][514,518]']")); 
		  			TestFile.click();
		  			TimeUnit.SECONDS.sleep(3);
		  			//Select OneGB folder
