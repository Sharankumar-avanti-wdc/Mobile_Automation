...
public class Test0_Int {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try {
				...
				MobileElement Delete =	driver.findElement(By.xpath("//*[@bounds='[992,64][1088,160]']"));
				Delete.click();
				TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Host does not support format with data scenario for internal mount. Hence skipping Image capture,video recoridng and format with data scenario");
			System.out.println("Host does not support format with data scenario for internal mount. Hence skipping Image capture,video recoridng and format with data scenario");
	...
	public void FormatAsExternal() throws  IOException, InterruptedException {
		...
		try {
			...
			logger.info("Clicking on more options");
			System.out.println("Clicking on more options");
			MobileElement moreOptions = driver.findElement(By.xpath("//*[@bounds='[1120,64][1200,160]']"));
			moreOptions.click();
			TimeUnit.SECONDS.sleep(5);
