...
import Blackview_Oscal_C20.Test9F_Int;
import Blackview_Oscal_C20.Test9;
...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("Select front camera front image resolution: (4:3) 1.9 megapixels");
		System.out.println("Select front camera front image resolution: (4:3) 1.9 megapixels");
		...
		//Select 3:4 
		logger.info("Select front camera second image resolution: (4:3) 0.7 megapixels");
		System.out.println("Select front camera second image resolution: (4:3) 0.7 megapixels");
		driver.findElement(By.xpath("//*[@text='(4:3) 0.7 megapixels']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		//Click 9:16
		logger.info("Select front camera third image resolution: (4:3) 0.4 megapixels");
		System.out.println("Select front camera third image resolution: (4:3) 0.4 megapixels");
		driver.findElement(By.xpath("//*[@text='(4:3) 0.4 megapixels']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		//Click 9:16
		logger.info("Select front camera fourth image resolution: (16:9) 0.9 megapixels");
		System.out.println("Select front camera fourth image resolution: (16:9) 0.9 megapixels");
		...
		//Click 9:16
		logger.info("Select front camera fifth image resolution (16:9) 0.4 megapixels");
		System.out.println("Select front camera fifth image resolution: (16:9) 0.4 megapixels");
		driver.findElement(By.xpath("//*[@text='(16:9) 0.4 megapixels']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		//Click 9:16
		logger.info("Select front camera sixth image resolution: (16:9) 0.2 megapixels");
		System.out.println("Select front camera sixth image resolution: (16:9) 0.2 megapixels");
		driver.findElement(By.xpath("//*[@text='(16:9) 0.2 megapixels']")).click();
		TimeUnit.SECONDS.sleep(3);
