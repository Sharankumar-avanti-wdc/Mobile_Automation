...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[547,1410][653,1440]']")).click();
			...
			MobileElement location1 =	driver.findElement(By.xpath("//*[@bounds='[95,261][684,299]']"));
			location1.click();
			try {
				//Select uSD card
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(187, 849)).perform();
			TimeUnit.SECONDS.sleep(20);
			//clikc Pause button
