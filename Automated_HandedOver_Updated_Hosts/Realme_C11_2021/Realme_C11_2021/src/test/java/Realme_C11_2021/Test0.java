...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		System.out.println("1.Call Image() and Capture Rear camera 25 images for default resolution in uSD card and Verify the data capture");
		System.out.println("2.Call Video() and record Rear camera video of first 2 resloutions for 2 minutes of duration in uSD Card and verify the same");
		System.out.println("3.Call Format() and format uSD card with data and verify the same");
		System.out.println("4.Setting up the appium desired capabilities");
		logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		...
		try
		{
			logger.info("clikc on cancel");
			System.out.println("clikc on cancel");
	...
	public void Video() throws  IOException, InterruptedException {
		...
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[50,677][670,789]']"));
		SecondRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(4);
		//Start Recording
