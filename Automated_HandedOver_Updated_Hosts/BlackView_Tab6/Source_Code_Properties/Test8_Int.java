...
public class Test8_Int
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Tab 6");
		dc.setCapability(MobileCapabilityType.UDID, "TAB6NEU00006443");
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("2.Launch file manager application and playback copied audio files from internal mount storage the files are placed in the Test1 folder");
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			// FastForward first mp3 music for 30 sceonds duration
						...
						touchAction.tap(PointOption.point(477, 997)).perform();
		...
		try {
			...
			// FastForward
						...
						//Pause Video
						MobileElement Pause1 = driver.findElement(By.xpath("//*[@bounds='[347,1040][454,1144]']")); 
						Pause1.click();
			TimeUnit.SECONDS.sleep(3);
		...
		try
		{
			...
			System.out.println("Pause Audio play back");
			//Pause Video
			MobileElement Pause2 = driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/play_pause']")); 
			Pause2.click();
		...
		logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		logger.info("Final Message: Pass Test8_Int Pass NA - for copied audio play back and fast forward scenario");
		System.out.println("Final Message: Pass Test8_Int Pass NA - for copied audio play back and fast forward scenario");
		...
		{
			logger.info("Final Message: Fail Test8_Int Fail NA - for copied audio play back and fast forward scenario");
			System.out.println("Final Message: Pass Test8_Int Fail NA - for copied audio play back and fast forward scenario");
			logger.info("Test: End");
			System.out.println("Test: End");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
