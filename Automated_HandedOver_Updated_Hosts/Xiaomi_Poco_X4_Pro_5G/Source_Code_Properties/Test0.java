...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try
			{
				driver.findElement(By.xpath("//*[@resource-id='com.mi.android.globallauncher:id/clearAnimView']")).click();
				TimeUnit.SECONDS.sleep(5);
	...
	public void Video() throws  IOException, InterruptedException {
		...
		try {
			...
			logger.info("Select Video resolution 1080 30Fps");
			System.out.println("Select Video resolution 1080 30Fps");
			...
			logger.info("Select second highest resolution 720 30FPS for recording");
			System.out.println("Select second highest resolution 720 30FPS for recording");
