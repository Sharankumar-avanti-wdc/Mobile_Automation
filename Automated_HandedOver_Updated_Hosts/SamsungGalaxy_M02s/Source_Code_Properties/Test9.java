...
public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
	...
	try {
		...
		MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[174,90][244,160]']"));
		FirstRes.click();
		TimeUnit.SECONDS.sleep(2);
		...
		//MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[275,90][345,160]']"));
		//SecRes.click();
		TimeUnit.SECONDS.sleep(2);
		...
		//MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[375,90][445,160]']"));
		//ThirdRes.click();
		TimeUnit.SECONDS.sleep(6);
		...
		//MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[475,90][545,160]']"));
		//FourthRes.click();
		TimeUnit.SECONDS.sleep(2);
