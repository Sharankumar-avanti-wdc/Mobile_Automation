...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(5);
		logger.info("Host does not suppport audio recording in uSD storage. Hence skipping audio recording and recorded audio playback scenario");
		System.out.println("Host does not suppport audio recording in uSD storage. Hence skipping audio recording and recorded audio playback scenario ");
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Pause Video
			//MobileElement Pause1 =  driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/play_pause']")); 
			//Pause1.click();		  
			TimeUnit.SECONDS.sleep(3);
			TimeUnit.SECONDS.sleep(3);
