...
import ZTE_Axon30_5G_ZTE_A2322G.Test9;
...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[211,126][269,216]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.id("com.zte.camera:id/photo_shutter_button")).click();
				TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[511,126][569,216]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			//Select 2ND resolution
			logger.info("Select first third Resoution: 16:9");
			System.out.println("Select third Image Resoution: 16:9");
			driver.findElement(By.xpath("//*[@bounds='[799,126][881,216]']")).click();
			TimeUnit.SECONDS.sleep(3);
