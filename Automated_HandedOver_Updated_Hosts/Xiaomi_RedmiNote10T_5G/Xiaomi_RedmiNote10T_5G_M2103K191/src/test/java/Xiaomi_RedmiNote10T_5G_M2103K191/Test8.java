...
public class Test8
{
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
		logger.info("Launch file manager application and Select SD card for For copied audio playback scenario");
		System.out.println("Launch file manager application and Select SD card for For copied audio playback scenario");
		...
		//Select First audio file 11 Rob Thomas - Lonely No More.mp3 play back
		try {
			System.out.println("Select First audio file 11 Rob Thomas - Lonely No More.mp3 play back");
			logger.info("Select First audio file 11 Rob Thomas - Lonely No More.mp3 play back");
