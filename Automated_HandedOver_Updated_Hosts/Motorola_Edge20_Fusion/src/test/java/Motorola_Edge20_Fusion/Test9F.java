...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Test9_Fcam_res: 3 resolutions supported");
			System.out.println("Test9_Fcam_res: 3 resolutions supported");
			...
			logger.info("Select first front camera resolution: Aspect ratio 9:16");
			System.out.println("Select first front camera resolution: Aspect ratio 9:16");
			...
			logger.info("Select second front camera resolution: Aspect ratio 3:4");
			System.out.println("Select second front camera Aspect ratio 3:4");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		TimeUnit.SECONDS.sleep(5);
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create BCFC_Videos folder and cut paste all videos in Test9F folder
			...
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera images create Test10 folder and cut paste all videos in Test9F folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//If file manager permission request access accept allow permission
			try
