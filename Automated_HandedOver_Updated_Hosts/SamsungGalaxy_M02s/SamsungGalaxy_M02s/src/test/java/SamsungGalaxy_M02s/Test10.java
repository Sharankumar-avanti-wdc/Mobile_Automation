...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//MobileElement RearVideoSize = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/videoQuality_switcher']"));
			//RearVideoSize.click();
			
			//Select 1st resolution
			logger.info("Select First back video Resolution:Video size:1920 by 1080,Show options");
			System.out.println("Select First Back video resolution:Video size:1920 by 1080,Show options ");
			...
			MobileElement StartRecording = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/shtter_button_layout']"));
			...
			logger.info("Select Rear Video size");
			System.out.println("Select Rear Video size");
			//MobileElement RearVideoSize1 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/videoQuality_switcher']"));
			//RearVideoSize1.click();

			//Select 2nd resolution
			logger.info("Select second Back Video Resolution:Video size:1280 by 720,Show options");
			System.out.println("Select second Back Video Resolution:Video size:1280 by 720,Show options");
			//MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[405,90][475,160]"));
			//SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording1 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/shtter_button_layout']"));
