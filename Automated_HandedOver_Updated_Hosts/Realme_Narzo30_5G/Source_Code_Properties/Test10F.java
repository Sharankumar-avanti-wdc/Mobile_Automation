...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			touchAction.tap(PointOption.point(314, 1784)).perform();
			TimeUnit.SECONDS.sleep(5);
			...
			touchAction.tap(PointOption.point(760, 1779)).perform();
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Click More options");
			System.out.println("Click More options");
			MobileElement MoreOptions11 =	driver.findElement(By.xpath("//*[@content-desc='More options']"));
			MoreOptions11.click();
			TimeUnit.SECONDS.sleep(6);
			//Click  Move to Option
			...
			TimeUnit.SECONDS.sleep(6);
			//Click on test9F
			logger.info("Select Test10F");
			System.out.println("Select Test10F");
			MobileElement TestFile = driver.findElement(By.xpath("//*[@text='Test10F']")); 
			TestFile.click();
			TimeUnit.SECONDS.sleep(5);
