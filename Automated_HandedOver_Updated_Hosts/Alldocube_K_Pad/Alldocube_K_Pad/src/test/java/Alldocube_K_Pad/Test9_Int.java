package Alldocube_K_Pad;
import org.testng.annotations.Test;
import Alldocube_K_Pad.Test9_Int;
...
public class Test9_Int
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "kPad");
		dc.setCapability(MobileCapabilityType.UDID, "T102664GB21383840407");
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select Rear camera first image resolution: (4:3) 5.0 megapixels");
			System.out.println("Select Rear camera first image resolution: (4:3) 5.0 megapixels");
			...
			Settings1.click();
			//Select settings option to select resolution
			logger.info("Select Picture size option to select resolution");
			System.out.println("Select Picture size option to select resolution");
			MobileElement RearPhotoSize1 = driver.findElement(By.xpath("//*[@text='Picture size(Back camera)']"));
			RearPhotoSize1.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select Rear camera second resolution: (4:3) 1.9 megapixels");
			System.out.println("Select Rear camera second resolution: (4:3) 1.9 megapixels");
			...
			TimeUnit.SECONDS.sleep(2);
			//Select settings option to select 3rd resolution image
			//Click On Settings
			logger.info("Select settings option");
			System.out.println("Select settings option");
			...
			logger.info("Select Rear camera third image resolution: (4:3) 1.6 megapixels");
			System.out.println("Select Rear camera third image resolution: (4:3) 1.6 megapixels");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st photo resolution
			logger.info("Select Rear camera fourth image resolution: (16:9) 3.8 megapixels");
			System.out.println("Select Rear camera fourth image resolution: (16:9) 3.8 megapixels");
			...
			//Select 5th photo resolution
			logger.info("Select Rear camera fifth image resolution: (16:9) 2.1 megapixels");
			System.out.println("Select Rear camera fifth image resolution: (16:9) 2.1 megapixels");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 6th photo resolution
			logger.info("Select Rear camera sixth image resolution: (16:9) 0.9 megapixels");
			System.out.println("Select Rear camera sixth image resolution: (16:9) 0.9 megapixels");
