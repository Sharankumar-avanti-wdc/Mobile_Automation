...
public class Test0_Int {
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Tab 12");
		dc.setCapability(MobileCapabilityType.UDID, "TAB12NEU000024483");
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			logger.info("Test0_Int Format with data scenario N/A. Internal mount storage data being present in Internal stroage after portable format and internal mount format(Host behaviour).Observed same scenario for manual as well");
			System.out.println("Test0_Int Format with data scenario N/A. Internal mount storage data being present in Internal stroage after portable format and internal mount format(Host behaviour).Observed same scenario for manual as well");
			logger.info("Pass: Test0_Int Pass for clear recent apps and clear internal mount scenario");
			System.out.println("Pass: Test0_Int Pass for clear recent apps and clear internal mount scenario");
			logger.info("Final Message: Pass Test0_Int Pass for clear recent apps and clear intenal memory scenario");
			System.out.println("Final Message: Pass Test0_Int Pass for clear recent apps and clear intenal memory scenario");
