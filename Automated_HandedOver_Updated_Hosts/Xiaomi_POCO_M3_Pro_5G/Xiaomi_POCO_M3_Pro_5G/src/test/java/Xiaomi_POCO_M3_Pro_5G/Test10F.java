...
import Xiaomi_POCO_M3_Pro_5G.Test0;
...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("Move front camera recorded video files to Test10F folder");
		...
		try {
			...
			logger.info("Pass: Test10F pass for front camera video recording");
			System.out.println("Pass: Test10F pass for front camera video recording");
			logger.info("Pass: Test10F Pass for front mare video recording scenario");
			System.out.println("Pass: Test10F Pass for front mare video recording scenario");
