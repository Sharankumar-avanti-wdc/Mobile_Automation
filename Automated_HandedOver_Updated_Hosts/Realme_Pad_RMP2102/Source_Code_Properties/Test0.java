...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try {
				...
				MobileElement Delete =	driver.findElement(By.xpath("//*[@content-desc='Delete']"));
				Delete.click();
				TimeUnit.SECONDS.sleep(3);
				//Accept delete pop-up
				logger.info("Accept delete pop-up");
				System.out.println("Accept delete pop-up");
				MobileElement Delete1 =	driver.findElement(By.xpath("//*[@bounds='[606,1146][999,1218]']"));
				Delete1.click();
	...
	public void Images() throws  IOException, InterruptedException {
		...
		try {
			...
			MobileElement Storagepath = driver.findElement(By.xpath("//*[@text='Storage location']"));
			Storagepath .click();
			TimeUnit.SECONDS.sleep(5);
