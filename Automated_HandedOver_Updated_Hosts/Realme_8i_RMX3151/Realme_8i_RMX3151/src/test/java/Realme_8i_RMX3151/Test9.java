...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[441,480][555,594]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[591,480][705,594]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[741,480][855,594]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[891,480][1005,594]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			{ 
				...
				driver.findElement(By.id("com.oppo.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions ultra 16:9: "+j);
				logger.info("clicking Image of 3rd Resolutions ultra 16:9: "+j);
			}
			TimeUnit.SECONDS.sleep(5);
