...
import Asus_Zenfone_8_Flip.Test9;
...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@text='Camera resolution']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select first Image Resoution: 4:3 ");
			System.out.println("Select first Image Resoution: 4:3 ");
			driver.findElement(By.xpath("//*[@bounds='[81,1507][999,1633]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 5th Image Resoution: 4:3 (64MP) ");
			System.out.println("Select 5th Image Resoution: 4:3 (64MP) ");
			driver.findElement(By.xpath("//*[@bounds='[81,1381][999,1507]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(3);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.asus.camera:id/capture_inside_icon_root']")).click();
				TimeUnit.SECONDS.sleep(7);
				System.out.println("clicking Image of 5th Resolutions ultra 4:3 (64MP): "+j4);
				logger.info("clicking Image of 5th Resolutions ultra 4:3 (64MP): "+j4);
			...
			System.out.println("Launch file manager application and verify catured images present in uSD Card");
