...
import Samsung_Galaxy_A23_SMA235F1DS.Test3;
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			try
			{
				...
				TimeUnit.SECONDS.sleep(5);
				logger.info("Clear recent apps is  successfull");
				System.out.println("Clear recent apps is successfull");
			}
			catch (Exception e) {
				e.printStackTrace();
			}
			...
			{ 
				...
				logger.info("Pass for MOunt,unmount and Formating the uSD Card");
				System.out.println("Pass for MOunt,unmount and Formating the uSD Card");
			}
			...
			try {
				...
				logger.info("Check for camera folder. If present print check for video and image files if video and images file present print fail message");
				System.out.println("Check for camera folder. If present print check for video and image files if video and images file present print fail message");
