...
import Samsung_Galaxy_M33_SMM336BVDS.Test10;
...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select rear camera first Video Resolution:BACK_CAMCORDER_RESOLUTION_UHD_30");
			System.out.println("Select rear camera first Video Resolution:BACK_CAMCORDER_RESOLUTION_UHD_30");
			...
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[481,121][601,241]']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[699,121][819,241]']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
