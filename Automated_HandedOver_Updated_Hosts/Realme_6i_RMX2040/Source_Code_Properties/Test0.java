...
public class Test0 {
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "realme 6i");
		dc.setCapability(MobileCapabilityType.UDID, "NZ5TDILNFIBQGEPZ");
	...
	public void Video() throws  IOException, InterruptedException {
		...
		touchAction.tap(PointOption.point(206, 1164)).perform();
		TimeUnit.SECONDS.sleep(5);
		//Click On Settings
		logger.info("Select settings option");
		System.out.println("Select settings option");
		...
		touchAction.tap(PointOption.point(506, 1164)).perform();
		TimeUnit.SECONDS.sleep(5);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
		...
		try {
			...
			System.err.println("Verifying Image Capture and videos ");
			TimeUnit.SECONDS.sleep(5);
