...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select First back video Resolution: 16:9(8K))");
			System.out.println("Select First Back video resolution: FHD(60 fps)");
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@text='16:9 (8K)']"));
			FirstRes.click();
			...
			logger.info("Select second Back Video Resolution: 16:9");
			System.out.println("Select second Back Video Resolution: 16:9");
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@text='16:9']"));
			SecondRes.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Settings3 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/quick_setting_button']"));
			Settings3.click();
			TimeUnit.SECONDS.sleep(2);
			//Click On Rear Video size to select resolution
			logger.info("Select Rear Video size");
			System.out.println("Select Rear Video size");
			MobileElement RearVideoSize2 = driver.findElement(By.xpath("//*[@text='Rear video size']"));
			RearVideoSize2.click();
			//Select 2nd resolution
			logger.info("Select Third Back Video Resolution: Full");
			System.out.println("Select Third Back Video Resolution: Full");
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@text='Full']"));
			ThirdRes.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Settings4 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/quick_setting_button']"));
			Settings4.click();
			TimeUnit.SECONDS.sleep(2);
			//Click On Rear Video size to select resolution
			logger.info("Select Rear Video size");
			System.out.println("Select Rear Video size");
			MobileElement RearVideoSize3 = driver.findElement(By.xpath("//*[@text='Rear video size']"));
			RearVideoSize3.click();
			//Select 2nd resolution
			logger.info("Select Fourth Back Video Resolution: 1:1");
			System.out.println("Select Fourth Back Video Resolution: 1:1");
			MobileElement FourthRes = driver.findElement(By.xpath("//*[@text='1:1']"));
			FourthRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
