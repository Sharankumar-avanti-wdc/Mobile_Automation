...
public class Test0 {
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Redmi Note 11S");
		dc.setCapability(MobileCapabilityType.UDID, "TODEFMWGXCDMQS8H");
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			MobileElement InternalStorage = driver.findElement(By.xpath("//*[@bounds='[0,586][1080,751]']"));
			...
			MobileElement SelectAll =	driver.findElement(By.xpath("//*[@bounds='[864,93][1080,245]']"));
			SelectAll.click();
	...
	public void Images() throws  IOException, InterruptedException {
		...
		logger.info("Select switch Storage");
		System.out.println("Select switch Storage");
		MobileElement SwitchStorage = driver.findElement(By.xpath("//*[@resource-id='com.mi.android.globalFileexplorer:id/volume_switch']"));
		SwitchStorage.click();
		TimeUnit.SECONDS.sleep(3);
		...
		MobileElement ExternalStorage = driver.findElement(By.xpath("//*[@bounds='[14,784][224,866]']"));
		...
		try {
			TimeUnit.SECONDS.sleep(3);
			driver.findElement(By.xpath("//*[@text='Selected 25 items']")).click();
	...
	public void Video() throws  IOException, InterruptedException {
		...
		TimeUnit.SECONDS.sleep(5);
		//Start Recording
		logger.info("Click Start video recording");
		System.out.println("Click Start video recording");
		...
		logger.info("Stop video recording");
		System.out.println("Stop video recording");
		MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@bounds='[412,1911][668,2167]']"));
		...
		TimeUnit.SECONDS.sleep(10);
		//Click Select all option
		logger.info("Click On SelectAll");
		...
		try {
			TimeUnit.SECONDS.sleep(3);
			driver.findElement(By.xpath("//*[@text='Selected 27 items']")).click();
	...
	public void Format() throws  IOException, InterruptedException  {
		...
		TimeUnit.SECONDS.sleep(5);*/
		//Swipe up and check for sd card option
