	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		//Click On Settings
			...
			// Load properties file
				...
				TimeUnit.SECONDS.sleep(3);
				//Select (16:9) 6.0 megapixels
				logger.info("Select Rear camera fourth resolution: (16:9) 6.0 megapixels");
				...
				TimeUnit.SECONDS.sleep(3);
				//Select (16:9) 6.0 megapixels
				logger.info("Select Rear camera fourth resolution: (16:9) 2.4 megapixels");
				System.out.println("Select Rear camera fourth resolution: (16:9) 2.4 megapixels");
				...
				TimeUnit.SECONDS.sleep(3);
				//Select (16:9) 6.0 megapixels
				logger.info("Select Rear camera fourth resolution: (16:9) 2.1 megapixels");
				System.out.println("Select Rear camera fourth resolution: (16:9) 2.1 megapixels");
...
//Sum total of User provided images resolution count 
		...
		logger.info("Swipe up to select Internal storag");
		System.out.println("Swipe up to select Internal storag");
		MobileElement element4 = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
				"new UiScrollable(new UiSelector().scrollable(true)).setMaxSearchSwipes(10)" +
				".scrollIntoView(new UiSelector().text(\"Internal storage\"))"));
		//Click External storage
		logger.info("Select Internal storag");
		System.out.println("Select Internal storag");
