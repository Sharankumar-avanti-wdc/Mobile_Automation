...
import Motorola_Moto_E30_XT21596.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Test9_Int_Bcam_res: 2 resolutions supported");
			System.out.println("Test9_Int_Bcam_res: 2 resolutions supported");
			...
			logger.info("Relaunch camera ");
			System.out.println("Relaunch camera ");
			((StartsActivity) driver).startActivity(new Activity("com.ontim.camera2", "com.ontim.camera2.CameraLauncher"));
			TimeUnit.SECONDS.sleep(4);
			//Click On Settings
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select Rear camera second resolution:  9:16");
			System.out.println("Select Rear camera second resolution: 9:16");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all back camera images create Test9_Int folder and cut paste all images in Test9_Int folder");
