...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select 1st rear Video Resolution: 1920x1080");
			System.out.println("Select 1st rear Video Resolution: 1920x1080");
			...
			logger.info("Select 2nd rear Video Resolution: 1280x720");
			System.out.println("Select 2nd rear Video Resolution: 1280x720");
			...
			logger.info("Select 3rd rear Video Resolution: 640x480");
			System.out.println("Select 3rd rear Video Resolution: 640x480");
			//Select 2nd resolution
			...
			logger.info("Select 3rd rear Video Resolution: 3840x2160");
			System.out.println("Select 3rd rear Video Resolution: 3840x2160");
			//Select 2nd resolution
			MobileElement fourthres = driver.findElement(By.xpath("//*[@text='3840x2160']"));
			fourthres.click();
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
