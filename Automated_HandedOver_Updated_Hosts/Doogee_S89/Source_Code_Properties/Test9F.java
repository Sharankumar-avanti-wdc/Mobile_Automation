...
public class Test9F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "S89");
		dc.setCapability(MobileCapabilityType.UDID, "S890000000000000127");
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@bounds='[905,93][1080,198]']"));
			Settings.click();
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[855,1986][1005,2136]']")).click();
			TimeUnit.SECONDS.sleep(5);
			//click on camera resolutions
			logger.info("Select  settings");
			System.out.println("Select settings");
			driver.findElement(By.xpath("//*[@bounds='[905,93][1080,198]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Select first Image Resoution: 16M ");
			System.out.println("Select first Image Resoution:16M ");
			...
			{  
				...
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 1st Resolutions 16M : "+j);
				logger.info("clicking Image of 1st Resolutions 16M : "+j);
			...
			logger.info("Select second Image Resoution: 12M");
			System.out.println("Select second Image Resoution: 12M");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 2nd Resolutions 12M : "+j1);
				logger.info("clicking Image of 2nd Resolutions 12M : "+j1);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first third Resoution:11M");
			System.out.println("Select third Image Resoution: 11M");
			driver.findElement(By.xpath("//*[@text='11M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions 11M: "+j2);
				logger.info("clicking Image of 3rd Resolutions 11M: "+j2);
			...
			logger.info("Select fourth Image Resoution: 8M");
			System.out.println("Select fourth Image Resoution: 8M");
			driver.findElement(By.xpath("//*[@text='8M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			{  
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 4th Resolutions 8M: "+j3);
				logger.info("clicking Image of 4th Resolutions 8M: "+j3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 4th resolution
			logger.info("Select fifth Image Resoution: 5M");
			System.out.println("Select fifth Image Resoution: 5M");
			driver.findElement(By.xpath("//*[@text='5M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 5th Resolutions 5M: "+j4);
				logger.info("clicking Image of 5th Resolutions 5M: "+j4);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 4th resolution
			logger.info("Select sixth Image Resoution: 5M");
			System.out.println("Select sixth Image Resoution: 5M");
			driver.findElement(By.xpath("//*[@text='5M']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			{  
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 4th Resolutions 5M: "+j5);
				logger.info("clicking Image of 4th Resolutions 5M: "+j5);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera images Test9F and cut paste all images in test9F folder");
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera images Test9F and cut paste all images in test9F folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//If file manager permission request access accept allow permission
			try
