...
public class Test0_Int {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			logger.info("Final Message: Pass Clearing phone internal memory, Format as Internal Mount scenario completed Successfull & format with data scenario not applicable because When we are formatting  the card external to internal  data is not deleting, observed in manually");
			System.out.println("Final Message: Pass Clearing phone internal memory, Format as Internal Mount scenario completed Successfull & format with data scenario not applicable because When we are formatting  the card external to internal  data is not deleting, observed in manually");
