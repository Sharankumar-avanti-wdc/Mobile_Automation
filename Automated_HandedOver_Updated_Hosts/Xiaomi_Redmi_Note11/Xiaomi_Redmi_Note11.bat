...
cd C:\Users\7320612\Android11\eclipse-workspace\Xiaomi_Redmi_Note11

mvn -DrecordingDurationfront=20 -DrecordingDurationfront1=120  -DfileName=testng10F.xml clean install >> C:\Users\7320612\Android11\eclipse-workspace\External_Logs\ABC_Iteration1\Xiaomi_Redmi_Note11_%mydate%_%mytime%_%Qual_Capacity%.txt
