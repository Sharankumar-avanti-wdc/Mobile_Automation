...
import Realme_Pad_Mini_RMP2106.Test10_Int;
...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first highest rear camera video resolution: HD 1080p, 30fps");
			System.out.println("Select first highest rear camera video resolution: HD 1080p, 30fps");
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@text='HD 1080p, 30fps']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select second highest rear camera video resolution: HD 720p, 30fps");
			System.out.println("Select second highest rear camera video resolution: HD 720p, 30fps");
			MobileElement secondRes = driver.findElement(By.xpath("//*[@text='HD 720p, 30fps']"));
			secondRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select third highest rear camera video resolution: SD 480p, 30fps");
			System.out.println("Select third highest rear camera video resolution: SD 480p, 30fps");
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@text='SD 480p, 30fps']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
