...
public class Test8
{
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement FasForward2 = driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/fast_forward']")); 
			FasForward2.click();
			TimeUnit.SECONDS.sleep(10);
			System.out.println("Playing  audio  for 10 seconds duration");
			logger.info("Playing audio for 10 seconds duration");
			//Pause Video
