...
public class Test10F
{
	...
	public void VideoPlayBackForSleepWake() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Click on first file to play newest date first recorded resolution video file in usd card");
			System.out.println("Click on first file to play newest date first recorded resolution video file in usd card");
