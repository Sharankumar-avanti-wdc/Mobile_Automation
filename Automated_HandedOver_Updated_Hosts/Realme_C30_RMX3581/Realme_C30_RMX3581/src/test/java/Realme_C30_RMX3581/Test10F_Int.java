...
public class Test10F_Int
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uInternal storage-->DCIM folder-->Camera folder-->Select all front camera videos create Test10F_Int folder and cut paste all videos in Test10F_Int folder
