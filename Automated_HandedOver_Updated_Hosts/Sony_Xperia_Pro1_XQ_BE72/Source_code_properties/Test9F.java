...
import Sony_Xperia_Pro1_XQ_BE72.Test9F;
...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first highest front camera  Image Resolution:4:3 (8MP)");
			System.out.println("Select first highest front camera  Image Resolution:4:3 (8MP)");
			...
			AspectRatio1.click();
			logger.info("Select second highest front camera  Image Resolution:16:9 (6MP)");
			System.out.println("Select second highest front camera  Image Resolution:16:9 (6MP)");
			//Select 1st resolution
			...
			AspectRatio2.click();
			logger.info("Select third highest front camera  Image Resolution:1:1 (6MP)");
			System.out.println("Select third highest front camera  Image Resolution:1:1 (6MP)");
			//Select 1st resolution
