...
import Realme_C25Y_RMX3265.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select zero Image Resoution: (4:3) 12.5 megapixels ");
			System.out.println("Select zero Image Resoution:(4:3) 12.5 megapixels ");
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 0th Resolutions ultra (4:3) 12.5 megapixels: "+j);
				logger.info("clicking Image of 0th Resolutions ultra (4:3) 12.5 megapixels: "+j);
			}
			TimeUnit.SECONDS.sleep(5);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 1st Resolutions ultra (4:3) 5.0 megapixels: "+j1);
				logger.info("clicking Image of 1st Resolutions ultra (4:3) 5.0 megapixels: "+j1);
			}
			TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select second Image Resoution: (4:3) 3.1 megapixels ");
			System.out.println("Select second Image Resoution:(4:3) 3.1 megapixels ");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 2nd Resolutions ultra (4:3) 3.1 megapixels: "+j2);
				logger.info("clicking Image of 2nd Resolutions ultra (4:3) 3.1 megapixels: "+j2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select third Image Resoution: (16:9) 9.0 megapixels ");
			System.out.println("Select third Image Resoution:(16:9) 9.0 megapixels ");
