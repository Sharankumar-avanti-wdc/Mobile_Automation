...
public class Test0 {
	...
	public void Video() throws  IOException, InterruptedException {
		...
		MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[378,80][458,160]']"));
		FirstRes.click();
		TimeUnit.SECONDS.sleep(5);
		//Start Recording
		...
		MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[294,1294][426,1426]']"));
		StopRecording.click();
		TimeUnit.SECONDS.sleep(8);
		//Click On Rear Video size to select resolution
		MobileElement RearVideoSize1 = driver.findElement(By.xpath("//*[@text='Video size']"));
		RearVideoSize1.click();
		logger.info("Select 2nd Rear camera video size, FHD (30 fps)");
		System.out.println("Select 2nd Rear camera video size, FHD (30 fps)");
		//Select 2nd resolution
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[262,80][342,160]']"));
		SecondRes.click();
		TimeUnit.SECONDS.sleep(5);
		//Start Recording
		logger.info("Start video recording");
		...
		logger.info("Stop video recording");
		System.out.println("Stop video recording");
		MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[294,1294][426,1426]']"));
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[362,1123][394,1155]']")).click();
			TimeUnit.SECONDS.sleep(5);
			//find element by xpath
