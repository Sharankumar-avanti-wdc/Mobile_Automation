...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("select front camera front resolution: 4:3 ");
			System.out.println("select front camera front resolution: 4:3 ");
			...
			System.out.println("select front camera sencond resolution: 16:9 ");
			logger.info("select front camera sencond resolution: 16:9 ");
			...
			System.out.println("select front camera thirs resolution: Full ");
			logger.info("select front camera thirs resolution: Full");
