...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Select 2nd resolution
			logger.info("Select 4th highest rear camera video resolution: 2K");
			System.out.println("Select 4th highest rear camera video resolution: 2K");
			MobileElement fourthres = driver.findElement(By.xpath("//*[@text='2K']"));
			fourthres.click();
			TimeUnit.SECONDS.sleep(2);
			// Load properties file for video recording duration
