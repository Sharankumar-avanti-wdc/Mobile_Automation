...
import Realme_85G_RMX3241.Test9F;
  ...
  public class Test9F
  {
	...
	private String Result;
		...
		//Select Settings option
				...
				//select turn on option if exists
				...
				logger.info("Select front camera first highest image resolution: Full");
				System.out.println("Select front camera first highest image resolution: Full");
		  	...
		  	//Click on image resolution
				...
				logger.info("select  front camera second highest image resolution image: 4:3");
				System.out.println("select  front camera second highest image resolution image: 4:3");
		  	...
		  	//Click on image resolution
				...
				logger.info("select  front camera third highest  image resolution image: 16:9");
				System.out.println("select  front camera third highest image resolution image:16:9");
		  	...
		  	//Click on image resolution
				...
				logger.info("select  front camera fourth highest  image resolution image: 1:1");
				System.out.println("select  front camera fourth highest image resolution image:1:1");
				...
				Properties prop3 = new Properties();
		  		...
		  		System.out.println("totalPictureCountFront2 = "+ totalPictureCountFront3);
  			...
  			//Select Settings option
				...
				System.out.println("uncheck on Save to SDCard Preferred");
