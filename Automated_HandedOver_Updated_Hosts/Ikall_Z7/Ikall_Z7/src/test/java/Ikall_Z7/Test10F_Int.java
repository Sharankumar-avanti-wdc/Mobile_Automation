...
public class Test10F_Int
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("1.Launch Camera application and start front camera video recording for all host applicable resolutions in ");
		logger.info("2.Playback Highest resolution recorded video from , fast forward playback and pause video scenario ");
		...
		System.out.println("1.Launch Camera application and start front camera video recording for all host applicable resolutions in ");
		System.out.println("2.Playback Highest resolution recorded video from , fast forward playback and pause video scenario ");
		System.out.println("3.Move front camera recorded videos from  to Test10 folder in ");
		...
		try {
			...
			//Switch to Video Tab
			driver.findElement(By.xpath("//android.widget.RelativeLayout[@content-desc=\"PhotoMode is previewing\"]/android.widget.RelativeLayout[2]/android.widget.TextView")).click();
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[21,118][395,216]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Selecting 1st resolution VGA");
			System.out.println("Selecting 1st resolution VGA");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			driver.findElement(By.xpath("//*[@bounds='[187,843][292,907]']")).click();
			//StopRecording.click();
			TimeUnit.SECONDS.sleep(3);
			//click Back to settings option
			driver.findElement(By.xpath("//*[@bounds='[15,83][62,130]']")).click();
			...
			driver.findElement(By.xpath("//*[@bounds='[21,217][395,315]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Selecting 2nd resolution CIF");
			System.out.println("Selecting 2nd resolution CIF");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			// Load properties file
			prop.load(Test10F_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[21,316][395,414]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Selecting 3rd resolution QVGA");
			System.err.println("Selecting 3rd resolution QVGA");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			prop.load(Test10F_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("start recording");
			System.out.println("start recording");
			MobileElement StartRecording2 = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Video\"]"));
			...
			//Click on Video Resolution
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Video quality\")").click();
			//driver.findElement(By.xpath("//*[@bounds='[21,267][141,296]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//		logger.info("Select Video resolution");
			System.out.println("Click settings option");
			//Select 4th resolution 
			//Selecting 4th Highest resolution
			driver.findElement(By.xpath("//*[@bounds='[21,415][395,513]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Selecting 4th resolution QCIF");
			System.out.println("Selecting 4th resolution QCIF");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			prop.load(Test10F_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("start recording");
			System.out.println("start recording");
			MobileElement StartRecording3 = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Video\"]"));
			...
			driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"front\"]")).click();
			TimeUnit.SECONDS.sleep(5);
			...
			//launch file manager application and verify recorded video files in u
			logger.info("Launch file manager application and verify recorded video capture ");
			System.out.println("Launch file manager application and verify recorded video capture ");
			...
			logger.info("Swipe up to select ");
			System.out.println("Swipe up to select ");
			...
			MobileElement ExternalStorage =	driver.findElement(By.xpath("//*[@Internal Storage='']"));
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select u-->DCIM folder-->Camera folder-->Select all back camera front camera videos create BCFC_Videos folder and cut paste all videos in BCFC_Cameravideos folder
			logger.info("launch file manager application select -->DCIM folder-->Camera folder-->Select all front camera videos create Test10F_Int and cut paste all videos in Test10F_Int folder");
			System.out.println("launch file manager application select -->DCIM folder-->Camera folder-->Select all front camera videos create Test10F_Int folder and cut paste all videos in Test10F_Int folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//If file manager permission request access accept allow permission
			//Swipe and Select external storage
			...
			logger.info("Select ");
			System.out.println("select ");
			MobileElement uSD =	driver.findElement(By.xpath("//*[@text='']"));
			uSD.click();
			TimeUnit.SECONDS.sleep(6);
			//Click  Move to Option
