...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("1.Launch voice recorder application, record 2 minutes audio in Internal mount storage and verify recorded audio in internal storage");
		logger.info("2.Play recorded audio file from internal mount storage,fast forward and pause audio.");
		...
		System.out.println("1.Launch voice recorder application, record 2 minutes audio in Internal mount storage and verify recorded audio in internal storage");
		System.out.println("2.Play recorded audio file from internal mount storage,fast forward and pause audio.");
		...
		//logger.info("Host does not support audio recording for external mount. Hence skipping audio recording and recorded audio playback scenario");
		//System.out.println("Host does not support audio recording for external mount. Hence skipping audio recording and recorded audio playback scenario");
		try {
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@bounds='[954,1837][1046,1924]']"));
			Settings.click();
			TimeUnit.SECONDS.sleep(5);
			...
			MobileElement SDcard = driver.findElement(By.xpath("//*[@bounds='[81,137][1170,175]']"));
			SDcard.click();
			TimeUnit.SECONDS.sleep(5);
			...
			MobileElement Stop = driver.findElement(By.xpath("//*[@bounds='[539,1653][661,1775]']"));
			Stop.click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			System.out.println("Select  Interal storage");
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Interal storage\")").click();
			TimeUnit.SECONDS.sleep(5);
			//Select Test1 folder
			...
			TimeUnit.SECONDS.sleep(5);
			//Select MP3 files for playback
			logger.info("Select MP3 files for playback");
			System.out.println("Select MP3 files for playback");
			driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/title']")).click();
			logger.info("Started playing recorded audio ");
			System.out.println("Started playing recorded audio ");
				...
				touchAction.tap(PointOption.point(734, 1678)).perform();
				...
				Pause.click();
				TimeUnit.SECONDS.sleep(3);
				logger.info("Pass: Test8_Int Pass for recorded audio playback and fast forward scenario");
				System.out.println("Pass: Test8_Int Pass for recorded audio playback and fast forward scenario");
				((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
				TimeUnit.SECONDS.sleep(2);
				...
				System.out.println("Fail: Test8_Int Fail for recorded audio file playback,fast forward scenario");
				System.out.println("Final Message: Test8_Int Fail for recorded audio file playback,fast forward scenario");
