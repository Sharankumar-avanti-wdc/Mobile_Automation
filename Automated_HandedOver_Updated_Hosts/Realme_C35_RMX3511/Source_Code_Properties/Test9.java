...
import Realme_C35_RMX3511.Test9;
...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select 1st Image Resoution: (4:3) 12.5 megapixels ");
			System.out.println("Select 1st Image Resoution:(4:3) 12.5 megapixels ");
			driver.findElement(By.xpath("//*[@text='(4:3) 12.5 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(5);
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 1st Resolutions (4:3) 12.5 megapixels: "+j);
				logger.info("clicking Image of 1st Resolutions (4:3) 12.5 megapixels: "+j);
			...
			logger.info("Select 2nd Image Resoution: (4:3) 5.0 megapixels ");
			System.out.println("Select 2nd Image Resoution:(4:3) 5.0 megapixels ");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 2nd Resolutions (4:3) 5.0 megapixels: "+j1);
				logger.info("clicking Image of 2nd Resolutions (4:3) 5.0 megapixels: "+j1);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 3rd Image Resoution: (4:3) 3.1 megapixels ");
			System.out.println("Select 3rd Image Resoution:(4:3) 3.1 megapixels ");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions ultra (4:3) 3.1 megapixels: "+j2);
				logger.info("clicking Image of 3rd Resolutions ultra (4:3) 3.1 megapixels: "+j2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 4th Image Resoution: (16:9) 9.0 megapixels ");
			System.out.println("Select 4th Image Resoution:(16:9) 9.0 megapixels ");
			driver.findElement(By.xpath("//*[@text='(16:9) 9.0 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(5);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions ultra (16:9) 9.0 megapixels: "+j3);
				logger.info("clicking Image of 3rd Resolutions ultra (16:9) 9.0 megapixels: "+j3);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 4th Resolutions ultra 16:9) 3.8 megapixels: "+j4);
				logger.info("clicking Image of 4th Resolutions ultra 16:9) 3.8 megapixels: "+j4);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 5th Resolutions ultra (16:9) 2.4 megapixels: "+j5);
				logger.info("clicking Image of 5th Resolutions ultra (16:9) 2.4 megapixels: "+j5);
