...
cd C:\Users\7336135\Android11\eclipse-workspace\BlackView_A55_Pro
mvn -DrecordingDurationRear=180 -DrecordingDurationRear1=180 -DfileName=testng10_Int.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\TEST\Blackview_A55_Pro_%mydate%_%mytime%_%Qual_Capacity%.txt
