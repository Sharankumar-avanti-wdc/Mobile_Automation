...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			System.out.println("recordingDurationRear_IntExt = "+ recordingDurationRear_Int + "sec");
	...
	//Launch file manager application, select Internal storage,select Test1 folder, select video folder and play back copied video files, fast forward and Pause the same     
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
		//Re-launch file manager application and select Internal storage
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uInternal storage-->DCIM folder-->Camera folder-->Select all front camera videos create Test10_Int folder and cut paste all videos in Test10_Int folder
