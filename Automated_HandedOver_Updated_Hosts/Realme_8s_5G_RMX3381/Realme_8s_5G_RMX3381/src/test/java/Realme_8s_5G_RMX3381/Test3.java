...
import Realme_8s_5G_RMX3381.Test3;
...
public class Test3 {
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("Host does'nt support Mount & Unmount option! Hence Skiping Mount & Unmount scenario");
		logger.info("Format uSD card for specified number of times");
		logger.info("Setting up the appium desired capabilities");
		System.out.println("Test3 Scenario is as follows");
		System.out.println("Host does'nt support Mount & Unmount option! Hence Skiping Mount & Unmount scenario");
		System.out.println("Format usd card for specified number of times");
