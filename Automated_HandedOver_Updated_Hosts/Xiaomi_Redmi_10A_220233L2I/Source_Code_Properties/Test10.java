...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select 1st video resolution: HD 720p, 30fps");
			System.out.println("Select 1st video resolution: HD 720p, 30fps");
			driver.findElement(By.xpath("//*[@bounds='[68,108][352,170]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[368,108][652,170]']")).click();
			TimeUnit.SECONDS.sleep(3);
