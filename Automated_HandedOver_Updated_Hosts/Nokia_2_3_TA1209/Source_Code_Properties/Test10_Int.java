	...
	private boolean isPaused;
		...
		public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
			...
			SimpleFormatter formatter = new SimpleFormatter();  
		  	...
		  	//Unlock phone
				...
				((StartsActivity) driver).startActivity(new Activity("com.android.launcher3", "com.android.searchlauncher.SearchLauncher"));
		  		TimeUnit.SECONDS.sleep(5);
		  		try {
		  			logger.info("Test10_Int_BCam_res: 2 resolutions supported");
	  				System.out.println("Test10_Int_BCam_res: 2 resolutions supported");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@text='FHD  1080P']")).click();
				TimeUnit.SECONDS.sleep(3);
				...
				((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
	   	  		...
	   	  		TimeUnit.SECONDS.sleep(2);
			  		...
			  		System.out.println("recordingDurationRearExt = "+ recordingDurationRearExt);
			  	...
			  	//click Back to settings option
					...
					((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		   	  	...
		   	  	((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			  		...
			  		System.out.println("recordingDurationRearExt1 = "+ recordingDurationRearExt1);
		  	...
		  	//Launch File manager
				logger.info("Launch file manager application and verify recorded video present");
				System.out.println("Launch file manager application and verify recorded video present");
				...
				((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
				((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
				logger.info("Test10_Int_Bcam_video: 2 videos captured successfully");
				System.out.println("Test10_Int_Bcam_video: 2 videos captured successfully");
				logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
				System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		...
		public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
			...
			try {
				...
				logger.info("Click on first file to play highest recorded resolution video file from Internal mount storage");
				System.out.println("Click on first file to play highest recorded resolution video file from Internal mount storage");
		...
		public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
			...
			try {
				...
				logger.info("Final message: Pass Test10_Int Pass for rear camera  video recording, playback and fast forward highest resolution recorded video and playback and fast forward copied video files from Test1 folder and data move operation scenario");
				System.out.println("Final message: Pass Test10_Int Pass for rear camera  video recording, playback and fast forward highest resolution recorded video and playback and fast forward copied video files from Test1 folder and data move operation scenario");
				logger.info("Test:End");
				System.out.println("Test:End");
				logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
				System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");	
		...
		public void DataMoveOperation() throws  IOException, InterruptedException {
			...
			String Result = null;
			try {
				logger.info("Re-launch file manager application and select internal storage for data move operation, select all rear camera videos present in camera folder and move to Test10 folder");
				System.out.println("Re-launch file manager application and select internal storage for data move operation, select all rear camera videos present in camera folder and move to Test10 folder");
				((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
				TimeUnit.SECONDS.sleep(5);
				logger.info("Launching file manager application");
				MobileElement element = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
