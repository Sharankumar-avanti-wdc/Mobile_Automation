...
public class Test0_Int {
	...
	public void FormatAsInternal() throws  IOException, InterruptedException {
		...
		try {
			...
			try {
				...
				driver.findElement(By.xpath("//*[@bounds='[446,1224][680,1320]']")).click();
				TimeUnit.SECONDS.sleep(5);
			}
			TimeUnit.SECONDS.sleep(5);
	...
	public void Images() throws  IOException, InterruptedException {
		...
		try {
			...
			System.out.println("SD card ejected");
	...
	public void Video() throws  IOException, InterruptedException {
		...
		try {
			...
			StopRecording.click();
			TimeUnit.SECONDS.sleep(5);
			logger.info("Select 2nd Back Video Resolution by default");
			System.out.println("Select 2nd Back Video Resolution by default");
			//Start Recording
			logger.info("Start video recording");
			System.out.println("Start video recording");
