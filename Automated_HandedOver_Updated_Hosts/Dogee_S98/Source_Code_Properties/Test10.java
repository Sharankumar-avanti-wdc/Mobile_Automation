  ...
  public class Test10
  {
	...
	private boolean isPaused;
			...
			//Launch Home screen 
			 logger.info("Launch Home screen");
				...
				try
				{
  				...
  				MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[71,861][197,987]']"));
  				FirstRes.click();
  	...
  	//Click On Settings
			...
			MobileElement fourthRes = driver.findElement(By.xpath("//*[@bounds='[881,861][1007,987]']"));
			fourthRes.click();
			TimeUnit.SECONDS.sleep(2);
