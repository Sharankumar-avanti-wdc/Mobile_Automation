...
import Umidigi_Bison_GT2Pro_RP02.Test10;
...
public class Test10F_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("3.Move front camera recorded videos from uSD card to Test10 folder in internal storage");
		...
		try {
			...
			logger.info("Select front camera first video resolution: FHD(1920x1080)");
			System.out.println("Select front camera first video resolution: FHD(1920x1080)");
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@text='FHD(1920x1080)']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
  	...
  	//Click On Video size
		...
		TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select front camera second video resolution : HD(1280x720)");
			System.out.println("Select front camera second video resolution : HD(1280x720)");
			MobileElement secondRes = driver.findElement(By.xpath("//*[@text='HD(1280x720)']"));
			secondRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Front camera third video resolution: VGA(640x480)");
			System.out.println("Select Front camera third video resolution: VGA(640x480)");
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@text='VGA(640x480)']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 3rd resolution
			logger.info("Select Front camera fourth video resolution: CIF(352x288)");
			System.out.println("Select Front camera fourth video resolution: CIF(352x288)");
			MobileElement FourthRes = driver.findElement(By.xpath("//*[@text='CIF(352x288)']"));
			FourthRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("recordingDurationfront3 = "+ recordingDurationfront3 +" Seconds");
