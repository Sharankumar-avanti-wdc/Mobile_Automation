...
import Samsung_GalaxyNote20_Ultra5G.Test10;
			...
			public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
				...
				TimeUnit.SECONDS.sleep(5);	
		  		...
		  		//Select 1st resolution
		  			logger.info("Select rear camera first Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
		  			System.out.println("Select rear camera first Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
			  	...
			  	// Load properties file
					...
					//Start Recording
		  			...
		  			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[555,110][699,254]']"));
		  			SecondRes.click();
			  		TimeUnit.SECONDS.sleep(2);
			  	...
			  	//Click On Rear Video size to select resolution
		  			...
		  			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[729,110][873,254]']"));
		  			ThirdRes.click();
			  		TimeUnit.SECONDS.sleep(2);
			  	...
			  	//Click On Rear Video size to select resolution
		  			...
		  			logger.info("Select rear camera fourth Video Resolution: BACK_CAMCORDER_RESOLUTION_FHD_60");
		  			System.out.println("Select rear camera fourth Video Resolution: BACK_CAMCORDER_RESOLUTION_FHD_60");
		  			//Select 3rd resolution
		  			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[555,110][699,254]']"));
		  			FourthRes.click();
			  		TimeUnit.SECONDS.sleep(2);
			  	...
			  	//Start Recording
			  		...
			  		MobileElement RearVideoSize4 = driver.findElement(By.xpath("//*[@text='Rear camera video size']"));
		  			RearVideoSize4.click();
		  			logger.info("Select rear camera Fifth Video Resolution: BACK_CAMCORDER_RESOLUTION_FHD_60");
		  			System.out.println("Select rear camera fifth Video Resolution: BACK_CAMCORDER_RESOLUTION_FHD_60");
		  			//Select 3rd resolution
		  			MobileElement FifthRes = driver.findElement(By.xpath("//*[@bounds='[729,110][873,254]']"));
		  			FifthRes.click();
			  		TimeUnit.SECONDS.sleep(2);
			  		...
			  		System.out.println("recordingDurationRearr = "+ recordingDurationRear4+" Seconds");
			  		int recordingDurationRear4Int=Integer.parseInt(recordingDurationRear4);
			  		
			  	//Start Recording
			  		logger.info("Start rear video recording");
			  		System.out.println("Start rear video recording");
			  		MobileElement StartRecording4 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/normal_center_button']"));
			  		...
			  		logger.info("Stop Recording");
			  		System.out.println("Stop Recording");
			  		MobileElement StopRecording4 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/stop_button']"));
			  	...
			  	//Select sixth resolution
			  		...
			  		MobileElement RearVideoSize5 = driver.findElement(By.xpath("//*[@text='Rear camera video size']"));
		  			RearVideoSize5.click();
		  			logger.info("Select rear camera sixth Video Resolution: BACK_CAMCORDER_RESOLUTION_HD_60");
		  			System.out.println("Select rear camera sixth Video Resolution: BACK_CAMCORDER_RESOLUTION_HD_60");
		  			//Select 3rd resolution
		  			MobileElement SixthRes = driver.findElement(By.xpath("//*[@bounds='[903,110][1047,254]']"));
		  			SixthRes.click();
			  		TimeUnit.SECONDS.sleep(2);
			  	...
			  	//Start Recording
			  		logger.info("Start rear video recording");
			  		System.out.println("Start rear video recording");
			  		MobileElement StartRecording5 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/normal_center_button']"));
			  		...
			  		logger.info("Stop Recording");
			  		System.out.println("Stop Recording");
			  		MobileElement StopRecording5 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/stop_button']"));
