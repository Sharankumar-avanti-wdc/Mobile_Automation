...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//MobileElement RearImage = driver.findElement(By.xpath("//*[@bounds='[472,90][542,160]']"));
			//RearImage.click();
			//Select first resolution
			//Click On Rear Image Resolution to select first resolution
			//logger.info("Select Rear Image Size");
			//System.out.println("Select Rear Image Size");
			//MobileElement Res1 = driver.findElement(By.xpath("//*[@bounds='[78,84][162,166]']"));
			//Res1.click();
			...
			//	MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[132,120][252,240]']"));
			//FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Rear camera :" + j + " images Captured succesfull");
			System.out.println("Rear camera :" + j + " images Captured succesfull" );
			...
			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[198,84][282,166]']"));
			SecRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[480,120][600,240]']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(6);
			...
			MobileElement FifthRes = driver.findElement(By.xpath("//*[@bounds='[828,120][948,240]']"));
			FifthRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			Result ="Pass";
			//Launch File manager
			logger.info("Launch file manager application and verify captures images present  in uSD Card");
