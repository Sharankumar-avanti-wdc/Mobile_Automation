...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Stop recording
			MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[412,1912][668,2168]']"));
			...
			System.out.println("click setting option to select Thirdhighest video resolution");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Select Video Resolution FHD 1080 fps
			logger.info("Select Third highest resolution: FHD 1080p, 60fps");
			System.out.println("Select Third highest resolution: FHD 1080p, 60fps");
