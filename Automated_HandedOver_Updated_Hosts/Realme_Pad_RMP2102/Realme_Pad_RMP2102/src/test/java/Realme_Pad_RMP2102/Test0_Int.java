...
public class Test0_Int {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			//logger.info("Host require physical restart after internal mount. Hence skipping format as internal mount, image capture,video recording and format with data scenario");
			//System.out.println("Host require physical restart after internal mount. Hence skipping format as internal mount, image capture,video recording and format with data scenario");
			//logger.info("Final Message: Pass Test0_Int pass for Clear recent apps and clear internal memory");
			//System.out.println("Final Message: Pass Test0_Int pass for Clear recent apps and clear internal memory");
	...
	public void FormatAsInternal() throws  IOException, InterruptedException {
		...
		try {
			...
			{
				logger.info("No-Move content option found");
				System.out.println("No-Move content option found");
			}
			//click Done option
	...
	public void Video() throws  IOException, InterruptedException {
		...
		MobileElement Videosize = driver.findElement(By.xpath("//*[@text='Video aspect ratio (Rear camera)']"));
		Videosize.click();
		TimeUnit.SECONDS.sleep(5);
		...
		logger.info("Select settings option");
		System.out.println("Select settings option");
		MobileElement Setting2 = driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/mode']"));
		Setting2.click();
		TimeUnit.SECONDS.sleep(5);
		...
		logger.info("Select Video size(Back camera) option");
		System.out.println("Select Video size(Back camera) option");
		MobileElement Videosize1 = driver.findElement(By.xpath("//*[@text='Video aspect ratio (Rear camera)']"));
		Videosize1.click();
		TimeUnit.SECONDS.sleep(5);
	...
	public void FormatASInternal() throws  IOException, InterruptedException  {	
		...
		try {
			...
			logger.info("Fail: Images and videos are  present in the DCIM folder, Host does not format with data for internal mount scenario ");
			System.out.println("Fail: Images and videos are  present in the DCIM folder, Host does not format with data for internal mount scenario ");
			logger.info("Final Message: Fail Test0_Int Fail for format with data scenario");
			System.out.println("Final Message: Fail Test0_Int Fail for format with data scenario");
			logger.info("Test: End");
			System.out.println("Test: End");
