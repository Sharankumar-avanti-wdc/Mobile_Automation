...
import io.appium.java_client.touch.offset.PointOption;
  ...
  public class Test8
  {
	  ...
	  AppiumDriver<MobileElement> driver;
		...
		public void recordAudio() throws InterruptedException, SecurityException, IOException {
			...
			logger.info("Stop Recording");
	  		...
	  		TimeUnit.SECONDS.sleep(2);
	  		//launch file manager application and verify recorded audio file present in uSD card
  		...
  		logger.info("Switch list view mode ");
		System.out.println("Switch list view mode ");
		driver.findElement(By.id("com.sec.android.app.myfiles:id/menu_toggle_list_type")).click();
		TimeUnit.SECONDS.sleep(5);	
  		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
  		TimeUnit.SECONDS.sleep(2);
	 	...
	 	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
	  	...
	  	//Launch File Manager application for recorded audio file playBack
			...
			logger.info("Playing recorded audio file");
	  		System.out.println("Playing recorded audio file");
			try
	  		{
  			...
  			TimeUnit.SECONDS.sleep(30);
  			//fast forward audio playback for 10 seconds
  			logger.info("fast forward playing audio file for 10 Seconds duration");
	  		System.out.println("fast forward playing audio file for 10 Seconds duration");
	  		
	  		TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(555, 1794)).perform();
	...
	java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
			...
			TimeUnit.SECONDS.sleep(5);
			System.out.println("select first mp3/audio file for playback and fast forward scenario");
			logger.info("select first mp3/audio file for playback and fast forward scenario");
			//Click 1st File to Play Video
			try {
			...
			System.out.println("Pass: First audio Play back is Successfull ");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("select second audio/mp3 file for playback and fast forward scenario");
			System.out.println("select second audio/mp3 file for playback and fast forward scenario");
			//Click 1st File to Play Video
			try {
			...
			Pause.click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Pass: Second Audio Play back is Successfull ");
			System.out.println("Pass: Second Audio Play back is Successfull ");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("select third audio/mp3 file for playback and fast forward scenario");
			System.out.println("select third audio/mp3 file for playback and fast forward scenario");
			//Click 1st File to Play Video
			try
			{
			...
			logger.info("Pass: Third Audio Play back is Successfull ");
			System.out.println("Pass: Third Audio Play back is Successfull ");
			}
			catch (Exception e) {
	            logger.info("Fail: Test8 Fail for Copied audio file playback,fast forward scenario");
			...
			TimeUnit.SECONDS.sleep(2);
	            ...
	            logger.info("Fail: Test8 Fail for Copied audio file playback,fast forward scenario");
	            System.out.println("Fail: Test8 Fail for Copied audio file playback,fast forward scenario");
	            logger.info("Final Message: Fail Test8 Fail for copied audio play back and fast forward scenario");
	            System.out.println("Final Message: Fail Test8 Fail for copied audio play back and fast forward scenario");
	            logger.info("Test: End");
				System.out.println("Test: End");
				logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		   		 System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
