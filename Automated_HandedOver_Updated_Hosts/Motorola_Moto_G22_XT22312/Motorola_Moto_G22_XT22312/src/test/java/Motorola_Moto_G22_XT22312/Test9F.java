...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement FrontPhotoSize = driver.findElement(By.xpath("//*[@text='Front photo resolution']"));
			FrontPhotoSize.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 1st photo resolution
			logger.info("Select front camera resolution: Recommended: 16MP");
			System.out.println("Select front camera resolution: Recommended: 16MP");
			driver.findElement(By.xpath("//*[@text='Recommended: 16MP']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select photo resolution option");
			System.out.println("select photo resolution option");
			MobileElement FrontPhotoSize1 = driver.findElement(By.xpath("//*[@text='Front photo resolution']"));
			FrontPhotoSize1.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 2nd photo resolution
			logger.info("Select front camera resolution: 12.6MP");
			System.out.println("Select front camera resolution: 12.6MP");
			driver.findElement(By.xpath("//*[@text='12.6MP']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
