...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[412,1916][668,2166]']"));
			StopRecording.click();
			...
			//Stop recording
			MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[412,1916][668,2166]']"));
			...
			logger.info("Select Third video resolution: FHD 1080p, 60fps");
			System.out.println("Select Third video resolution: FHD 1080p, 60fps");
			...
			logger.info("Stop video recording");
			System.out.println("Stop video recording");
			MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@bounds='[412,1916][668,2166]']"));
			...
			logger.info("Select Fourth  video resolution: UHD 4K, 30fps");
			System.out.println("Select Fourth  video resolution: UHD 4K, 30fps");
			...
			logger.info("Stop video recording");
			System.out.println("Stop video recording");
			MobileElement StopRecording3 = driver.findElement(By.xpath("//*[@bounds='[412,1916][668,2166]']"));
