...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[405,465][519,579]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("1st resolution selected 4:3");
			driver.findElement(By.xpath("//*[@bounds='[480,804][600,858]']")).click();
			TimeUnit.SECONDS.sleep(2);
			...
			driver.findElement(By.xpath("//*[@bounds='[567,465][681,579]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("2nd resolution selected 1:1");
			driver.findElement(By.xpath("//*[@bounds='[480,804][600,858]']")).click();
			TimeUnit.SECONDS.sleep(2);
			...
			// capture  pics for the selected resolution
			int j1=1;
			for( j1 = 0; j1 < totalPictureCountRearInt; j1++) 
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.id("com.oppo.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Back camera 2nd resolution: " + j1 + " images Captured succesfull");
			System.out.println("Back camera 2nd resolution: " + j1 + " images Captured succesfull" );
			...
			driver.findElement(By.xpath("//*[@bounds='[729,465][843,579]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("3rd resolution selected Full");
			driver.findElement(By.xpath("//*[@bounds='[480,804][600,858]']")).click();
			TimeUnit.SECONDS.sleep(2);
			...
			// capture  pics for the selected resolution
			int j2=0;
			for( j2 = 0; j2 < totalPictureCountRearInt; j2++) 
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.id("com.oppo.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(5);
			logger.info("Back camera 3rd resolution: " + j2 + " images Captured succesfull");
			System.out.println("Back camera 3rd resolution: " + j2 + " images Captured succesfull" );
			//click on camera resolutions
			logger.info("Select  Image Resoution");
			System.out.println("Select Image Resoution");
			driver.findElement(By.xpath("//*[@bounds='[480,240][600,294]']")).click();
			...
			driver.findElement(By.xpath("//*[@bounds='[891,465][1005,579]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("4th resolution selected16:9");
			driver.findElement(By.xpath("//*[@bounds='[480,804][600,858]']")).click();
			TimeUnit.SECONDS.sleep(2);
			...
			// capture  pics for the selected resolution
			int j3=0;
			for( j3 = 0; j3 < totalPictureCountRearInt; j3++) 
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.id("com.oppo.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 4th Resolutions ultra 16:9: "+j3);
				logger.info("clicking Image of 4th Resolutions ultra 16:9: "+j3);
