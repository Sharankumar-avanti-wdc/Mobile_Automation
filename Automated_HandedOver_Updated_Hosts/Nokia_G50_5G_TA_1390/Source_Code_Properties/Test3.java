...
import Nokia_G50_5G_TA_1390.Test3;
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
      ...
      logger.info("1.Mount,Unmount uSD Card and Format uSD card for specified number of times");
		...
		try {
			...
			TimeUnit.SECONDS.sleep(5);
			//Select Eject SD Card option
			logger.info("Select Eject SD card option");
			System.out.println("Select Eject SD card option");
			driver.findElement(By.xpath("//*[@bounds='Eject']")).click();
			...
			//Accpet Mount pop-up option
			logger.info("Accept mount pop-up option");
			System.out.println("Accept mount pop-up option");
			driver.findElement(By.xpath("//*[@text='MOUNT']")).click();
			TimeUnit.SECONDS.sleep(10);
			logger.info("Unmount,Mount uSD scneario is successfull");
			System.out.println("Unmount,Mount uSD scneario is successfull");
			//select Sandisk SD card option
			logger.info("Select Sandisk Sd card option");
			System.out.println("Select Sandisk Sd card option");
			driver.findElement(By.xpath("//*[@bounds='[126,675][220,713]']")).click();
