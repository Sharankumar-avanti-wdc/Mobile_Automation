package Xiaomi_11i_HyperCharge_21091116UI;
...
import Xiaomi_11i_HyperCharge_21091116UI.Test0;
...
public class Test10F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Xiaomi 11i HyperCharge");
		dc.setCapability(MobileCapabilityType.UDID, "ukx8vgxodeu455ei");
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		{
			//Click Allow pop-up
			logger.info("accept appium permission access pop-up");
			System.out.println("accept appium permission access pop-up");
		...
		try {
			...
			{ 
				//Click Deny Option
				logger.info("If location permission pop-up exists select deny  option");
				System.out.println("If location permission pop-up exists select deny  option");
			...
			logger.info("Select first highest  video resolution FHD 1080p, 60fps,");
			System.out.println("Select first highest video resolution FHD 1080p, 60fps,");
			...
			logger.info("click setting option to select second highest video resolution FHD 1080p, 30fps");
			System.out.println("click setting option to select second highest video resolution FHD 1080p, 30fps");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			TimeUnit.SECONDS.sleep(3);
			//Select Video Resolution FHD 1080 fps
			logger.info("Select second video resolution FHD 1080p, 30fps");
			System.out.println("Select second video resolution FHD 1080p, 30fps");
			...
			//click Back to settings option
			logger.info("click setting option to select third highest video resolution FHD 1080p, 30fps");
			System.out.println("click setting option to select third highest video resolution FHD 1080p, 30fps");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			TimeUnit.SECONDS.sleep(3);
			//Select Video Resolution FHD 1080 fps
			...
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
			TimeUnit.SECONDS.sleep(2);
			//Calling videoPlayBackSleepWake() for recorded front camera video playback from external storage,Pause,Lock and unlock phone with 30 seconds delay.
