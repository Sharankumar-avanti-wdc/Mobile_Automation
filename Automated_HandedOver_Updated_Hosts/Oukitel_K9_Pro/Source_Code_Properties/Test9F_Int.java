...
import Oukitel_K9_Pro.Test9F_Int;
...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select front camera front image resolution: 3264x2448");
			System.out.println("Select front camera front image resolution: 3264x2448");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select front camera second image resolution: 2560x1920");
			System.out.println("Select front camera second image resolution: 2560x1920");
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select front camera third image resolution: 1440x1080");
			System.out.println("Select front camera third image resolution: 1440x1080");
			driver.findElement(By.xpath("//*[@text='1440x1080']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select front camera fourth image resolution: 3968x1984");
			System.out.println("Select front camera fourth image resolution: 3968x1984");
			driver.findElement(By.xpath("//*[@text='3968x1984']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
