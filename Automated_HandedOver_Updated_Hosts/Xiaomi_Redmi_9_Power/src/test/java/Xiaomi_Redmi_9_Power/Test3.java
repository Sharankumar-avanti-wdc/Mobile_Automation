...
public class Test3 {
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Redmi 9 Power");
		dc.setCapability(MobileCapabilityType.UDID, "e5f141d11220");
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("1.Format uSD card for specified number of times and verify data format");
		logger.info("2.Host does not support  mount,unmount uSD card");
		logger.info("Setting up the appium desired capabilities");
		System.out.println("Test3 Scenario is as follows");
		System.out.println("1.Format uSD card for specified number of times and verify data format");
		logger.info("2.Host does not support  mount,unmount uSD card");
		...
		try {
			...
			{ 
				...
				logger.info("Host does not support  mount,unmount uSD card");
				System.out.println("Host does not support  mount,unmount uSD card");
