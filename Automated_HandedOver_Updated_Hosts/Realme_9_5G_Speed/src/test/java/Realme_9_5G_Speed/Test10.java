...
public class Test10
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "realme 9 5G Speed Edition");
		dc.setCapability(MobileCapabilityType.UDID, "1eabf3ae");
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				//Click Deny Option
				logger.info("Clicking deny option");
				System.out.println("Clicking deny option");
				driver.findElement(By.xpath("//*[@resource-id='com.android.permissioncontroller:id/permission_deny_button']")).click();
				TimeUnit.SECONDS.sleep(3);
				//Click Ok option
				logger.info("Clicking ok option");
				System.out.println("Clicking ok option");
			...
			//back camera supports 5 video resolutions
			...
			touchAction.tap(PointOption.point(323, 1775)).perform();
			TimeUnit.SECONDS.sleep(5);
			//Click On Settings
			...
			logger.info("Search for settings option");
			System.out.println("Search for settings option");
			driver.findElement(By.xpath("//*[@bounds='[0,792][1080,948]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			try {
				...
				((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Turn on \"Save to SD card\"?\")").click();
				TimeUnit.SECONDS.sleep(5);
			...
			MobileElement VideoResolution = driver.findElement(By.xpath("//*[@bounds='[480,240][600,294]']"));
			VideoResolution.click();
			logger.info("Select 1st Back Video Resolution: 1080P(60fps)");
			System.out.println("Select 1st Back Video Resolution: 1080P(60fps)");
			//Select 1st resolution
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[729,465][843,579]']"));
			FirstRes.click();
			MobileElement fps60 = driver.findElement(By.xpath("//*[@bounds='[656,654][819,738]']"));
			fps60.click();
			...
			//2nd resolution
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution1 = driver.findElement(By.xpath("//*[@bounds='[480,240][600,294]']"));
			VideoResolution1.click();
			logger.info("Select 2nd Back Video Resolution: 1080P(30fps)");
			System.out.println("Select 2nd Back Video Resolution:  1080P(30fps)");
			//Select 2nd resolution
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[867,654][1030,738]']"));
			SecondRes.click();
			...
			//3rd resolution
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution2 = driver.findElement(By.xpath("//*[@bounds='[480,240][600,294]']"));
			VideoResolution2.click();
			logger.info("Select 3rd Back Video Resolution: 720P(60fps)");
			System.out.println("Select 3rd Back Video Resolution: 720P(60fps)");
			//Select 3rd resolution
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[891,465][1005,579]']"));
			ThirdRes.click();
			MobileElement fps601 = driver.findElement(By.xpath("//*[@bounds='[656,654][819,738]']"));
			fps601.click();
			...
			//24th resolution
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution3 = driver.findElement(By.xpath("//*[@bounds='[480,240][600,294]']"));
			VideoResolution3.click();
			logger.info("Select 4th Back Video Resolution: 720P(30fps)");
			System.out.println("Select 4th Back Video Resolution:  720P(30fps)");
			//Select 4th resolution
			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[867,654][1030,738]']"));
			FourthRes.click();
			TimeUnit.SECONDS.sleep(4);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording3 = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Video Recording Button\"]"));
			...
			//5th resolution
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution4 = driver.findElement(By.xpath("//*[@bounds='[480,240][600,294]']"));
			VideoResolution4.click();
			//Select 5th resolution
			logger.info("Select 5th Back Video Resolution: 4K");
			System.out.println("Select 5th Back Video Resolution:  4K");
			MobileElement FifthRes = driver.findElement(By.xpath("//*[@bounds='[867,654][1030,738]']"));
			FifthRes.click();
			TimeUnit.SECONDS.sleep(4);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording4 = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Video Recording Button\"]"));
			...
			touchAction1.tap(PointOption.point(749, 1780)).perform();
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			logger.info("Test10_Bcam_video: 5 Videos captured successfull");
			System.out.println("Test10_Bcam_video: 5 Videos captured successfull");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Click on first file to play highest recorded resolution video file from external stortage");
	...
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("switch to grid view mode and select test1  folder");
			System.out.println("switch to grid view mode and select test1 folder");
