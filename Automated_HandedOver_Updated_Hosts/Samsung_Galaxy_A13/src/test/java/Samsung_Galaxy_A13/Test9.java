...
import Samsung_Galaxy_A13.Test9;
...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Test9_Bcam_Image: 5 resolutions supported");
			System.out.println("Test9_Bcam_Image: 5 resolutions supported");
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Back camera first resolution:" + j1 + " images Captured succesfull");
			System.out.println("Back camera first resolution:" + j1 + " images Captured succesfull" );
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Back camera first resolution:" + j2 + " images Captured succesfull");
			System.out.println("Back camera first resolution:" + j2 + " images Captured succesfull" );
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Back camera first resolution:" + j3 + " images Captured succesfull");
			System.out.println("Back camera first resolution:" + j3 + " images Captured succesfull" );
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Back camera first resolution:" + j4 + " images Captured succesfull");
			System.out.println("Back camera first resolution:" + j4 + " images Captured succesfull" );
