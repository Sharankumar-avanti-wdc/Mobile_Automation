...
import Motorola_Moto_G_Stylus_2022.Test3;
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				try {
					driver.findElement(By.xpath("//*[@bounds='[660,231][692,263]']")).click();
					TimeUnit.SECONDS.sleep(5);
				}
				catch (Exception e) {
				...
				TimeUnit.SECONDS.sleep(5);
				//click on unmount
				logger.info("Clicking on unmount");
				System.out.println("Clicking on unmount");
				MobileElement  unmount =	driver.findElement(By.xpath("//*[@resource-id='com.android.settings:id/unmount']"));
				unmount.click();
				TimeUnit.SECONDS.sleep(15);
				((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Ejected\")").click();
