...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("1.Launch mobile default voice recording application and set Internal storage storage option, record audio file for 2 minutes duration");
		...
		System.out.println("1.Launch mobile default voice recording application and set Internal storage storage option, record audio file for 2 minutes duration");
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[539,1384][660,1459]']")).click();
			...
			MobileElement location =	driver.findElement(By.xpath("//*[@resource-id='com.media.bestrecorder.audiorecorder:id/location_path']"));
			location.click();
			TimeUnit.SECONDS.sleep(5);
			//Select Storage location
			logger.info("Select Internal storage");
			System.out.println("Select Internal storage");
			MobileElement location1 =	driver.findElement(By.xpath("//*[@bounds='[108,140][680,221]']"));
			location1.click();
			try {
				//Select uInternal storage
			...
			logger.info("Pass: Test8_Int pass for audio recording in uInternal storage");
			System.out.println("Pass: Test8_Int pass for audio recording in uInternal storage");
			...
			logger.info("Fail: Test8_Int Fail for audio recording in uInternal storage");
			logger.info("Final Message: Fail Test8_Int Fail for audio recording in uInternal storage");
			System.out.println("Fail: Test8_Int Fail for audio recording in uInternal storage");
			System.out.println("Final Message: Fail Test8_Int Fail for audio recording in uInternal storage");
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(229, 1174)).perform();
			TimeUnit.SECONDS.sleep(20);
			//clikc Pause button
