...
public class Test0 {
	...
	public void Images() throws  IOException, InterruptedException {
		...
		//Capture Images
		logger.info("Capture 25 Images of Default Resolution");
		System.out.println("Capture 25 Images of Default Resolution");
		for(int j = 0; j < 25; j++) 
		{ 
			TimeUnit.SECONDS.sleep(2);
			driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc=\"Take picture\"]")).click();
	...
	public void Video() throws  IOException, InterruptedException {
		...
		RearVideoSize.click();
		logger.info("Select 1st Back Video Resolution:Rear camera video size, UHD (30 fps)");
		System.out.println("Select 1st Back Video Resolution:Rear camera video size, UHD (30 fps)");
		...
		MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[540,2024][744,2175]']"));
		StopRecording.click();
		TimeUnit.SECONDS.sleep(5);
		//Click On Rear Video size to select resolution
		MobileElement RearVideoSize1 = driver.findElement(By.xpath("//*[@text='Video size']"));
		RearVideoSize1.click();
		logger.info("Select 2nd Rear camera video size, FHD (60 fps)");
		System.out.println("Select 2nd Rear camera video size, FHD (60 fps)");
		//Select 2nd resolution
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[393,120][513,240]']"));
		SecondRes.click();
		TimeUnit.SECONDS.sleep(5);
		//Start Recording
		logger.info("Start video recording");
		...
		logger.info("Stop video recording");
		System.out.println("Stop video recording");
		MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[540,2024][744,2175]']"));
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		try {
			...
			logger.info("Clicking on slide button");
			System.out.println("Clicking on slide button");
			driver.findElement(By.xpath("//*[@bounds='[542,1707][590,1755]']")).click();
			TimeUnit.SECONDS.sleep(5);
			//find element by xpath
			...
			TimeUnit.SECONDS.sleep(5);
			// click on format
			logger.info("Click on again Format");
			System.out.println("Click on again Format");
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Format\")").click();
			// wait for 2 mins
