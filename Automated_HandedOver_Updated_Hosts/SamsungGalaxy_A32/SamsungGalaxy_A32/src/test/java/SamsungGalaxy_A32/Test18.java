...
public class Test18
{
	...
	public void CopyPaste() throws InterruptedException, IOException {
		...
		logger.info("Pushing File to Host Internal Memory via server folder named as Test1");
		logger.info("Launch file manager application extract zip from Internal storage");
		logger.info("Copy Paste 1GB file (Test1) from host internal memory to uSD Card, Create a folder named Test2 in uSD Card, Copy paste 1GB Folder(Test1) From internal to external inside folder Test2 and Vice versa");
		logger.info("Create folder name(New_Scenario in External memory, select folder name(Test2) from internal memory and perform cut paste operation from internla to external memory");
		logger.info("Setting up the appium desired capabilities");
		logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		System.out.println("Test18 Scenario is as follows");
		System.out.println("Pushing File to Host Internal Memory via server folder named as Test1");
		System.out.println("Launch file manager application extract zip from Internal storage");
		...
		logger.info("Clicking Recent Apps");
		System.out.println("Clicking Recent Apps");
		...
		//((PushesFiles) driver).pushFile("/storage/emulated/0/Test1/test_file.zip",new File ("C:\Users\7340193\Desktop\TestDlinkAll1_183750\Test.zip"));
		...
		try {
			...
			MobileElement Finished = driver.findElement(By.xpath("//*[@text='Finished']")); 
			Finished.click();
