...
cd C:\Users\7336135\Android11\eclipse-workspace\Xiaomi_POCO_M3_Pro_5G
mvn -DtotalPictureCountFront=1 -DtotalPictureCountFront1=1 -DtotalPictureCountFront2=1 -DtotalPictureCountFront3=1 -DTolerance_Level=%Tolerance_Level%  -DfileName=testng9F.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\ABC\Xiaomi_Redmi10_Prime_%mydate%_%mytime%_%Qual_Capacity%.txt
