...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("3.Move front camera recorded videos from external storage to Test10 folder in external storage");
		...
		try {
			...
			System.out.println("Select thirg resolution");
