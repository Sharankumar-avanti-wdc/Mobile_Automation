...
import Samsung_Galaxy_A21s.Test9F;
...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//*[@bounds='[507,1358][607,1448]']"));
			TimeUnit.SECONDS.sleep(2);
			...
			driver.findElement(By.xpath("//*[@bounds='[507,1358][607,1448]']")).click();
			TimeUnit.SECONDS.sleep(5);
