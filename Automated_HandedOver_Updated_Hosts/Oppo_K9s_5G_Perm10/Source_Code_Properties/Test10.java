...
public class Test10
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "OPPO K9s 5G");
		dc.setCapability(MobileCapabilityType.UDID, "29527758");
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			touchAction.tap(PointOption.point(313, 1780)).perform();
			TimeUnit.SECONDS.sleep(5);
			//Click On Settings
			logger.info("Select settings option");
			System.out.println("Select settings option");
			driver.findElement(By.xpath("//*[@bounds='[887,0][1004,240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Select settings1 option");
			driver.findElement(By.xpath("//*[@bounds='[930,712][1026,808]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			//Click On Settings
			logger.info("Select  camera settings option");
			System.out.println("Select camera settings option");
			driver.findElement(By.xpath("//*[@bounds='[887,0][1004,240]']")).click();
			TimeUnit.SECONDS.sleep(2);
			logger.info("Select 1st Back Video Resolution:1080p");
			System.out.println("Select 1st Back Video Resolution: 1080p");
			//Select 1st resolution
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[741,303][855,417]']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			driver.findElement(By.xpath("//*[@bounds='[480,839][600,893]']")).click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[891,303][1005,417]']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			driver.findElement(By.xpath("//*[@bounds='[480,839][600,893]']")).click();
			TimeUnit.SECONDS.sleep(2);
			...
			//Select 2nd resolution
			MobileElement thirdres = driver.findElement(By.xpath("//*[@bounds='[591,303][705,417]']"));
			thirdres.click();
			TimeUnit.SECONDS.sleep(2);
			driver.findElement(By.xpath("//*[@bounds='[480,839][600,893]']")).click();
			TimeUnit.SECONDS.sleep(2);
			...
			touchAction.tap(PointOption.point(751, 1777)).perform();
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
	...
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		...
		try {
			...
			try {
				...
				//Tap Somewhere on Screen for contents to visible on Screen
				logger.info("Tap Somewhere on Screen for contents to visible on Screen");
				System.err.println("Tap Somewhere on Screen for contents to visible on Screen");
				driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/video_player']")).click();
