  ...
  public class Test10
  {
	...
	private boolean isPaused;
		...
		public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
	        ...
	        System.out.println("4.Move recorded rear camera videos from uSD card to Test10 folder in uSD card");
		 ...
		 // Load properties file
	  	...
	  	//launch file manager application and verify recorded video files in uSD card
			...
			TimeUnit.SECONDS.sleep(5);
			TotalFiles.click();
			logger.info("Test10_Bcam_video: 1 Videos captured successfull");
			System.out.println("Test10_Bcam_video: 1 Videos captured successfull");
