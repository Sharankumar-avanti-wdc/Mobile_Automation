...
public class Test10F_Int
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[21,96][62,125]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[21,195][53,224]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			//Select 2nd resolution 
			//Selecting 2nd Highest resolution
			driver.findElement(By.xpath("//*[@bounds='[21,294][76,323]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Selecting 3rd resolution QVGA");
			System.out.println("Selecting 3rd resolution QVGA");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			prop.load(Test10F_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			//Select 2nd resolution 
			//Selecting 2nd Highest resolution
			driver.findElement(By.xpath("//*[@bounds='[21,393][67,422]']")).click();
			TimeUnit.SECONDS.sleep(3);
