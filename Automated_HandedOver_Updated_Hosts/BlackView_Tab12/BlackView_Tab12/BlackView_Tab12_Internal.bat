...
cd C:\Users\7336135\Android11\eclipse-workspace\BlackView_Tab12
mvn -DmountUnmountCycle=1 -DfileName=testng3_Int.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\TEST\Blackview_Tab12_%mydate%_%mytime%_%Qual_Capacity%.txt
