...
import SamsungGalaxy_M02s.Test10;
...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Switch to front camera\"]"));
			TimeUnit.SECONDS.sleep(5);
			...
			// click on video tab
			TimeUnit.SECONDS.sleep(5);
			driver.findElement(By.xpath("//android.widget.TextView[@content-desc=\"VIDEO\"]")).click();
			TimeUnit.SECONDS.sleep(5);
			//Click On Settings
			//find element by xpath
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Settings = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Go to Settings\"]"));
			TimeUnit.SECONDS.sleep(5);
			Settings.click();
			...
			MobileElement FrontVideoResolution = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/videoQuality_switcher']"));
			FrontVideoResolution.click();
			//Select 1st resolution
			logger.info("Select 1st Front Video Resolution:FRONT_CAMCORDER_RESOLUTION_UHD_60");
			System.out.println("Select 1st Front Video Resolution:FRONT_CAMCORDER_RESOLUTION_UHD_60");
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[245,90][315,160]']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement StartRecording = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.FrameLayout"));
			StartRecording.click();
			TimeUnit.SECONDS.sleep(recordingDurationFrontInt);
			//Stop Recording
			logger.info("Stop front video recording");
			System.out.println("Stop front video recording");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			//MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[292,1338][428,1471]']"));
			//StopRecording.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement FrontVideoResolution1 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/videoQuality_switcher']"));
			...
			//MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[405,90][475,160]']"));
			//SecRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start front video recording");
			System.out.println("Start front video recodring");
			MobileElement StartRecording1 = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.FrameLayout"));
			...
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			//MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[292,1338][428,1471]']"));
			...
			MobileElement SwitchTobackCamera = driver.findElement(By.xpath("//*[@text='PHOTO']"));
			TimeUnit.SECONDS.sleep(2);
