...
import Samsung_Galaxy_M13_5G_SM_M136BDS.Test10;
...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select First Rear camera video size, HD (30 fps)");
			System.out.println("Select First Rear camera video size, HD (30 fps) ");
			...
			driver.findElement(By.xpath("//*[@bounds='[294,1294][426,1426]']")).click();
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			logger.info("Select Rear Video size");
			System.out.println("Select Rear Video size");
			...
			logger.info("Select second Rear camera video size, FHD (30 fps)");
			System.out.println("Select second Rear camera video size, FHD (30 fps)");
