...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			TimeUnit.SECONDS.sleep(5);
			logger.info("Pass: Test8_Int Pass for clearing Recent apps ");
			System.out.println("Pass: Test8_Int Pass for clearing Recent apps ");
		}
		catch (Exception e) {
			e.printStackTrace();
		...
		try {
			...
			logger.info("Fail: Test8_Int Fail for audio recording in Internal storage");
			logger.info("Final Message: Fail Test8_Int Fail for audio recording in Internal storage");
			System.out.println("Fail: Test8_Int Fail for audio recording in Internal storage");
			System.out.println("Final Message: Fail Test8_Int Fail for audio recording in Internal storage");
