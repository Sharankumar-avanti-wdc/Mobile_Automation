...
public class Test0 {
	...
	public void Video() throws  IOException, InterruptedException {
		...
		driver.findElement(By.xpath("//*[@bounds='[938,132][1062,256]']")).click();
		TimeUnit.SECONDS.sleep(2);

		logger.info("Select 1st rear Video Resolution:1080p");
		System.out.println("Select 1st rear Video Resolution: 1080p");
		//Select 1st resolution
		MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[402,162][678,255]']"));
		FirstRes.click();
		TimeUnit.SECONDS.sleep(3);
		//Start Recording
		...
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[102,162][378,255]']"));
		SecondRes.click();
		TimeUnit.SECONDS.sleep(3);
		//Start Recording
		logger.info("Start video recording");
