...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		System.out.println("1.1Unlock phone, clear recent apps, clear internal memory");
		...
		try {
			...
			MobileElement InternalStorage = driver.findElement(By.xpath("//*[@bounds='[0,596][1080,761]']")); 
			...
			MobileElement SelectAll =	driver.findElement(By.xpath("//*[@bounds='[864,103][1080,255]']"));
			SelectAll.click();
	...
	public void Images() throws  IOException, InterruptedException {
		...
		MobileElement ExternalStorage = driver.findElement(By.xpath("//*[@bounds='[14,794][224,876]']")); 
	...
	public void Video() throws  IOException, InterruptedException {
		...
		MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[412,1916][668,2167]']"));
		StopRecording.click();
		TimeUnit.SECONDS.sleep(5);
		...
		logger.info("Stop video recording");
		System.out.println("Stop video recording");
		MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@bounds='[412,1916][668,2167]']"));
