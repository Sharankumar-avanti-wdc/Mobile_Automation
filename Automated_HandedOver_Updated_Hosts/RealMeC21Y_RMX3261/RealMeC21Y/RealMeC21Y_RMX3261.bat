...
cd C:\Users\7336135\Android11\eclipse-workspace\RealMeC21Y
mvn -DrecordingDurationfrontExt=180 -DrecordingDurationfrontExt1=180 -DrecordingDurationfrontExt2=180  -DfileName=testng10F.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\ABC\RealMeC21Y_RMX3261_%mydate%_%mytime%_%Qual_Capacity%.txt
