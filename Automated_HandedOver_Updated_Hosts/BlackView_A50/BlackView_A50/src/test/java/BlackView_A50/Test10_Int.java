...
import BlackView_A50.Test10_Int;
  	...
  	// Load properties file for video recording duration
		...
		//Start Recording
	  	...
	  	//launch file manager application and verify recorded video files in uSD card
			logger.info("Launch File Manager Application to verify captured videos in interanl mount storage");
			System.out.println("Launch File Manager Application to verify captured videos in interanl mount storage");
