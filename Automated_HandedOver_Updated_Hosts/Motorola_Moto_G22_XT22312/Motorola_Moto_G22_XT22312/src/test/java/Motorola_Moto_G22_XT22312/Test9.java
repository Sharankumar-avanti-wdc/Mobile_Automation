...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement RearPhotoSize = driver.findElement(By.xpath("//*[@text='Rear photo resolution']"));
			RearPhotoSize.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 1st photo resolution
			logger.info("Select first rear camera resolution: High resolution");
			System.out.println("Select first rear camera resolution: High resolution");
			driver.findElement(By.xpath("//*[@text='High resolution']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				TimeUnit.SECONDS.sleep(2);
				//Start image capture
				driver.findElement(By.xpath("//*[@resource-id='com.myos.camera:id/photo_shutter_button_photo']")).click();
				TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select photo resolution option");
			System.out.println("select photo resolution option");
			MobileElement RearPhotoSize1 = driver.findElement(By.xpath("//*[@text='Rear photo resolution']"));
			RearPhotoSize1.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 2nd photo resolution
			logger.info("Select second rear camera resolution: Recommended: 12.5MP (50MP / Quad Pixel)");
			System.out.println("Select second rear camera resolution: Recommended: 12.5MP (50MP / Quad Pixel)");
			driver.findElement(By.xpath("//*[@text='Recommended: 12.5MP (50MP / Quad Pixel)']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select photo resolution option");
			System.out.println("select photo resolution option");
			MobileElement RearPhotoSize2 = driver.findElement(By.xpath("//*[@text='Rear photo resolution']"));
			RearPhotoSize2.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3rd photo resolution
			logger.info("Select second rear camera resolution: Recommended: 8MP (32MP / Quad Pixel)");
			System.out.println("Select second rear camera resolution: Recommended: 8MP (32MP / Quad Pixel)");
			driver.findElement(By.xpath("//*[@text='8MP (32MP / Quad Pixel)']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
