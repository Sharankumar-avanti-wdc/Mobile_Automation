...
mvn -DtotalPictureCountFront=18 -DtotalPictureCountFront1=18 -DtotalPictureCountFront2=18 -DTolerance_Level=%Tolerance_Level%    -DfileName=testng9F.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\ABC\One_Plus_Nord_N10_5G_%mydate%_%mytime%_%Qual_Capacity%.txt
