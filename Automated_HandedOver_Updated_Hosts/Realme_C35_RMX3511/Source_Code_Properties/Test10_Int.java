...
public class Test10_Int
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all back camera rear camera videos create Test10_Int and cut paste all videos in Test10_Int folder");
