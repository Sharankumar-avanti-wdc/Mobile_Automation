...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[30,0][186,240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Select Second back video Resolution:  720P");
			System.out.println("Select Second Back video resolution:  720P");
			driver.findElement(By.xpath("//*[@bounds='[30,0][186,240]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			touchAction1.tap(PointOption.point(774, 1770)).perform();
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
