...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		//select location option
				...
				MobileElement SDCard = driver.findElement(By.xpath("//*[@bounds='[108,259][680,340]']")); 
				SDCard.click();
				TimeUnit.SECONDS.sleep(3);
				//Select SD card 
				//logger.info("Select Default option");
				//System.out.println("Select Default option ");
				//MobileElement Default = driver.findElement(By.xpath("//*[@text='Default']")); 
				//Default.click();
				//TimeUnit.SECONDS.sleep(3);
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			touchAction.tap(PointOption.point(385, 1267)).perform();
