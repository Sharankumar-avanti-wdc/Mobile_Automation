...
public class Test0_Int {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			logger.info("Final Message: Clearing phone internal memory is successfull, Test0_Int,not applicable. Host, When we formatting the card from external to internal card is corrupted in automation.");
			System.out.println("Final Message: Clearing phone internal memory is successfull, Test0_Int,not applicable. Host, When we formatting the card from external to internal card is corrupted in automation.");
