...
cd C:\Users\7336135\Android11\eclipse-workspace\Xiaomi_11i_HyperCharge_21091116UI
mvn   -DfileName=testng8.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\Test\Xiaomi_11i_HyperCharge_21091116UI_%mydate%_%mytime%_%Qual_Capacity%.txt
