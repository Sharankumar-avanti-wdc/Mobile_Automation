...
public class Test8
{
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
		logger.info("Launch file manager application select SD cad for recorded audio file playback scenario");
		System.out.println("Launch file manager application select SD cad for recorded audio file playback scenario");
		...
		try {
			...
			touchAction.tap(PointOption.point(633, 1812)).perform();
