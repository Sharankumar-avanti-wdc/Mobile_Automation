...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first Image Resoution: (4:3) 8 megapixels ");
			System.out.println("Select first Image Resoution: (4:3) 8 megapixels");
			...
			{  
				...
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 1st Resolutions (4:3) 8 megapixels : "+j);
				logger.info("clicking Image of 1st Resolutions (4:3) 8 megapixels: "+j);
			...
			logger.info("Select second Image Resoution: (4:3) 4 megapixels");
			System.out.println("Select second Image Resoution: (4:3) 4 megapixels");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 2nd Resolutions (4:3) 4 megapixels : "+j1);
				logger.info("clicking Image of 2nd Resolutions (4:3) 4 megapixels : "+j1);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first third Resoution:(4:3) 2 megapixels");
			System.out.println("Select third Image Resoution: (4:3) 2 megapixels");
			driver.findElement(By.xpath("//*[@text='(4:3) 2 megapixels']")).click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{  
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions (4:3) 2 megapixels: "+j2);
				logger.info("clicking Image of 3rd Resolutions (4:3) 2 megapixels: "+j2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first 4TH Resoution:(16:9) 6 megapixels");
			System.out.println("Select 4TH Image Resoution: (16:9) 6 megapixels");
			...
			{  
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 4th Resolutions (16:9) 6 megapixels: "+j3);
				logger.info("clicking Image of 4th Resolutions (16:9) 6 megapixels: "+j3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first 5TH Resoution:(16:9) 2 megapixels");
			System.out.println("Select 5th Image Resoution: (16:9) 2 megapixels");
			...
			{  
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 5th Resolutions (16:9) 2 megapixels: "+j4);
				logger.info("clicking Image of 5th Resolutions (16:9) 2 megapixels: "+j4);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first 6TH Resoution:(16:9) 2 megapixels");
