...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@bounds='[539,1288][660,1402]']"));
			Settings.click();
			TimeUnit.SECONDS.sleep(5);
			...
			MobileElement SDcard = driver.findElement(By.xpath("//*[@bounds='[108,143][680,224]']"));
			SDcard.click();
			TimeUnit.SECONDS.sleep(5);
			//Select  Option
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			driver.findElement(By.id("com.google.android.apps.nbu.files:id/play_pause")).click();
			TimeUnit.SECONDS.sleep(3);
