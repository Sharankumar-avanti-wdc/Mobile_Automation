	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
  	...
  	//Switch to rear camera mode if the current existing is front camera mode
		...
		//Select 2nd resolution
			...
			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[392,120][512,240]']"));
			SecRes.click();
			TimeUnit.SECONDS.sleep(2);
		...
		//Click On Rear Video size to select resolution
				...
				//Select 2nd resolution
					logger.info("Select front camera third video resolutio:FRONT_CAMCORDER_RESOLUTION_FHD_30");
					System.out.println("Select front camera third video resolutio:FRONT_CAMCORDER_RESOLUTION_FHD_30");
				...
				//Select 2nd resolution
					logger.info("Select front camera third video resolutio:FRONT_CAMCORDER_RESOLUTION_HD_30");
					System.out.println("Select front camera third video resolutio:FRONT_CAMCORDER_RESOLUTION_HD_30");
