package Samsung_Galaxy_A03_SMA035FD;
...
import Samsung_Galaxy_A03_SMA035FD.Test10;
...
public class Test10
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Galaxy A03");
		dc.setCapability(MobileCapabilityType.UDID, "R9ZT30JQMVY");
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Test10_Bcam_res: 1 resolutions supported");
			System.out.println("Test10_Bcam_res: 1 resolutions supported");
			...
			{ 
				// Block of code to handle errors
				logger.info("Current camera mode is rear camera mode no need switch"); 
				System.out.println("Current camera mode is rear camera mode no need switch"); 
			}
			...
			TimeUnit.SECONDS.sleep(5);
			logger.info("Host rear camera video resolution selection not applicable. host does not support resolution selection during automation do it time limit");
			System.out.println("Host rear camera video resolution selection not applicable. host does not support resolution selection during automation do it time limit");
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/quick_setting_button_image']"));
			Settings.click();
			TimeUnit.SECONDS.sleep(5);	
			...
			TimeUnit.SECONDS.sleep(2);
			 */
			//select frame rate option
			//logger.info("Select Frame rate option");
			//System.out.println("Select Frame rate option");
			//MobileElement Framerate = driver.findElement(By.xpath("//*[@text='Video size']"));
			//Framerate.click();
			//Click On Rear Video size to select resolution
			//	logger.info("Select 9:16 Frame rate");
			//System.out.println("Select 9:16 Frame rate");
			//MobileElement Frame = driver.findElement(By.xpath("//*[@bounds='[178,90][248,160]']"));
			//Frame.click();


			//Select 1st resolution
			//logger.info("Host unable to select video resolutions during automation. !Hence recording only default video resolution");
			//System.out.println("Host unable to select video resolutions during automation. !Hence recording only default video resolution");
			//	MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[217,120][337,240]']"));
			//	FirstRes.click();
			...
			MobileElement StartRecording = driver.findElement(By.xpath("//*[@bounds='[301,1348][417,1464]']"));
			StartRecording.click();
			TimeUnit.SECONDS.sleep(recordingDurationRearInt);
			//Stop Recording
			logger.info("Stop video recording");
			System.out.println("Stop video recording");
			MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[301,1348][417,1464]']"));
			StopRecording.click();
			//Click On Rear Video size to select resolution
			...
			/*	
		  			...
		  			logger.info("Select rear camera second Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
		  			System.out.println("Select rear camera second Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
		  			//MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[392,120][512,240]']"));
		  			//SecondRes.click();
			  		TimeUnit.SECONDS.sleep(2);
			  	...
			  	//select 3rd resolution video
			  //Click On Rear Video size to select resolution
		  		logger.info("Select Rear Video size");
		  		System.out.println("Select Rear Video size");
		  	// RearVideoSize2 = driver.findElement(By.xpath("//*[@text='Video size']"));
	  		...
	  		//	MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[567,120][687,240]']"));
	  		//	ThirdRes.click();
		  	//	TimeUnit.SECONDS.sleep(2);
		  		...
		  		logger.info("Stop video recording");
		  		System.out.println("Stop video recording");
		  		MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@content-desc='Stop recording']"));
		  		StopRecording2.click();
		  	TimeUnit.SECONDS.sleep(15);
		  	//Select rear camera 4th video resolution
	  		logger.info("Select Rear Video size");
	  		System.out.println("Select Rear Video size");
  		...
  		//	RearVideoSize3.click();
  			...
  			logger.info("Select rear camera Fourth Video Resolution:BACK_CAMCORDER_RESOLUTION_HD_30");
  			System.out.println("Select rear camera Fourth Video Resolution:BACK_CAMCORDER_RESOLUTION_HD_30");
  			//MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[742,120][862,240]']"));
  			//FourthRes.click();
	  		TimeUnit.SECONDS.sleep(2);
	  		...
	  		logger.info("Stop video recording");
	  		System.out.println("Stop video recording");
	  		MobileElement StopRecording3 = driver.findElement(By.xpath("//*[@content-desc='Stop recording']"));
	  	...
	  	TimeUnit.SECONDS.sleep(15);
			...
			TimeUnit.SECONDS.sleep(3);
			driver.findElement(By.xpath("//*[@text='1 selected']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
			logger.info("Test10_Bcam_video: 1 video captured successfully");
			System.out.println("Test10_Bcam_video: 1 video captured successfully");
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Playing higest resolution recorded video file from external storage");
			System.out.println("Playing higest resolution recorded video file from external storage");
