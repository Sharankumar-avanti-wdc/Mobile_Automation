...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Test10_Int_Bcam_video: 3 resolutions supported");
			System.out.println("Test10_Int_Bcam_video: 3 resolutions supported");
			//Click On video
			...
			driver.findElement(By.xpath("//*[@bounds='[60,177][180,297]']")).click();
			TimeUnit.SECONDS.sleep(5);
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select 1st rear Video Resolution:1080p");
			System.out.println("Select 1st rear Video Resolution: 1080p");
			//Select 1st resolution
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[48,1718][1032,1892]']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 2nd rear Video Resolution: 720P");
			System.out.println("Select 2nd rear Video Resolution:  720P");
			//Select 2nd resolution
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[48,1892][1032,2066]']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 3rd rear Video Resolution: 2k");
			System.out.println("Select 3rd rear Video Resolution:  2k");
			//Select 2nd resolution
			MobileElement thirdRes = driver.findElement(By.xpath("//*[@bounds='[48,1544][1032,1718]']"));
			thirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
