...
import Oukitel_K9_Pro.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select Rear camera first image resolution: 4160x3120");
			System.out.println("Select Rear camera first image resolution: 4160x3120");
			driver.findElement(By.xpath("//*[@text='4160x3120']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select Rear camera second resolution: 3264x2448");
			System.out.println("Select Rear camera second resolution: 3264x2448");
			driver.findElement(By.xpath("//*[@text='3264x2448']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select rear camera third resolution:2560x1920");
			System.out.println("Select rear camera third resolution:2560x1920");
			driver.findElement(By.xpath("//*[@text='2560x1920']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select Rear camera fourth image resolution 5088x2544");
			System.out.println("Select Rear camera fourth image resolution 5088x2544");
			driver.findElement(By.xpath("//*[@text='5088x2544']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all back camera images create Test9_Int and cut paste all images in Test9_Int folder");
			System.out.println("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all back camera images create Test9_Int and cut paste all images in Test9_Int folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//Swipe and Select external storage
			logger.info("Swipe up to select Internal storage");
