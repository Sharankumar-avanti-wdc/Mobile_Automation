...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
  	...
  	//Switch to front camera mode
  		...
  		{ 
  				// Block of code to handle errors
  			logger.info("Camera is front camera.!Hence no need to switch camera");
  	  		System.out.println("Camera is front camera.!Hence no need to switch camera");
  		}
		...
		MobileElement FrontVideoResolution = driver.findElement(By.xpath("//*[@text='Ratio']"));
		...
		//Select 1st resolution
			...
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[642,104][786,248]']"));
			FirstRes.click();
  		TimeUnit.SECONDS.sleep(2);
		...
		MobileElement FrontVideoResolution1 = driver.findElement(By.xpath("//*[@text='Ratio']"));
		...
		logger.info("Click front video size and select second resolution");
		System.out.println("Click front video size and select second resolution");
		MobileElement FrontVideoResolution2 = driver.findElement(By.xpath("//*[@text='Ratio']"));
		...
		logger.info("Select Third Back Video Resolution: BACK_CAMCORDER_RESOLUTION_FHD_30");
			...
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[294,104][438,248]']"));
			ThirdRes.click();
  		TimeUnit.SECONDS.sleep(2);
