...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try {
				...
				MobileElement Folder =	driver.findElement(By.xpath("//*[@bounds='[39,311][109,381]']"));
	...
	public void Images() throws  IOException, InterruptedException {
		...
		{ 
			...
			logger.info("No location access found: "+exp); 
			System.out.println("No location access found : "+exp); 
		}
	...
	public void Video() throws  IOException, InterruptedException {
		...
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		logger.info("Launch Camera Application to capture rear camera videos");
		System.out.println("Launch Camera Application to capture rear camera videos");
		...
		RearVideoSize.click();
		logger.info("Select first rear camera video resolution :FHD (30 fps)");
		System.out.println("Select first rear camera video resolution :FHD (30 fps)");
		...
		logger.info("Select second rear camera video resolution:HD 30(fps)");
		System.out.println("Select second rear camera video resolution:FHD 30(fps)");
