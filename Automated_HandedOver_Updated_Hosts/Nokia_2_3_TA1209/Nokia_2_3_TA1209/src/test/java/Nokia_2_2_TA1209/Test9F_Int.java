		...
		driver.findElement(By.xpath("//*[@resource-id='com.hmdglobal.app.camera:id/camera_toggle_button']")).click();
  		TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@text='Photo Resolution']")).click();
	  		...
	  		logger.info("select photos from front camera  option");
			System.out.println("select photos from front camera  option");
			driver.findElement(By.xpath("//*[@text='Photos from front camera']")).click();
	  		TimeUnit.SECONDS.sleep(3);
			logger.info("Click Photo rear camera option");
			...
			driver.findElement(By.xpath("//*[@text='(4:3) 5MP']")).click();
	  		TimeUnit.SECONDS.sleep(3);
  			...
  			logger.info("Select settings option");
				...
				driver.findElement(By.xpath("//*[@text='(16:9) 4MP']")).click();
		  		TimeUnit.SECONDS.sleep(3);
		  		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		  		TimeUnit.SECONDS.sleep(2);
				((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		  	...
		  	//Click Photo rear camera
		  		System.out.println("select photo resoultion option");
	  			logger.info("select photo resoultion option");
				driver.findElement(By.xpath("//*[@text='Photos from front camera']")).click();
		  		TimeUnit.SECONDS.sleep(3);
		  	...
		  	//Select 3rd resolution
				...
				driver.findElement(By.xpath("//*[@text='(Full) 3MP']")).click();
		  		TimeUnit.SECONDS.sleep(3);
		  		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		  		TimeUnit.SECONDS.sleep(2);
		  		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		  	...
		  	//Switch back to rear camera mode
				...
				//	System.out.println("Tolerance level value  = " + TolerancePercentage);
					...
					if(Result=="Pass")
					{
						logger.info("Final message: Fail Test9F_Int Fail for front Camera image capture");
						System.out.println("Final message: Fail Test9F_Int Fail for front Camera image capture");
