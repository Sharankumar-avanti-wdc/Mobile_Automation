...
public class Test9F_Int
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera videos create test9F_Int folder and cut paste all videos in test9F_Int folder
