...
cd C:\Users\sandisk\Android11\Sony_Xperia_Pro1_XQ_BE72
mvn -DmountUnmountCycle=1  -DtotalPictureCountRear=75 -DtotalPictureCountRear1=75 -DtotalPictureCountRear2=75 -DtotalPictureCountRear3=75  -DTolerance_Level=%Tolerance_Level% -DtotalPictureCountFront=100 -DtotalPictureCountFront1=100 -DtotalPictureCountFront2=100  -DTolerance_Level=%Tolerance_Level% -DfileName=testngMain.xml clean install  >> C:\Users\sandisk\Android11\External_Logs\Test\Sony_Xperia_Pro1_XQ_BE72_%mydate%_%mytime%_%Qual_Capacity%.txt
