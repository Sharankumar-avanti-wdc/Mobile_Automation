...
import Motorola_Moto_e32s_XT22292.Test0;
import Motorola_Moto_e32s_XT22292.Test10;
...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement frontVideoSize = driver.findElement(By.xpath("//*[@resource-id='com.myos.camera:id/camera_top_bar_end_right_item']"));
			frontVideoSize.click();
			TimeUnit.SECONDS.sleep(3);
			driver.findElement(By.xpath("//*[@text='Front video resolution']")).click();
			TimeUnit.SECONDS.sleep(5);
			//Select first highest resolution 4Kfps.
			logger.info("Select first video resolution:Full");
			System.out.println("Select first video resolution: Full");
			...
			MobileElement frontVideoSize1 = driver.findElement(By.xpath("//*[@resource-id='com.myos.camera:id/camera_top_bar_end_right_item']"));
			frontVideoSize1.click();
			TimeUnit.SECONDS.sleep(3);
			driver.findElement(By.xpath("//*[@text='Front video resolution']")).click();
			TimeUnit.SECONDS.sleep(5);
			//Select Video Resolution FHD 1080 fps
			logger.info("Select second highest resolution:1080p");
			System.out.println("Select second highest resolution: 1080p");
			...
			logger.info("click setting option to select second highest video resolution");
			System.out.println("click setting option to select second highest video resolution");
			MobileElement frontVideoSize2 = driver.findElement(By.xpath("//*[@resource-id='com.myos.camera:id/camera_top_bar_end_right_item']"));
			frontVideoSize2.click();
			TimeUnit.SECONDS.sleep(3);
			driver.findElement(By.xpath("//*[@text='Front video resolution']")).click();
			TimeUnit.SECONDS.sleep(5);
			//Select Video Resolution FHD 1080 fps
			logger.info("Select 3rd highest resolution:720p");
			System.out.println("Select 3rd highest resolution: 720p");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		TimeUnit.SECONDS.sleep(5);
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera front camera videos create Test10F folder and cut paste all videos in Test10F folder
			...
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera images create Test10F folder and cut paste all videos in Test10F folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
