...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			MobileElement Delete =	driver.findElement(By.xpath("//*[@bounds='[574,554][1025,615]']"));
			Delete.click();
			TimeUnit.SECONDS.sleep(3);
			//Select Delete
	...
	public void Video() throws  IOException, InterruptedException {
		...
		logger.info("Select second highest resolution FHD 1080p, 30fps for recording");
		System.out.println("Select second highest resolution FHD 1080p, 30fps for recording");
		...
		//Start Recording
		logger.info("Click Start video recording for: 2minute video duration");
		System.out.println("Click Start video recording for: 2minute video duration");
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		try {
			...
			logger.info("Fail: Images and videos are present in the Camera folder");
