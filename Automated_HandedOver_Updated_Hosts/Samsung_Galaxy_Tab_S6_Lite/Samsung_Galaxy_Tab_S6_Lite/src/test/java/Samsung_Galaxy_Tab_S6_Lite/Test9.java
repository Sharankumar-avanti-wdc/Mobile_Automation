...
import Samsung_Galaxy_Tab_S6_Lite.Test9;
	...
	private boolean isPaused;
		...
		public void SetUp() throws MalformedURLException {
  		...
  		//Select second resolution
  			...
  			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[492,97][573,178]']"));
  			SecRes.click();
	  		TimeUnit.SECONDS.sleep(2);
	  	...
	  	//Click On Rear Image Resolution to select 3rd resolution
			MobileElement RearImage2 = driver.findElement(By.xpath("//*[@text='Ratio']"));
  			...
  			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[625,97][706,178]']"));
  			ThirdRes.click();
	  		TimeUnit.SECONDS.sleep(6);
	  	...
	  	//Click On Rear Image Resolution to select 4th resolution
			MobileElement RearImage3 = driver.findElement(By.xpath("//*[@text='Ratio']"));
  			...
  			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[758,97][839,178]']"));
  			FourthRes.click();
	  		TimeUnit.SECONDS.sleep(2);
