...
import Infinix_Note10_Pro.Test3_Int;
		...
		try {
			...
			{ 
				try {
					...
					//driver.findElement(By.xpath("//*[@text='Samsung SD card']")).click();
					TimeUnit.SECONDS.sleep(5);
					//Select More option
					...
					//	driver.findElement(By.xpath("//*[@bounds='[912,132][1056,276]']")).click();
//					TouchAction touchAction = new TouchAction(driver);
//					touchAction.tap(PointOption.point(979, 207)).perform();
					TimeUnit.SECONDS.sleep(5);
