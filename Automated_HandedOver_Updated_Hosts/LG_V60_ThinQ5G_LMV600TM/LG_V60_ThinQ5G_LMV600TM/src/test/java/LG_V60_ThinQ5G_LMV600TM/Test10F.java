...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("3.Move recorded front camera video to Test10F folder");
		...
		System.out.println("3.Move recorded front camera video to Test10F folder");
		...
		try {
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(3);
				logger.info("clcik on again later");
				System.out.println("clcik on again later");
				driver.findElement(By.xpath("//*[@text='Later']")).click();
				TimeUnit.SECONDS.sleep(3);
			} 
			catch(Exception exp)
