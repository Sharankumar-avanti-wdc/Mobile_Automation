...
public class Test10F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "realme 8i");
		dc.setCapability(MobileCapabilityType.UDID, "BM4XAYQ4DEIVNFMJ");
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			touchAction.tap(PointOption.point(320, 1780)).perform();
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("select for video resolution");
			System.out.println("select for video resolution");
			...
			driver.findElement(By.xpath("//*[@bounds='[486,56][594,242]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[900,56][1008,242]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			touchAction.tap(PointOption.point(748, 1775)).perform();
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
	...
	public void VideoPlayBackForSleepWake() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Click on first file to play newest date first recorded resolution video file from usd card");
			System.out.println("Click on first file to play newest date first recorded resolution video file from usd card");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			System.out.println("Re-launch file manager application and select external storage for data move operation, select all front camera videos present in camera folder and move to Test101F folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
