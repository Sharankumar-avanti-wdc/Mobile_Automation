...
import AlldoCube_Smile_X.Test9F_Int;
...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select Picture mode option");
			System.out.println("Select Picture mode option");
			...
			MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/btn_camera_switch']"));
			...
			//Select 3:4 
			logger.info("Select front camera third image resolution: (4:3) 0.5 megapixels");
			System.out.println("Select front camera third image resolution: (4:3) 0.5 megapixels");
			driver.findElement(By.xpath("//*[@text='(4:3) 0.5 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
