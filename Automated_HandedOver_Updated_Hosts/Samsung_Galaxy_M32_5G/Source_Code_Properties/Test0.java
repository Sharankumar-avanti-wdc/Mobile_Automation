...
public class Test0 {
	...
	@Test
  	...
  	try {
  		...
  		MobileElement Folder =	driver.findElement(By.xpath("//*[@bounds='[42,373][117,448]']"));
			...
			MobileElement Delete =	driver.findElement(By.xpath("//*[@bounds='[370,1397][529,1465]']"));
			Delete.click();
			TimeUnit.SECONDS.sleep(3);
			...
			MobileElement MovetoRecycleBin =	driver.findElement(By.xpath("//*[@bounds='[273,1374][675,1442]']"));
