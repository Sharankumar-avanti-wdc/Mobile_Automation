...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select front camera front image resolution: 13M");
			System.out.println("Select front camera front image resolution: 13M");
			driver.findElement(By.xpath("//*[@text='13M']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select front camera second image resolution: 8M");
			System.out.println("Select front camera second image resolution: 8M");
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select front camera third image resolution: 5M");
			System.out.println("Select front camera third image resolution: 5M");
			...
			driver.findElement(By.xpath("//*[@text='1M']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9F_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
