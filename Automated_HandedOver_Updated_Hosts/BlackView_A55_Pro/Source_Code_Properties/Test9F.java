...
import BlackView_A55_Pro.Test9F;
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("Captureing second resolution image "+j2);
				logger.info("Captureing second resolution image "+j2);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("Captureing second resolution image "+j3);
				logger.info("Captureing second resolution image "+j3);
			}
			TimeUnit.SECONDS.sleep(2);
