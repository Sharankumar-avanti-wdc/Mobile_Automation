...
public class Test10F_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select front camera first video resolution: SD 480p");
			System.out.println("Select front camera first video resolution: SD 480p");
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@text='SD 480p']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement secondRes = driver.findElement(By.xpath("//*[@text='CIF']"));
			secondRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Internal storagerd");
