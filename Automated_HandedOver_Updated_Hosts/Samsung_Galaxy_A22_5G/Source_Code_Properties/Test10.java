			...
			public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
				...
				Settings.click();
		  		...
		  		//Select 1st resolution
		  			logger.info("Select rear camera first video resolution:2K 30");
		  			System.out.println("Select rear camera first video resolution:2K 30");
			  	...
			  	//Click On Rear Video size to select resolution
			  		...
			  		MobileElement RearVideoSize2 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/qs_item_quality']"));
		  			...
		  			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[642,125][786,269]']"));
		  			ThirdRes.click();
			  		TimeUnit.SECONDS.sleep(2);
			  	...
			  	//Start Recording
			  		...
			  		MobileElement StartRecording2 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/shutter_button']"));
			  		...
			  		MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/shutter_button']"));
