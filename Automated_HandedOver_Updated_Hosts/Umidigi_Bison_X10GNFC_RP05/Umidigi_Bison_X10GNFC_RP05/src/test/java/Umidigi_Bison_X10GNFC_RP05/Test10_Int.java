...
import Umidigi_Bison_X10GNFC_RP05.Test10_Int;
...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select rear camera second video reslotion: HD 720p");
			System.out.println("Select rear camera second video reslotion: HD 720p");
			...
			//Select 2nd resolution
			logger.info("Select rear camera third video resolution: SD 480p");
			System.out.println("Select rear camera third video resolution: SD 480p");
