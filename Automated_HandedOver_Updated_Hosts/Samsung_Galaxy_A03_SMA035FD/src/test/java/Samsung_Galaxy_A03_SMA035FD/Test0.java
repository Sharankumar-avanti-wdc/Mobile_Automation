...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
			TimeUnit.SECONDS.sleep(2);
			logger.info("Host does not suppport Save to SD card option during Image and video capture in automation. Hence skipping Data format scenario.");
			System.out.println("Host does not suppport Save to SD card option during Image and video capture in automation. Hence skipping Data format scenario.");
			logger.info("Final Message: Pass Test0 Pass for clear recent apps and clear recent internal memory");
			System.out.println("Final Message: Pass Test0 Pass for clear recent apps and clear recent internal memory");
	...
	public void Images() throws  IOException, InterruptedException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[48,849][312,898]']")).click();
			...
			touchAction.tap(PointOption.point(121, 981)).perform();
			TimeUnit.SECONDS.sleep(10);
			//driver.findElement(By.xpath("//*[@bounds='[50,953][168,999]']")).click();
			//TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/shutter_circle_stroke']")).click();
				TimeUnit.SECONDS.sleep(2);
	...
	public void Video() throws  IOException, InterruptedException {
		...
		try {
			...
			logger.info("Select first highest  video frame rate  resolution option");
			System.out.println("Select first highest  video frame rate  resolution option");
			MobileElement FrameRate = driver.findElement(By.xpath("//*[@bounds='[319,90][389,160]']"));
			FrameRate.click();
			//Start Recording
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording = driver.findElement(By.xpath("//*[@content-desc='Start recording']"));
			...
			logger.info("Select first highest  video frame rate  resolution option");
			System.out.println("Select first highest  video frame rate  resolution option");
			MobileElement FrameRate1 = driver.findElement(By.xpath("//*[@bounds='[326,90][396,160]']"));
			FrameRate1.click();
			logger.info("Select Second highest  video frame rate  resolution option");
			System.out.println("Select Second highest  video frame rate  resolution option");
			MobileElement FrameRate2 = driver.findElement(By.xpath("//*[@bounds='[319,90][389,160]']"));
			FrameRate2.click();
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording1 = driver.findElement(By.xpath("//*[@content-desc='Start recording']"));
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		try {
			...
			try {
				...
				driver.findElement(By.xpath("//*[@bounds='[121,1168][468,1214]']")).click();
				TimeUnit.SECONDS.sleep(3);
