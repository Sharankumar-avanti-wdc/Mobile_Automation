package Ulefone_Note_6P;
import org.testng.annotations.Test;
import Ulefone_Note_6P.Test9_Int;
...
public class Test9_Int
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Note 6P");
		dc.setCapability(MobileCapabilityType.UDID, "3277BH1010001576");
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			logger.info("Test9_Int_Bcam_res: 8 resolutions supported");
			System.out.println("Test9_Int_Bcam_res: 8 resolutions supported");
			...
			logger.info("Select Rear camera first image resolution: (4:3) 8.0 megapixels");
			System.out.println("Select Rear camera first image resolution: (4:3) 8.0 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera second resolution: (4:3) 4.0 megapixels");
			System.out.println("Select Rear camera second resolution: (4:3) 4.0 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera third resolution: (4:3) 1.9 megapixels");
			System.out.println("Select Rear camera third resolution: (4:3) 1.9 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera fouth resolution: (16:9) 6.0 megapixels");
			System.out.println("Select Rear camera fourth resolution: (16:9) 6.0 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera fifth resolution: (16:9) 2.4 megapixels");
			System.out.println("Select Rear camera fifth resolution: (16:9) 2.4 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera sixth resolution: (16:9) 2.1 megapixels");
			System.out.println("Select Rear camera sixth resolution: (16:9) 2.1 megapixels");
			...
			//Select 3:4 
			logger.info("Select Rear camera seventh resolution: (18:9) 5.3 megapixels");
			System.out.println("Select Rear camera seventh resolution: (18:9) 5.3 megapixels");
			driver.findElement(By.xpath("//*[@text='(18:9) 5.3 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("totalPictureCountRear6 = "+ totalPictureCountRear6 + " Imgaes to be captured");
			...
			//Select 3:4 
			logger.info("Select Rear camera eigth resolution: (18:9) 2.3 megapixels");
			System.out.println("Select Rear camera eigth resolution: (18:9) 2.3 megapixels");
			...
			System.out.println("totalPictureCountRear7 = "+ totalPictureCountRear7 + " Imgaes to be captured");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("captureing seventh  Resolution image "+j7);
				logger.info("captureing seventh  Resolution image "+j7);
			}
			TimeUnit.SECONDS.sleep(2);
