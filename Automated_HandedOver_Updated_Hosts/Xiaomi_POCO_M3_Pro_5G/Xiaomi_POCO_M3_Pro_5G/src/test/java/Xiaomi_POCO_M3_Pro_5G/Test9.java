...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			//Select rear camera first image resolution
			logger.info("Select rear camera first image resolution");
			System.out.println("Select rear camera first image resolution");
			...
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			TimeUnit.SECONDS.sleep(3);
			//Select rear camera second image resolution
			logger.info("Select rear camera second image resolution");
			System.out.println("Select rear camera second image resolution");
			...
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			TimeUnit.SECONDS.sleep(3);
			//Select rear camera third image resolution
			logger.info("Select rear camera third image resolution");
			System.out.println("Select rear camera third image resolution");
			...
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			TimeUnit.SECONDS.sleep(3);
			//Select rear camera Fourth image resolution
			logger.info("Select rear camera Fourth image resolution");
			System.out.println("Select rear camera fourth image resolution");
