package Samsung_Galaxy_A23_SMA235F1DS;
...
public class Test8
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Galaxy A23 ");
		dc.setCapability(MobileCapabilityType.UDID, "RZ8T31WK83X");
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			logger.info("Switch to grid view mode to select music foder");
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(5);
		System.out.println("Select First audio 11 Rob Thomas - Lonely No More.mp3 for playback");
		logger.info("Select First audio 11 Rob Thomas - Lonely No More.mp3 for playback");
		//Click 1st File to Play Video
		try {
		...
		try
		{
			logger.info("Select Laahe.Mp3.mp3 file for playback");
			System.out.println("Select Laahe.Mp3.mp3 file for playback");
