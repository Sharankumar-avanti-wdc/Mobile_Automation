		...
		public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
	  	...
	  	//If Location access Permission appears Click Cancel Option
            ...
            try {
				...
				MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/switch_camera']"));
				TimeUnit.SECONDS.sleep(2);
          ...
          //Click settings options
			...
			Settings.click();
	  		...
	  		//Select 1st resolution
	  			...
	  			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[207,125][351,269]']"));
	  			FirstRes.click();
		  		TimeUnit.SECONDS.sleep(2);
	  		...
	  		//Select second  resolution
	  			...
	  			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[381,125][525,269]']"));
	  			SecRes.click();
		  		TimeUnit.SECONDS.sleep(2);
		  		// Load properties file
	  		...
	  		//Select third resolution
	  			...
	  			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[555,125][699,269]']"));
	  			ThirdRes.click();
		  		TimeUnit.SECONDS.sleep(2);
	  		...
	  		//Select fourth resolution
	  			...
	  			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[729,125][873,269]']"));
	  			FourthRes.click();
		  		TimeUnit.SECONDS.sleep(2);
