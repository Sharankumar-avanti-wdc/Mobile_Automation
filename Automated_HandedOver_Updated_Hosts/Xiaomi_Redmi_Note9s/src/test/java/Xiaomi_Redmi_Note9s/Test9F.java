...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/v9_camera_picker']"));
			...
			TimeUnit.SECONDS.sleep(3);
			//Click Full
			logger.info("Select first front camera resolution: Full");
			System.out.println("Select first front camera resolution: Full");
			...
			MobileElement SwitchToBackCamera = driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/v9_camera_picker']"));
