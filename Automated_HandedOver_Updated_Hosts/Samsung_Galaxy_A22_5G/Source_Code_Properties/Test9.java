...
import Samsung_GalaxyA22.Test9;
	...
	private boolean isPaused;
		...
		public void SetUp() throws MalformedURLException {
	  	...
	  	//Click On Rear Image Resolution to select first resolution
	  		...
	  		MobileElement RearImage = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/qs_item_ratio']"));
  			RearImage.click();
  		...
  		//Select 1st resolution
  			...
  			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[120,125][264,269]']"));
  			FirstRes.click();
	  		TimeUnit.SECONDS.sleep(2);
	  	...
	  	//Click On Rear Image Resolution to select 2nd resolution
	  		logger.info("Select Rear Image Size");
	  		System.out.println("Select Rear Image Size");
	  		MobileElement RearImage1 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/qs_item_ratio']"));
  			RearImage1.click();
  		...
  		//Select second resolution
  			...
  			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[294,125][438,269]']"));
  			SecRes.click();
	  		TimeUnit.SECONDS.sleep(2);
	  	...
	  	//Click On Rear Image Resolution to select 3rd resolution
			MobileElement RearImage2 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/qs_item_ratio']"));
  			RearImage2.click();
  			logger.info("Select third Image Resoution: 9:16");
  			System.out.println("Select third Image Resoution: 9:16");
  			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[468,125][612,269]']"));
  			ThirdRes.click();
	  		TimeUnit.SECONDS.sleep(6);
	  	...
	  	//Click On Rear Image Resolution to select 4th resolution
			MobileElement RearImage3 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/qs_item_ratio']"));
  			RearImage3.click();
  			logger.info("Select Fourth Image Resoution: 1:1");
  			System.out.println("Select Fourth Image Resoution: 1:1");
  			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[642,125][786,269]']"));
  			FourthRes.click();
	  		TimeUnit.SECONDS.sleep(2);
			...
			MobileElement RearImage4 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/qs_item_ratio']"));
  			RearImage4.click();
  			//Select fifth resolution
  			logger.info("Select fifth resolution");
  			System.out.println("Select fifth resolution");
  			MobileElement FifthRes = driver.findElement(By.xpath("//*[@bounds='[816,125][960,269]']"));
  			FifthRes.click();
	  		TimeUnit.SECONDS.sleep(2);
