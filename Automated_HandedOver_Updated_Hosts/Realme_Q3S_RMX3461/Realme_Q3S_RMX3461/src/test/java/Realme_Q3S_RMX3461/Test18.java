...
public class Test18
{
	...
	public void CopyPaste() throws InterruptedException, IOException {
		...
		try {
			...
			touchAction5.tap(PointOption.point(1003, 203)).perform();
			TimeUnit.SECONDS.sleep(5);
			// click on create folder
			logger.info("Select create folder option");
			System.out.println("Select create folder option");
			...
			touchAction7.tap(PointOption.point(1003, 203)).perform();
			TimeUnit.SECONDS.sleep(5);
			//Select Copy to
			logger.info("Select Copy to");
			System.out.println("Select Copy to");
			...
			touchAction8.longPress(LongPressOptions.longPressOptions().withDuration(Duration.ofMillis(3)).withElement (ElementOption.element (CheckTest3))).release().perform();
			TimeUnit.SECONDS.sleep(10);
			...
			touchAction9.tap(PointOption.point(1003, 203)).perform();
			TimeUnit.SECONDS.sleep(5);
