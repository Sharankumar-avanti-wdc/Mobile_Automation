...
import Samsung_Galaxy_M32_5G.Test10;
...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select First back video Resolution: FHD(30 fps)");
			System.out.println("Select First Back video resolution: FHD(30 fps)");
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[196,73][292,169]']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select second Back Video Resolution:UHD 30");
			System.out.println("Select second Back Video Resolution:UHD 30");
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[312,73][408,169]']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Third Back Video Resolution:HD 30");
			System.out.println("Select Third Back Video Resolution:HD 30");
			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[428,73][524,169]']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement StartRecording2 = driver.findElement(By.xpath("//*[@bounds='[302,1350][418,1465]']"));
			...
			MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@bounds='[302,1350][418,1465]']"));
	...
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		...
		try {
			...
			//Tap On Video Screen 
			driver.findElement(By.xpath("//*[@bounds='[0,597][720,1002]']")).click();
			logger.info("Pause Video");
			System.out.println("Pause Video");
			//Pause Video
			driver.findElement(By.xpath("//*[@bounds='[311,1378][409,1465]']")).click();
		...
		try {
			...
			//Tap On Video Screen 
			driver.findElement(By.xpath("//*[@bounds='[0,610][720,990]']")).click();
			logger.info("Pause Video");
			System.out.println("Pause Video");
			//Pause Video
			driver.findElement(By.xpath("//*[@bounds='[311,1378][409,1465]']")).click();
