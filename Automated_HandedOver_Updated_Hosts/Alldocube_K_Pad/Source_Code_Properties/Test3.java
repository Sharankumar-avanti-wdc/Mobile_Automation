...
public class Test3 {
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			// Declaring number of format cycle
			...
			{ 
				...
				MobileElement Unmount =	driver.findElement(By.xpath("//*[@bounds='[1040,740][1152,885]']"));
				Unmount.click();
				...
				MobileElement SDCard =	driver.findElement(By.xpath("//*[@bounds='[160,772][200,815]']"));
				SDCard.click();
			...
			try {
				...
				TimeUnit.SECONDS.sleep(5);
				logger.info("Check for camera folder existance");
				System.out.println("Check for camera folder existance");
