...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			((StartsActivity) driver).startActivity(new Activity("com.android.soundrecorder", "com.android.soundrecorder.SoundRecorder"));
			TimeUnit.SECONDS.sleep(4);
			...
			driver.findElement(By.xpath("//*[@text='Set save path']")).click();
			TimeUnit.SECONDS.sleep(5);
			//Select uSD card
			...
			driver.findElement(By.xpath("//*[@resource-id='com.android.soundrecorder:id/recordButton']")).click();
			TimeUnit.SECONDS.sleep(120);
			// stop recording
			logger.info("Stop Recording");
			System.out.println("Stop Recording");
			driver.findElement(By.xpath("//*[@resource-id='com.android.soundrecorder:id/stopButton']")).click();
			TimeUnit.SECONDS.sleep(5);
			...
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Recording\")").click();
			TimeUnit.SECONDS.sleep(5);
			//click on list view
