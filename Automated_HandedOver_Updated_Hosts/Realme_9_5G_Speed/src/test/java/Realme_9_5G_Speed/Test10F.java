...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@resource-id='com.oppo.camera:id/switch_camera_button']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			try {
				...
				System.err.println("Select turn on option");
			...
			MobileElement VideoResolution = driver.findElement(By.xpath("//*[@bounds='[684,0][801,240]']"));
			...
			driver.findElement(By.xpath("//*[@bounds='[486,38][594,242]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Select video Resolution");
			System.out.println("Select video resolution");
			MobileElement VideoResolution1 = driver.findElement(By.xpath("//*[@bounds='[684,0][801,240]']"));
			...
			driver.findElement(By.xpath("//*[@bounds='[900,38][1008,242]']")).click();
			TimeUnit.SECONDS.sleep(3);
	...
	public void VideoPlayBackForSleepWake() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Click on first file to play newest date first recorded resolution video file");
			System.out.println("Click on first file to play newest date first  recorded resolution video file");
