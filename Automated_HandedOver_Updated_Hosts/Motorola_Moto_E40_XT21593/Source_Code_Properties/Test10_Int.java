...
import Motorola_Moto_E40_XT21593.Test10_Int;
...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("1.Launch Camera application and start back camera video recording for all host applicable resolutions in uInternal storage");
		logger.info("2.Playback Highest resolution recorded video from UInternal storage, fast forward playback and pause video scenario ");
		logger.info("3.Playback copied videos from Test1 folder, fast forward and pause scenario");
		logger.info("4.Move recorded videos from Exteranl storage-->DCIM-->Camera folder to Test10_Int folder in external storage");
		logger.info("Setting up the appium desired capabilities");
		System.out.println("Test10_Int Scenario is as follows");
		System.out.println("1.Launch Camera application and start back camera video recording for all host applicable resolutions in uInternal storage");
		System.out.println("2.Playback Highest resolution recorded video from uInternal storage, fast forward playback and pause video scenario ");
		System.out.println("3.Playback copied videos from Test1 folder, fast forward and pause scenario");
		System.out.println("4.Move recorded videos from Exteranl storage-->DCIM-->Camera folder to Test10_Int folder in external storage");
