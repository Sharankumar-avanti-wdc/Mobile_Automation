  ...
  public class Test10_Int
  {
	...
	private boolean isPaused;
		...
		public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
	        ...
	        System.out.println("3.Playback copied videos from uSD card--> Test1-->Videos folder, fast forward and pause scenario");
	        System.out.println("4.Move recorded rear camera videos from Internal mount storage to Test10_Int folder in internal mounnt storage");
	  	...
	  	//Launch Camera Application for rear camera video recording
	  		...
	  		logger.info("Test10_Bcam_Int_res: 1 resolutions supported");
				System.out.println("Test10_Bcam_Int_res: 1 resolutions supported");
		 ...
		 // Load properties file
	  	...
	  	//launch file manager application and verify recorded video files in uSD card
			...
			TimeUnit.SECONDS.sleep(5);
			TotalFiles.click();
			logger.info("Test10_Bcam_Int_video: 1 Videos captured successfull");
			System.out.println("Test10_Bcam_Int_video: 1 Videos captured successfull");
