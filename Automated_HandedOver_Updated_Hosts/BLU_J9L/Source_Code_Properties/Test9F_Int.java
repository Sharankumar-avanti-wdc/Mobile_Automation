...
public class Test9F_Int
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "J9L");
		dc.setCapability(MobileCapabilityType.UDID, "2040306021133362");
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[364,776][436,848]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//click on camera resolutions
			logger.info("Select  settings");
			System.out.println("Select settings");
			driver.findElement(By.xpath("//*[@bounds='[408,0][480,48]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[17,424][71,478]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			driver.findElement(By.xpath("//*[@bounds='[173,424][227,478]']")).click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			driver.findElement(By.xpath("//*[@bounds='[95,424][149,478]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			driver.findElement(By.xpath("//*[@bounds='[252,424][306,478]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			driver.findElement(By.xpath("//*[@bounds='[408,424][462,478]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 4th resolution
			logger.info("Select sixth Image Resoution: (16:9) 2.4 megapixels");
			System.out.println("Select sixth Image Resoution: (16:9) 2.4 megapixels");
			driver.findElement(By.xpath("//*[@bounds='[330,424][384,478]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			{  
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 4th Resolutions (16:9) 2.4 megapixels: "+j5);
				logger.info("clicking Image of 4th Resolutions (16:9) 2.4 megapixels: "+j5);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all front camera images create Test9F_Int and cut paste all images in test9F_Int folder");
			System.out.println("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all front camera images create Test9F_Int folder and cut paste all images in test9F_Int folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//If file manager permission request access accept allow permission
			try
