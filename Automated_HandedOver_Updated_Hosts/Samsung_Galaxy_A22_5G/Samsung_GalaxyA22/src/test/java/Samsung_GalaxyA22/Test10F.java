...
import Samsung_GalaxyA22.Test10;
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
  	...
  	//Switch to rear camera mode if the current existing is front camera mode
  		try {
			...
			MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Front camera, preview\"]"));
			TimeUnit.SECONDS.sleep(2);
		...
		MobileElement FrontVideoResolution = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/qs_item_quality']"));
		...
		//Select 1st resolution
				...
				MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[381,125][525,269]']"));
				FirstRes.click();
				TimeUnit.SECONDS.sleep(2);
		...
		MobileElement FrontVideoResolution1 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/qs_item_quality']"));
		...
		//Select 2nd resolution
			...
			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[555,125][699,269]']"));
			SecRes.click();
  		TimeUnit.SECONDS.sleep(2);
