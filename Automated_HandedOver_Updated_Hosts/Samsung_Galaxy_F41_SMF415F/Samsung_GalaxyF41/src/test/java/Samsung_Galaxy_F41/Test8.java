...
public class Test8
{
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Playing recorded audio file from uSD card");
			System.out.println("Playing recorded audio file from uSD card");
			try
			{
			...
			touchAction.tap(PointOption.point(610, 1774)).perform();
