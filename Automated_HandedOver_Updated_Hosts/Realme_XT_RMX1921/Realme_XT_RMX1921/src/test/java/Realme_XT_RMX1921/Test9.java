...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		{ 
			...
			driver.findElement(By.xpath("//*[@bounds='[480,216][600,270]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select first Image Resoution: 4:3 ");
			System.out.println("Select first Image Resoution: 4:3 ");
			driver.findElement(By.xpath("//*[@bounds='[405,267][519,381]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[567,267][681,381]']")).click();
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[729,267][843,381]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[891,267][1005,381]']")).click();
			TimeUnit.SECONDS.sleep(3);
