...
public class Test10
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all Rear  camera front camera videos create BCFC_Videos folder and cut paste all videos in Test10 folder
