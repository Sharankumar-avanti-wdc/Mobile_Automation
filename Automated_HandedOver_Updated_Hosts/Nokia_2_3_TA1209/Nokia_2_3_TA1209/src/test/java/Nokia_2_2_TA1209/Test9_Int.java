  ...
  public class Test9_Int
  {
	...
	private String Result;
		...
		logger.info("Click Photo resolution");
  		...
  		//Click Photo rear camera
		logger.info("Select rear camera photo resolution option");
		System.out.println("Select rear camera photo resolution option");
  	...
  	//Select 1st resolution
		...
		driver.findElement(By.xpath("//*[@text='(4:3) 13MP']")).click();
  		TimeUnit.SECONDS.sleep(3);
  	...
  	// Load properties file
		...
		System.out.println("Rear camera first resolution:" + j + " images Captured succesfull" );
			...
			driver.findElement(By.xpath("//*[@text='(16:9) 9MP']")).click();
	  		TimeUnit.SECONDS.sleep(3);
			logger.info("2nd resolution selected (16:9) 9MP");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
	  		TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
	  		TimeUnit.SECONDS.sleep(2);
	  	...
	  	//Click Photo rear camera
	  		System.out.println("select rear camear photo resolution option");
			logger.info("select rear camear photo resolution option");
			driver.findElement(By.xpath("//*[@text='Photos from rear camera']")).click();
	  		TimeUnit.SECONDS.sleep(3);
	  	...
	  	//Select 3rd resolution
			...
			driver.findElement(By.xpath("//*[@text='(Full) 8MP']")).click();
	  		TimeUnit.SECONDS.sleep(3);
	  		...
	  		TimeUnit.SECONDS.sleep(2);
	  			...
	  			// Load properties file
	  		  	...
	  		  	//Sum total of User provided images resolution count 
	  				...
	  				if(Result=="Pass")
	  				{
	  					logger.info("Final message: Fail Test9_Int Fail for rear Camera image capture");
