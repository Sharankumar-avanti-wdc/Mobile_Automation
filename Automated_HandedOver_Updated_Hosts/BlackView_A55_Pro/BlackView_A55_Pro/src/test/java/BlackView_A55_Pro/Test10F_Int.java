...
import BlackView_A55_Pro.Test10;
...
public class Test10F_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select second highest front camera video resolution: HD");
			System.out.println("Select second highest front camera video resolution: HD");
