...
public class Test0 {
	...
	public void Video() throws  IOException, InterruptedException {
		...
		touchAction.tap(PointOption.point(316, 1781)).perform();
		TimeUnit.SECONDS.sleep(5);
		//Click On Settings
		logger.info("Select settings option");
		System.out.println("Select settings option");
		...
		logger.info("Select 1st rear Video Resolution:4K");
		System.out.println("Select 1st rear Video Resolution:  4K");
		//Select 1st resolution
		MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[72,436][129,501]']"));
		FirstRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		...
		logger.info("Select 2nd rear Video Resolution: 1080P");
		System.out.println("Select 2nd rear Video Resolution:  1080P");
		//Select 2nd resolution
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[72,588][210,653]']"));
		SecondRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		...
		logger.info("click on photo mode");
		System.out.println("click on photo mode");
		TouchAction touchAction1 = new TouchAction(driver);
		touchAction.tap(PointOption.point(750, 1768)).perform();
		TimeUnit.SECONDS.sleep(5);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(2);
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.HOME));
