	...
	private boolean isPaused;
		...
		public void SetUp() throws MalformedURLException {
  		...
  		//Select 1st resolution
  			logger.info("Select rear camera first Image Resoution: 3:4 108MP");
  			System.out.println("Select rear camera first Image Resoution: 3:4 108MP");
  			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[39,110][1041,254]']"));
  			FirstRes.click();
	  		TimeUnit.SECONDS.sleep(2);
