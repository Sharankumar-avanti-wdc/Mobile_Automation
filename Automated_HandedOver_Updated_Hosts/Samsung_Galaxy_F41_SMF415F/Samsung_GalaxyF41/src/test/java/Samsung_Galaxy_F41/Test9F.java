...
import Samsung_Galaxy_F41.Test9;
          ...
          //Click settings options
			...
			Settings.click();
	  		...
	  		//Select 1st resolution
	  			...
	  			MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[120,104][264,248]']"));
	  			FirstRes.click();
		  		TimeUnit.SECONDS.sleep(2);
	  		...
	  		//Select second  resolution
	  			...
	  			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[294,104][438,248]']"));
	  			SecRes.click();
		  		TimeUnit.SECONDS.sleep(2);
		  		// Load properties file
	  		...
	  		//Select third resolution
	  			...
	  			MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[468,104][612,248]']"));
	  			ThirdRes.click();
		  		TimeUnit.SECONDS.sleep(2);
	  		...
	  		//Select fourth resolution
	  			...
	  			MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[642,104][786,248]']"));
	  			FourthRes.click();
		  		TimeUnit.SECONDS.sleep(2);
			...
			//Result ="Pass";
			logger.info("Launch file manager application and verify captured front camera images present  in uSD Card");
			System.out.println("Launch file manager application and verify captured front camera images present  in uSD Card");
			...
			//	System.out.println("Tolerance level value  = " + TolerancePercentage);
				if(TotalImageCaptured>(Tolerance_LevelInt/100)*TotalCount)
				{
					...
					System.out.println("\nPass: Test9F pass for front camera Image capture");
