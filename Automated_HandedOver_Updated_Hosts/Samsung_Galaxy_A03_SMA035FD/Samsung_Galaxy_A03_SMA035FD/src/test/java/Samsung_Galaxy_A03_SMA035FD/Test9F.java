...
import Samsung_Galaxy_A03_SMA035FD.Test9;
...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Test9F_Fcam_res: 1 resolutions supported");
			System.out.println("Test9F_Fcam_res: 1 resolutions supported");
			...
			//RearImage.click();
			logger.info("Host does not support front camera image resolution selection.Hence capturing Images with default resolution");
			System.out.println("Host does not support front camera image resolution selection.Hence capturing Images with default resolution");

			//Select 1st resolution
			//logger.info("Select First front Image Resoution: FRONT_CAMERA_PICTURE_RATIO_NORMAL");
			//MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[219,120][339,240]']"));
			//FirstRes.click();
			//TimeUnit.SECONDS.sleep(2);
			...
			{ 
				TimeUnit.SECONDS.sleep(2);
				driver.findElement(By.xpath("//*[@bounds='[301,1348][417,1464]']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking default resolution Image"+j);
				logger.info("clicking default resolution Image"+j);
			}
			TimeUnit.SECONDS.sleep(2);
			System.out.println("Front camera :" + j + " images Captured succesfull" );
			logger.info("Front camera :" + j + " images Captured succesfull" );
			//Select Front Image size
			//logger.info("Select Front Image size");
			//System.out.println("Select Front Image size");
			...
			logger.info("Select Second resolution: FRONT_CAMERA_PICTURE_RATIO_WIDE");
			System.out.println("Select Second resolution: FRONT_CAMERA_PICTURE_RATIO_WIDE");
			...
			logger.info("Select third Image Resoution: FRONT_CAMERA_PICTURE_RATIO_SQUARE");
			System.out.println("Select third Image Resoution: FRONT_CAMERA_PICTURE_RATIO_SQUARE");
			...
			logger.info("Select fourth resolution:FRONT_CAMERA_PICTURE_RATIO_FULL");
			System.out.println("Select fourth resolution:FRONT_CAMERA_PICTURE_RATIO_FULL");
			//MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[741,120][861,240]']"));
			//FourthRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			int Tolerance_Level=75;



			double TolerancePercentage = (Tolerance_Level/100)*TotalCount;				
			...
			if(TotalImageCaptured>=TolerancePercentage*TotalCount)
			{
				...
				System.out.println("Test9F_Bcam_image: " + TotalImageCaptured + "  images Captured succesfull" );
				logger.info("Test9F_Bcam_image: " + TotalImageCaptured + "  images Captured succesfull" );
				logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
				System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
