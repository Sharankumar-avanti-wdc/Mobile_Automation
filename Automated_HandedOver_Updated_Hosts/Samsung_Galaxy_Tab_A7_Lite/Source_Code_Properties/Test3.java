...
import Samsung_Galaxy_Tab_A7_Lite.Test3;
...
public class Test3 {
	...
	//	driver.findElement(By.xpath("//*[@bounds='[216,828][864,952]']")).click();
		...
		//driver.findElement(By.xpath("//*[@bounds='[545,2071][1012,2172]']")).click();
		TimeUnit.SECONDS.sleep(30);
