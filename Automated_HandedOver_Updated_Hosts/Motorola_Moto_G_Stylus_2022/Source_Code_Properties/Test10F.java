package Motorola_Moto_G_Stylus_2022;
...
import Motorola_Moto_G_Stylus_2022.Test0;
import Motorola_Moto_G_Stylus_2022.Test10;
...
public class Test10F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "moto g stylus (2022)");
		dc.setCapability(MobileCapabilityType.UDID, "ZY22DXJK6R");
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first video resolution: Aspect ratio 9:16");
			System.out.println("Select first video resolution: Aspect ratio 9:16");
			MobileElement FirstRes = driver.findElement(By.xpath("//*[@content-desc='Aspect ratio 9:16']"));
			FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			MobileElement close = driver.findElement(By.xpath("//*[@content-desc='Close capture settings']"));
			close.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select second highest resolution: Aspect ratio Full");
			System.out.println("Select second highest resolution: Aspect ratio Full");
			MobileElement SecondRes = driver.findElement(By.xpath("//*[@content-desc='Aspect ratio Full']"));
			SecondRes.click();
			TimeUnit.SECONDS.sleep(2);
			MobileElement close1 = driver.findElement(By.xpath("//*[@content-desc='Close capture settings']"));
			close1.click();
			TimeUnit.SECONDS.sleep(2);
