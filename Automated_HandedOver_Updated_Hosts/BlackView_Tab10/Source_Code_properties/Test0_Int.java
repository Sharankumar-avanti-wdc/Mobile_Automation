...
public class Test0_Int {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			MobileElement Delete =	driver.findElement(By.xpath("//*[@bounds='[1044,48][1116,120]']"));
			Delete.click();
			TimeUnit.SECONDS.sleep(3);
	...
	public void Images() throws  IOException, InterruptedException {
		...
		try {
			...
			try {
				...
				//MobileElement SwitchToBackCamera = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout[1]/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout[1]/android.widget.RelativeLayout/android.widget.RelativeLayout[1]/android.widget.RelativeLayout"));
				TimeUnit.SECONDS.sleep(2);
			...
			MobileElement Picture = driver.findElement(By.xpath("//*[@text='Picture']"));
			Picture.click();
	...
	public void Video() throws  IOException, InterruptedException {
		...
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			e.printStackTrace();
			logger.info("Fail: Test0_Int Fail for video recording");
			logger.info("Fail: Test0_Int Fail for video recording");
			logger.info("Final Message: Test0_Int Fail for video recording");
			System.out.println("Fail: Test0_Int Fail for video recording");
			System.out.println("Fail: Test0_Int Fail for video recording");
			System.out.println("Final Message: Test0_Int Fail for video recording");
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
		}
	}
