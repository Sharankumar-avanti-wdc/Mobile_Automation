...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try {
			...
			try {
				...
				MobileElement Delete =	driver.findElement(By.xpath("//*[@bounds='[840,110][960,230]']"));
				Delete.click();
				TimeUnit.SECONDS.sleep(3);
				//Click move to recycle Bin
				logger.info("Select  move to recycle Bin");
				System.out.println("Select  move to recycle Bin");
	...
	public void Video() throws  IOException, InterruptedException {
		...
		RearVideoSize.click();
		logger.info("Select 1st Back Video Resolution: Resolution 4K UHD");
		System.out.println("Select 1st Back Video Resolution: Resolution 4K UHD");
		...
		logger.info("Select 2nd Back Video Resolution: Resolution FHD");
		System.out.println("Select 2nd Back Video Resolution: Resolution FHD");
