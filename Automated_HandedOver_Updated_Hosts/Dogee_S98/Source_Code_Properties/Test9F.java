...
public class Test9F
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement Storagepath = driver.findElement(By.xpath("//*[@bounds='[72,831][198,957]']"));
			Storagepath .click();
			TimeUnit.SECONDS.sleep(5);
			//Select SD Card
			...
			logger.info("Select photo resolution option to select resolution");
			...
			logger.info("Select front camera second image resolution: 7M");
			System.out.println("Select front camera second image resolution: 7M");
			...
			//Select third photo resolution
			logger.info("Select front camera fourth image resolution: 1M");
			System.out.println("Select front camera fourth image resolution: 1M");
			...
			// capture  pics for the selected resolution
			int j3=0;
			for(j3 = 0; j3 < totalPictureCountFront2Int; j3++) 
			{ 
				TimeUnit.SECONDS.sleep(2);
				//Start image capture
				driver.findElement(By.xpath("//*[@resource-id='com.mediatek.camera:id/iv_shutter_button_bg']")).click();
