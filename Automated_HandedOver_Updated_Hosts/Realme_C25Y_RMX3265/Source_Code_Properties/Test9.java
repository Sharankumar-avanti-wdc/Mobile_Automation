	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 1st Resolutions ultra (4:3) 12.5 megapixels: "+j);
				logger.info("clicking Image of 1st Resolutions ultra (4:3) 12.5 megapixels: "+j);
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("1st resolution selected 4:3");
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(5);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 2nd Resolutions ultra (4:3) 5.0 megapixels: "+j1);
				logger.info("clicking Image of 2nd Resolutions ultra (4:3) 5.0 megapixels: "+j1);
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("5th resolution selected (16:9) 2.4 megapixels");
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(5);
