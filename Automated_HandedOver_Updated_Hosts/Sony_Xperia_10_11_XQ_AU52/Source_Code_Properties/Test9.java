...
import Sony_Xperia_10II_XQ_AU52.Test9;
	...
	private String Result;
		...
		public void SetUp() throws MalformedURLException {
	  	...
	  	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
			...
			{ 
				logger.info("Location access element not found : "+exp); 
				System.out.println("Location access element not found : "+exp); 
			...
			logger.info("Select settings option and select image resolution");
			System.out.println("Select settings option and select image resolution");
	  	...
	  	//Click On Rear Image Resolution to select first resolution
	  		...
	  		TimeUnit.SECONDS.sleep(2);
	  	//Select 1st resolution
  			logger.info("Select second Image Resoution: 16:9 (9MP)");
  			System.out.println("Select second Image Resoution: 16:9 (9MP)");
	  	...
	  	//Select third resolution
  			logger.info("Select third Image Resoution: 1:1 (9MP)");
  			System.out.println("Select third Image Resoution: 1:1 (9MP)");
	  	...
	  	//Click Setting and select third resolution
			...
			//Click On Rear Image Resolution to select first resolution
	  		logger.info("Select Rear Image Size");
	  		System.out.println("Select Rear Image Size");
	  		MobileElement StillImage3 = driver.findElement(By.xpath("//*[@text='Still image size']"));
	  		StillImage3.click();
  		
	  	//Select Fourth resolution
  			logger.info("Select fourth Image Resoution: 1:1 (9MP)");
  			System.out.println("Select fourth Image Resoution: 1:1 (9MP)");
  			MobileElement FourthRes = driver.findElement(By.xpath("//*[@text='1:1 (9MP)']"));
  			FourthRes.click();
	  		TimeUnit.SECONDS.sleep(2);
	  		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			Properties prop3 = new Properties();
	  		...
	  		System.out.println("totalPictureCountRear2 = "+ totalPictureCountRear3);
