...
import Ulefone_Armor_X8i.Test3;
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				//MobileElement Unmount =	driver.findElement(By.xpath("//*[@bounds='[556,692][668,837]']"));
				//Unmount.click();
				...
				//MobileElement SDCard =	driver.findElement(By.xpath("//*[@bounds='[164,724][399,767]']"));
				//SDCard.click();
				...
				logger.info("Skipping Unmount/Eject, Mount scenario as host needs physical restart after Unmount/eject option");
				System.out.println("Skipping Unmount/Eject, Mount scenario as host needs physical restart after Unmount/eject option");
				try
				{
					// click on SD card
