...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			RearPhotoSize.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 first front camera resolution
			logger.info("Select first front camera resolution: Aspect ratio 3:4");
			System.out.println("Select first front camera resolution: Aspect ratio 3:4");
			driver.findElement(By.xpath("//*[@content-desc='Aspect ratio 3:4']")).click();
			TimeUnit.SECONDS.sleep(3);
			MobileElement closesettings = driver.findElement(By.xpath("//*[@content-desc='Close capture settings']"));
			closesettings.click();
			TimeUnit.SECONDS.sleep(3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 second front camera resolution
			logger.info("Select second front camera resolution: Aspect ratio 9:16");
			System.out.println("Select second front camera resolution: Aspect ratio 9:16");
			driver.findElement(By.xpath("//*[@content-desc='Aspect ratio 9:16']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("Click Photo resolution");
			MobileElement closesettings1 = driver.findElement(By.xpath("//*[@content-desc='Close capture settings']"));
			closesettings1.click();
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16 third front camera resolution
			logger.info("Select third front camera resolution: Aspect ratio Full");
			System.out.println("Select third front camera resolution: Aspect ratio Full");
			driver.findElement(By.xpath("//*[@content-desc='Aspect ratio Full']")).click();
			TimeUnit.SECONDS.sleep(3);
			MobileElement closesettings2 = driver.findElement(By.xpath("//*[@content-desc='Close capture settings']"));
			closesettings2.click();
			// Load properties file
			prop.load(Test9.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		TimeUnit.SECONDS.sleep(5);
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test9F folder and cut paste all videos in BCFC_Cameravideos folder
