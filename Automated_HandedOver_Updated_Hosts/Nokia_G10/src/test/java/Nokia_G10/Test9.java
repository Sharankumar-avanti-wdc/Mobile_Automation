	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 1st Resolutions 1:1: "+j);
			...
			TimeUnit.SECONDS.sleep(2);
			System.out.println("Back camera third resolution:" + j3 + " images Captured succesfull" );
			logger.info("Back camera third resolution:" + j3 + " images Captured succesfull" );
