...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select front camera first Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
			System.out.println("Select front camera first Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
			...
			logger.info("Select front camera second Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
			System.out.println("Select front camera second Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
