...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@bounds='[336,159][384,207]']"));
			Settings.click();
			TimeUnit.SECONDS.sleep(5);
			//Click On Storage path
			logger.info("Select Storagepath option");
			System.out.println("Select Storagepath option");
			MobileElement Storagepath = driver.findElement(By.xpath("//*[@bounds='[225,297][340,402]']"));
			Storagepath .click();
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[70,297][185,402]']")).click();
			TimeUnit.SECONDS.sleep(3);
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2nd resolution
			logger.info("Select third front video Resolution:  420p");
			System.out.println("Select third front video resolution: 420p");
			driver.findElement(By.xpath("//*[@bounds='[70,297][185,402]']")).click();
			TimeUnit.SECONDS.sleep(3);
