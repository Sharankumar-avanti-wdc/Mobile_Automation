...
public class Test3 {
	...
	public void Format() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			e.printStackTrace();
			logger.info("No apps found in background to clear");
			System.out.println("No apps found in background to clear");
		}	
		...
		try {
			...
			{ 
				// open settings app
				logger.info("Launch  setting app");
