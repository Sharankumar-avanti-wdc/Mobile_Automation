...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement Settings = driver.findElement(By.xpath("//*[@bounds='[636,48][720,132]']"));
			TimeUnit.SECONDS.sleep(5);
			Settings.click();
			////Scroll Up to find  Storage path option
			MobileElement element = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
					"new UiScrollable(new UiSelector().scrollable(true)).setMaxSearchSwipes(10)" +
					".scrollIntoView(new UiSelector().text(\"Storage Path\"))"));
			TimeUnit.SECONDS.sleep(5);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera images create Test10 and cut paste all videos in Test9 folder");
