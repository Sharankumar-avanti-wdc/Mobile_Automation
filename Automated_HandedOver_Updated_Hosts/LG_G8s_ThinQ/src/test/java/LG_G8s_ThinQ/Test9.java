...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Test9_Bcam_res: 8 resolutions supported");
			System.out.println("Test9_Bcam_res: 8 resolutions supported");
			...
			logger.info("Select first Image Resoution: 4:3 (12 MP)");
			System.out.println("Select first Image Resoution: 4:3 (12 MP)");
			driver.findElement(By.xpath("//*[@bounds='[53,922][1033,982]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("1st resolution selected 4:3 (12 MP)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 1st Resolutions 4:3 (12 MP): "+j);
				logger.info("clicking Image of 1st Resolutions 4:3 (12 MP): "+j);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select second Image Resoution:  4:3 (6.1MP)");
			System.out.println("Select first Image Resoution: 4:3 (6.1MP)");
			driver.findElement(By.xpath("//*[@bounds='[53,1029][879,1225]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("2nd resolution selected  4:3 (6.1MP)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.lge.camera:id/shutter_large_comp")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of second Resolutions  4:3 (6.1MP): "+j1);
				logger.info("clicking Image of second Resolutions  4:3 (6.1MP): "+j1);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select third Image Resoution: 16:9 (9.2 MP)");
			System.out.println("Select third Image Resoution:16:9 (9.2 MP)");
			driver.findElement(By.xpath("//*[@bounds='[53,1226][879,1377]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("3rd resolution selected 16:9 (9.2 MP)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.lge.camera:id/shutter_large_comp")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 3rd Resolutions 16:9 (9.2 MP): "+j2);
				logger.info("clicking Image of 3rd Resolutions 16:9 (9.2 MP): "+j2);
			}
			TimeUnit.SECONDS.sleep(2);	
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select fourth Image Resoution: 16:9 (4.6MP)");
			System.out.println("Select fourth Image Resoution:  16:9 (4.6MP)");
			driver.findElement(By.xpath("//*[@bounds='[53,1378][879,1529]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("4th resolution selected  16:9 (4.6MP)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.lge.camera:id/shutter_large_comp")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 4th Resolutions  16:9 (4.6MP): "+j3);
				logger.info("clicking Image of 4th Resolutions  16:9 (4.6MP): "+j3);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select fifth Image Resoution: 18:9 (8.1MP) ");
			System.out.println("Select fifth Image Resoution: 118:9 (8.1MP) ");
			driver.findElement(By.xpath("//*[@bounds='[21,1456][1059,1598]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.lge.camera:id/shutter_large_comp")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 5th Resolutions 18:9 (8.1MP) : "+j4);
				logger.info("clicking Image of 5th Resolutions 18:9 (8.1MP) : "+j4);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select sixth Image Resoution: 18:9 (4.1MP) ");
			System.out.println("Select sixth Image Resoution: 18:9 (4.1MP) ");
			driver.findElement(By.xpath("//*[@bounds='[21,1599][1059,1741]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.lge.camera:id/shutter_large_comp")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 6th Resolutions 18:9 (4.1MP) : "+j5);
				logger.info("clicking Image of 6th Resolutions 18:9 (4.1MP) : "+j5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select seventh Image Resoution: 1:1 (9.7MP) ");
			System.out.println("Select seventh Image Resoution:1:1 (9.7MP) ");
			driver.findElement(By.xpath("//*[@bounds='[21,1742][1059,1884]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.lge.camera:id/shutter_large_comp")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 7th Resolutions 1:1 (9.7MP) : "+j6);
				logger.info("clicking Image of 7th Resolutions 1:1 (9.7MP) : "+j6);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			/*MobileElement element = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
				"new UiScrollable(new UiSelector().scrollable(true)).setMaxSearchSwipes(90)" +
				".scrollIntoView(new UiSelector().text(\"1:1 (6.0MP) 2448x2448\"))"));*/
			//String text = "1:1 (6.0MP) 2448x2448";
			//driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()).setAsVerticalList().scrollIntoView("+ "new UiSelector().text(\""+text+"\"));"));
			/*	MobileElement element = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
				"new UiScrollable(new UiSelector().scrollable(true)).setMaxSearchSwipes(90)" +
				".scrollIntoView(new UiSelector().text(\"1:1 (3.4MP) 1836x1836\"))"));
		TimeUnit.SECONDS.sleep(5);*/
			//Select 1st resolution
			logger.info("Select eighth Image Resoution: 1:1 (3.4MP)");
			System.out.println("Select eighth Image Resoution: 1:1 (3.4MP)");
			driver.findElement(By.xpath("//*[@bounds='[21,1742][1059,1884]']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("8th resolution selected 1:1 (3.4MP)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.id("com.lge.camera:id/shutter_large_comp")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 8th Resolutions 1:1 (3.4MP) "+j7);
				logger.info("clicking Image of 8th Resolutions 1:1 (3.4MP): "+j7);
