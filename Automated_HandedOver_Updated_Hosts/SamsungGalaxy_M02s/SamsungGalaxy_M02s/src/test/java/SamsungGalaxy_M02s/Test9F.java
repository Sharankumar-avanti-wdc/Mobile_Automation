...
import SamsungGalaxy_M02s.Test9;
...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement res1 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/ratio_switcher']"));
			res1.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Front Image size");
			System.out.println("Select Front Image size");
			MobileElement RearImage1 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/ratio_switcher']"));
			RearImage1.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement SecRes = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/ratio_switcher']"));
			SecRes.click();
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			...
			logger.info("Select Front Image size");
			System.out.println("Select Front Image size");
			MobileElement RearImage2 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/ratio_switcher']"));
			RearImage2.click();
			TimeUnit.SECONDS.sleep(2);
			...
			MobileElement ThirdRes =driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/ratio_switcher']"));
			ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select Front Image size");
			System.out.println("Select Front Image size");
			MobileElement RearImage3 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/ratio_switcher']"));
			RearImage3.click();
			TimeUnit.SECONDS.sleep(5);
			//Select fourth resolution
			logger.info("Select fourth resolution");
			System.out.println("Select fourth resolution");
			MobileElement FourthRes =driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/ratio_switcher']"));
			FourthRes.click();
			TimeUnit.SECONDS.sleep(5);
