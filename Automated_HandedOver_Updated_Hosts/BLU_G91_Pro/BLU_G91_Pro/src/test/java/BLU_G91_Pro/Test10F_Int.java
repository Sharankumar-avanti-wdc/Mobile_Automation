...
public class Test10F_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("3.Move front camera recorded videos from Internal storage to Test10 folder in uInternal storage");
		...
		try {
			...
			MobileElement fourthres = driver.findElement(By.xpath("//*[@text='Low']"));
			fourthres.click();
			TimeUnit.SECONDS.sleep(2);
			// Load properties file for video recording duration
			...
			logger.info("Launch file manager application and verify recorded video capture uInternal storage");
			System.out.println("Launch file manager application and verify recorded video capture uInternal storage");
