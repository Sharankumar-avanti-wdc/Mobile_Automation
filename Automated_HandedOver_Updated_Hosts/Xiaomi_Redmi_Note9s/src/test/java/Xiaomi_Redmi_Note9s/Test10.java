...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[412,1915][668,2168]']"));
			...
			//click setting option to select Fourth video resolution
			logger.info("click setting option to select Fourth video resolution");
			System.out.println("click setting option to select Fourth video resolution");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_10']")).click();	
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Stop Recording");
			System.out.println("Stop Recording");
			MobileElement StopRecording3 = driver.findElement(By.xpath("//*[@bounds='[412,1915][668,2168]']"));
			...
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
