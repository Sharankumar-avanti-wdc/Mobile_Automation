...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("select front camera front resolution: 4:3 16MP");
			System.out.println("select front camera front resolution: 4:3 16MP");
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3rd resolution
			System.out.println("select front camera 5th resolution: 4:3");
			logger.info("select front camera 5Tth resolution: 4:3");
			...
			{ 
				...
				driver.findElement(By.id("com.hmdglobal.app.camera:id/shutter_button")).click();
				TimeUnit.SECONDS.sleep(3);
				System.out.println("clicking 4th Resolution image " +j4);
				logger.info("clicking 4th Resolution image " +j4);
			}
			TimeUnit.SECONDS.sleep(2);
