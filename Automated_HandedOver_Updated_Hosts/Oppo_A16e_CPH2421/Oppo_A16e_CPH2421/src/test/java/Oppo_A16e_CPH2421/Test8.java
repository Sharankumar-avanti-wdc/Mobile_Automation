...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[539,1392][660,1456]']")).click();
			...
			MobileElement location1 =	driver.findElement(By.xpath("//*[@bounds='[108,255][680,336]']"));
			location1.click();
			try {
				//Select uSD card
			...
			driver.findElement(By.xpath("//*[@text='com.media.bestrecorder.audiorecorder']")).click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(606, 1329)).perform();
