...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement VideoResolution = driver.findElement(By.xpath("//*[@bounds='[199,312][330,443]']"));
			...
			logger.info("Select Video quality");
			System.out.println("Select Video quality");
			MobileElement VideoResolution1 = driver.findElement(By.xpath("//*[@bounds='[199,312][330,443]']"));
			...
			logger.info("Select Video quality");
			System.out.println("Select Video quality");
			MobileElement VideoResolution2 = driver.findElement(By.xpath("//*[@bounds='[199,312][330,443]']"));
			...
			logger.info("Select Video quality");
			System.out.println("Select Video quality");
			MobileElement VideoResolution3 = driver.findElement(By.xpath("//*[@bounds='[199,312][330,443]']"));
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera videos create Test10 and cut paste all videos in Test10 folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
