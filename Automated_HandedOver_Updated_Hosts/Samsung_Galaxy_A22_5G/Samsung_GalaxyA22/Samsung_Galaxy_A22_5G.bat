...
cd C:\Users\7336135\Android11\eclipse-workspace\Samsung_GalaxyA22
mvn -DrecordingDurationfront=180 -DrecordingDurationfront1=180 -DrecordingDurationfront2=180  -DfileName=testng10F.xml clean install  >> C:\Users\7336135\Android11\eclipse-workspace\External_Logs\ABC\Samsung_Galaxy_A22_5G_%mydate%_%mytime%_%Qual_Capacity%.txt
