...
import Samsung_GalaxyA72.Test10;
...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
  		...
  		try 
  		{ 
  			MobileElement DenyLocation = driver.findElement(By.id("android:id/button2")); 
  	...
  	//Switch to front camera mode
		...
		//Select 1st resolution
			logger.info("Select First back video Resolution:BACK_CAMCORDER_RESOLUTION_UHD_30");
			System.out.println("Select First Back video resolution:BACK_CAMCORDER_RESOLUTION_UHD_30");
		...
		//Select 2nd resolution
			logger.info("Select second Back Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
			System.out.println("Select second Back Video Resolution:BACK_CAMCORDER_RESOLUTION_FHD_60");
		...
		logger.info("Select Third Back Video Resolution: BACK_CAMCORDER_RESOLUTION_FHD_30");
			System.out.println("Select Third Back Video Resolution: BACK_CAMCORDER_RESOLUTION_FHD_30");
		...
		//Stop Recording
		MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/normal_center_button']"));
		...
		logger.info("Click front video size and select second resolution");
		System.out.println("Click front video size and select second resolution");
		MobileElement FrontVideoResolution3 = driver.findElement(By.xpath("//*[@text='Front camera video size']"));
		FrontVideoResolution3.click();
		
		logger.info("Select Fourth Front Video Resolution: BACK_CAMCORDER_RESOLUTION_HD_30");
			System.out.println("Select Fourth Front Video Resolution: BACK_CAMCORDER_RESOLUTION_HD_30");
		...
		//Stop Recording
		MobileElement StopRecording3 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/normal_center_button']"));
