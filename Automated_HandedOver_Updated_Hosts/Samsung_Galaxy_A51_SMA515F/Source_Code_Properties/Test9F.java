	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			try {
				...
				logger.info("Switch To front Camera if current Exiting camera is in rear camera mode");
				System.out.println("Switch To front Camera if current Exiting camera is in rear camera mode");
			...
			//MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[131,120][251,240]']"));
			//FirstRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			//	MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[481,120][601,240]']"));
			//ThirdRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			//	MobileElement FourthRes = driver.findElement(By.xpath("//*[@bounds='[656,120][776,240]']"));
			//FourthRes.click();
			TimeUnit.SECONDS.sleep(2);
			...
			//Select fourth resolution
			logger.info("Select fith resolution");
			System.out.println("Select fifth resolution");
			//	MobileElement fifthRes = driver.findElement(By.xpath("//*[@bounds='[831,120][951,240]']"));
			//fifthRes.click();
			TimeUnit.SECONDS.sleep(2);
