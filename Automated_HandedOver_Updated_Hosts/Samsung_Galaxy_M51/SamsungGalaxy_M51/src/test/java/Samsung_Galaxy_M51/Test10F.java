...
import Samsung_Galaxy_M51.Test10;
...
public class Test10F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Galaxy M51");
		dc.setCapability(MobileCapabilityType.UDID, "RZ8NA12311F");
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
  	...
  	//Switch to rear camera mode if the current existing is front camera mode
		...
		MobileElement FrontVideoResolution = driver.findElement(By.xpath("//*[@text='Front camera video size']"));
		...
		//Select 1st resolution
				...
				MobileElement FirstRes = driver.findElement(By.xpath("//*[@bounds='[294,110][438,254]']"));
				FirstRes.click();
				TimeUnit.SECONDS.sleep(2);
		...
		//Stop Recording
		MobileElement StopRecording = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/stop_button_icon']"));
  		StopRecording.click();
		...
		MobileElement FrontVideoResolution1 = driver.findElement(By.xpath("//*[@text='Front camera video size']"));
		...
		//Select 2nd resolution
			...
			MobileElement SecRes = driver.findElement(By.xpath("//*[@bounds='[468,110][612,254]']"));
			SecRes.click();
  		TimeUnit.SECONDS.sleep(2);
		...
		//Stop Recording
		MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/stop_button_icon']"));
		...
		//Click On Rear Video size to select resolution
				logger.info("Click front video size and select second resolution");
				System.out.println("Click front video size and select second resolution");
				MobileElement FrontVideoResolution2 = driver.findElement(By.xpath("//*[@text='Front camera video size']"));
				...
				//Select 2nd resolution
					...
					MobileElement ThirdRes = driver.findElement(By.xpath("//*[@bounds='[642,110][786,254]']"));
					ThirdRes.click();
		  		TimeUnit.SECONDS.sleep(2);
