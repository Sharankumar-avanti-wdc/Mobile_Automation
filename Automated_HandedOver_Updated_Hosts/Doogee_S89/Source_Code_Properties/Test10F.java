...
public class Test10F
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera front camera videos create Test10 and cut paste all videos in Test10F folder");
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera images create Test10 folder and cut paste all videos in Test10F folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//If file manager permission request access accept allow permission
			try
