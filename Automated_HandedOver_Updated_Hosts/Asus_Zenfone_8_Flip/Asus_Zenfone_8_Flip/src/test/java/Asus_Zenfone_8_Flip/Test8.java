...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			((StartsActivity) driver).startActivity(new Activity("com.asus.soundrecorder", "com.asus.soundrecorder.AsusRecorder"));
			TimeUnit.SECONDS.sleep(4);
			...
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Settings\")").click();
			TimeUnit.SECONDS.sleep(5);
			//Select Storage location
			logger.info("Select Storage location");
			System.out.println("Select Storage location");
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Storage location of recordings\")").click();
			TimeUnit.SECONDS.sleep(5);
			//Select uSD card
			...
			driver.findElement(By.id("com.asus.soundrecorder:id/txt_choose_btn_recorder")).click();
			TimeUnit.SECONDS.sleep(120);
			// stop recording
			logger.info("Stop Recording");
			System.out.println("Stop Recording");
			driver.findElement(By.id("com.asus.soundrecorder:id/txt_choose_btn_pause")).click();
			TimeUnit.SECONDS.sleep(5);
			logger.info("Stop and Save Recording" );
			System.out.println("Stop and Save Recording");
			driver.findElement(By.id("com.asus.soundrecorder:id/img_choose_btn_done")).click();
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Select AsusSoundRecorder");
			System.out.println("Select AsusSoundRecorder");
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"AsusSoundRecorder\")").click();
			TimeUnit.SECONDS.sleep(5);
			//click on list view
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			touchAction.tap(PointOption.point(691, 1918)).perform();
			TimeUnit.SECONDS.sleep(20);
			//clikc Pause button
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(273, 1918)).perform();
			TimeUnit.SECONDS.sleep(20);
			//clikc Pause button
