...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[539,1384][660,1449]']")).click();
			...
			MobileElement location1 =	driver.findElement(By.xpath("//*[@bounds='[108,265][680,308]']"));
			location1.click();
			try {
				//Select uSD card
			...
			logger.info("Select sd card");
			System.out.println("Select sd card");
			driver.findElement(By.xpath("//*[@bounds='[10,527][150,587]']")).click();
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@bounds='[128,1046][430,1084]']")).click();
			TimeUnit.SECONDS.sleep(5);
			logger.info("Select android");
			System.out.println("Select android");
			driver.findElement(By.xpath("//*[@text='Android']")).click();
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			TouchAction touchAction = new TouchAction(driver);
			touchAction.tap(PointOption.point(236, 1170)).perform();
