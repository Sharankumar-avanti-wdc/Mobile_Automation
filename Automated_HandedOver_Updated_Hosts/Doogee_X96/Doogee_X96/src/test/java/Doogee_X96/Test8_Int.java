...
public class Test8_Int
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("2.Launch file manager application and playback recorded audio file from internal mount storage, fast forward audio file and pause");
		logger.info("3.Launch file manager application and playback copied audio files from internal mount storage the files are placed in the Test1 folder");
		...
		System.out.println("2.Launch file manager application and playback recorded audio file from internal mount storage, fast forward audio file and pause");
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			//System.out.println("Launch File Manager Application");
			System.out.println("SelecInternal storage");
			...
			touchAction.tap(PointOption.point(444, 1169)).perform();
