...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[930,535][1026,631]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			MobileElement VideoResolution = driver.findElement(By.xpath("//*[@bounds='[887,0][1004,240]']"));
			...
			TimeUnit.SECONDS.sleep(3);
			driver.findElement(By.xpath("//*[@bounds='[480,662][600,716]']")).click();
			...
			TimeUnit.SECONDS.sleep(5);
			//Click On Rear Video size to select resolution
			MobileElement VideoResolution1 = driver.findElement(By.xpath("//*[@bounds='[887,0][1004,240]']"));
	...
	public void VideoPlayBackForSleepWake() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Click on first file to play newest date first recorded resolution video file from sd card");
			System.out.println("Click on first file to play newest date first recorded resolution video file from sd card");
