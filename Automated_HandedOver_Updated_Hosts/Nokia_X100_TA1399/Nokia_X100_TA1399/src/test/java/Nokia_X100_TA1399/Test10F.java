...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("select 1st highest front camera video resolution:FHD 1080P/30fps");
			System.out.println("select 1st highest front camera video resolution:  FHD 1080P/30fps");
			...
			driver.findElement(By.xpath("//*[@text='Video from front camera']")).click();
			TimeUnit.SECONDS.sleep(3);
			logger.info("select 2nd highest front camera video resolution:FHD 1080P/60fps");
			System.out.println("select 2nd highest front camera video resolution:  FHD 1080P/60fps");
