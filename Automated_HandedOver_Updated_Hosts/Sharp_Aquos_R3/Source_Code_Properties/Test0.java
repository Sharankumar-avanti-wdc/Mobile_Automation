...
public class Test0 {
	...
	public void start() throws 	IOException, InterruptedException  {
		...
		try
		{
			...
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().resource-id(\"jp.co.sharp.android.launcher3:id/snapshot\")").click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void Images() throws  IOException, InterruptedException {
		...
		{ 
			TimeUnit.SECONDS.sleep(2);
			driver.findElement(By.xpath("//*[@resource-id='jp.co.sharp.android.camera:id/ui_stillcamerashutter']")).click();
			TimeUnit.SECONDS.sleep(5);
		...
		((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"100SHARP\")").click();
		TimeUnit.SECONDS.sleep(5);
	...
	public void Video() throws  IOException, InterruptedException {
		...
		logger.info("Select 2nd Back Video Resolution:4K (3840x2160)");
		System.out.println("Select 2nd Back Video Resolution: 4K (3840x2160)");
		//Select 2nd resolution
		MobileElement SecondRes = driver.findElement(By.xpath("//*[@bounds='[288,656][684,816]']"));
		SecondRes.click();
		((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
		TimeUnit.SECONDS.sleep(4);
		//Start Recording
		...
		//Search For Camera Folder
		logger.info("Select Camera Folder");
		System.out.println("select on camera folder");
		((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"100SHARP\")").click();
		TimeUnit.SECONDS.sleep(5);
		//click on more option
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		System.err.println("select browse option");
		driver.findElement(By.xpath("//*[@text='Browse']")).click();
		TimeUnit.SECONDS.sleep(3);
