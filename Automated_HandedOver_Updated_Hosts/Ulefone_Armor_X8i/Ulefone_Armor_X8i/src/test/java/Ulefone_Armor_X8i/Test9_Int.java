package Ulefone_Armor_X8i;
import org.testng.annotations.Test;
import Ulefone_Armor_X8i.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select Rear camera first image resolution: 13M");
			System.out.println("Select Rear camera first image resolution: 13M");
			driver.findElement(By.xpath("//*[@bounds='[192,570][348,726]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 18M
			logger.info("Select Rear camera second resolution: 12M");
			System.out.println("Select Rear camera second resolution: 12M");
			driver.findElement(By.xpath("//*[@bounds='[12,570][168,726]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 8M
			logger.info("Select Rear camera third resolution: 7M");
			System.out.println("Select Rear camera third resolution: 7m");
			driver.findElement(By.xpath("//*[@bounds='[372,570][528,726]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			...
			logger.info("Select Picture size option to select resolution");
			System.out.println("Select settings option to select resolution");
			MobileElement RearPhotoSize3 = driver.findElement(By.xpath("//*[@bounds='[12,80][168,231]']"));
			RearPhotoSize3.click();
			TimeUnit.SECONDS.sleep(3);
			//Select 8M
			logger.info("Select Rear camera third resolution: 5M");
			System.out.println("Select Rear camera third resolution: 5M");
			driver.findElement(By.xpath("//*[@bounds='[552,570][708,726]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
