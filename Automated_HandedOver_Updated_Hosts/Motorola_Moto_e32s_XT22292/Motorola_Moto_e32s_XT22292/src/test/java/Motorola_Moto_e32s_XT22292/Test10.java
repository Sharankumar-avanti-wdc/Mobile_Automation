...
public class Test10 
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(5);
			logger.info("Select 1st rear Video Resolution: Resolution 1080p");
			System.out.println("Select 1st rear Video Resolution: Resolution 1080p");
			...
			driver.findElement(By.xpath("//*[@text='Rear video resolution']")).click();
			TimeUnit.SECONDS.sleep(5);
			logger.info("Select 2nd rear Video Resolution: Resolution  Full");
			System.out.println("Select 2nd rear Video Resolution: Resolution  Full");
			...
			driver.findElement(By.xpath("//*[@text='Rear video resolution']")).click();
			TimeUnit.SECONDS.sleep(5);
			logger.info("Select 3rd rear Video Resolution: Resolution  720p");
			System.out.println("Select 3rd rear Video Resolution: Resolution  720p");
			//Select 2nd resolution
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		TimeUnit.SECONDS.sleep(5);
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera front camera videos create Test10 folder and cut paste all videos in Test10 folder
