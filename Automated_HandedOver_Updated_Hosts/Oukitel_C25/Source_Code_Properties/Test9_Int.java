...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first Image Resoution: (4:3) 13 megapixels");
			System.out.println("Select first Image Resoution: (4:3) 13 megapixels ");
			driver.findElement(By.xpath("//*[@text='(4:3) 13 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			...
			{ 
				...
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 1st Resolutions (4:3) 13 megapixels: "+j);
				logger.info("clicking Image of 1st Resolutions (4:3) 13 megapixels: "+j);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 2nd Image Resoution: (4:3) 7 megapixels ");
			System.out.println("Select 2nd Image Resoution: (4:3) 7 megapixels ");
			driver.findElement(By.xpath("//*[@text='(4:3) 7 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image  Resolution (4:3) 7 megapixels: "+j1);
				logger.info("clicking Image  Resolution (4:3) 7 megapixels "+j1);
			}
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select third Image Resoution: (4:3) 3 megapixels ");
			System.out.println("Select third Image Resoution: (4:3) 3 megapixels ");
			driver.findElement(By.xpath("//*[@text='(4:3) 3 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 3rd Resolutions (4:3) 3 megapixels: "+j2);
				logger.info("clicking Image of 3rd Resolutions (4:3) 3 megapixels: "+j2);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 4TH Image Resoution: (16:9) 10 megapixels ");
			System.out.println("Select 4TH Image Resoution: (16:9) 10 megapixels ");
			driver.findElement(By.xpath("//*[@text='(16:9) 10 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			for( j3 = 0; j3 < totalPictureCountRear_Int3Int; j3++)
			{
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 4TH Resolutions (16:9) 10 megapixels: "+j3);
				logger.info("clicking Image of 4TH Resolutions (16:9) 10 megapixels: "+j3);
			}
			TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 5TH Image Resoution: (16:9) 4 megapixels ");
			System.out.println("Select tTH Image Resoution: (16:9) 4 megapixels ");
			...
			for( j4 = 0; j4 < totalPictureCountRear_Int4Int; j4++)
			{
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 5TH Resolutions (16:9) 4 megapixels: "+j4);
				logger.info("clicking Image of 5TH Resolutions (16:9) 4 megapixels: "+j4);
			}
			TimeUnit.SECONDS.sleep(5);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 1st resolution
			logger.info("Select 6TH Image Resoution: (16:9) 2 megapixels ");
			System.out.println("Select 6TH Image Resoution: (16:9) 2 megapixels ");
			...
			for( j5 = 0; j5 < totalPictureCountRear_Int5Int; j5++)
			{
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(5);
				System.out.println("clicking Image of 6TH Resolutions (16:9) 2 megapixels: "+j5);
				logger.info("clicking Image of 6TH Resolutions (16:9) 2 megapixels: "+j5);
			}
			TimeUnit.SECONDS.sleep(5);
			...
			Result ="Pass";
			//Launch File manager
			logger.info("Launch file manager application and verify captured images present  in uInternal storage");
			System.out.println("Launch file manager application and verify captured images present in uInternal storage");
