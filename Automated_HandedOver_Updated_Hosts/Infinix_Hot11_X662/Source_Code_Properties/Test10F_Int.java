...
public class Test10F_Int
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@bounds='[48,1718][1032,1892]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			...
			MobileElement StartRecording = driver.findElement(By.xpath("//*[@bounds='[450,2004][630,2156]']"));
			StartRecording.click();
			//Stop Recording
			logger.info("Stop video recording");
			System.out.println("Stop video recording");
			TimeUnit.SECONDS.sleep(recordingDurationFront_IntInt);
			MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[450,2004][630,2156]']"));
			StopRecording.click();
			...
			driver.findElement(By.xpath("//*[@bounds='[48,1892][1032,2066]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording1 = driver.findElement(By.xpath("//*[@bounds='[450,2004][630,2156]']"));
			...
			MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[450,2004][630,2156]']"));
			...
			driver.findElement(By.xpath("//*[@bounds='[48,1544][1032,1718]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Click Press Back
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			logger.info("Start video recording");
			System.out.println("Start video recording");
			MobileElement StartRecording2 = driver.findElement(By.xpath("//*[@bounds='[450,2004][630,2156]']"));
			StartRecording2.click();
			//driver.findElement(By.xpath("//*[@resource-id='com.oppo.camera:id/shutter_button']")).click();
			//Stop Recording
			TimeUnit.SECONDS.sleep(recordingDurationFront_Int2Int);
			MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@bounds='[450,2004][630,2156]']"));
