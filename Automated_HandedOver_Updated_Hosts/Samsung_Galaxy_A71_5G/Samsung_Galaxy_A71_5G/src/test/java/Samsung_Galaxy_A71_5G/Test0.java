...
public class Test0 {
	...
	public void Video() throws  IOException, InterruptedException {
		...
		RearVideoSize.click();
		logger.info("Select rear camera first  Video Resolution:Rear camera video size, UHD (30 fps)");
		System.out.println("Select rear camera first  Video Resolution:Rear camera video size, UHD (30 fps)");
		...
		MobileElement StopRecording = driver.findElement(By.xpath("//*[@bounds='[540,2009][744,2183]']"));
		StopRecording.click();
		TimeUnit.SECONDS.sleep(8);
		//Click On Rear Video size to select resolution
		MobileElement RearVideoSize1 = driver.findElement(By.xpath("//*[@text='Rear camera video size']"));
		RearVideoSize1.click();
		logger.info("Select rear camera second video resolution : FHD (60 fps)");
		System.out.println("Select rear camera second video resolution: FHD (60 fps)");
		...
		logger.info("Stop video recording");
		System.out.println("Stop video recording");
		MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@bounds='[540,2009][744,2183]']"));
	...
	public void Format() throws  IOException, InterruptedException  {	
		...
		try {
			...
			System.out.println("Final Message: Fail Test0 Fail for with data scenario");
