...
cd C:\Users\7336135\Android11\eclipse-workspace\OnePlus_Nord_N10_5G
mvn -DmountUnmountCycle=1 -DrecordingDurationRearExt=600 -DrecordingDurationRearExt1=600 -DrecordingDurationfront=600 -DrecordingDurationfront1=600 -DtotalPictureCountRear=100 -DtotalPictureCountRear1=100 -DtotalPictureCountRear2=100 -DtotalPictureCountRear3=100 -DTolerance_Level=%Tolerance_Level% -DtotalPictureCountFront=18 -DtotalPictureCountFront1=18 -DtotalPictureCountFront2=18 -DTolerance_Level=%Tolerance_Level%    -DfileName=testngMain.xml clean install  >> C:\Users\Android11\eclipse-workspace\External_Logs\Test\One_Plus_Nord_N10_5G_%mydate%_%mytime%_%Qual_Capacity%.txt
