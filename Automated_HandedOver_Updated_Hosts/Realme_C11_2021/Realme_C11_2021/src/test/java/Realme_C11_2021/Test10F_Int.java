...
public class Test10F_Int
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select Video size(Front camera)");
			System.out.println("Select Video size(Front camera)");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera front camera videos create Test10F_Int folder and cut paste all videos in Test10F_Int folder
