...
public class Test18
{
	...
	public void CopyPaste() throws InterruptedException, IOException {
		...
		try {
			...
			Paste2.click();
			TimeUnit.SECONDS.sleep(120);
			logger.info("Pass: Test18 pass for Copy paste Test2 folder from External memory to internal memory is successfull");
			System.out.println("Pass: Test18 pass for Copy paste Test2 folder from External memory to internal memory is successfull");
			...
			logger.info("Select new_scenario");
			System.out.println("Select new_scenario");
