...
public class Test8
{
	...
	public void PlayCopiedAudioFile() throws InterruptedException, SecurityException, IOException {
		...
		try {
			System.out.println("Select First audio 11 Rob Thomas - Lonely No More.mp3 for play back");
			logger.info("Select First audio 11 Rob Thomas - Lonely No More.mp3 for play back");
		...
		try
		{
			...
			logger.info("Fail: Test8 Fail for Laahe.Mp3.mp3 audio play back"); 
			System.out.println("Fail: Test8 Fail for Laahe.Mp3.mp3 audio play back: "); 
			logger.info("Final Message: Fail Test8 Fail for Recorded and copied audio play back and fast forward scenario");
			System.out.println("Final Message: Fail Test8 Fail for Recorded and copied audio play back and fast forward scenario");
			logger.info("Test: End");
			System.out.println("Test: End");
