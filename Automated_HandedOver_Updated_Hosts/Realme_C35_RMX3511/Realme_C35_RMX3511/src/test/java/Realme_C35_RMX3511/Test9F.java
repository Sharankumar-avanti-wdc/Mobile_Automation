...
public class Test9F
{
	...
	public void FrontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Select first Image Resoution: (4:3) 8.1 megapixels ");
			System.out.println("Select first Image Resoution:(4:3) 8.1 megapixels ");
			driver.findElement(By.xpath("//*[@text='(4:3) 8.1 megapixels']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(4);
			...
			{  
				...
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 1st Resolutions (4:3) 8.1 megapixels : "+j);
				logger.info("clicking Image of 1st Resolutions (4:3) 8.1 megapixels : "+j);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 2ND resolution
			logger.info("Select first third Resoution:(4:3) 4.0 megapixels");
			...
			{ 
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 3rd Resolutions (4:3) 4.0 megapixels: "+j2);
				logger.info("clicking Image of 3rd Resolutions (4:3) 4.0 megapixels: "+j2);
			...
			{  
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(4);
				System.out.println("clicking Image of 4th Resolutions (16:9) 2.4 megapixels: "+j3);
				logger.info("clicking Image of 4th Resolutions (16:9) 2.4 megapixels: "+j3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 4th resolution
			logger.info("Select sixth Image Resoution: (16:9) 6.0 megapixels");
			System.out.println("Select sixth Image Resoution: (16:9) 6.0 megapixels");
			...
			{  
				...
				driver.findElement(By.xpath("//*[@resource-id='com.android.camera2:id/shutter_button']")).click();
				TimeUnit.SECONDS.sleep(2);
				System.out.println("clicking Image of 4th Resolutions (16:9) 6.0 megapixels: "+j5);
				logger.info("clicking Image of 4th Resolutions (16:9) 6.0 megapixels: "+j5);
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera videos create Test9F folder and cut paste all videos in Test9F folder
