...
import BlackView_A55_Pro.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("Select Rear camera first image resolution: 13M(4:3)");
		System.out.println("Select Rear camera first image resolution: 13M(4:3)");
		...
		//Select 3:4 
		logger.info("Select Rear camera second resolution: 10M(16:9)");
		System.out.println("Select Rear camera second resolution: 10M(16:9)");
		driver.findElement(By.xpath("//*[@text='10M(16:9)']")).click();
		TimeUnit.SECONDS.sleep(3);
		...
		//Click On Settings
				...
				//Select 3:4 
				logger.info("Select Rear camera third resolution: 10M(1:1)");
				System.out.println("Select Rear camera third resolution: 10M(1:1)");
				driver.findElement(By.xpath("//*[@text='10M(1:1)']")).click();
				TimeUnit.SECONDS.sleep(3);
				...
				//Click On Settings
						...
						//Select 3:4 
						logger.info("Select Rear camera second resolution: 10M(1:1)");
						System.out.println("Select Rear camera second resolution: 10M(1:1)");
						driver.findElement(By.xpath("//*[@text='10M(1:1)']")).click();
						TimeUnit.SECONDS.sleep(3);
