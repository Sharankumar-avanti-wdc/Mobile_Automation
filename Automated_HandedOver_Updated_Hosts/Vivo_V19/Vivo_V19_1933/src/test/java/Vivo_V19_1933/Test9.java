...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("2.Move rear camera captured images from uSD card to Test9 folder in external storage");
		...
		System.out.println("2.Move rear camera captured images from uSD card to Test9 folder in external storage");
		...
		//Launch Home screen 
				...
				TimeUnit.SECONDS.sleep(5);
				try {
					logger.info("Clearig recent apps");
					System.out.println("Clearig recent apps");
		...
		try {
			...
			MobileElement RearPhotoSize = driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/camera_switch_size_button']"));
			RearPhotoSize.click();
			TimeUnit.SECONDS.sleep(3);
			...
			driver.findElement(By.xpath("//*[@bounds='[493,90][570,210]']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			logger.info("Select photo resolution option");
			System.out.println("select photo resolution option");
			MobileElement RearPhotoSize1 = driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/camera_switch_size_button']"));
			RearPhotoSize1.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 2nd photo resolution
			logger.info("Select second rear camera resolution: Recommended: 16:9");
			System.out.println("Select second rear camera resolution: Recommended: 16:9)");
			...
			logger.info("Select photo resolution option");
			System.out.println("select photo resolution option");
			MobileElement RearPhotoSize2 = driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/camera_switch_size_button']"));
			RearPhotoSize2.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3rd photo resolution
			logger.info("Select third rear camera resolution: Recommended: 4:3");
			System.out.println("Select third rear camera resolution: Recommended: 4:3");
			...
			logger.info("Select photo resolution option");
			System.out.println("select photo resolution option");
			MobileElement RearPhotoSize3 = driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/camera_switch_size_button']"));
			RearPhotoSize3.click();
			TimeUnit.SECONDS.sleep(3);

			//Select 3rd photo resolution
			logger.info("Select fourth rear camera resolution: Recommended: 1:1");
			System.out.println("Select fourth rear camera resolution: Recommended: 1:1");
			...
			if(Result == "Fail")
			{
				...
				Result= "Pass";
				logger.info("Final Message: Pass Test9 Pass for Rear camera image captured  successfully");
				System.out.println("Final Message: Pass Test9 Pass for Rear camera image captured  successfully");
				logger.info("Test: End");
				System.out.println("Test: End");
				logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
				System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("Cut paste  rear camera images from external storage to Test9 in external storage completed successfully");
			System.out.println("Cut paste  rear camera images from external storage to Test9 in external storage completed successfully");
