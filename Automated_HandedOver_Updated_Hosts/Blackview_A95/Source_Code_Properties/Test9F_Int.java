...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("2.Move captured front images from camera folder to Test9F_Int folder");
		logger.info("Setting up the appium desired capabilities");
		System.out.println("Test9F_Int Scenario is as follows:");
		System.out.println("1.Launch camera application, set Internal storage as a Storage option, start Front camera image picture capture for all Host front resolutions");
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select front camera second image resolution: 5M(18:9)");
			System.out.println("Select front camera second image resolution: 5M(18:9)");
			driver.findElement(By.xpath("//*[@text='5M(18:9)']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			// Load properties file
			...
			System.out.println("Select front camera third image resolution: V");
			...
			logger.info("Select settings option");
			System.out.println("Select settings option");
			MobileElement Settings4 = driver.findElement(By.xpath("//*[@bounds='[636,48][720,132]']"));
			Settings4.click();
			TimeUnit.SECONDS.sleep(5);
			//Select settings option to select resolution
			logger.info("Select settings option to select resolution");
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select front camera fourth image resolution: 1M(1:1)");
			System.out.println("Select front camera fourth image resolution: 1M(1:1)");
