package Xiaomi_Redmi_10;
import org.testng.annotations.Test;
import Xiaomi_Redmi_10.Test9;
...
public class Test9
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "Redmi 10");
		dc.setCapability(MobileCapabilityType.UDID, "106092d40507");
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("2.Move rear camera captured images form uSD card to Test9 Folder in uSD card");
		...
		System.out.println("2.Move rear camera captured images form uSD card to Test9 Folder in uSD card");
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select third rear camera resolution:");
			System.out.println("Select third rear camera resolution:");
			...
			TimeUnit.SECONDS.sleep(3);
			//Click Full
			logger.info("Select Fourth rear camera resolution");
			System.out.println("Select totalPictureCountRear rear camera resolution");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test9 and cut paste all images in Test9 Folder");
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera images create Test9 folder and cut paste all images in Test8 Folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//If file manager permission request access accept allow permission
			try
