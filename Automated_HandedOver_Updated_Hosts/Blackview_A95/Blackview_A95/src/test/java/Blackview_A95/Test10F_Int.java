...
public class Test10F_Int
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		TimeUnit.SECONDS.sleep(5);
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all front camera videos create Test10F_Int folder and cut paste all videos in Test10F_Int folder
			...
			System.out.println("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all front camera videoscreate Test10F_Int folder and cut paste all videos in Test10F_Int  folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			//If file manager permission request access accept allow permission
			//Swipe and Select external storage
