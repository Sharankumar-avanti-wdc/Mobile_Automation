...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(2);	
			System.out.println("front camera third resolution:" + j1 + " images Captured succesfull" );
			logger.info("Front camera third resolution:" + j1 + " images Captured succesfull" );
			//Select settings option to select resolution
			logger.info("Select settings option to select resolution");
			System.out.println("Select settings option to select resolution");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			...
			TimeUnit.SECONDS.sleep(2);	
			System.out.println("front camera fourth resolution:" + j1 + " images Captured succesfull" );
			logger.info("Front camera fourth resolution:" + j1 + " images Captured succesfull" );
			...
			System.out.println("Total Image captured");
