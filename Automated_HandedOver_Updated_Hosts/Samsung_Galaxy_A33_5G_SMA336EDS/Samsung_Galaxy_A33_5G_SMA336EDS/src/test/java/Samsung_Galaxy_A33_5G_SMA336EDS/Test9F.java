...
import Samsung_Galaxy_A33_5G_SMA336EDS.Test9;
...
public class Test9F
{
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("2.Move rear camera captured images from external storage to Test9F folder");
		...
		try {
			...
			logger.info("Host unable to select Rear camera image resolutions during automation. !Hence captureing images with default resolution.");
			System.out.println("Host unable to select Rear camera image resolutions during automation. !Hence captureing images with default resolution.");
			...
			System.out.println("totalPictureCountFront = "+ totalPictureCountFront +"Images to captured");
