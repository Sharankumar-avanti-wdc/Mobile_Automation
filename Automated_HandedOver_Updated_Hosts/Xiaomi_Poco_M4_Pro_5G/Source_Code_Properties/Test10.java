...
import Xiaomi_Poco_M4_Pro_5G.Test10;
...
import Xiaomi_Poco_M4_Pro_5G.Test0;
...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("4.Move recorded rear camera video files to Test10 folder within uSD card");
		...
		try {
			...
			{ 
				...
				System.out.println("Location access permission pop-up not found");
			...
			logger.info("Select first highest rear camera Video resolution 1080 30Fps");
			System.out.println("Select first highest rear camera Video resolution 1080 30Fps");
			...
			logger.info("Start video recording for specified duration");
			System.out.println("Start video recording for specified duration");
			...
			logger.info("Select second highest rear camera video resolution 1080p 60FPS for recording");
			System.out.println("Select second highest rear camera video resolution 1080p 60FPS for recording");
			driver.findElement(By.xpath("//*[@bounds='[702,162][978,255]']")).click();
			TimeUnit.SECONDS.sleep(3);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/shutter_button_horizontal']")).click();
			//CLick settings button and select third resolution
			//click Back to settings option
			logger.info("click setting option to select second highest video resolution");
			System.out.println("click setting option to select second highest video resolution");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			TimeUnit.SECONDS.sleep(3);
			//Select Video Resolution FHD 1080 fps
			logger.info("Select third highest rear camera video resolution 720p 30FPS for recording");
			System.out.println("Select third highest rear camera video resolution 720 30FPS for recording");
			...
			System.out.println("Start Recording third resolution video for specified duration time");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/shutter_button_horizontal']")).click();
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		...
		try {
			...
			driver.findElement(By.xpath("//*[@resource-id='com.google.android.apps.nbu.files:id/view_mode_switch']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Select RAW folder and delete
			logger.info("Select RAW folder and delete");
			System.out.println("Select RAW folder and delete");
			// Long press and select RAW folder
			logger.info("Select RAW folder from external storage");
			System.out.println("Select RAW folder from external storage");
			MobileElement Test1 =	driver.findElement(By.xpath("//*[@text='Raw']"));
			...
			logger.info("Select Delete Permanentely option");
			System.out.println("Select Delete Permanentely option");
