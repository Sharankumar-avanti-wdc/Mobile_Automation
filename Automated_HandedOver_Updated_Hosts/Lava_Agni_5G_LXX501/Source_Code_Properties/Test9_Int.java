...
import Lava_Agni_5G_LXX501.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@text='64M']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Select 3:4 
			logger.info("Select Rear camera second resolution:  30M");
			System.out.println("Select Rear camera second resolution: 30M");
			driver.findElement(By.xpath("//*[@text='30M']")).click();
			TimeUnit.SECONDS.sleep(3);
			...
			TimeUnit.SECONDS.sleep(3);
			//Click 9:16
			logger.info("Select Rear camera fourth image resolution 16M");
			System.out.println("Select Rear camera fourth image resolution 16M");
			driver.findElement(By.xpath("//*[@text='16M']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			prop.load(Test9_Int.class.getClassLoader().getResourceAsStream("MyProject.properties"));
