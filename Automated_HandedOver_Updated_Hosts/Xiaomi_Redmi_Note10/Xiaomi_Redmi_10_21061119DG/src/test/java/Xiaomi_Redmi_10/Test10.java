...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("4. Move rear camera recorded videos from uSD card to Test10 Folder in uSD card");
		...
		System.out.println("4. Move rear camera recorded videos from uSD card to Test10 Folder in uSD card");
		...
		try {
			...
			logger.info("Select second highest resolution: FHD 1080p");
			System.out.println("Select second highest resolution: FHD 1080p");
			...
			logger.info("Pass: Test10 Pass for rear camera video recorindg scenario");
			System.out.println("Pass: Test10 Pass for rear camera video recorindg scenario");
