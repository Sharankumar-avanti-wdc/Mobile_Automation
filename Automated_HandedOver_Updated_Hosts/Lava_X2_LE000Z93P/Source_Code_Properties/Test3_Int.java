...
public class Test3_Int {
	...
	public void FormatAsInternal() throws  IOException, InterruptedException {
		...
		try {
			...
			logger.info("Click on images");
			System.out.println("Click on images");
			((FindsByAndroidUIAutomator<MobileElement>) driver).findElementByAndroidUIAutomator("new UiSelector().text(\"IMG_20230215_181315.jpg\")").click();
			TimeUnit.SECONDS.sleep(5);
