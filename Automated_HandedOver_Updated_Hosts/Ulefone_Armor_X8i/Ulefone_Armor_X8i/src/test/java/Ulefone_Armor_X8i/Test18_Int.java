...
public class Test18_Int
{
	...
	public void CopyPaste() throws InterruptedException, IOException {
		...
		try {
			...
			driver.findElement(By.xpath("//*[@text='Copy to folder']")).click();
			...
			logger.info("Select Internal storage");
			System.out.println("Select Internal storage");
			driver.findElement(By.xpath("//*[@bounds='[48,1309][112,1373]']")).click();
			TimeUnit.SECONDS.sleep(3);
			//Select ADD new folder option
			logger.info("Select ADD NEW Folder option");
			System.out.println("Select ADD NEW Folder option");
			MobileElement CreateFolder1 =	driver.findElement(By.xpath("//*[@text='Add new folder']"));
			CreateFolder1.click();
			TimeUnit.SECONDS.sleep(6);
