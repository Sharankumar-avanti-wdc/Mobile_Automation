...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			System.err.println("Select front camera");
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("1st resolution selected 8M(4:3)");
			System.out.println("1st resolution selected 8M(4:3)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				System.out.println("clicking Image of 1st Resolutions 8M(4:3)"+j);
				logger.info("clicking Image of 1st Resolutions 8M(4:3)"+j);
			}
			TimeUnit.SECONDS.sleep(2);
			//Click Settings Option
			driver.findElement(By.xpath("//*[@bounds='[15,83][62,130]']")).click();
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("2nd resolution selected 5M(4:3)");
			System.out.println("2nd resolution selected 5M(4:3)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Picture\"]")).click();
				TimeUnit.SECONDS.sleep(4);
				System.out.println("clicking Image of 2nd Resolutions 5M(4:3)"+j1);
				logger.info("clicking Image of 2nd Resolutions 5M(4:3)"+j1);
			}
			TimeUnit.SECONDS.sleep(2);
			//Click Settings Option
			driver.findElement(By.xpath("//*[@bounds='[15,83][62,130]']")).click();
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("3rd resolution selected 2M(16:9)");
			System.out.println("3rd resolution selected 2M(16:9)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{  
				...
				driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Picture\"]")).click();
				TimeUnit.SECONDS.sleep(4);
				System.out.println("clicking Image of 3rd Resolutions 2M(16:9)"+j2);
				logger.info("clicking Image of 3rd Resolutions 2M(16:9)"+j2);
			}
			TimeUnit.SECONDS.sleep(2);
			//Click Settings Option
			driver.findElement(By.xpath("//*[@bounds='[15,83][62,130]']")).click();
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("4th resolution selected 2M(4:3)");
			System.out.println("4th resolution selected 2M(4:3)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			{ 
				...
				driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Picture\"]")).click();
				TimeUnit.SECONDS.sleep(4);
				System.out.println("clicking Image of 1st Resolutions 2M(4:3)"+j3);
				logger.info("clicking Image of 1st Resolutions 2M(4:3)"+j3);
			}
			TimeUnit.SECONDS.sleep(2);
			//Click Settings Option
			driver.findElement(By.xpath("//*[@bounds='[15,83][62,130]']")).click();
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("5th resolution selected1M(16:9)");
			System.out.println("5th resolution selected1M(16:9)");
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			TimeUnit.SECONDS.sleep(5);
			//driver.findElement(By.id("//android.widget.ImageView[@content-desc="front"]")).click();
			//TimeUnit.SECONDS.sleep(5);
