...
import Blackview_Oscal_C20.Test10_Int;
...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		System.out.println("4.Copy rear camera recorded video from internal mount uSD card to Test10_Int folder in Internal mount uSD card");
		...
		try {
			...
			logger.info("Select rear camera first video resolution: HD 720p");
			System.out.println("Select rear camera first video resolution: HD 720p");
			...
			logger.info("Select rear camera second video reslotion: SD 480p");
			System.out.println("Select rear camera second video reslotion: SD 480p");
			...
			logger.info("Select rear camera third video resolution: CIF");
				System.out.println("Select rear camera third video resolution: CIF");
	...
	//Launch file manager application select internal storage,select DCIM-->Camera folder select highest resolution recorded video, Playback recorded video,fast forward and pause scenario
	...
	//Re-launch file manager application select Internal storage-->Test1 folder-->Videos folder playback all 3 copied videos fast forward and pause scenario
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test10_Int and cut paste all videos in BCFC_Cameravideos folder");
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera images create Test10_Int folder and cut paste all videos in BCFC_Cameravideos folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
