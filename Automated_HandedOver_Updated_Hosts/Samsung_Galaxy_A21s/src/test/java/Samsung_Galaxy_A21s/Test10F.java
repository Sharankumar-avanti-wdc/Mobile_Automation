...
import Samsung_Galaxy_A21s.Test10F;
...
public class Test10F
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			MobileElement SwitchToRearCamera = driver.findElement(By.xpath("//*[@content-desc='Switch to rear camera']"));
