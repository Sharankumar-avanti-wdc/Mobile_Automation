...
import io.appium.java_client.touch.offset.PointOption;
  ...
  public class Test8
  {
	...
	java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
			...
			//Click 1st File to Play Video
			try {
				System.out.println("Select 11 Rob Thomas - Lonely No More.mp3 file for play back");
				logger.info("Select  11 Rob Thomas - Lonely No More.mp3 for play back");
			...
			try {
				...
				//Click Fast forward button
				logger.info("Click fast forward button for 10 seconds audio forward");
				System.out.println("Click fast forward button for 10 seconds audio forward");TouchAction touchAction = new TouchAction(driver);
				touchAction.tap(PointOption.point(661, 1834)).perform();
				TimeUnit.SECONDS.sleep(10);
				//click Pause button
				logger.info("Pause audio playback");
