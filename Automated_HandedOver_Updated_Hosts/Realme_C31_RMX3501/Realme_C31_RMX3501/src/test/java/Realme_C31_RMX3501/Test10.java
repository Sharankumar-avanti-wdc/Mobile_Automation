...
public class Test10
{
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		isPaused = true;
		try {
			//launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera  videos create Test10 folder and cut paste all videos in Test10 folder
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera front camera videos create Test10 and cut paste all videos in Test10 folder");
