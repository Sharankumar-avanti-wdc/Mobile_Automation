...
import BlackView_A50.Test9_Int;
...
public class Test9_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		Result= "Pass";
		logger.info("Launch file manager application and verify recorded Captured images in internal mount storage");
		System.out.println("Launch file manager application and verify recorded Captured images in internal mount storage");
...
public void DataMoveOperation() throws  IOException, InterruptedException{	   
	...
	try {
		...
		logger.info("launch file manager application select Internal storage-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test9_Int and cut paste all images in Test9_Int folder");
