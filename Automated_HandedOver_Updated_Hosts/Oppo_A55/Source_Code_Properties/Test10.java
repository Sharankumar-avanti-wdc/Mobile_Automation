...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			touchAction.tap(PointOption.point(201, 1162)).perform();
			TimeUnit.SECONDS.sleep(5);
			//Click On Settings
			...
			touchAction.tap(PointOption.point(501, 1160)).perform();
			TimeUnit.SECONDS.sleep(5);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
	...
	public void CopiedvideosPlayBack() throws  IOException, InterruptedException{	   
		...
		try {
			...
			try {
				...
				logger.info("Started video playback");
				System.err.println("Started video playback");
				TimeUnit.SECONDS.sleep(20);
				//Tap Somewhere on Screen for contents to visible on Screen
				logger.info("Tap Somewhere on Screen for contents to visible on Screen");
				System.out.println("Tap Somewhere on Screen for contents to visible on Screen");
			...
			System.out.println("Select FHD 5.1 ( 1350 X 2560 ).webm.mp4 file for video playback");
