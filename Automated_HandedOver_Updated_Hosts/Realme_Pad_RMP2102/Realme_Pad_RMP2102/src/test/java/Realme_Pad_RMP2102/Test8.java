...
public class Test8
{
	...
	public void recordAudio() throws InterruptedException, SecurityException, IOException {
		...
		/*try {
			...
			MobileElement SDcard = driver.findElement(By.xpath("//*[@bounds='[81,209][1170,247]']"));
			SDcard.click();
			TimeUnit.SECONDS.sleep(5);
	...
	public void PlayRecordedAudio() throws InterruptedException, SecurityException, IOException {
		...
		try
		{
			...
			System.out.println("Selec Android folder");
			...
			data.click();
			TimeUnit.SECONDS.sleep(5);
			//Select best recorder folder
			logger.info("Select best recorder folder");
			System.out.println("Select best recorder folder");
			MobileElement best =	driver.findElement(By.xpath("//*[@text='com.media.bestrecorder.audiorecorder']"));
			best.click();
			TimeUnit.SECONDS.sleep(5);
			//Select files recorder folder
			logger.info("Select files recorder folder");
			System.out.println("Select files recorder folder");
			...
			touchAction.tap(PointOption.point(410, 1066)).perform();
