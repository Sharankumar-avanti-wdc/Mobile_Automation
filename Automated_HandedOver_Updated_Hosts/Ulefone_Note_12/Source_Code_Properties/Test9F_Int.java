...
import Ulefone_Note_12.Test9F_Int;
...
public class Test9F_Int
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Select 3:4 
			logger.info("Select front camera second image resolution: (4:3) 4.0 megapixels");
			System.out.println("Select front camera second image resolution: (4:3) 4.0 megapixels");
			...
			//Select 3:4 
			logger.info("Select front camera third image resolution: (4:3) 1.9 megapixels");
			System.out.println("Select front camera third image resolution: (4:3) 1.9 megapixels");
			...
			//Select 3:4 
			logger.info("Select front camera fourth image resolution: (16:9) 6.0 megapixels");
			System.out.println("Select front camera fourth image resolution: (16:9) 6.0 megapixels");
			...
			//Select 3:4 
			logger.info("Select front camera fifth image resolution: (16:9) 2.4 megapixels");
			System.out.println("Select front camera fifth image resolution: (16:9) 2.4 megapixels");
			...
			//Select 3:4 
			logger.info("Select front camera sixth image resolution: (16:9) 2.1 megapixels");
			System.out.println("Select front camera sixth image resolution: (16:9) 2.1 megapixels");
			...
			//Select 3:4 
			logger.info("Select front camera Seventh image resolution: (18:9) 5.3 megapixels");
			System.out.println("Select front camera Seventh image resolution: (18:9) 5.3 megapixels");
