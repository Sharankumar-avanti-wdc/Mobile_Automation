...
public class Test10_Int
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		logger.info("1.Launch Camera application and start Rear camera video recording for all host applicable resolutions in Internal mount uSD card");
		...
		System.out.println("1.Launch Camera application and start Rear camera video recording for all host applicable resolutions in Internal mount uSD card");
		System.out.println("2.Playback Highest resolution recorded video from Internal mount uSD, fast forward playback and pause video scenario ");
		...
		try {
			...
			logger.info("Test10_Int_Bcam_video: 4 resolutions supported");
			System.out.println("Test10_Int_Bcam_video: 4 resolutions supported");
			//Click On video
			...
			logger.info("Select 1st Rear Video Resolution:1080p,30fps");
			System.out.println("Select 1st Rear Video Resolution: 1080p,30fps");
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 2nd Rear Video Resolution: 720P,30fps");
			System.out.println("Select 2nd Rear Video Resolution:  720P,30fps");
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 3rd Rear Video Resolution: 1080,30fps");
			System.out.println("Select 3rd Rear Video Resolution:  1080p,60fps");
			//Select 2nd resolution
			...
			TimeUnit.SECONDS.sleep(4);
			logger.info("Select 4th Rear Video Resolution: 4k,30fps");
			System.out.println("Select 4th Rear Video Resolution:  4k,30fps");
			//Select 2nd resolution
			MobileElement FOURTHRes = driver.findElement(By.xpath("//*[@bounds='[48,1422][1032,1596]']"));
			FOURTHRes.click();
			TimeUnit.SECONDS.sleep(2);
			((PressesKey) driver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
			TimeUnit.SECONDS.sleep(2);
			...
			System.out.println("recordingDurationRear_Int3 = "+ recordingDurationRear_Int3 + "sec");
			...
			MobileElement element0 = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
					"new UiScrollable(new UiSelector().scrollable(true)).setMaxSearchSwipes(120)" +
			...
			logger.info("Calling DataMovementOperation() to move recorded rear camer videos to Test10_Int_Int Folder");
			System.out.println("Calling DataMovementOperation() to move recorded rear camer videos to Test10_Int_Int Folder");
			DataMoveOperation();
	...
	public void  RecordedVideoPlayback() throws  IOException, InterruptedException{	   
		java.util.logging.Logger logger =  java.util.logging.Logger.getLogger(this.getClass().getName());
		//Launch Camera Application for rear camera video recording
		logger.info("Launching filemanager application ");
		System.out.println("Launching filemanager application");
		((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
		TimeUnit.SECONDS.sleep(5);
		logger.info("swipe up and search for internal storage");
		System.out.println("swipe up and search for internal storage");
		...
		try {
			...
			System.out.println("Calling DataMoveOperation() to move all rear camera recorded video files to Test10_Int_Int folder");
			logger.info("Calling DataMoveOperation() to move all rear camera recorded video files to Test10_Int_Int folder");
			DataMoveOperation();
			System.out.println("Final Message: Fail Test10_Int Fail for RecordedVideoPlayBAck()");
			logger.info("Final Message: Fail Test10_Int Fail for RecordedVideoPlayBAck()");
			logger.info("Test: End");
	...
	public void DataMoveOperation() throws  IOException, InterruptedException{	   
		...
		try {
			...
			logger.info("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all back camera front camera videos create Test10_Int_Int and cut paste all videos in BCFC_Cameravideos folder");
			System.out.println("launch file manager application select uSD card-->DCIM folder-->Camera folder-->Select all rear camera images create Test10_Int_Int folder and cut paste all videos in BCFC_Cameravideos folder");
			((StartsActivity) driver).startActivity(new Activity("com.google.android.apps.nbu.files", "com.google.android.apps.nbu.files.home.HomeActivity"));
			TimeUnit.SECONDS.sleep(5);
			...
			driver.findElement(By.id("com.google.android.apps.nbu.files:id/folder_name_edit_text")).sendKeys("Test10_Int_Int");
			TimeUnit.SECONDS.sleep(5);
			//Click Create option
