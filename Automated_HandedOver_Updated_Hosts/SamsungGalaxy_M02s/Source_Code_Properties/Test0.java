...
public class Test0 {
	...
	public void Video() throws  IOException, InterruptedException {
		...
		//MobileElement RearVideoSize = driver.findElement(By.xpath("//*[@id='com.sec.android.app.camera:id/videoQuality_switcher']"));
		//RearVideoSize.click();
		logger.info("Select 1st Back Video Resolution:BACK_CAMCORDER_RESOLUTION_8K_24");
		System.out.println("Select 1st Back Video Resolution:BACK_CAMCORDER_RESOLUTION_8K_24");
		...
		//MobileElement StopRecording = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/shtter_button_layout']"));
		//StopRecording.click();
		...
		System.out.println("Select 2nd Back Video Resolution:HD 30(fps)");
		...
		logger.info("Stop video recording");
		System.out.println("Stop video recording");
		//MobileElement StopRecording1 = driver.findElement(By.xpath("//*[@resource-id='com.sec.android.app.camera:id/shtter_button_layout']"));
