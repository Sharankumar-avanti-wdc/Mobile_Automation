...
public class Test10F
{
	...
	public void frontVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			//Select 1st resolution
			logger.info("Select First back video Resolution: HD FullVision 1600x720");
			System.out.println("Select First Back video resolution: HD FullVision 1600x720");
			...
			//Select 1st resolution
			logger.info("Select First back video Resolution: HD 16:9 1280x720");
			System.out.println("Select First Back video resolution: HD 16:9 1280x720");
