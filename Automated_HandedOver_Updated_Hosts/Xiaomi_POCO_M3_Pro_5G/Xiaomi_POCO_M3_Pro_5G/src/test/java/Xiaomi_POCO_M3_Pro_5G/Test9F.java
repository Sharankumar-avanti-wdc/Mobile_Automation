...
public class Test9F
{
	...
	public void SetUp() throws MalformedURLException {
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "POCO M3 Pro 5G");
		dc.setCapability(MobileCapabilityType.UDID, "7l9twofy8xwobqi7");
	...
	public void frontPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			logger.info("Launching settings application and set external storage as storage option for front camera image capture.");
			System.out.println("Launching settings application and set external storage as storage option for front camera image capture.");
			...
			MobileElement SwitchToFrontCamera = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Front and rear camera switch\"]"));
			...
			//Select settings option to select resolution
			logger.info("Select settings option to select resolution");
			System.out.println("Select settings option to select resolution");//Click Settings Option
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			TimeUnit.SECONDS.sleep(3);
			...
			System.out.println("totalPictureCountRear2 = "+ totalPictureCountFront2);
