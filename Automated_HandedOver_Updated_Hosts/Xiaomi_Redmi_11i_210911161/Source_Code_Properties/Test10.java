...
public class Test10
{
	...
	public void rearVideoRec() throws InterruptedException, SecurityException, IOException {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(3);
			logger.info("UHD 4K, 30fps Video Resolution doesn't support to recording 7 minutes morethan ");
			System.out.println("UHD 4K, 30fps Video Resolution doesn't support to recording 7 minutes morethan ");
			//click Back to settings option
			logger.info("click setting option to select 1st highest video resolution");
			System.out.println("click setting option to select 1st highest video resolution");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			TimeUnit.SECONDS.sleep(3);
			//Select Video Resolution FHD 1080 fps
			logger.info("Select 1st highest resolution: UHD 4K, 30fps");
			System.out.println("Select 1st highest resolution: UHD 4K, 30fps");
			...
			//Start recording
			logger.info("Start Recording 1st resolution video for specified duration time");
			System.out.println("Start Recording 1st resolution video time");
			...
			prop1.load(Test10.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			String recordingDurationRear1 = prop1.getProperty("recordingDurationRear1");  
			...
			TimeUnit.SECONDS.sleep(3);
			//click Back to settings option
			logger.info("click setting option to select 3rd highest video resolution");
			System.out.println("click setting option to select 3rd highest video resolution");
			driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/top_config_12']")).click();	
			TimeUnit.SECONDS.sleep(3);
			//Select Video Resolution FHD 1080 fps
			logger.info("Select 3rd highest resolution: FHD 1080p, 60fps");
			System.out.println("Select 3rd highest resolution: FHD 1080p, 60fps");
			driver.findElement(By.xpath("//*[@bounds='[552,162][753,255]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file
			Properties prop2 = new Properties();
			prop2.load(Test10.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			String recordingDurationRear2 = prop2.getProperty("recordingDurationRear2");  
			...
			System.out.println("Start Recording 3rd resolution video time");
			...
			//Stop recording
			MobileElement StopRecording2 = driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/shutter_button_horizontal']"));
			...
			logger.info("Select 4th video resolution: HD 720p, 30fps");
			System.out.println("Select 4th video resolution: HD 720p, 30fps");
			driver.findElement(By.xpath("//*[@bounds='[102,162][303,255]']")).click();
			TimeUnit.SECONDS.sleep(3);
			// Load properties file for video recording duration
			Properties prop3 = new Properties();
			prop3.load(Test10.class.getClassLoader().getResourceAsStream("MyProject.properties"));
			TimeUnit.SECONDS.sleep(5);
			String recordingDurationRear3 = prop3.getProperty("recordingDurationRear3");  
			...
			MobileElement StopRecording3 = driver.findElement(By.xpath("//*[@resource-id='com.android.camera:id/shutter_button_horizontal']"));
			...
			logger.info("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			System.out.println("===================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================");
			logger.info("Calling RecordedVideoPlayback() for Playing Highest record video, fast forward video play back scenario");			System.out.println("Calling RecordedVideoPlayback() for Playing Highest record video, fast forward video play back scenario");
			//call recordedvideoplayback
