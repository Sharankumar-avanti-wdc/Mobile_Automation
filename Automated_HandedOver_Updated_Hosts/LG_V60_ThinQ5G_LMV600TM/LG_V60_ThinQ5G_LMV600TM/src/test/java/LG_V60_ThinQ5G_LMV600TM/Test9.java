...
public class Test9
{
	...
	public void RearPictureCapture() throws InterruptedException, SecurityException, IOException {
		...
		{ 
			...
			TimeUnit.SECONDS.sleep(2);
			logger.info("Rear camera 9th resolution: " + j8 + " images Captured succesfull");
			System.out.println("Rear camera 9th resolution: " + j8 + " images Captured succesfull" );
			...
			Result ="Pass";
			//Launch File manager
			logger.info("Launch file manager application and verify captured imgaes present  in uSD Card");
			System.out.println("Launch file manager application and verify captured imgaes present in uSD Card");
